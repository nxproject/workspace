...
(function (root, factory) {
    ...
    var NotiflixNotify = function (message, callbackOrOptions, options, staticType) {
        ...
        var closeButtonHTML = '';
        // ECANDIDUS 2020-09-20
        //if (newNotifySettings.closeButton && typeof callbackOrOptions !== 'function') {
        if (newNotifySettings.callbackOnTextClick || (newNotifySettings.closeButton && typeof callbackOrOptions !== 'function')) {
            // END ECANDIDUS
        ...
        if (newNotifySettings.useIcon) {
            ...
            if (newNotifySettings.useFontAwesome) {
                ...
                ntflxNotify.innerHTML = '<i style="color:' + theType.fontAwesomeIconColor + '; font-size:' + newNotifySettings.fontAwesomeIconSize + ';" class="nmi wfa ' + theType.fontAwesomeClassName + ' ' + (newNotifySettings.fontAwesomeIconStyle === 'shadow' ? 'shadow' : 'basic') + '"></i><span class="the-message with-icon">' + message + '</span>' + (newNotifySettings.callbackOnTextClick || newNotifySettings.closeButton ? closeButtonHTML : '');
                // END ECANDIDUS
            }
            // use notiflix icon
            else {
                ...
                ntflxNotify.innerHTML = svgIcon + '<span class="the-message with-icon">' + message + '</span>' + (newNotifySettings.callbackOnTextClick || newNotifySettings.closeButton ? closeButtonHTML : '');
                // END ECANDIDUS
            }
        }
        // without icon
            ...
            ntflxNotify.innerHTML = '<span class="the-message">' + message + '</span>' + (newNotifySettings.callbackOnTextClick || newNotifySettings.closeButton ? closeButtonHTML : '');
            // END ECANDIDUS
        }
        // use icon: end
        // notify content: end
        ...
        if (window.document.getElementById(ntflxNotify.id)) {
            ...
            if (newNotifySettings.callbackOnTextClick || (newNotifySettings.closeButton && typeof callbackOrOptions !== 'function')) {
                ...
                closeButtonElm.addEventListener('click', function () {
                    // ECANDIDUS 2020-09-20
                    ntflxNotify.forcedCloseClicked = true;
                    // END ECANDIDUS
            ...
            if (typeof callbackOrOptions === 'function' || newNotifySettings.clickToClose) {
                removeDiv.addEventListener('click', function () {
                    // ECANDIDUS 2020-09-20
                    //if (typeof callbackOrOptions === 'function') {
                    if (typeof callbackOrOptions === 'function' && !ntflxNotify.forcedCloseClicked) {
                        // END ECANDIDUS
                        notifyElmCountOnlyCallback--;
                        callbackOrOptions();
                    }
