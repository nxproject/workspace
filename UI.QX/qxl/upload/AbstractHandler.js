 ...
 */
qx.Class.define("qxl.upload.AbstractHandler", {
  type : "abstract", 
   ...
   * 
   * @param uploader
   *          {qxl.upload.UploadMgr} controller for uploading
   */
  ...
  members: {
    ...
    // Queue of qxl.upload.File's to send
    __queue: null,

    // List of qxl.upload.File's currently being sent
    __current: null,
     ...
     * 
     * @param file
     *          {qxl.upload.File} the file to add
     */
     ...
     * 
     * @param file
     *          {qxl.upload.File} the file to cancel
     */
     ...
     * 
     * @param file
     *          {qxl.upload.File} the file which has finsihed
     *          uploading
     * @param response
     ...
     * @deprecated {1.0} see qxl.upload.UploadMgr.setParam or
     *             qxl.upload.File.setParam
     */
    addParam: function(key, value) {
      qx.log.Logger.deprecatedMethodWarning(arguments.callee,
          "see qxl.upload.UploadMgr.setParam or qxl.upload.File.setParam");
     ...
     * 
     * @returns {Map}
     * @deprecated {1.0} see qxl.upload.File.getParam
     */
    getParams: function() {
      qx.log.Logger.deprecatedMethodWarning(arguments.callee,
          "see qxl.upload.UploadMgr.getParam or qxl.upload.File.getParam");
    ...
    /**
     * Implementation must create a qxl.upload.File or array of
     * qxl.upload.File
     * 
     * @param input
     *          {DOM} the DOM input[type=file]
     * @return {qxl.upload.File|qxl.upload.File[]}
     */
     ...
     * 
     * @param file
     *          {qxl.upload.File} file to cancel uploading
     */
