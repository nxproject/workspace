    ...
    function save() {
        function saveByteArrayLocally(err, data) {
            ...
            reader.onloadend = function () {
                ...
                // Send to server
                $.post('/fraw' + window.nx.file.substr(2), text, function () {
                    // Close(maybe not for Save & Continue)
                    parent.window.nx.desktop.findWindow(window.nx.winid).safeClose();
                }, 'text');
            }
