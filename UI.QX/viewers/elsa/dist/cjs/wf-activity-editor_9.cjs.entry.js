...
class ActivityEditor {
    constructor(hostRef) {
        ...
        this.submit = __chunk_1.createEvent(this, "update-activity", 7);
    }
    async onSubmit(e) {
        e.preventDefault();
        const form = e.target;
    ...
    render() {
        ...
        return (__chunk_1.h("div", null, __chunk_1.h("div", { class: "modal", tabindex: "-1", role: "dialog" }, __chunk_1.h("div", { class: "modal-dialog modal-xl", role: "document" }, __chunk_1.h("div", { class: "modal-content" }, __chunk_1.h("form", { onSubmit: e => this.onSubmit(e) }, __chunk_1.h("div", { class: "modal-header" }, __chunk_1.h("h5", { class: "modal-title" }, "Edit ", displayName), __chunk_1.h("button", { type: "button", class: "close", "data-dismiss": "modal", "aria-label": "Close" }, __chunk_1.h("span", { "aria-hidden": "true" }, "\u00D7"))), __chunk_1.h("div", { class: "modal-body" }, __chunk_1.h("wf-activity-renderer", { activity: activity, activityDefinition: activityDefinition, displayMode: ActivityDisplayMode.Edit, ref: x => this.renderer = x })), __chunk_1.h("div", { class: "modal-footer" }, __chunk_1.h("button", { type: "button", class: "btn btn-secondary", "data-dismiss": "modal" }, "Cancel"), __chunk_1.h("button", { type: "submit", class: "btn btn-primary" }, "Save"))))))));
    }
...
class ActivityPicker {
    constructor(hostRef) {
        ...
        this.renderActivity = (activity) => {
            ...
            return (__chunk_1.h("div", { class: "card activity" }, __chunk_1.h("div", { class: "card-body" }, __chunk_1.h("h4", { class: "card-title" }, __chunk_1.h("i", { class: iconClass }), activity.displayName), __chunk_1.h("p", null, activity.description), __chunk_1.h("a", { href: "#", onClick: e => {
                    e.preventDefault();
                    this.selectCategory(activity.category);
                } }, __chunk_1.h("span", { class: "badge badge-light" }, activity.category))), __chunk_1.h("div", { class: "card-footer text-muted text-xs-right" }, __chunk_1.h("a", { class: "btn btn-primary btn-sm", href: "#", onClick: async (e) => {
                    e.preventDefault();
                    await this.onActivitySelected(activity);
                } }, "Select"))));
        };
        this.activitySelected = __chunk_1.createEvent(this, "activity-picked", 7);
    }
    async show() {
        this.isVisible = true;
    ...
    render() {
        ...
        return (__chunk_1.h("div", null, __chunk_1.h("div", { class: "modal", tabindex: "-1", role: "dialog", ref: el => this.modal = el }, __chunk_1.h("div", { class: "modal-dialog modal-xl", role: "document" }, __chunk_1.h("div", { class: "modal-content" }, __chunk_1.h("div", { class: "modal-header" }, __chunk_1.h("h5", { class: "modal-title" }, "Available Activities"), __chunk_1.h("button", { type: "button", class: "close", "data-dismiss": "modal", "aria-label": "Close" }, __chunk_1.h("span", { "aria-hidden": "true" }, "\u00D7"))), __chunk_1.h("div", { class: "modal-body" }, __chunk_1.h("div", { class: "row" }, __chunk_1.h("div", { class: "col-sm-3 col-md-3 col-lg-2" }, __chunk_1.h("div", { class: "form-group" }, __chunk_1.h("input", { class: "form-control", type: "search", placeholder: "Filter", "aria-label": "Filter", autofocus: true, onKeyUp: this.onFilterTextChanged })), __chunk_1.h("ul", { class: "nav nav-pills flex-column activity-picker-categories" }, categories.map(category => {
            ...
            return (__chunk_1.h("li", { class: "nav-item" }, __chunk_1.h("a", { class: classes, href: "#", "data-toggle": "pill", onClick: e => {
                    e.preventDefault();
                    this.selectCategory(category);
                } }, categoryDisplayText)));
        }))), __chunk_1.h("div", { class: "col-sm-9 col-md-9 col-lg-10" }, __chunk_1.h("div", { class: "card-columns tab-content" }, definitions.map(this.renderActivity))))), __chunk_1.h("div", { class: "modal-footer" }, __chunk_1.h("button", { type: "button", class: "btn btn-secondary", "data-dismiss": "modal" }, "Cancel")))))));
    }
    get el() { return __chunk_1.getElement(this); }
    static get style() { return ""; }
}
...
class ActivityRenderer {
    ...
    renderDesigner() {
        ...
        return (__chunk_1.h("div", null, __chunk_1.h("h5", null, __chunk_1.h("i", { class: iconClass }), result.title), __chunk_1.h("p", { innerHTML: result.description })));
    }
    renderEditor() {
        const activity = this.activity;
        const definition = this.activityDefinition;
        const properties = definition.properties;
        return (__chunk_1.h(__chunk_1.Host, null, properties.map(property => {
            const html = DisplayManager$1.displayEditor(activity, property);
            return __chunk_1.h("div", { class: "form-group", innerHTML: html });
        })));
    }
...
class ContextMenu {
    constructor(hostRef) {
        ...
        this.contextMenuEvent = __chunk_1.createEvent(this, "context-menu", 7);
    }
    ...
    render() {
        ...
        return (__chunk_1.h(__chunk_1.Host, { class: "dropdown-menu context-menu canvas-context-menu position-fixed", style: css, onClick: this.onContextMenuClick }, __chunk_1.h("slot", null)));
    }
    setupTarget(value) {
        if (!!value) {
...
class ContextMenuItem {
    ...
    render() {
        ...
        return (__chunk_1.h("a", { class: "dropdown-item", href: "#", onClick: e => e.preventDefault() }, text));
    }
    get el() { return __chunk_1.getElement(this); }
    static get style() { return ""; }
}
...
class Designer {
    constructor(hostRef) {
        ...
        this.renderContextMenu = () => {
            if (this.readonly)
                return null;
            return ([
                __chunk_1.h("wf-context-menu", { target: this.elem() }, __chunk_1.h("wf-context-menu-item", { text: "Add", onClick: this.onAddActivityClick })),
                __chunk_1.h("wf-context-menu", { ref: (el) => this.activityContextMenu = el }, __chunk_1.h("wf-context-menu-item", { text: "Edit", onClick: this.onEditActivityClick }), __chunk_1.h("wf-context-menu-item", { text: "Delete", onClick: this.onDeleteActivityClick }))
            ]);
        };
        ...
        this.editActivityEvent = __chunk_1.createEvent(this, "edit-activity", 7);
        this.addActivityEvent = __chunk_1.createEvent(this, "add-activity", 7);
        this.workflowChanged = __chunk_1.createEvent(this, "workflowChanged", 7);
    }
    ...
    render() {
        ...
        return (__chunk_1.h("host", { class: "workflow-canvas", ref: el => this.canvas = el, style: { height: this.canvasHeight } }, activities.map((model) => {
            ...
            if (!this.readonly) {
                return (__chunk_1.h("div", { id: `wf-activity-${activity.id}`, "data-activity-id": activity.id, class: classes, style: styles, onDblClick: () => this.onEditActivity(activity), onContextMenu: (e) => this.onActivityContextMenu(e, activity) }, __chunk_1.h("wf-activity-renderer", { activity: activity, activityDefinition: model.definition, displayMode: ActivityDisplayMode.Design })));
            }
            else {
                ...
                return (__chunk_1.h("div", Object.assign({ id: `wf-activity-${activity.id}`, "data-activity-id": activity.id, class: classes, style: styles }, popoverAttributes), __chunk_1.h("wf-activity-renderer", { activity: activity, activityDefinition: model.definition, displayMode: ActivityDisplayMode.Design })));
            }
        }), this.renderContextMenu()));
    }
...
class ExpressionFieldDriver {
    constructor() {
        this.displayEditor = (activity, property) => {
            const name = property.name;
            const label = property.label;
            const value = activity.state[name] || { expression: '', syntax: 'Eval' };
...
class TaskActivities {
    constructor() {
        ...
        this.sendemail = () => ({ type: 'send.email', displayName: 'send.email,', description: 'Sends an EMail,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'to', type: 'expression', label: 'To', hint: 'E-Mail address to send the email' }, { name: 'subj', type: 'expression', label: 'Subj', hint: 'The subject of the message to be sent' }, { name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to be sent' }, { name: 'list', type: '', label: 'List', hint: 'List of documents to attach' }, { name: 'meeting', type: '', label: 'Meeting', hint: 'Calendar object' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.sendqm = () => ({ type: 'send.qm', displayName: 'send.qm,', description: 'Sends a Quick Message,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'to', type: 'expression', label: 'To', hint: 'User to send the quick message to' }, { name: 'subj', type: 'expression', label: 'Subj', hint: 'The subject of the message to be sent' }, { name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to be sent' }, { name: 'list', type: 'expression', label: 'List', hint: 'List of documents to attach' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.sendsms = () => ({ type: 'send.sms', displayName: 'send.sms,', description: 'Sends a SMS message,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'to', type: 'expression', label: 'To', hint: 'Phone number to send SMS message to (self if empty)' }, { name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to be sent' }, { name: 'list', type: 'expression', label: 'List', hint: 'List of documents to attach' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
...
class WorkflowActivities {
    constructor() {
        ...
        this.call = () => ({ type: 'call', displayName: 'call,', description: 'Starts a workflow,', runtimeDescription: 'x => !!x.state.workflow ? `Starts <strong>${ x.state.workflow.expression }</strong>` : x.definition.description', category: 'Action', icon: 'fas fa-dot-circle', outcomes: [OutcomeNames.Done, OutcomeNames.OnError], properties: [{ name: 'workflow', type: 'expression', label: 'Workflow', hint: 'The workflow to start' }, { name: 'name', type: 'text', label: 'Name', hint: 'The user defined name' }, { name: 'store', type: 'expression', label: 'Store', hint: 'The store to pass' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.delay = () => ({ type: 'delay', displayName: 'delay,', description: 'Delays for a specified duration,', runtimeDescription: 'x => !!x.state.duration ? `Delay for <strong>${ x.state.duration.expression }</strong>` : x.definition.description', category: 'Action', icon: 'fas fa-dot-circle', outcomes: [OutcomeNames.Done], properties: [{ name: 'duration', type: 'expression', label: 'Duration', hint: 'The duration length' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.end = () => ({ type: 'end', displayName: 'end,', description: 'Ends the workflow,', category: 'Flow', icon: 'fas fa-code-branch', outcomes: [], properties: [{ name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.fork = () => ({ type: 'fork', displayName: 'fork,', description: 'Fork workflow execution into multiple branches,', category: 'Flow', icon: 'fas fa-code-branch', outcomes: 'x => x.state.branches', properties: [{ name: 'branches', type: 'list', label: 'Branches', hint: 'A comma-separated list of names representing branches' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.ifelse = () => ({ type: 'ifelse', displayName: 'ifelse,', description: 'Evaluate a Boolean expression and continue execution depending on the result,', runtimeDescription: 'x => !!x.state.expression ? `Evaluate <strong>${ x.state.expression.expression }</strong> and continue execution depending on the result.` : x.definition.description', category: 'Flow', icon: 'fas fa-code-branch', outcomes: [OutcomeNames.True, OutcomeNames.False], properties: [{ name: 'expression', type: 'expression', label: 'Expression', hint: 'The expression to evaluate. The evaluated value will be used to switch on' }] });
        ...
        this.switch = () => ({ type: 'switch', displayName: 'switch,', description: 'Switch execution based on a given expression,', runtimeDescription: 'x => !!x.state.expression ? `Switch execution based on <strong>${ x.state.expression.expression }</strong>.` : x.definition.description', category: 'Flow', icon: 'fas fa-code-branch', outcomes: 'x => x.state.cases', properties: [{ name: 'expression', type: 'expression', label: 'Expression', hint: 'The expression to evaluate. The evaluated value will be used to switch on' }, { name: 'cases', type: 'list', label: 'Cases', hint: 'A comma-separated list of possible outcomes of the expression' }] });
        this.task = () => ({ type: 'task', displayName: 'task,', description: 'Calls a task,', runtimeDescription: 'x => !!x.state.task ? `Calls <strong>${ x.state.task.expression }</strong>` : x.definition.description', category: 'Action', icon: 'fas fa-dot-circle', outcomes: [OutcomeNames.Done], properties: [{ name: 'task', type: 'expression', label: 'Task', hint: 'The task to call' }, { name: 'store', type: 'expression', label: 'Store', hint: 'The store to pass' }, { name: 'return', type: 'expression', label: 'Return', hint: 'The store to use for the return' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.continueon = () => ({ type: 'continue.on', displayName: 'continue.on,', description: 'Continues an an on.xxx call,', category: 'Flow', icon: 'fas fa-code-branch', outcomes: [], properties: [{ name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.onerror = () => ({ type: 'on.error', displayName: 'on.error,', description: 'Sets the default process to handle errors,', category: 'Flow', icon: 'fas fa-code-branch', outcomes: [OutcomeNames.Done, OutcomeNames.OnError], properties: [{ name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.onoverdue = () => ({ type: 'on.overdue', displayName: 'on.overdue,', description: 'Sets the default process to handle overdues,', category: 'Flow', icon: 'fas fa-code-branch', outcomes: [OutcomeNames.Done, OutcomeNames.OnOverdue], properties: [{ name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.do = () => ({ type: 'do', displayName: 'do,', description: 'Creates activity,', runtimeDescription: 'x => !!x.state.subject ? \`<strong>\${ x.state.subject }</strong>\` : x.definition.description', category: 'Action', icon: 'fas fa-dot-circle', outcomes: [OutcomeNames.Done, OutcomeNames.Fail, OutcomeNames.OnOverdue, OutcomeNames.OnError], properties: [{ name: 'subject', type: 'expression', label: 'Subject', hint: 'The subject line' }, { name: 'message', type: 'expression', label: 'Message', hint: 'The message line' }, { name: 'assignedTo', type: 'expression', label: 'AssignedTo', hint: 'The group to whom the activity is assigned to' }, { name: 'duration', type: 'expression', label: 'Duration', hint: 'The duration length' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.storeuse = () => ({ type: 'store.use', displayName: 'store.use,', description: 'Sets the default store,', category: 'Store', icon: 'fas fa-database', outcomes: [OutcomeNames.Done], properties: [{ name: 'store', type: 'expression', label: 'Store', hint: 'The store to use' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
        this.set = () => ({ type: 'set', displayName: 'set,', description: 'Sets a value,', category: 'Ops', icon: 'fas fa-plus-square', outcomes: [OutcomeNames.Done], properties: [{ name: 'field', type: 'expression', label: 'Field', hint: 'The field' }, { name: 'value', type: 'expression', label: 'Value', hint: 'The value' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] });
    }
}
...
class DesignerHost {
    ...
    render() {
        const activityDefinitions = this.activityDefinitions;
        return (__chunk_1.h("host", null, __chunk_1.h("wf-activity-picker", { activityDefinitions: activityDefinitions, ref: el => this.activityPicker = el }), __chunk_1.h("wf-activity-editor", { activityDefinitions: activityDefinitions, ref: el => this.activityEditor = el }), __chunk_1.h("wf-import-export", { ref: el => this.importExport = el }), __chunk_1.h("div", { class: "workflow-designer-wrapper dragscroll" }, __chunk_1.h("wf-designer", { activityDefinitions: activityDefinitions, ref: el => this.designer = el, canvasHeight: this.canvasHeight, workflow: this.workflow, readonly: this.readonly, onWorkflowChanged: this.onWorkflowChanged }))));
    }
    get el() { return __chunk_1.getElement(this); }
    static get style() { return ".workflow-designer-wrapper{height:80vh;overflow-y:auto}"; }
}
...
class ExportButton {
    constructor(hostRef) {
        ...
        this.exportClickedEvent = __chunk_1.createEvent(this, "export", 7);
    }
    render() {
        const descriptors = this.workflowFormats;
        return (__chunk_1.h("div", { class: "dropdown" }, __chunk_1.h("button", { class: "btn btn-secondary dropdown-toggle", type: "button", id: "exportButton", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, "Export"), __chunk_1.h("div", { class: "dropdown-menu", "aria-labelledby": "exportButton" }, Object.keys(descriptors).map(key => {
            const descriptor = descriptors[key];
            return (__chunk_1.h("a", { class: "dropdown-item", href: "#", onClick: e => this.handleExportClick(e, descriptor) }, descriptor.displayName));
        }))));
    }
    get el() { return __chunk_1.getElement(this); }
}
...
class ImportExport {
    constructor(hostRef) {
        ...
        this.importEvent = __chunk_1.createEvent(this, "import-workflow", 7);
    }
    ...
    async download(designer, formatDescriptor) {
        let blobUrl = this.blobUrl;
        if (!!blobUrl) {
            window.URL.revokeObjectURL(blobUrl);
        }
    ...
    render() {
        return (__chunk_1.h("host", null, __chunk_1.h("input", { type: "file", class: "import-button", onChange: this.importWorkflow, ref: el => this.fileInput = el })));
    }
    get el() { return __chunk_1.getElement(this); }
    static get style() { return ".import-button{display:none}"; }
}
