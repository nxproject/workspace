...
var TaskActivities = /** @class */ (function () {
    function TaskActivities() {
        ...
        this.getActivityDefinitions = function () { return ([
            ...
            _this_1.texttext(),
            _this_1.textuse(),
            _this_1.msgactionadd(),
            _this_1.msgattachmentadd(),
            _this_1.msgtoadd(),
            ...
            _this_1.msgsetitem(),
            _this_1.msgsetmessage(),
            _this_1.msgsetpost(),
            _this_1.msgsettemplatesms(),
            _this_1.msgsetsubject(),
            _this_1.msguse(),
            _this_1.send(),
            _this_1.doclistadd(),
        ...
        this.msgactionadd = function () { return ({ type: 'msg.action.add', displayName: 'msg.action.add,', description: 'Adds an action to the message,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to use' }, { name: 'task', type: 'expression', label: 'Task', hint: 'The task' }, { name: 'name', type: 'expression', label: 'Name', hint: 'The name to display' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] }); };
        this.msgattachmentadd = function () { return ({ type: 'msg.attachment.add', displayName: 'msg.attachment.add,', description: 'Adds an attachment to the message,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to use' }, { name: 'doc', type: 'expression', label: 'Doc', hint: 'The document' }, { name: 'name', type: 'expression', label: 'Name', hint: 'The name to display' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] }); };
        this.msgtoadd = function () { return ({ type: 'msg.to.add', displayName: 'msg.to.add,', description: 'Adds an addressee to the message,', category: 'Comm', icon: 'fas fa-tty', outcomes: [OutcomeNames.Done], properties: [{ name: 'msg', type: 'expression', label: 'Msg', hint: 'The message to use' }, { name: 'to', type: 'expression', label: 'To', hint: 'The to' }, { name: 'if', type: 'expression', label: 'If', hint: 'Execute if' }, { name: 'comment', type: 'text', label: 'Comment', hint: 'What does this step accomplish' }] }); };
