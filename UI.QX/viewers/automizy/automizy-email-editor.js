    ...
    $AEE.layoutReady(function () {
        ...
        $AEE.nx = {
            templates: {
                ...
                invoice: '<~-- {{#if _invoice}} --><table border=0 style="border-collapse:collapse;width:98.6254%;height:477px;"><tbody><tr style="height:opx;"><td style="width:1.0%;"></td><td style="width:13.0%;"></td><td style="width:10.0%;"></td><td style="width:25.0%;"></td><td style="width:10.0%;"></td><td style="width:12.5%;"></td><td style="width:12.5%;"></td><td style="width:15.0%;"></td><td style="width:1.0%;"></td></tr><tr style="height:31px;"><td /><td colspan=3><strong>{{_sys.name}}</strong></td><td colspan=4>{{acct.actual.name}}</td><td /></tr><tr style="height:26px;"><td /><td colspan=3>{{_sys.addr1}}</td><td colspan=4>{{acct.actual.address}}</td><td /></tr><tr style="height:26px;"><td /><td colspan=3>{{_sys.city}}, {{_sys.state}}{{_sys.zip}}</td><td colspan=4>{{acct.actual.city}}, {{acct.actual.state}}{{acct.actual.zip}}</td><td /></tr><tr style="height:26px;"><td /><td colspan=3>{{_sys.phone}}</td><td colspan=4></td><td /></tr><tr style="height:26px;"><td /></tr><tr style="height:26px;"><td /><td colspan=4>Invoice: {{code}}</td></tr><tr style="height:26px;"><td /><td colspan=4>Description: {{desc}}</td></tr><tr style="height:26px;"><td /><td colspan=4>Invoiced On: {{on}}</td></tr><tr style="height:26px;"><td /><td colspan=7><hr /></td></tr><tr style="height:26px;"><td /><td><strong>On</strong></td><td><strong>Item</strong></td><td><strong>Description</strong></td><td style="text-align:right;"><strong>Units</strong></td><td style="text-align:right;"><strong>Rate</strong></td><td style="text-align:right;"><strong>Disc</strong></td><td style="text-align:right;"><strong>Amount</strong></td><td></td></tr><!-- {{#each _child._billcharge}}--><tr style="height:26px;"><td></td><td>{{this.on}}</td><td>{{this.code}}</td><td style="text-align:left;">{{this.desc}}</td><td style="text-align:right;">{{this.units}}</td><td style="text-align:right;">{{this.rate}}</td><td style="text-align:right;">{{this.disc}}</td><td style="text-align:right;">{{this.total}}</td></tr><!-- {{/each}}--><tr style="height:26px;"><td /></tr><tr style="height:26px;"><td colspan=6></td><td>Tax</td><td>{{tax}}</td></tr><tr style="height:26px;"><td colspan=6></td><td><strong>Total</strong></td><td>{{billed}}</td></tr><tr><td /></tr></tbody><tbody></tbody></table><!-- {{/if}} -->'
            }
        };
    ...
    $AEE.layoutReady(function () {
        ...
        $AEE.recalculateColumnsWidth = function (columnId) {
            ...
            if (parseFloat(newFullWidth.toFixed(5)) > 100) {
                ...
                (function (columns, columnId, newFullWidth) {
                    setTimeout(function () {
                        var count = 0;
                        for (var i = 0; i < columns.length; i++) {
                            if (columns[i].active) {
    ...
    $AEE.ready(function () {
        ...
        $AEE.inputs.screenSizeSelect = $A.newInput2({
            ...
            options: [
                ...
                ['600x1024', 'Amazon Kindle Fire'],
                ['800x1280', 'Amazon Kindle Fire HD 7'],
                ['1200x1920', 'Amazon Kindle Fire HD 8.9'],
                ['768x1024', 'Apple iPad 1, 2'],
                ['1536x2048', 'Apple iPad 3, 4, Air, Air2'],
                ['768x1024', 'Apple iPad mini'],
                ['1536x2048', 'Apple iPad mini 2, 3, 4'],
                ['2048x2732', 'Apple iPad Pro'],
                ['1536x2048', 'Apple iPad Pro 9.7'],
                ['320x480', 'Apple iPhone 3'],
                ['640x960', 'Apple iPhone 4'],
                ['640x1136', 'Apple iPhone 5'],
                ['1080x1920', 'Apple iPhone 6+, 6s+, 7+, 8+'],
                ['750x1334', 'Apple iPhone 6, 6s'],
                ['750x1334', 'Apple iPhone 7, iPhone 8'],
                ['1125x2436', 'Apple iPhone X'],
                ['640x1136', 'Apple iPod Touch'],
                ['800x1280', 'Asus Nexus 7 (v1)'],
                ['1080x1920', 'Asus Nexus 7 (v2)'],
                ['720x720', 'Blackberry Classic'],
                ['720x1280', 'Blackberry Leap'],
                ['1440x1440', 'Blackberry Passport'],
                ['600x1024', 'Blackberry Playbook'],
                ['720x720', 'Blackberry Q10'],
                ['360x480', 'Blackberry Torch 9800'],
                ['768x1280', 'Blackberry Z10'],
                ['720x1280', 'Blackberry Z30'],
                ['640x360', 'Google Glass'],
                ['720x1280', 'HTC 8X'],
                ['540x960', 'HTC Evo 3D'],
                ['1538x2048', 'HTC Nexus 9'],
                ['1080x1920', 'HTC One'],
                ['1080x1920', 'Lenovo K900'],
                ['1440x2560', 'LG G3'],
                ['1440x2560', 'LG G4'],
                ['1440x2560', 'LG G5'],
                ['1200x1920', 'LG G Pad 8.3'],
                ['768x1280', 'LG Nexus 4'],
                ['1080x1920', 'LG Nexus 5'],
                ['768x1280', 'LG Optimus G'],
                ['480x800', 'Microsoft Lumia 620'],
                ['720x1280', 'Microsoft Lumia 830'],
                ['480x800', 'Microsoft Lumia 900'],
                ['768x1280', 'Microsoft Lumia 920'],
                ['768x1280', 'Microsoft Lumia 925'],
                ['768x1280', 'Microsoft Lumia 1020'],
                ['1080x1920', 'Microsoft Lumia 1520'],
                ['768x1366', 'Microsoft Surface'],
                ['1080x1920', 'Microsoft Surface Pro'],
                ['1080x1920', 'Microsoft Surface Pro 2'],
                ['1440x2160', 'Microsoft Surface Pro 3'],
                ['1440x2560', 'Motorola Nexus 6'],
                ['1080x1920', 'Pantech Vega n°6'],
                ['720x1200', 'Samsung Galaxy Nexus'],
                ['800x1280', 'Samsung Galaxy Note'],
                ['720x1280', 'Samsung Galaxy Note 2'],
                ['1080x1920', 'Samsung Galaxy Note 3'],
                ['1440x2560', 'Samsung Galaxy Note 4'],
                ['1440x2960', 'Samsung Galaxy Note 8'],
                ['1440x2960', 'Samsung Galaxy Note 9'],
                ['1080x2280', 'Samsung Galaxy Note 10'],
                ['1080x2280', 'Samsung Galaxy Note 10+'],
                ['480x800', 'Samsung Galaxy S'],
                ['480x800', 'Samsung Galaxy S2'],
                ['720x1280', 'Samsung Galaxy S3'],
                ['480x800', 'Samsung Galaxy S3 mini'],
                ['1080x1920', 'Samsung Galaxy S4'],
                ['540x960', 'Samsung Galaxy S4 mini'],
                ['1080x1920', 'Samsung Galaxy S5'],
                ['1440x2560', 'Samsung Galaxy S6'],
                ['1440x2560', 'Samsung Galaxy S7, S7 edge'],
                ['1440x2960', 'Samsung Galaxy S8'],
                ['1440x2960', 'Samsung Galaxy S8+'],
                ['1440x2960', 'Samsung Galaxy S9'],
                ['1440x2960', 'Samsung Galaxy S9+'],
                ['1440x3040', 'Samsung Galaxy S10'],
                ['1440x3040', 'Samsung Galaxy S10+'],
                ['800x1280', 'Samsung Galaxy Tab 2 10"'],
                ['600x1024', 'Samsung Galaxy Tab 2 (7")'],
                ['800x1280', 'Samsung Galaxy Tab 3 10"'],
                ['800x1280', 'Samsung Galaxy Tab (8.9")'],
                ['1600x2560', 'Samsung Nexus 10'],
                ['540x960', 'Sony Xperia P'],
                ['720x1280', 'Sony Xperia S'],
                ['1080x1920', 'Sony Xperia Z'],
                ['1080x1920', 'Sony Xperia Z3'],
                ['1080x1920', 'Xiaomi Mi 3'],
                ['1080x1920', 'Xiaomi Mi 4'],
                ['1080x2160', 'Xiaomi Redmi Note 5'],
                ['1080x1920', 'ZTE Grand S'],
        ...
        $AEE.forms.preview = $A.newForm().addInputs([
            ...
            //$AEE.inputs.previewSegments                       // ECANDIDUS 2021-04-03
            //]).addButtons([                                       
            //    $AEE.buttons.sendTestButton                       // END ECANDIDUS
...
(function () {
    $AEE.getTinyMceBuiltInMenu = function (editor) {
        ...
        for (var i in $AEE.d.systemFields) {
            arr.push({
                text: $AEE.d.systemFields[i], onclick: (function (i) {
                    return function () {
...
(function () {
    $AEE.getTinyMceUserDefinedMenu = function (editor) {
        ...
        for (var i in $AEE.d.customFields) {
            arr.push({
                text: $AEE.d.customFields[i], onclick: (function (i) {
                    return function () {
                        editor.insertContent(i);
                    }
                })(i)
