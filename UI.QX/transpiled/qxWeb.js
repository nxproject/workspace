  ...
  qx.Bootstrap.define("qxWeb", {
    ...
    statics: {
      ...
      $init: function $init(arg, clazz) {
        ...
        for (var i = 0; i < qxWeb.__init__P_135_0.length; i++) {
          qxWeb.__init__P_135_0[i].call(col);
        }
      ...
      $attachInit: function $attachInit(init) {
        this.__init__P_135_0.push(init);
      },
...
//# sourceMappingURL=qxWeb.js.map?dt=1598025379632