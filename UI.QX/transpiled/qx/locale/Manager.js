  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__translations__P_69_0 = qx.$$translations || {};
      this.__locales__P_69_1 = qx.$$locales || {};
      this.initLocale();
      this.__clientLocale__P_69_2 = this.getLocale();
    },
    ...
    */
    members: {
      __defaultLocale__P_69_3: qx.core.Environment.get("locale.default"),
      __locale__P_69_4: null,
      __language__P_69_5: null,
      __translations__P_69_0: null,
      __locales__P_69_1: null,
      __clientLocale__P_69_2: null,
      ...
      getLanguage: function getLanguage() {
        return this.__language__P_69_5;
      },
      ...
      getAvailableLocales: function getAvailableLocales(includeNonloaded) {
        ...
        for (var locale in this.__locales__P_69_1) {
          if (locale != this.__defaultLocale__P_69_3) {
            if (this.__locales__P_69_1[locale] === null && !includeNonloaded) {
       ...
       */
      __extractLanguage__P_69_6: function __extractLanguage__P_69_6(locale) {
        var language;
      ...
      _applyLocale: function _applyLocale(value, old) {
        {
          if (!(value in this.__locales__P_69_1 || value == this.__clientLocale__P_69_2)) {
            qx.log.Logger.warn("Locale: " + value + " not available.");
          }
        }
        this.__locale__P_69_4 = value;
        this.__language__P_69_5 = this.__extractLanguage__P_69_6(value);
      },
      ...
      addTranslation: function addTranslation(languageCode, translationMap) {
        var catalog = this.__translations__P_69_0;
      ...
      addLocale: function addLocale(localeCode, localeMap) {
        var catalog = this.__locales__P_69_1;
      ...
      translate: function translate(messageId, args, locale) {
        var catalog = this.__translations__P_69_0;
        return this.__lookupAndExpand__P_69_7(catalog, messageId, args, locale);
      },
       ...
       * @return {String | LocalizedString} translated message or localized string
       */
      __lookupAndExpand__P_69_7: function __lookupAndExpand__P_69_7(catalog, messageId, args, locale) {
        {
        ...
        if (locale) {
          var language = this.__extractLanguage__P_69_6(locale);
        } else {
          locale = this.__locale__P_69_4;
          language = this.__language__P_69_5;
        } // e.g. DE_at
        ...
        if (!txt && catalog[this.__defaultLocale__P_69_3]) {
          txt = catalog[this.__defaultLocale__P_69_3][messageId];
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__locales__P_69_1);
        }
        return txt;
      }
    }
...
//# sourceMappingURL=Manager.js.map?dt=1598045170898