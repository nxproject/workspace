  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct: function construct() {
      ...
      this.__queue__P_282_0 = [];
      this.__active__P_282_1 = [];
      this.__totalRequests__P_282_2 = 0; // timeout handling

      this.__timer__P_282_3 = new qx.event.Timer(500);

      this.__timer__P_282_3.addListener("interval", this._oninterval, this);
    },
    ...
    */
    members: {
      __queue__P_282_0: null,
      __active__P_282_1: null,
      __totalRequests__P_282_2: null,
      __timer__P_282_3: null,
      ...
      */
      ...
      _debug: function _debug() {
        {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            // Debug output
            var vText = this.__active__P_282_1.length + "/" + (this.__queue__P_282_0.length + this.__active__P_282_1.length);
      ...
      _check: function _check() {
        ...
        if (this.__active__P_282_1.length == 0 && this.__queue__P_282_0.length == 0) {
          this.__timer__P_282_3.stop();
        } // Checking if enabled
        ...
        if (this.__queue__P_282_0.length == 0 || this.__queue__P_282_0[0].isAsynchronous() && this.__active__P_282_1.length >= this.getMaxConcurrentRequests()) {
          return;
        } // Checking number of total requests


        if (this.getMaxTotalRequests() != null && this.__totalRequests__P_282_2 >= this.getMaxTotalRequests()) {
          return;
        }

        var vRequest = this.__queue__P_282_0.shift();

        var vTransport = new qx.io.remote.Exchange(vRequest); // Increment counter

        this.__totalRequests__P_282_2++; // Add to active queue

        this.__active__P_282_1.push(vTransport); // Debug output
        ...
        if (this.__queue__P_282_0.length > 0) {
          this._check();
        }
      },
      ...
      _remove: function _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__active__P_282_1, vTransport); // Dispose transport object
      ...
      */
      ...
      _onsending: function _onsending(e) {
        {
          if (qx.core.Environment.get("qx.debug.io.remote")) {
            this.__activeCount__P_282_4++;
            e.getTarget()._counted = true;
            this.debug("ActiveCount: " + this.__activeCount__P_282_4);
          }
        }
      ...
      */
      ...
      _oninterval: function _oninterval(e) {
        var vActive = this.__active__P_282_1;
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        ...
        this.__timer__P_282_3.setEnabled(value);
      },
      ...
      */
      ...
      add: function add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__queue__P_282_0.push(vRequest);
        } else {
          this.__queue__P_282_0.unshift(vRequest);
        }

        this._check();

        if (this.getEnabled()) {
          this.__timer__P_282_3.start();
        }
      },
      ...
      abort: function abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__queue__P_282_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__queue__P_282_0, vRequest);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__active__P_282_1");

      this._disposeObjects("__timer__P_282_3");

      this.__queue__P_282_0 = null;
    }
  });
  qx.io.remote.RequestQueue.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RequestQueue.js.map?dt=1598599872475