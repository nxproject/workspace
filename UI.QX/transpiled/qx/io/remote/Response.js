    ...
    members: {
      ...
      */
      ...
      getResponseHeader: function getResponseHeader(vHeader) {
        if (this.__lowerHeaders__P_286_0) {
          return this.__lowerHeaders__P_286_0[vHeader.toLowerCase()] || null;
        }
      ...
      _applyResponseHeaders: function _applyResponseHeaders(value, old) {
        ...
        if (value !== null) {
          ...
          this.__lowerHeaders__P_286_0 = lowerHeaders;
        }
      }
    }
  });
...
//# sourceMappingURL=Response.js.map?dt=1598599873235