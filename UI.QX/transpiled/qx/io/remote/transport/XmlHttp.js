  ...
  qx.Class.define("qx.io.remote.transport.XmlHttp", {
    ...
    */
    statics: {
      ...
      setTimeout: function setTimeout(timeout) {
        this.__timeout__P_285_0 = timeout;
      },
      ...
      getTimeout: function getTimeout() {
        return this.__timeout__P_285_0;
      }
    },
    ...
    */
    members: {
      ...
      ---------------------------------------------------------------------------
      */
      __localRequest__P_285_1: false,
      __lastReadyState__P_285_2: 0,
      __request__P_285_3: null,
      ...
      getRequest: function getRequest() {
        if (this.__request__P_285_3 === null) {
          this.__request__P_285_3 = qx.io.remote.transport.XmlHttp.createRequestObject();
          this.__request__P_285_3.onreadystatechange = qx.lang.Function.bind(this._onreadystatechange, this);
        }

        return this.__request__P_285_3;
      },
      ...
      */
       ...
       */
      send: function send() {
        this.__lastReadyState__P_285_2 = 0;
        ...
        this.__localRequest__P_285_1 = vLocalRequest; // --------------------------------------
      ...
      */
      ...
      _onreadystatechange: qx.event.GlobalError.observeMethod(function (e) {
        ...
        if (vReadyState == 4) {
          ...
          if (!qx.io.remote.Exchange.wasSuccessful(this.getStatusCode(), vReadyState, this.__localRequest__P_285_1)) {
            // Fix for bug #2272
        ...
        if (vReadyState == 3 && this.__lastReadyState__P_285_2 == 1) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_285_2]);
        } // Updating internal state


        while (this.__lastReadyState__P_285_2 < vReadyState) {
          this.setState(qx.io.remote.Exchange._nativeMap[++this.__lastReadyState__P_285_2]);
        }
      }),
      ...
      */
      ...
      getResponseXml: function getResponseXml() {
        ...
        if (qx.io.remote.Exchange.wasSuccessful(vStatus, vReadyState, this.__localRequest__P_285_1)) {
          try {
    ...
    */
    destruct: function destruct() {
      ...
      this.__request__P_285_3 = null;
    }
  });
  qx.io.remote.transport.XmlHttp.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=XmlHttp.js.map?dt=1598599873167