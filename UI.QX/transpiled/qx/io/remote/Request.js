  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct: function construct(vUrl, vMethod, vResponseType) {
      ...
      this.__requestHeaders__P_280_0 = {};
      this.__urlParameters__P_280_1 = {};
      this.__dataParameters__P_280_2 = {};
      this.__formFields__P_280_3 = {};
      ...
      this.__seqNum__P_280_4 = ++qx.io.remote.Request.__seqNum__P_280_4;
    },
    ...
    */
    members: {
      __requestHeaders__P_280_0: null,
      __urlParameters__P_280_1: null,
      __dataParameters__P_280_2: null,
      __formFields__P_280_3: null,
      __seqNum__P_280_4: null,
      ...
      */
       ...
       */
      __forwardEvent__P_280_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      _onqueued: function _onqueued(e) {
        ...
        this.__forwardEvent__P_280_5(e);
      },
      ...
      _oncompleted: function _oncompleted(e) {
        ...
        this.__forwardEvent__P_280_5(e); // Automatically dispose after event completion
      ...
      */
      ...
      setRequestHeader: function setRequestHeader(vId, vValue) {
        this.__requestHeaders__P_280_0[vId] = vValue;
      },
      ...
      removeRequestHeader: function removeRequestHeader(vId) {
        delete this.__requestHeaders__P_280_0[vId];
      },
      ...
      getRequestHeader: function getRequestHeader(vId) {
        return this.__requestHeaders__P_280_0[vId] || null;
      },
      ...
      getRequestHeaders: function getRequestHeaders() {
        return this.__requestHeaders__P_280_0;
      },
      ...
      */
      ...
      setParameter: function setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__dataParameters__P_280_2[vId] = vValue;
        } else {
          this.__urlParameters__P_280_1[vId] = vValue;
        }
      },
      ...
      removeParameter: function removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__dataParameters__P_280_2[vId];
        } else {
          delete this.__urlParameters__P_280_1[vId];
        }
      },
      ...
      getParameter: function getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__dataParameters__P_280_2[vId] || null;
        } else {
          return this.__urlParameters__P_280_1[vId] || null;
        }
      },
      ...
      getParameters: function getParameters(bFromData) {
        return bFromData ? this.__dataParameters__P_280_2 : this.__urlParameters__P_280_1;
      },
      ...
      */
      ...
      setFormField: function setFormField(vId, vValue) {
        this.__formFields__P_280_3[vId] = vValue;
      },
      ...
      removeFormField: function removeFormField(vId) {
        delete this.__formFields__P_280_3[vId];
      },
      ...
      getFormField: function getFormField(vId) {
        return this.__formFields__P_280_3[vId] || null;
      },
      ...
      getFormFields: function getFormFields() {
        return this.__formFields__P_280_3;
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__requestHeaders__P_280_0 = this.__urlParameters__P_280_1 = this.__dataParameters__P_280_2 = this.__formFields__P_280_3 = null;
    }
  });
  qx.io.remote.Request.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Request.js.map?dt=1598599871876