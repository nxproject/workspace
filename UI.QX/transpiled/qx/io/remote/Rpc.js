(function () {
  ...
  */
  qx.Class.define("qx.io.remote.Rpc", {
    ...
    */
    ...
    construct: function construct(url, serviceName) {
      ...
      if (qx.core.ServerSettings) {
        this.__currentServerSuffix__P_279_0 = qx.core.ServerSettings.serverPathSuffix;
      }
    },
    ...
    */
    members: {
      __previousServerSuffix__P_279_1: null,
      __currentServerSuffix__P_279_0: null,
        ...
        req.addListener("completed", function (evt) {
          ...
          if (exTest != null) {
            ...
            if (refreshSession) {
              ...
              if (self.__currentServerSuffix__P_279_0 != newSuffix) {
                self.__previousServerSuffix__P_279_1 = self.__currentServerSuffix__P_279_0;
                self.__currentServerSuffix__P_279_0 = newSuffix;
              }
      ...
      fixUrl: function fixUrl(url) {
        if (this.__previousServerSuffix__P_279_1 == null || this.__currentServerSuffix__P_279_0 == null || this.__previousServerSuffix__P_279_1 == "" || this.__previousServerSuffix__P_279_1 == this.__currentServerSuffix__P_279_0) {
          return url;
        }

        var index = url.indexOf(this.__previousServerSuffix__P_279_1);

        if (index == -1) {
          return url;
        }

        return url.substring(0, index) + this.__currentServerSuffix__P_279_0 + url.substring(index + this.__previousServerSuffix__P_279_1.length);
      },
...
//# sourceMappingURL=Rpc.js.map?dt=1598599871467