  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.dev.StackTrace", {
    statics: {
      ...
      getStackTraceFromError: function getStackTraceFromError(error) {
        ...
        if (traceProp === "stack") {
          ...
          while ((hit = lineRe.exec(error.stack)) != null) {
            url = hit[1];
            lineNumber = hit[2];
            className = this.__fileNameToClassName__P_25_0(url);
            trace.push(className + ":" + lineNumber);
          }

          if (trace.length > 0) {
            return this.__formatStackTrace__P_25_1(trace);
          }
          /*
          ...
          while ((hit = lineRe.exec(error.stack)) != null) {
            ...
            if (fileMatch) {
              className = this.__fileNameToClassName__P_25_0(fileMatch[1]);
          ...
          for (var i = 0; i < lines.length; i++) {
            ...
            if (reResult && reResult.length >= 2) {
              ...
              fileName = this.__fileNameToClassName__P_25_0(reResult[2]);
              trace.push(fileName + ":" + lineNumber);
            }
          }
        } else if (error.sourceURL && error.line) {
          // Safari
          trace.push(this.__fileNameToClassName__P_25_0(error.sourceURL) + ":" + error.line);
        }
       ...
       */
      __fileNameToClassName__P_25_0: function __fileNameToClassName__P_25_0(fileName) {
        ...
        return qx.dev.StackTrace.__fileNameToClassNameDefault__P_25_2(fileName);
      },
       ...
       */
      __fileNameToClassNameDefault__P_25_2: function __fileNameToClassNameDefault__P_25_2(fileName) {
       ...
       */
      __formatStackTrace__P_25_1: function __formatStackTrace__P_25_1(trace) {
...
//# sourceMappingURL=StackTrace.js.map?dt=1598045163913