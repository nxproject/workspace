  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    members: {
      ...
      */
      ...
      getBounds: function getBounds() {
        return this.__userBounds__P_61_5 || this.__computedLayout__P_61_1 || null;
      },
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        var computed = this.__computedLayout__P_61_1;

        if (!computed) {
          computed = this.__computedLayout__P_61_1 = {};
        } // Detect changes
        ...
        if (this.__hasInvalidLayout__P_61_2) {
          changes.local = true;
          delete this.__hasInvalidLayout__P_61_2;
        }

        if (this.__updateMargin__P_61_4) {
          changes.margin = true;
          delete this.__updateMargin__P_61_4;
        }
        /*
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__computedHeightForWidth__P_61_0) {
            // This variable is used in the next computation of the size hint
            this.__computedHeightForWidth__P_61_0 = flowHeight; // Re-add to layout queue
      ...
      hasValidLayout: function hasValidLayout() {
        return !this.__hasInvalidLayout__P_61_2;
      },
      ...
      invalidateLayoutCache: function invalidateLayoutCache() {
        ...
        this.__hasInvalidLayout__P_61_2 = true;
        this.__sizeHint__P_61_3 = null;
      },
      ...
      getSizeHint: function getSizeHint(compute) {
        var hint = this.__sizeHint__P_61_3;
        ...
        hint = this.__sizeHint__P_61_3 = this._computeSizeHint(); // Respect height for width

        if (this._hasHeightForWidth() && this.__computedHeightForWidth__P_61_0 && this.getHeight() == null) {
          hint.height = this.__computedHeightForWidth__P_61_0;
        } // normalize width
      ...
      _applyMargin: function _applyMargin() {
        this.__updateMargin__P_61_4 = true;
      ...
      */
      ...
      hasUserBounds: function hasUserBounds() {
        return !!this.__userBounds__P_61_5;
      },
      ...
      resetUserBounds: function resetUserBounds() {
        delete this.__userBounds__P_61_5;
        qx.ui.core.queue.Layout.add(this);
      },
      ...
      */
      ...
      setLayoutProperties: function setLayoutProperties(props) {
        ...
        var storage = this.__layoutProperties__P_61_6;

        if (!storage) {
          storage = this.__layoutProperties__P_61_6 = {};
      ...
      getLayoutProperties: function getLayoutProperties() {
        return this.__layoutProperties__P_61_6 || this.__emptyProperties__P_61_7;
      },
      ...
      clearLayoutProperties: function clearLayoutProperties() {
        delete this.__layoutProperties__P_61_6;
      },
      ...
      */
      ...
      clone: function clone() {
        ...
        var props = this.__layoutProperties__P_61_6;

        if (props) {
          clone.__layoutProperties__P_61_6 = qx.lang.Object.clone(props);
        }
    ...
    */
    destruct: function destruct() {
      ...
      this.$$parent = this.$$subparent = this.__layoutProperties__P_61_6 = this.__computedLayout__P_61_1 = this.__userBounds__P_61_5 = this.__sizeHint__P_61_3 = null;
    }
  });
  qx.ui.core.LayoutItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=LayoutItem.js.map?dt=1598045170045