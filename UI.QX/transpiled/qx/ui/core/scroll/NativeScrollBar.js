(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.scroll.NativeScrollBar", {
    ...
    members: {
      __isHorizontal__P_240_0: null,
      __scrollPaneElement__P_240_1: null,
      __requestId__P_240_2: null,
      __scrollAnimationframe__P_240_3: null,
      ...
      _getScrollPaneElement: function _getScrollPaneElement() {
        if (!this.__scrollPaneElement__P_240_1) {
          this.__scrollPaneElement__P_240_1 = new qx.html.Element();
        }

        return this.__scrollPaneElement__P_240_1;
      },
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        return {
          width: this.__isHorizontal__P_240_0 ? 100 : scrollbarWidth,
          maxWidth: this.__isHorizontal__P_240_0 ? null : scrollbarWidth,
          minWidth: this.__isHorizontal__P_240_0 ? null : scrollbarWidth,
          height: this.__isHorizontal__P_240_0 ? scrollbarWidth : 100,
          maxHeight: this.__isHorizontal__P_240_0 ? scrollbarWidth : null,
          minHeight: this.__isHorizontal__P_240_0 ? scrollbarWidth : null
        };
      },
      // overridden
      ...
      */
      ...
      _applyPosition: function _applyPosition(value) {
        ...
        if (this.__isHorizontal__P_240_0) {
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        var isHorizontal = this.__isHorizontal__P_240_0 = value === "horizontal";
        this.set({
      ...
      _updateScrollBar: function _updateScrollBar() {
        var isHorizontal = this.__isHorizontal__P_240_0;
      ...
      scrollTo: function scrollTo(position, duration) {
        ...
        if (duration) {
          ...
          this.__scrollAnimationframe__P_240_3 = new qx.bom.AnimationFrame();

          this.__scrollAnimationframe__P_240_3.on("frame", function (timePassed) {
            var newPos = parseInt(timePassed / duration * (position - from) + from);
            this.updatePosition(newPos);
          }, this);

          this.__scrollAnimationframe__P_240_3.on("end", function () {
            this.setPosition(Math.max(0, Math.min(this.getMaximum(), position)));
            this.__scrollAnimationframe__P_240_3 = null;
            this.fireEvent("scrollAnimationEnd");
          }, this);

          this.__scrollAnimationframe__P_240_3.startSequence(duration);
        } else {
      ...
      stopScrollAnimation: function stopScrollAnimation() {
        if (this.__scrollAnimationframe__P_240_3) {
          this.__scrollAnimationframe__P_240_3.cancelSequence();
      ...
      _onScroll: function _onScroll(e) {
        ...
        var position = this.__isHorizontal__P_240_0 ? container.getScrollX() : container.getScrollY();
    ...
    destruct: function destruct() {
      this._disposeObjects("__scrollPaneElement__P_240_1");
    }
  });
  qx.ui.core.scroll.NativeScrollBar.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=NativeScrollBar.js.map?dt=1598051410456