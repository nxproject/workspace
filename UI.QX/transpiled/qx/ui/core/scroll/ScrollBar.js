  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.scroll.ScrollBar", {
    ...
    */
    members: {
      __offset__P_241_0: 2,
      __originalMinSize__P_241_1: 0,
      // overridden
      _computeSizeHint: function _computeSizeHint() {
        var hint = qx.ui.core.scroll.ScrollBar.prototype._computeSizeHint.base.call(this);

        if (this.getOrientation() === "horizontal") {
          this.__originalMinSize__P_241_1 = hint.minWidth;
          hint.minWidth = 0;
        } else {
          this.__originalMinSize__P_241_1 = hint.minHeight;
          hint.minHeight = 0;
        }
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (this.__originalMinSize__P_241_1 >= (horizontal ? width : height)) {
      ...
      */
      ...
      _onResizeSlider: function _onResizeSlider(e) {
        ...
        if (this.getOrientation() == "vertical") {
          if (sliderSize.height < knobHint.minHeight + this.__offset__P_241_0) {
            hideKnob = true;
          }
        } else {
          if (sliderSize.width < knobHint.minWidth + this.__offset__P_241_0) {
            hideKnob = true;
          }
        }
...
//# sourceMappingURL=ScrollBar.js.map?dt=1598051410552