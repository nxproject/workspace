      ...
      */
      ...
      scrollToX: function scrollToX(value, duration) {
        ...
        if (duration) {
          ...
          this.__frame__P_171_0 = new qx.bom.AnimationFrame();

          this.__frame__P_171_0.on("end", function () {
            this.setScrollX(value);
            this.__frame__P_171_0 = null;
            this.fireEvent("scrollAnimationEnd");
          }, this);

          this.__frame__P_171_0.on("frame", function (timePassed) {
            var newX = parseInt(timePassed / duration * (value - from) + from);
            this.setScrollX(newX);
          }, this);

          this.__frame__P_171_0.startSequence(duration);
        } else {
          this.setScrollX(value);
        }
      },
      ...
      stopScrollAnimation: function stopScrollAnimation() {
        if (this.__frame__P_171_0) {
          this.__frame__P_171_0.cancelSequence();
...
//# sourceMappingURL=ScrollPane.js.map?dt=1598045327091