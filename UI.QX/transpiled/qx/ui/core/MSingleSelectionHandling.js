  ...
  qx.Mixin.define("qx.ui.core.MSingleSelectionHandling", {
    ...
    */
    members: {
      ...
      */
      ...
      setValue: function setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__getManager__P_193_1().setSelected(item);
      ...
      getValue: function getValue() {
        return this.__getManager__P_193_1().getSelected() || null;
      },
      ...
      resetValue: function resetValue() {
        this.__getManager__P_193_1().resetSelected();
      },
      ...
      getSelection: function getSelection() {
        var selected = this.__getManager__P_193_1().getSelected();
      ...
      setSelection: function setSelection(items) {
        switch (items.length) {
          ...
          case 1:
            this.__getManager__P_193_1().setSelected(items[0]);
      ...
      isSelected: function isSelected(item) {
        return this.__getManager__P_193_1().isSelected(item);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__getManager__P_193_1().isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__getManager__P_193_1().getSelectables(all);
      },
      ...
      */
       ...
       */
      __getManager__P_193_1: function __getManager__P_193_1() {
        if (this.__manager__P_193_0 == null) {
          var that = this;
          this.__manager__P_193_0 = new qx.ui.core.SingleSelectionManager({
          ...
          this.__manager__P_193_0.addListener("changeSelected", this._onChangeSelected, this);
        }

        this.__manager__P_193_0.setAllowEmptySelection(this._isAllowEmptySelection());

        return this.__manager__P_193_0;
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__manager__P_193_0");
    }
  });
  qx.ui.core.MSingleSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MSingleSelectionHandling.js.map?dt=1598051401011