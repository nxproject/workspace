  ...
  qx.Mixin.define("qx.ui.core.MResizable", {
    ...
    */
    construct: function construct() {
      ...
      content.addListener("pointerdown", this.__onResizePointerDown__P_78_0, this, true);
      content.addListener("pointerup", this.__onResizePointerUp__P_78_1, this);
      content.addListener("pointermove", this.__onResizePointerMove__P_78_2, this);
      content.addListener("pointerout", this.__onResizePointerOut__P_78_3, this);
      content.addListener("losecapture", this.__onResizeLoseCapture__P_78_4, this); // Get a reference of the drag and drop handler
      ...
      this.__dragDropHandler__P_78_5 = qx.event.Registration.getManager(domElement).getHandler(qx.event.handler.DragDrop);
    },
    ...
    */
    members: {
      __dragDropHandler__P_78_5: null,
      __resizeFrame__P_78_6: null,
      __resizeActive__P_78_7: null,
      __resizeLeft__P_78_8: null,
      __resizeTop__P_78_9: null,
      __resizeStart__P_78_10: null,
      __resizeRange__P_78_11: null,
      RESIZE_TOP: 1,
      RESIZE_BOTTOM: 2,
      RESIZE_LEFT: 4,
      RESIZE_RIGHT: 8,
      ...
      */
      ...
      _getResizeFrame: function _getResizeFrame() {
        var frame = this.__resizeFrame__P_78_6;

        if (!frame) {
          frame = this.__resizeFrame__P_78_6 = new qx.ui.core.Widget();
       ...
       */
      __showResizeFrame__P_78_12: function __showResizeFrame__P_78_12() {
      ...
      */
       ...
       */
      __computeResizeResult__P_78_13: function __computeResizeResult__P_78_13(e) {
        // Detect mode
        var resizeActive = this.__resizeActive__P_78_7; // Read size hint

        var hint = this.getSizeHint();
        var range = this.__resizeRange__P_78_11; // Read original values

        var start = this.__resizeStart__P_78_10;
        ...
        if (resizeActive & this.RESIZE_TOP || resizeActive & this.RESIZE_BOTTOM) {
          diff = Math.max(range.top, Math.min(range.bottom, e.getDocumentTop())) - this.__resizeTop__P_78_9;
        ...
        if (resizeActive & this.RESIZE_LEFT || resizeActive & this.RESIZE_RIGHT) {
          diff = Math.max(range.left, Math.min(range.right, e.getDocumentLeft())) - this.__resizeLeft__P_78_8;
       ...
       * @param e {qx.event.type.Pointer} Last pointer event
       */
      __computeResizeMode__P_78_15: function __computeResizeMode__P_78_15(e) {
        var location = this.getContentLocation();
        var pointerTolerance = this.getResizeSensitivity();
        var pointerLeft = e.getDocumentLeft();
        var pointerTop = e.getDocumentTop();

        var resizeActive = this.__computeResizeActive__P_78_16(location, pointerLeft, pointerTop, pointerTolerance); // check again in case we have a corner [BUG #1200]


        if (resizeActive > 0) {
          // this is really a | (or)!
          resizeActive = resizeActive | this.__computeResizeActive__P_78_16(location, pointerLeft, pointerTop, pointerTolerance * 2);
        }

        this.__resizeActive__P_78_7 = resizeActive;
      },
       ...
       */
      __computeResizeActive__P_78_16: function __computeResizeActive__P_78_16(location, pointerLeft, pointerTop, pointerTolerance) {
      ...
      */
       ...
       */
      __onResizePointerDown__P_78_0: function __onResizePointerDown__P_78_0(e) {
        // Check for active resize
        if (!this.__resizeActive__P_78_7 || !this.getEnabled() || e.getPointerType() == "touch") {
          return;
        } // Add resize state
        ...
        this.__resizeLeft__P_78_8 = e.getDocumentLeft();
        this.__resizeTop__P_78_9 = e.getDocumentTop(); // Cache bounds

        var location = this.getContentLocation();
        var bounds = this.getBounds();
        this.__resizeStart__P_78_10 = {
          top: location.top,
          left: location.left,
        ...
        if (this.getUseResizeFrame()) {
          this.__showResizeFrame__P_78_12();
        } // Enable capturing
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __onResizePointerUp__P_78_1: function __onResizePointerUp__P_78_1(e) {
        // Check for active resize
        ...
        var bounds = this.__computeResizeResult__P_78_13(e); // Sync with widget
        ...
        this.__resizeActive__P_78_7 = 0; // Remove resize state
       ...
       */
      __onResizeLoseCapture__P_78_4: function __onResizeLoseCapture__P_78_4(e) {
        // Check for active resize
        if (!this.__resizeActive__P_78_7) {
          return;
        } // Reset cursor
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __onResizePointerMove__P_78_2: function __onResizePointerMove__P_78_2(e) {
        if (!this.getEnabled() || e.getPointerType() == "touch") {
          return;
        }

        if (this.hasState("resize")) {
          var bounds = this.__computeResizeResult__P_78_13(e); // Update widget
          ...
          e.stopPropagation();
        } else if (!this.hasState("maximized") && !this.__dragDropHandler__P_78_5.isSessionActive()) {
          this.__computeResizeMode__P_78_15(e);

          var resizeActive = this.__resizeActive__P_78_7;
          var root = this.getApplicationRoot();

          if (resizeActive) {
            var cursor = this.__resizeCursors__P_78_14[resizeActive];
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __onResizePointerOut__P_78_3: function __onResizePointerOut__P_78_3(e) {
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__resizeFrame__P_78_6 != null && !qx.core.ObjectRegistry.inShutDown) {
        this.__resizeFrame__P_78_6.destroy();

        this.__resizeFrame__P_78_6 = null;
      }

      this.__dragDropHandler__P_78_5 = null;
    }
  });
  qx.ui.core.MResizable.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MResizable.js.map?dt=1598045171587