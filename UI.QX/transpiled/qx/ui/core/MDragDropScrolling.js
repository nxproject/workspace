  ...
  qx.Mixin.define("qx.ui.core.MDragDropScrolling", {
    ...
    */
    construct: function construct() {
      ...
      widget.addListener("drag", this.__onDrag__P_191_0, this);
      widget.addListener("dragend", this.__onDragend__P_191_1, this);
      this.__xDirs__P_191_2 = ["left", "right"];
      this.__yDirs__P_191_3 = ["top", "bottom"];
    },
    ...
    */
    members: {
      __dragScrollTimer__P_191_4: null,
      __xDirs__P_191_2: null,
      __yDirs__P_191_3: null,
      ...
      _getAxis: function _getAxis(edgeType) {
        if (this.__xDirs__P_191_2.indexOf(edgeType) !== -1) {
          return "x";
        } else if (this.__yDirs__P_191_3.indexOf(edgeType) !== -1) {
          return "y";
        } else {
      ...
      _scrollBy: function _scrollBy(scrollable, axis, exceedanceAmount) {
        ...
        if (this._isScrollbarExceedingMaxPos(scrollbar, axis, amount)) {
          this.__dragScrollTimer__P_191_4.stop();
        }
      ...
      */
       ...
       */
      __onDrag__P_191_0: function __onDrag__P_191_0(e) {
        if (this.__dragScrollTimer__P_191_4) {
        ...
        while (scrollable) {
          ...
          if (this._isScrollbarVisible(scrollable, axis)) {
            ...
            if (this.__dragScrollTimer__P_191_4) {
              this.__dragScrollTimer__P_191_4.dispose();
            }

            this.__dragScrollTimer__P_191_4 = new qx.event.Timer(50);

            this.__dragScrollTimer__P_191_4.addListener("interval", function (scrollable, axis, amount) {
              this._scrollBy(scrollable, axis, amount);
            }.bind(this, scrollable, axis, exceedanceAmount));

            this.__dragScrollTimer__P_191_4.start();
       ...
       * @param e {qx.event.type.Drag} The drag event instance.
       */
      __onDragend__P_191_1: function __onDragend__P_191_1(e) {
        if (this.__dragScrollTimer__P_191_4) {
          this.__dragScrollTimer__P_191_4.stop();
        }
      }
...
//# sourceMappingURL=MDragDropScrolling.js.map?dt=1598051400759