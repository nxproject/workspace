(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    statics: {
      __visible__P_125_0: null,
      __direction__P_125_1: "left",
      ...
      getVisibleElement: function getVisibleElement() {
        return this.__visible__P_125_0;
      },
      ...
      setMoveDirection: function setMoveDirection(direction) {
        if (direction === "top" || direction === "left") {
          this.__direction__P_125_1 = direction;
        } else {
      ...
      getMoveDirection: function getMoveDirection() {
        return this.__direction__P_125_1;
      }
    },
    properties: {
      /**
    ...
    members: {
      __ptwLiveUpdater__P_125_2: null,
      __ptwLiveDisappearListener__P_125_3: null,
      __ptwLiveUpdateDisappearListener__P_125_4: null,
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__cleanupFromLastPlaceToWidgetLiveUpdate__P_125_5(); // Bind target and livupdate to placeToWidget


          this.__ptwLiveUpdater__P_125_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__ptwLiveUpdater__P_125_2); // Remove the listener when the element disappears.

          this.__ptwLiveUpdateDisappearListener__P_125_4 = function () {
            this.__cleanupFromLastPlaceToWidgetLiveUpdate__P_125_5();
          };

          this.addListener("disappear", this.__ptwLiveUpdateDisappearListener__P_125_4, this);
        }
       ...
       */
      __cleanupFromLastPlaceToWidgetLiveUpdate__P_125_5: function __cleanupFromLastPlaceToWidgetLiveUpdate__P_125_5() {
        if (this.__ptwLiveUpdater__P_125_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__ptwLiveUpdater__P_125_2);
          this.__ptwLiveUpdater__P_125_2 = null;
        }

        if (this.__ptwLiveUpdateDisappearListener__P_125_4) {
          this.removeListener("disappear", this.__ptwLiveUpdateDisappearListener__P_125_4, this);
          this.__ptwLiveUpdateDisappearListener__P_125_4 = null;
        }
      },
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__ptwLiveUpdater__P_125_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__ptwLiveUpdater__P_125_2); // Remove the listener when the element disappears.
       ...
       *    first argument
       */
      __getPlacementSize__P_125_6: function __getPlacementSize__P_125_6(callback) {
        var size = null;
        ...
        if (size == null) {
          this.addListenerOnce("appear", function () {
            this.__getPlacementSize__P_125_6(callback);
          }, this);
        } else {
      ...
      _place: function _place(coords) {
        this.__getPlacementSize__P_125_6(function (size) {
...
//# sourceMappingURL=MPlacement.js.map?dt=1598045176662