  ...
  qx.Class.define("qx.ui.core.selection.Widget", {
    ...
    members: {
      ...
      */
      ...
      _isSelectable: function _isSelectable(item) {
        return this._isItemSelectable(item) && item.getLayoutParent() === this.__widget__P_243_0;
      },
      // overridden
      ...
      _capture: function _capture() {
        this.__widget__P_243_0.capture();
      },
      // overridden
      _releaseCapture: function _releaseCapture() {
        this.__widget__P_243_0.releaseCapture();
      },
      ...
      */
      ...
      _getLocation: function _getLocation() {
        var elem = this.__widget__P_243_0.getContentElement().getDomElement();

        return elem ? qx.bom.element.Location.get(elem) : null;
      },
      // overridden
      _getDimension: function _getDimension() {
        return this.__widget__P_243_0.getInnerSize();
      },
      // overridden
      ...
      */
      ...
      _scrollItemIntoView: function _scrollItemIntoView(item) {
        this.__widget__P_243_0.scrollChildIntoView(item);
      },
      ...
      */
      ...
      getSelectables: function getSelectables(all) {
        ...
        var children = this.__widget__P_243_0.getChildren();
      ...
      _getRelatedSelectable: function _getRelatedSelectable(item, relation) {
        var vertical = this.__widget__P_243_0.getOrientation() === "vertical";
    ...
    */
    destruct: function destruct() {
      this.__widget__P_243_0 = null;
    }
  });
  qx.ui.core.selection.Widget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Widget.js.map?dt=1598051411027