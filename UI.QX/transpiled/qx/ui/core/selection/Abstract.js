(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.selection.Abstract", {
    ...
    */
    members: {
      __scrollStepX__P_242_1: 0,
      __scrollStepY__P_242_2: 0,
      __scrollTimer__P_242_3: null,
      __frameScroll__P_242_4: null,
      __lastRelX__P_242_5: null,
      __lastRelY__P_242_6: null,
      __frameLocation__P_242_7: null,
      __dragStartX__P_242_8: null,
      __dragStartY__P_242_9: null,
      __inCapture__P_242_10: null,
      __pointerX__P_242_11: null,
      __pointerY__P_242_12: null,
      __moveDirectionX__P_242_13: null,
      __moveDirectionY__P_242_14: null,
      __selectionModified__P_242_15: null,
      __selectionContext__P_242_16: null,
      __leadItem__P_242_17: null,
      __selection__P_242_0: null,
      __anchorItem__P_242_18: null,
      __pointerDownOnSelected__P_242_19: null,
      ...
      */
      ...
      getSelectionContext: function getSelectionContext() {
        return this.__selectionContext__P_242_16;
      },
      ...
      getSelection: function getSelection() {
        return Object.values(this.__selection__P_242_0);
      },
      ...
      getSortedSelection: function getSortedSelection() {
        ...
        var sel = Object.values(this.__selection__P_242_0);
      ...
      isItemSelected: function isItemSelected(item) {
        ...
        return this.__selection__P_242_0[hash] !== undefined;
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return qx.lang.Object.isEmpty(this.__selection__P_242_0);
      },
      ...
      */
      ...
      _setLeadItem: function _setLeadItem(value) {
        var old = this.__leadItem__P_242_17;
        ...
        this.__leadItem__P_242_17 = value;
      },
      ...
      getLeadItem: function getLeadItem() {
        return this.__leadItem__P_242_17;
      },
      ...
      _setAnchorItem: function _setAnchorItem(value) {
        var old = this.__anchorItem__P_242_18;
        ...
        this.__anchorItem__P_242_18 = value;
      },
      ...
      _getAnchorItem: function _getAnchorItem() {
        return this.__anchorItem__P_242_18 !== null ? this.__anchorItem__P_242_18 : null;
      },
      ...
      */
      ...
      handlePointerOver: function handlePointerOver(event) {
        ...
        if (this.__oldScrollTop__P_242_20 != null && this.__oldScrollTop__P_242_20 != this._getScroll().top) {
          this.__oldScrollTop__P_242_20 = null;
          return;
      ...
      handlePointerDown: function handlePointerDown(event) {
        ...
        if (this.isItemSelected(item) && !isShiftPressed && !isCtrlPressed && !this.getDrag()) {
          this.__pointerDownOnSelected__P_242_19 = item;
          this._userInteraction = false;
          return;
        } else {
          this.__pointerDownOnSelected__P_242_19 = null;
        ...
        if (this.getDrag() && mode !== "single" && mode !== "one" && !isShiftPressed && !isCtrlPressed && event.getPointerType() == "mouse") {
          ...
          this.__frameLocation__P_242_7 = this._getLocation();
          this.__frameScroll__P_242_4 = this._getScroll(); // Store position at start

          this.__dragStartX__P_242_8 = event.getDocumentLeft() + this.__frameScroll__P_242_4.left;
          this.__dragStartY__P_242_9 = event.getDocumentTop() + this.__frameScroll__P_242_4.top; // Switch to capture mode

          this.__inCapture__P_242_10 = true;
      ...
      handleTap: function handleTap(event) {
        ...
        if (!isCtrlPressed && !isShiftPressed && this.__pointerDownOnSelected__P_242_19 != null) {
          this._userInteraction = false;
      ...
      handlePointerMove: function handlePointerMove(event) {
        ...
        if (!this.__inCapture__P_242_10) {
          return;
        } // Update pointer position cache


        this.__pointerX__P_242_11 = event.getDocumentLeft();
        this.__pointerY__P_242_12 = event.getDocumentTop(); // this is a method invoked by an user interaction, so be careful to
        // set / clear the mark this._userInteraction [BUG #3344]

        this._userInteraction = true; // Detect move directions

        var dragX = this.__pointerX__P_242_11 + this.__frameScroll__P_242_4.left;

        if (dragX > this.__dragStartX__P_242_8) {
          this.__moveDirectionX__P_242_13 = 1;
        } else if (dragX < this.__dragStartX__P_242_8) {
          this.__moveDirectionX__P_242_13 = -1;
        } else {
          this.__moveDirectionX__P_242_13 = 0;
        }

        var dragY = this.__pointerY__P_242_12 + this.__frameScroll__P_242_4.top;

        if (dragY > this.__dragStartY__P_242_9) {
          this.__moveDirectionY__P_242_14 = 1;
        } else if (dragY < this.__dragStartY__P_242_9) {
          this.__moveDirectionY__P_242_14 = -1;
        } else {
          this.__moveDirectionY__P_242_14 = 0;
        } // Update scroll steps


        var location = this.__frameLocation__P_242_7;

        if (this.__pointerX__P_242_11 < location.left) {
          this.__scrollStepX__P_242_1 = this.__pointerX__P_242_11 - location.left;
        } else if (this.__pointerX__P_242_11 > location.right) {
          this.__scrollStepX__P_242_1 = this.__pointerX__P_242_11 - location.right;
        } else {
          this.__scrollStepX__P_242_1 = 0;
        }

        if (this.__pointerY__P_242_12 < location.top) {
          this.__scrollStepY__P_242_2 = this.__pointerY__P_242_12 - location.top;
        } else if (this.__pointerY__P_242_12 > location.bottom) {
          this.__scrollStepY__P_242_2 = this.__pointerY__P_242_12 - location.bottom;
        } else {
          this.__scrollStepY__P_242_2 = 0;
        } // Dynamically create required timer instance


        if (!this.__scrollTimer__P_242_3) {
          this.__scrollTimer__P_242_3 = new qx.event.Timer(100);

          this.__scrollTimer__P_242_3.addListener("interval", this._onInterval, this);
        } // Start interval


        this.__scrollTimer__P_242_3.start(); // Auto select based on new cursor position
      ...
      */
      ...
      _cleanup: function _cleanup() {
        if (!this.getDrag() && this.__inCapture__P_242_10) {
          return;
        } // Fire change event if needed


        if (this.__selectionModified__P_242_15) {
          this._fireChange("tap");
        } // Remove flags


        delete this.__inCapture__P_242_10;
        delete this.__lastRelX__P_242_5;
        delete this.__lastRelY__P_242_6; // Stop capturing

        this._releaseCapture(); // Stop timer


        if (this.__scrollTimer__P_242_3) {
          this.__scrollTimer__P_242_3.stop();
        }
      },
      ...
      _onInterval: function _onInterval(e) {
        ...
        this._scrollBy(this.__scrollStepX__P_242_1, this.__scrollStepY__P_242_2); // Update scroll cache


        this.__frameScroll__P_242_4 = this._getScroll(); // Auto select based on new scroll position and cursor
      ...
      _autoSelect: function _autoSelect() {
        ...
        var relX = Math.max(0, Math.min(this.__pointerX__P_242_11 - this.__frameLocation__P_242_7.left, inner.width)) + this.__frameScroll__P_242_4.left;

        var relY = Math.max(0, Math.min(this.__pointerY__P_242_12 - this.__frameLocation__P_242_7.top, inner.height)) + this.__frameScroll__P_242_4.top; // Compare old and new relative coordinates (for performance reasons)


        if (this.__lastRelX__P_242_5 === relX && this.__lastRelY__P_242_6 === relY) {
          return;
        }

        this.__lastRelX__P_242_5 = relX;
        this.__lastRelY__P_242_6 = relY; // Cache anchor

        var anchor = this._getAnchorItem();

        var lead = anchor; // Process X-coordinate

        var moveX = this.__moveDirectionX__P_242_13;
        var nextX, locationX;
        ...
        var moveY = this.__moveDirectionY__P_242_14;
        var nextY, locationY;
      ...
      */
      ...
      handleKeyPress: function handleKeyPress(event) {
        ...
        if (key === "A" && isCtrlPressed) {
        ...
        } else if (this.__navigationKeys__P_242_21[key]) {
          consumed = true;
          ...
          if (next !== null) {
            ...
            this.__oldScrollTop__P_242_20 = this._getScroll().top;
      ...
      */
      ...
      _clearSelection: function _clearSelection() {
        var selection = this.__selection__P_242_0;
      ...
      _selectItemRange: function _selectItemRange(item1, item2, extend) {
        ...
        if (!extend) {
          var selected = this.__selection__P_242_0;

          var mapped = this.__rangeToMap__P_242_22(range);
       ...
       */
      __rangeToMap__P_242_22: function __rangeToMap__P_242_22(range) {
        var mapped = {};
        var item;
      ...
      */
      ...
      _getSelectedItem: function _getSelectedItem() {
        for (var hash in this.__selection__P_242_0) {
          return this.__selection__P_242_0[hash];
        }
      ...
      _setSelectedItem: function _setSelectedItem(item) {
        if (this._isSelectable(item)) {
          ...
          var current = this.__selection__P_242_0;
      ...
      */
      ...
      _addToSelection: function _addToSelection(item) {
        ...
        if (this.__selection__P_242_0[hash] == null && this._isSelectable(item)) {
          this.__selection__P_242_0[hash] = item;

          this._styleSelectable(item, "selected", true);

          this.__selectionModified__P_242_15 = true;
        }
      },
      ...
      _toggleInSelection: function _toggleInSelection(item) {
        ...
        if (this.__selection__P_242_0[hash] == null) {
          this.__selection__P_242_0[hash] = item;

          this._styleSelectable(item, "selected", true);
        } else {
          delete this.__selection__P_242_0[hash];
      ...
      _fireChange: function _fireChange(context) {
        if (this.__selectionModified__P_242_15) {
          // Store context
          this.__selectionContext__P_242_16 = context || null; // Fire data event which contains the current selection

          this.fireDataEvent("changeSelection", this.getSelection());
          delete this.__selectionModified__P_242_15;
        }
      },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__scrollTimer__P_242_3");

      this.__selection__P_242_0 = this.__pointerDownOnSelected__P_242_19 = this.__anchorItem__P_242_18 = null;
      this.__leadItem__P_242_17 = null;
    }
  });
  qx.ui.core.selection.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1598051410869