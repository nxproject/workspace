(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.core.MMovable", {
    ...
    */
    members: {
      __moveHandle__P_79_0: null,
      __moveFrame__P_79_1: null,
      __dragRange__P_79_2: null,
      __dragLeft__P_79_3: null,
      __dragTop__P_79_4: null,
      __parentLeft__P_79_5: null,
      __parentTop__P_79_6: null,
      __blockerAdded__P_79_7: false,
      __oldBlockerColor__P_79_8: null,
      __oldBlockerOpacity__P_79_9: 0,
      ...
      */
      ...
      _activateMoveHandle: function _activateMoveHandle(widget) {
        if (this.__moveHandle__P_79_0) {
          throw new Error("The move handle could not be redefined!");
        }

        this.__moveHandle__P_79_0 = widget;
        ...
        widget.addListener("losecapture", this.__onMoveLoseCapture__P_79_10, this);
      },
       ...
       */
      __getMoveFrame__P_79_11: function __getMoveFrame__P_79_11() {
        var frame = this.__moveFrame__P_79_1;

        if (!frame) {
          frame = this.__moveFrame__P_79_1 = new qx.ui.core.Widget();
       ...
       */
      __showMoveFrame__P_79_12: function __showMoveFrame__P_79_12() {
        var location = this.getContentLocation();
        var bounds = this.getBounds();

        var frame = this.__getMoveFrame__P_79_11();
      ...
      */
       ...
       */
      __computeMoveCoordinates__P_79_13: function __computeMoveCoordinates__P_79_13(e) {
        var range = this.__dragRange__P_79_2;
        ...
        var viewportLeft = this.__dragLeft__P_79_3 + pointerLeft;
        var viewportTop = this.__dragTop__P_79_4 + pointerTop;
        return {
          viewportLeft: parseInt(viewportLeft, 10),
          viewportTop: parseInt(viewportTop, 10),
          parentLeft: parseInt(viewportLeft - this.__parentLeft__P_79_5, 10),
          parentTop: parseInt(viewportTop - this.__parentTop__P_79_6, 10)
        };
      },
      ...
      */
      ...
      _onMovePointerDown: function _onMovePointerDown(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (!parent.isBlocked()) {
            this.__oldBlockerColor__P_79_8 = parent.getBlockerColor();
            this.__oldBlockerOpacity__P_79_9 = parent.getBlockerOpacity();
            parent.setBlockerColor(null);
            parent.setBlockerOpacity(1);
            parent.blockContent(this.getZIndex() - 1);
            this.__blockerAdded__P_79_7 = true;
          }
        }

        this.__dragRange__P_79_2 = {
        ...
        this.__parentLeft__P_79_5 = parentLocation.left;
        this.__parentTop__P_79_6 = parentLocation.top;
        this.__dragLeft__P_79_3 = widgetLocation.left - e.getDocumentLeft();
        this.__dragTop__P_79_4 = widgetLocation.top - e.getDocumentTop(); // Add state

        this.addState("move"); // Enable capturing

        this.__moveHandle__P_79_0.capture(); // Enable drag frame


        if (this.getUseMoveFrame()) {
          this.__showMoveFrame__P_79_12();
        } // Stop event
      ...
      _onMovePointerMove: function _onMovePointerMove(e) {
        ...
        var coords = this.__computeMoveCoordinates__P_79_13(e);

        if (this.getUseMoveFrame()) {
          this.__getMoveFrame__P_79_11().setDomPosition(coords.viewportLeft, coords.viewportTop);
        } else {
      ...
      _onMovePointerUp: function _onMovePointerUp(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (this.__blockerAdded__P_79_7) {
            parent.unblock();
            parent.setBlockerColor(this.__oldBlockerColor__P_79_8);
            parent.setBlockerOpacity(this.__oldBlockerOpacity__P_79_9);
            this.__oldBlockerColor__P_79_8 = null;
            this.__oldBlockerOpacity__P_79_9 = 0;
            this.__blockerAdded__P_79_7 = false;
          }
        } // Disable capturing


        this.__moveHandle__P_79_0.releaseCapture(); // Apply them to the layout
        ...
        if (this.getUseMoveFrame()) {
          this.__getMoveFrame__P_79_11().exclude();
        }
       ...
       */
      __onMoveLoseCapture__P_79_10: function __onMoveLoseCapture__P_79_10(e) {
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__moveFrame__P_79_1", "__moveHandle__P_79_0");

      this.__dragRange__P_79_2 = null;
    }
  });
  qx.ui.core.MMovable.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MMovable.js.map?dt=1598045171655