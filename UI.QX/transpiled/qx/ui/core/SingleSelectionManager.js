  ...
  qx.Class.define("qx.ui.core.SingleSelectionManager", {
    ...
    */
    ...
    construct: function construct(selectionProvider) {
      ...
      this.__selectionProvider__P_194_0 = selectionProvider;
    },
    ...
    */
    properties: {
      ...
      allowEmptySelection: {
        check: "Boolean",
        init: true,
        apply: "__applyAllowEmptySelection__P_194_1"
      }
    },
    ...
    */
    members: {
      ...
      */
      ...
      getSelected: function getSelected() {
        return this.__selected__P_194_2;
      },
      ...
      resetSelected: function resetSelected() {
        this.__setSelected__P_194_4(null);
      },
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__selected__P_194_2 === item;
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__selected__P_194_2 == null;
      },
      ...
      getSelectables: function getSelectables(all) {
        var items = this.__selectionProvider__P_194_0.getItems();

        var result = [];

        for (var i = 0; i < items.length; i++) {
          if (this.__selectionProvider__P_194_0.isItemSelectable(items[i])) {
            result.push(items[i]);
          }
      ...
      */
      // apply method
      __applyAllowEmptySelection__P_194_1: function __applyAllowEmptySelection__P_194_1(value, old) {
        if (!value) {
          this.__setSelected__P_194_4(this.__selected__P_194_2);
        }
      },
      ...
      */
       ...
       */
      __setSelected__P_194_4: function __setSelected__P_194_4(item) {
        var oldSelected = this.__selected__P_194_2;
        ...
        this.__selected__P_194_2 = newSelected;
       ...
       *    <code>false</code> otherwise.
       */
      __isChildElement__P_194_3: function __isChildElement__P_194_3(item) {
        var items = this.__selectionProvider__P_194_0.getItems();
    ...
    destruct: function destruct() {
      if (this.__selectionProvider__P_194_0.toHashCode) {
        this._disposeObjects("__selectionProvider__P_194_0");
      } else {
        this.__selectionProvider__P_194_0 = null;
      }

      this._disposeObjects("__selected__P_194_2");
    }
  });
  qx.ui.core.SingleSelectionManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SingleSelectionManager.js.map?dt=1598051401102