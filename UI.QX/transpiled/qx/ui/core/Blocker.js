  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__onBoundsChange__P_76_0, this);
      widget.addListener("move", this.__onBoundsChange__P_76_0, this);
      widget.addListener("disappear", this.__onWidgetDisappear__P_76_1, this);
      ...
      this.__activeElements__P_76_2 = [];
      this.__focusElements__P_76_3 = [];
    },
    ...
    */
    members: {
      __blocker__P_76_4: null,
      __blockerCount__P_76_5: 0,
      __activeElements__P_76_2: null,
      __focusElements__P_76_3: null,
      __timer__P_76_6: null,
      _widget: null,
      _isRoot: false,
      __appearListener__P_76_7: null,
       ...
       */
      __onBoundsChange__P_76_0: function __onBoundsChange__P_76_0(e) {
        var data = e.getData();
       ...
       */
      __onWidgetAppear__P_76_8: function __onWidgetAppear__P_76_8() {
       ...
       */
      __onWidgetDisappear__P_76_1: function __onWidgetDisappear__P_76_1() {
        if (this.isBlocked()) {
          this.getBlockerElement().getParent().remove(this.getBlockerElement());

          this._widget.addListenerOnce("appear", this.__onWidgetAppear__P_76_8, this);
        }
      },
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__setBlockersStyle__P_76_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__setBlockersStyle__P_76_9("opacity", value);
      },
       ...
       */
      __setBlockersStyle__P_76_9: function __setBlockersStyle__P_76_9(key, value) {
        var blockers = [];
        this.__blocker__P_76_4 && blockers.push(this.__blocker__P_76_4);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__activeElements__P_76_2.push(activeWidget);

        this.__focusElements__P_76_3.push(focusedWidget);
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__focusElements__P_76_3.length;

        if (focusElementsLength > 0) {
          widget = this.__focusElements__P_76_3.pop();
        ...
        var activeElementsLength = this.__activeElements__P_76_2.length;

        if (activeElementsLength > 0) {
          widget = this.__activeElements__P_76_2.pop();
       ...
       */
      __createBlockerElement__P_76_10: function __createBlockerElement__P_76_10() {
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__blocker__P_76_4) {
          this.__blocker__P_76_4 = this.__createBlockerElement__P_76_10();

          this.__blocker__P_76_4.setStyle("zIndex", 15);
          ...
          widget.getContentElement().add(this.__blocker__P_76_4);

          this.__blocker__P_76_4.exclude();
        }

        return this.__blocker__P_76_4;
      },
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__appearListener__P_76_7) {
            this.__appearListener__P_76_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
        ...
        this.__blockerCount__P_76_5++;

        if (this.__blockerCount__P_76_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__activateBlockerElement__P_76_11, this);
          blocker.addListener("keypress", this.__stopTabEvent__P_76_12, this);
          blocker.addListener("keydown", this.__stopTabEvent__P_76_12, this);
          blocker.addListener("keyup", this.__stopTabEvent__P_76_12, this);
      ...
      isBlocked: function isBlocked() {
        return this.__blockerCount__P_76_5 > 0;
      },
      ...
      unblock: function unblock() {
        if (this.__appearListener__P_76_7) {
          this._widget.removeListenerById(this.__appearListener__P_76_7);

          this.__appearListener__P_76_7 = null;
        }
        ...
        if (this.__blockerCount__P_76_5 < 1) {
          this.__unblock__P_76_13();

          this.__blockerCount__P_76_5 = 0;
        }
      },
       ...
       */
      __unblock__P_76_13: function __unblock__P_76_13() {
        this._restoreActiveWidget();

        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__activateBlockerElement__P_76_11, this);
        blocker.removeListener("keypress", this.__stopTabEvent__P_76_12, this);
        blocker.removeListener("keydown", this.__stopTabEvent__P_76_12, this);
        blocker.removeListener("keyup", this.__stopTabEvent__P_76_12, this);
        blocker.exclude();
       ...
       */
      __stopTabEvent__P_76_12: function __stopTabEvent__P_76_12(e) {
       ...
       */
      __activateBlockerElement__P_76_11: function __activateBlockerElement__P_76_11() {
        //
    ...
    */
    destruct: function destruct() {
      ...
      this._widget.removeListener("resize", this.__onBoundsChange__P_76_0, this);

      this._widget.removeListener("move", this.__onBoundsChange__P_76_0, this);

      this._widget.removeListener("appear", this.__onWidgetAppear__P_76_8, this);

      this._widget.removeListener("disappear", this.__onWidgetDisappear__P_76_1, this);

      if (this.__appearListener__P_76_7) {
        this._widget.removeListenerById(this.__appearListener__P_76_7);
      }

      this._disposeObjects("__blocker__P_76_4", "__timer__P_76_6");

      this.__activeElements__P_76_2 = this.__focusElements__P_76_3 = this._widget = null;
    }
  });
  qx.ui.core.Blocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Blocker.js.map?dt=1598045171393