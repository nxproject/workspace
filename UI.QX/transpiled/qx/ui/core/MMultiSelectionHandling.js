  ...
  qx.Mixin.define("qx.ui.core.MMultiSelectionHandling", {
    ...
    */
    construct: function construct() {
      ...
      var manager = this.__manager__P_192_0 = new clazz(this); // Add widget event listeners
    ...
    */
    members: {
      ...
      __manager__P_192_0: null,

      /** @type {Boolean} used to control recursion in onSelectionChange */
      __inOnSelectionChange__P_192_1: false,
      ...
      */
      ...
      setValue: function setValue(items) {
        if (null === items) {
          this.__manager__P_192_0.clearSelection();
      ...
      getValue: function getValue() {
        return this.__manager__P_192_0.getSelection();
      },
      ...
      selectAll: function selectAll() {
        this.__manager__P_192_0.selectAll();
      },
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__manager__P_192_0.isItemSelected(item);
      },
      ...
      addToSelection: function addToSelection(item) {
        ...
        this.__manager__P_192_0.addItem(item);
      },
      ...
      removeFromSelection: function removeFromSelection(item) {
        ...
        this.__manager__P_192_0.removeItem(item);
      },
      ...
      selectRange: function selectRange(begin, end) {
        this.__manager__P_192_0.selectItemRange(begin, end);
      },
      ...
      setSelection: function setSelection(items) {
        ...
        //  null.
        if (this.__inOnSelectionChange__P_192_1) {
          return;
        }
        ...
        if (items.length === 0) {
          ...
          if (!qx.lang.Array.equals(currentSelection, items)) {
            this.__manager__P_192_0.replaceSelection(items);
          }
        }
      },
      ...
      getSortedSelection: function getSortedSelection() {
        return this.__manager__P_192_0.getSortedSelection();
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__manager__P_192_0.isSelectionEmpty();
      },
      ...
      getSelectionContext: function getSelectionContext() {
        return this.__manager__P_192_0.getSelectionContext();
      },
      ...
      _getManager: function _getManager() {
        return this.__manager__P_192_0;
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__manager__P_192_0.getSelectables(all);
      },
      ...
      invertSelection: function invertSelection() {
        this.__manager__P_192_0.invertSelection();
      },
      ...
      _getLeadItem: function _getLeadItem() {
        var mode = this.__manager__P_192_0.getMode();

        if (mode === "single" || mode === "one") {
          return this.__manager__P_192_0.getSelectedItem();
        } else {
          return this.__manager__P_192_0.getLeadItem();
        }
      },
      ...
      */
      ...
      _onSelectionChange: function _onSelectionChange(e) {
        ...
        this.__inOnSelectionChange__P_192_1 = true;

        try {
          this.fireDataEvent("changeSelection", e.getData(), e.getOldData());
          this.fireDataEvent("changeValue", e.getData(), e.getOldData());
        } finally {
          this.__inOnSelectionChange__P_192_1 = false;
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__manager__P_192_0");
    }
  });
  qx.ui.core.MMultiSelectionHandling.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MMultiSelectionHandling.js.map?dt=1598051400879