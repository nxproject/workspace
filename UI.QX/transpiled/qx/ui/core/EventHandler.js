  ...
  qx.Class.define("qx.ui.core.EventHandler", {
    ...
    */
    construct: function construct() {
      ...
      this.__manager__P_59_0 = qx.event.Registration.getManager(window);
    },
    ...
    */
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        if (this.__focusEvents__P_59_1[domEvent.getType()]) {
        ...
        if (!currentWidget || !(currentWidget.isEnabled() || this.__ignoreDisabled__P_59_2[type])) {
          return;
        } // PROCESS LISTENERS
        // Load listeners
        ...
        var listeners = this.__manager__P_59_0.getListeners(currentWidget, type, capture);
        ...
        if (domEvent.getEventPhase() == qx.event.type.Event.AT_TARGET) {
          ...
          var otherListeners = this.__manager__P_59_0.getListeners(currentWidget, type, !capture);
...
//# sourceMappingURL=EventHandler.js.map?dt=1598045169732