  ...
  qx.Mixin.define("qx.ui.core.MRemoteChildrenHandling", {
    ...
    */
    members: {
       ...
       */
      __forward__P_77_0: function __forward__P_77_0(functionName, a1, a2, a3) {
      ...
      getChildren: function getChildren() {
        return this.__forward__P_77_0("getChildren");
      },
      ...
      hasChildren: function hasChildren() {
        return this.__forward__P_77_0("hasChildren");
      },
      ...
      add: function add(child, options) {
        return this.__forward__P_77_0("add", child, options);
      },
      ...
      remove: function remove(child) {
        return this.__forward__P_77_0("remove", child);
      },
      ...
      removeAll: function removeAll() {
        return this.__forward__P_77_0("removeAll");
      },
      ...
      indexOf: function indexOf(child) {
        return this.__forward__P_77_0("indexOf", child);
      },
      ...
      addAt: function addAt(child, index, options) {
        this.__forward__P_77_0("addAt", child, index, options);
      },
      ...
      addBefore: function addBefore(child, before, options) {
        this.__forward__P_77_0("addBefore", child, before, options);
      },
      ...
      addAfter: function addAfter(child, after, options) {
        this.__forward__P_77_0("addAfter", child, after, options);
      },
      ...
      removeAt: function removeAt(index) {
        return this.__forward__P_77_0("removeAt", index);
      }
    }
  });
...
//# sourceMappingURL=MRemoteChildrenHandling.js.map?dt=1598045171453