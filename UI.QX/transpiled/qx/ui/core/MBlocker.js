  ...
  qx.Mixin.define("qx.ui.core.MBlocker", {
    ...
    members: {
      ...
      isBlocked: function isBlocked() {
        return this.__blocker__P_23_0 && this.__blocker__P_23_0.isBlocked();
      },
      ...
      unblock: function unblock() {
        if (this.__blocker__P_23_0) {
          this.__blocker__P_23_0.unblock();
        }
      },
      ...
      forceUnblock: function forceUnblock() {
        if (this.__blocker__P_23_0) {
          this.__blocker__P_23_0.forceUnblock();
        }
      },
      ...
      getBlocker: function getBlocker() {
        if (!this.__blocker__P_23_0) {
          this.__blocker__P_23_0 = this._createBlocker();
        }

        return this.__blocker__P_23_0;
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__blocker__P_23_0");
    }
  });
  qx.ui.core.MBlocker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MBlocker.js.map?dt=1598045163531