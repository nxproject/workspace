  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__lookup__P_64_1[widget.toHashCode()]) {
          delete this.__lookup__P_64_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__queue__P_64_0, widget);
        }

        delete this.__data__P_64_2[widget.toHashCode()];
      },
      ...
      isVisible: function isVisible(widget) {
        return this.__data__P_64_2[widget.toHashCode()] || false;
      },
       ...
       * @return {Boolean} Whether the widget is visible
       */
      __computeVisible__P_64_3: function __computeVisible__P_64_3(widget) {
        var data = this.__data__P_64_2;
        ...
        if (widget.isExcluded()) {
          ...
          if (parent) {
            visible = this.__computeVisible__P_64_3(parent);
          } else {
      ...
      add: function add(widget) {
        ...
        this.__queue__P_64_0.unshift(widget);

        this.__lookup__P_64_1[widget.toHashCode()] = widget;
      ...
      flush: function flush() {
        ...
        var queue = this.__queue__P_64_0;
        var data = this.__data__P_64_2; // Dynamically add children to queue
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          if (data[hash] == null) {
            this.__computeVisible__P_64_3(widget);
        ...
        this.__queue__P_64_0 = [];
        this.__lookup__P_64_1 = {};
      }
    }
  });
...
//# sourceMappingURL=Visibility.js.map?dt=1598045170183