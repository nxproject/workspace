    ...
    statics: {
      ...
      remove: function remove(widget, job) {
        ...
        if (job == null) {
          ...
          delete this.__jobs__P_75_1[hash];
          return;
        }

        if (this.__jobs__P_75_1[hash]) {
          delete this.__jobs__P_75_1[hash][job];

          if (qx.lang.Object.getLength(this.__jobs__P_75_1[hash]) == 0) {
            qx.lang.Array.remove(queue, widget);
          }
        }
      },
      ...
      add: function add(widget, job) {
        var queue = this.__queue__P_75_0; //add widget if not containing
        ...
        if (!this.__jobs__P_75_1[hash]) {
          this.__jobs__P_75_1[hash] = {};
        }

        this.__jobs__P_75_1[hash][job] = true;
      ...
      flush: function flush() {
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          obj = queue[i];
          jobs = this.__jobs__P_75_1[obj.toHashCode()];
          queue.splice(i, 1);
          obj.syncWidget(jobs);
        } // Empty check
...
//# sourceMappingURL=Widget.js.map?dt=1598045171305