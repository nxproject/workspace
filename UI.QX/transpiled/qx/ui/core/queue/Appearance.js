  ...
  qx.Class.define("qx.ui.core.queue.Appearance", {
    statics: {
      ...
      has: function has(widget) {
        return !!this.__lookup__P_71_1[widget.toHashCode()];
      },
      ...
      flush: function flush() {
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          obj = queue[i];
          queue.splice(i, 1);
          delete this.__lookup__P_71_1[obj.toHashCode()]; // Only apply to currently visible widgets
...
//# sourceMappingURL=Appearance.js.map?dt=1598045171048