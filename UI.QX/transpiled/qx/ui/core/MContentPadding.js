  ...
  qx.Mixin.define("qx.ui.core.MContentPadding", {
    ...
    */
    members: {
       ...
       */
      __contentPaddingSetter__P_80_0: {
       ...
       */
      __contentPaddingThemedSetter__P_80_1: {
       ...
       */
      __contentPaddingResetter__P_80_2: {
      ...
      _applyContentPadding: function _applyContentPadding(value, old, name, variant) {
        ...
        if (value == null) {
          var resetter = this.__contentPaddingResetter__P_80_2[name];
          target[resetter]();
        } else {
          // forward the themed sates if case the apply was invoked by a theme
          if (variant == "setThemed" || variant == "resetThemed") {
            var setter = this.__contentPaddingThemedSetter__P_80_1[name];
            target[setter](value);
          } else {
            var setter = this.__contentPaddingSetter__P_80_0[name];
            target[setter](value);
          }
        }
      }
...
//# sourceMappingURL=MContentPadding.js.map?dt=1598045171690