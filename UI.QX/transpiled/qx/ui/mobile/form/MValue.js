(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.mobile.form.MValue", {
    ...
    */
    members: {
      __oldValue__P_265_0: null,
      __inputTimeoutHandle__P_265_1: null,
      __hasFocus__P_265_2: null,
      ...
      */
      _onBlur: function _onBlur() {
        this.__hasFocus__P_265_2 = false;
      },
      ...
      */
      hasFocus: function hasFocus() {
        return this.__hasFocus__P_265_2;
      },
      ...
      setValue: function setValue(value) {
        ...
        if (this.__oldValue__P_265_0 != value) {
          if (this._setValue) {
          ...
          this.__fireChangeValue__P_265_3(value);
        }
      },
      ...
      _onChangeContent: function _onChangeContent(evt) {
        this.__fireChangeValue__P_265_3(this._convertValue(evt.getData()));
      },
      ...
      _onInput: function _onInput(evt) {
        ...
        if (this.getLiveUpdate()) {
          if (this._setValue) {
            ...
            this.__fireChangeValue__P_265_3(this._convertValue(data));
          }
        }
      },
      ...
      */
       ...
       */
      __fireChangeValue__P_265_3: function __fireChangeValue__P_265_3(value) {
        if (this.__oldValue__P_265_0 != value) {
          this.__oldValue__P_265_0 = value;
...
//# sourceMappingURL=MValue.js.map?dt=1598051413993