    ...
    */
    members: {
      ...
      addState: function addState(state) {
        if (this.__states__P_264_0 === null) {
          this.__states__P_264_0 = {};
        }

        this.__states__P_264_0[state] = true;
      ...
      hasState: function hasState(state) {
        return this.__states__P_264_0 !== null && this.__states__P_264_0[state];
      },
      ...
      removeState: function removeState(state) {
        if (this.hasState(state)) {
          delete this.__states__P_264_0[state];
      ...
      replaceState: function replaceState(oldState, newState) {
        if (this.hasState(oldState)) {
          delete this.__states__P_264_0[oldState];
          this.__states__P_264_0[newState] = true;
...
//# sourceMappingURL=MState.js.map?dt=1598051413911