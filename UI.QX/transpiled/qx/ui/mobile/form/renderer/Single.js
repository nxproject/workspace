  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.form.renderer.Single", {
    ...
    construct: function construct(form) {
      this.__errorMessageContainers__P_323_0 = [];
      this._rows = [];
      this._labels = [];
    ...
    members: {
       ...
       */
      __errorMessageContainers__P_323_0: null,
      // override
      ...
      */
      ...
      showErrorForItem: function showErrorForItem(item) {
        ...
        this.__errorMessageContainers__P_323_0.push(errorNode);
      },
      ...
      */
      ...
      resetForm: function resetForm() {
        for (var i = 0; i < this.__errorMessageContainers__P_323_0.length; i++) {
          qx.dom.Element.remove(this.__errorMessageContainers__P_323_0[i]);
        }
      }
    },
...
//# sourceMappingURL=Single.js.map?dt=1598051422465