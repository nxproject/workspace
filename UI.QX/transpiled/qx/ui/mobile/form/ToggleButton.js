  ...
  qx.Class.define("qx.ui.mobile.form.ToggleButton", {
    ...
    construct: function construct(value, labelChecked, labelUnchecked) {
      ...
      if (labelChecked && labelUnchecked) {
        this.__labelUnchecked__P_269_0 = labelUnchecked;
        this.__labelChecked__P_269_1 = labelChecked;
      }

      this._setAttribute("data-label-checked", this.__labelChecked__P_269_1);

      this._setAttribute("data-label-unchecked", this.__labelUnchecked__P_269_0);

      this.__switch__P_269_2 = this._createSwitch();

      this._add(this.__switch__P_269_2);
    ...
    members: {
      __switch__P_269_2: null,
      __value__P_269_3: false,
      __labelUnchecked__P_269_0: "OFF",
      __labelChecked__P_269_1: "ON",
      __lastToggleTimestamp__P_269_4: 0,
      ...
      _onSwipe: function _onSwipe(evt) {
        if (this._checkLastPointerTime()) {
          ...
          if (direction == "left") {
            if (this.__value__P_269_3 == true) {
              this.toggle();
            }
          } else {
            if (this.__value__P_269_3 == false) {
              this.toggle();
            }
          }
        }
      ...
      _checkLastPointerTime: function _checkLastPointerTime() {
        var elapsedTime = new Date().getTime() - this.__lastToggleTimestamp__P_269_4;

        this.__lastToggleTimestamp__P_269_4 = new Date().getTime();
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__switch__P_269_2", "__labelUnchecked__P_269_0", "__labelChecked__P_269_1");
    }
  });
  qx.ui.mobile.form.ToggleButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ToggleButton.js.map?dt=1598051414558