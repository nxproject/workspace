  ...
  qx.Class.define("qx.ui.mobile.form.Form", {
    ...
    */
    construct: function construct() {
      ...
      this.__invalidItems__P_262_0 = [];
    },
    members: {
      /**
       * the renderer this form uses to be displayed
       */
      __renderer__P_262_1: null,

      /**
       * Contains all invalid items.
       */
      __invalidItems__P_262_0: null,
      ...
      setRenderer: function setRenderer(renderer) {
        this.__renderer__P_262_1 = renderer;
      },
      ...
      validate: function validate() {
        ...
        if (this.__renderer__P_262_1 != null) {
          this.__renderer__P_262_1.resetForm();
        }
        ...
        for (var i = 0; i < groups.length; i++) {
          ...
          for (var j = 0; j < group.items.length; j++) {
            ...
            if (!item.isValid()) {
              this.__invalidItems__P_262_0.push(item);

              if (this.__renderer__P_262_1 != null) {
                this.__renderer__P_262_1.showErrorForItem(item);
              } else {
        ...
        if (this.__renderer__P_262_1 != null) {
          this.__renderer__P_262_1._domUpdated();
        }
      ...
      showRow: function showRow(groupIndex, rowIndex) {
        ...
        if (item) {
          this.__renderer__P_262_1.showItem(item);
        }
      },
      ...
      hideRow: function hideRow(groupIndex, rowIndex) {
        ...
        if (item) {
          this.__renderer__P_262_1.hideItem(item);
        }
      },
      ...
      */
      getInvalidItems: function getInvalidItems() {
        return this.__invalidItems__P_262_0;
      }
    }
  });
...
//# sourceMappingURL=Form.js.map?dt=1598051413693