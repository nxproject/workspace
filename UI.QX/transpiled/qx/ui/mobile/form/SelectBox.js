  ...
  qx.Class.define("qx.ui.mobile.form.SelectBox", {
    ...
    */
    construct: function construct() {
      ...
      this.__selectionDialog__P_266_0 = this._createSelectionDialog();
      this.addCssClass("gap"); // When selectionDialogs changes selection, get chosen selectedIndex from it.

      this.__selectionDialog__P_266_0.addListener("changeSelection", this._onChangeSelection, this);
    },
    ...
    */
    ...
    members: {
      __selectionDialog__P_266_0: null,
      // overridden
      ...
      getSelectionDialog: function getSelectionDialog() {
        return this.__selectionDialog__P_266_0;
      },
      ...
      setDialogTitle: function setDialogTitle(title) {
        this.__selectionDialog__P_266_0.setTitle(title);
      },
      ...
      setClearButtonLabel: function setClearButtonLabel(value) {
        this.__selectionDialog__P_266_0.setClearButtonLabel(value);
      },
       ...
       */
      __showSelectionDialog__P_266_1: function __showSelectionDialog__P_266_1() {
        if (this.isEnabled() == true) {
          // Set index before items, because setItems() triggers rendering.
          this.__selectionDialog__P_266_0.setSelectedIndex(this.getSelection());

          this.__selectionDialog__P_266_0.setItems(this.getModel());

          this.__selectionDialog__P_266_0.show();
        }
      },
      ...
      */
      _onTap: function _onTap(evt) {
        this.__showSelectionDialog__P_266_1(); // request focus so that it leaves previous widget
      ...
      _applyNullable: function _applyNullable(value, old) {
        ...
        this.__selectionDialog__P_266_0.setNullable(value);
      }
    },
    destruct: function destruct() {
      this.__selectionDialog__P_266_0.removeListener("changeSelection", this._onChangeSelection, this);

      this._disposeObjects("__selectionDialog__P_266_0", "__selectionDialogTitle__P_266_2");
...
//# sourceMappingURL=SelectBox.js.map?dt=1598051414304