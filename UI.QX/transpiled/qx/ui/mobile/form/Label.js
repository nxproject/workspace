    ...
    */
    members: {
      ...
      */
      ...
      setLabelFor: function setLabelFor(elementId) {
        if (this.__forWidget__P_263_0) {
          this.__forWidget__P_263_0.removeListener("changeEnabled", this._changeEnabled, this);
        }

        this.__forWidget__P_263_0 = qx.ui.mobile.core.Widget.getWidgetById(elementId);

        if (this.__forWidget__P_263_0) {
          this.__forWidget__P_263_0.addListener("changeEnabled", this._changeEnabled, this);

          this.setEnabled(this.__forWidget__P_263_0.getEnabled());
        }
      ...
      _onTap: function _onTap(evt) {
        if (this.__forWidget__P_263_0 && qx.core.Environment.get("event.dispatchevent")) {
          var target = this.__forWidget__P_263_0.getContentElement();
    ...
    destruct: function destruct() {
      ...
      if (this.__forWidget__P_263_0) {
        ...
        this.__forWidget__P_263_0 = null;
      }
...
//# sourceMappingURL=Label.js.map?dt=1598051413862