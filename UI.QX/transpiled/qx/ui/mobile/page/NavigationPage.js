  ...
  qx.Class.define("qx.ui.mobile.page.NavigationPage", {
    ...
    */
    ...
    members: {
      ...
      __backButton__P_273_0: null,
      __actionButton__P_273_1: null,
      __content__P_273_2: null,
      __scrollContainer__P_273_3: null,
      __title__P_273_4: null,
      __leftContainer__P_273_5: null,
      __rightContainer__P_273_6: null,
      // interface implementation
      getTitleWidget: function getTitleWidget() {
        if (!this.__title__P_273_4) {
          this.__title__P_273_4 = this._createTitleWidget();
        }

        return this.__title__P_273_4;
      },
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (this.__title__P_273_4) {
          this.__title__P_273_4.setValue(value);
        }
      },
      // interface implementation
      getLeftContainer: function getLeftContainer() {
        if (!this.__leftContainer__P_273_5) {
          this.__leftContainer__P_273_5 = this._createLeftContainer();
        }

        return this.__leftContainer__P_273_5;
      },
      // interface implementation
      getRightContainer: function getRightContainer() {
        if (!this.__rightContainer__P_273_6) {
          this.__rightContainer__P_273_6 = this._createRightContainer();
        }

        return this.__rightContainer__P_273_6;
      },
      ...
      _createLeftContainer: function _createLeftContainer() {
        ...
        this.__backButton__P_273_0 = this._createBackButton();

        this.__backButton__P_273_0.addListener("tap", this._onBackButtonTap, this);

        this._showBackButton();

        container.add(this.__backButton__P_273_0);
        return container;
      },
      ...
      _createRightContainer: function _createRightContainer() {
        ...
        this.__actionButton__P_273_1 = this._createButton();

        this.__actionButton__P_273_1.addListener("tap", this._onButtonTap, this);

        this._showButton();

        container.add(this.__actionButton__P_273_1);
        return container;
      },
      ...
      getContent: function getContent() {
        return this.__content__P_273_2;
      },
      ...
      _getBackButton: function _getBackButton() {
        return this.__backButton__P_273_0;
      },
      ...
      _getButton: function _getButton() {
        return this.__actionButton__P_273_1;
      },
      ...
      _getScrollContainer: function _getScrollContainer() {
        return this.__scrollContainer__P_273_3;
      },
      ...
      addAfterNavigationBar: function addAfterNavigationBar(widget) {
        if (widget && this.__scrollContainer__P_273_3) {
          this.addBefore(widget, this.__scrollContainer__P_273_3);
        }
      },
      // property apply
      _applyBackButtonText: function _applyBackButtonText(value, old) {
        if (this.__backButton__P_273_0) {
          this.__backButton__P_273_0.setValue(value);
        }
      },
      // property apply
      _applyActionButtonText: function _applyActionButtonText(value, old) {
        if (this.__actionButton__P_273_1) {
          this.__actionButton__P_273_1.setValue(value);
        }
      },
      // property apply
      _applyActionButtonIcon: function _applyActionButtonIcon(value, old) {
        if (this.__actionButton__P_273_1) {
          this.__actionButton__P_273_1.setIcon(value);
        }
      },
      // property apply
      ...
      _applyContentCssClass: function _applyContentCssClass(value, old) {
        if (this.__content__P_273_2) {
          this.__content__P_273_2.setDefaultCssClass(value);
        }
      },
      ...
      _showBackButton: function _showBackButton() {
        if (this.__backButton__P_273_0) {
          if (this.getShowBackButton()) {
            this.__backButton__P_273_0.show();
          } else {
            this.__backButton__P_273_0.exclude();
          }
        }
      },
      ...
      _showButton: function _showButton() {
        if (this.__actionButton__P_273_1) {
          if (this.getShowButton()) {
            this.__actionButton__P_273_1.show();
          } else {
            this.__actionButton__P_273_1.exclude();
          }
        }
      },
      // overridden
      _initialize: function _initialize() {
        ...
        this.__scrollContainer__P_273_3 = this._createScrollContainer();
        this.__content__P_273_2 = this._createContent();

        if (this.__content__P_273_2) {
          this.__scrollContainer__P_273_3.add(this.__content__P_273_2, {
            flex: 1
          });
        }

        if (this.__scrollContainer__P_273_3) {
          this.add(this.__scrollContainer__P_273_3, {
            flex: 1
          });
        }
      },
    ...
    destruct: function destruct() {
      this._disposeObjects("__leftContainer__P_273_5", "__rightContainer__P_273_6", "__backButton__P_273_0", "__actionButton__P_273_1", "__title__P_273_4");

      this.__leftContainer__P_273_5 = this.__rightContainer__P_273_6 = this.__backButton__P_273_0 = this.__actionButton__P_273_1 = null;
      this.__title__P_273_4 = this.__content__P_273_2 = this.__scrollContainer__P_273_3 = null;
      this._isTablet = null;
    }
  });
...
//# sourceMappingURL=NavigationPage.js.map?dt=1598051415320