(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.page.Manager", {
    ...
    */
    ...
    construct: function construct(isTablet, root) {
      ...
      if (typeof isTablet !== "undefined" && isTablet !== null) {
        this.__isTablet__P_272_0 = isTablet;
      } else {
        // If isTablet is undefined, call environment variable "device.type".
        // When "tablet" or "desktop" type >> do tablet layouting.
        this.__isTablet__P_272_0 = qx.core.Environment.get("device.type") == "desktop" || qx.core.Environment.get("device.type") == "tablet";
      }

      this.__detailNavigation__P_272_1 = this._createDetailNavigation();

      this.__detailNavigation__P_272_1.getNavigationBar().hide();

      if (this.__isTablet__P_272_0) {
        this.__masterNavigation__P_272_2 = this._createMasterNavigation();

        this.__masterNavigation__P_272_2.getNavigationBar().hide();

        this.__masterContainer__P_272_3 = this._createMasterContainer();
        this.__detailContainer__P_272_4 = this._createDetailContainer();
        this.__masterButton__P_272_5 = this._createMasterButton();

        this.__masterButton__P_272_5.addListener("tap", this._onMasterButtonTap, this);

        this.__hideMasterButton__P_272_6 = this._createHideMasterButton();

        this.__hideMasterButton__P_272_6.addListener("tap", this._onHideMasterButtonTap, this);

        this.__masterNavigation__P_272_2.addListener("update", this._onMasterContainerUpdate, this);

        this.__detailNavigation__P_272_1.addListener("update", this._onDetailContainerUpdate, this);

        root.add(this.__detailContainer__P_272_4, {
          flex: 1
        });

        this.__masterContainer__P_272_3.add(this.__masterNavigation__P_272_2, {
          flex: 1
        });

        this.__detailContainer__P_272_4.add(this.__detailNavigation__P_272_1, {
          flex: 1
        });

        qx.event.Registration.addListener(window, "orientationchange", this._onLayoutChange, this);

        this.__masterContainer__P_272_3.addListener("resize", this._onLayoutChange, this); // On Tablet Mode, no Animation should be shown by default.


        this.__masterNavigation__P_272_2.getLayout().setShowAnimation(false);

        this.__detailNavigation__P_272_1.getLayout().setShowAnimation(false);

        this.__masterContainer__P_272_3.forceHide();

        setTimeout(function () {
          if (qx.bom.Viewport.isLandscape()) {
            this.__masterContainer__P_272_3.show();
          }
        }.bind(this), 300);
      } else {
        root.add(this.__detailNavigation__P_272_1, {
          flex: 1
        });
      }
    },
    ...
    */
    members: {
      __isTablet__P_272_0: null,
      __detailNavigation__P_272_1: null,
      __masterNavigation__P_272_2: null,
      __masterButton__P_272_5: null,
      __hideMasterButton__P_272_6: null,
      __masterPages__P_272_7: null,
      __detailPages__P_272_8: null,
      __masterContainer__P_272_3: null,
      __detailContainer__P_272_4: null,
      ...
      getMasterContainer: function getMasterContainer() {
        return this.__masterContainer__P_272_3;
      },
      ...
      getDetailContainer: function getDetailContainer() {
        return this.__detailContainer__P_272_4;
      },
      ...
      getMasterButton: function getMasterButton() {
        return this.__masterButton__P_272_5;
      },
      ...
      getMasterNavigation: function getMasterNavigation() {
        return this.__masterNavigation__P_272_2;
      },
      ...
      getDetailNavigation: function getDetailNavigation() {
        return this.__detailNavigation__P_272_1;
      },
      ...
      */
      ...
      addMaster: function addMaster(pages) {
        if (this.__isTablet__P_272_0) {
          if (pages) {
            ...
            if (this.__masterPages__P_272_7) {
              this.__masterPages__P_272_7.concat(pages);
            } else {
              this.__masterPages__P_272_7 = pages;
            }

            this._add(pages, this.__masterNavigation__P_272_2);
          }
        } else {
      ...
      addDetail: function addDetail(pages) {
        this._add(pages, this.__detailNavigation__P_272_1);

        if (pages && this.__isTablet__P_272_0) {
          if (!qx.lang.Type.isArray(pages)) {
            pages = [pages];
          }
          ...
          if (this.__detailPages__P_272_8) {
            this.__detailPages__P_272_8.concat(pages);
          } else {
            this.__detailPages__P_272_8 = pages;
          }
        }
      },
      ...
      _onDetailPageStart: function _onDetailPageStart(evt) {
        if (qx.bom.Viewport.isPortrait() && this.isHideMasterOnDetailStart()) {
          this.__masterContainer__P_272_3.hide();
        }
      },
      ...
      _add: function _add(pages, target) {
        ...
        for (var i = 0; i < pages.length; i++) {
          ...
          if (this.__isTablet__P_272_0 && !page.getShowBackButtonOnTablet()) {
            page.setShowBackButton(false);
          }

          page.setIsTablet(this.__isTablet__P_272_0);
          target.add(page);
        }
      },
      ...
      _onMasterContainerUpdate: function _onMasterContainerUpdate(evt) {
        ...
        widget.getRightContainer().remove(this.__hideMasterButton__P_272_6);
        widget.getRightContainer().add(this.__hideMasterButton__P_272_6);
      },
      ...
      _onDetailContainerUpdate: function _onDetailContainerUpdate(evt) {
        var widget = evt.getData();
        widget.getLeftContainer().remove(this.__masterButton__P_272_5);
        widget.getLeftContainer().add(this.__masterButton__P_272_5);
      },
        ...
        if (qx.bom.Viewport.isLandscape()) {
          if (this.isAllowMasterHideOnLandscape()) {
            if (isMasterVisible) {
              ...
              this.__masterButton__P_272_5.exclude();

              this.__hideMasterButton__P_272_6.show();
            } else {
              this.__masterButton__P_272_5.show();
            ...
            this.__hideMasterButton__P_272_6.exclude();
          }
        } else {
          this._removeDetailContainerGap();
      ...
      */
      _onLayoutChange: function _onLayoutChange() {
        if (this.__isTablet__P_272_0) {
          if (qx.bom.Viewport.isLandscape()) {
            this.__masterContainer__P_272_3.setHideOnParentTap(false);

            if (this.__masterContainer__P_272_3.isHidden()) {
              this.__masterContainer__P_272_3.show();
            } else {
              this._removeDetailContainerGap();
            ...
            this.__masterContainer__P_272_3.setHideOnParentTap(true);
      ...
      */
      _getGapPropertyKey: function _getGapPropertyKey() {
        return "padding" + qx.lang.String.capitalize(this.__masterContainer__P_272_3.getOrientation());
      },
      ...
      _createDetailContainerGap: function _createDetailContainerGap() {
        qx.bom.element.Style.set(this.__detailContainer__P_272_4.getContainerElement(), this._getGapPropertyKey(), this.__masterContainer__P_272_3.getSize() / 16 + "rem");
      ...
      _removeDetailContainerGap: function _removeDetailContainerGap() {
        qx.bom.element.Style.set(this.__detailContainer__P_272_4.getContainerElement(), this._getGapPropertyKey(), null);
        qx.event.Registration.fireEvent(window, "resize");
      },
      ...
      */
      _applyHideMasterButtonCaption: function _applyHideMasterButtonCaption(value, old) {
        if (this.__isTablet__P_272_0) {
          this.__hideMasterButton__P_272_6.setLabel(value);
        }
      },
      ...
      */
      _applyMasterTitle: function _applyMasterTitle(value, old) {
        if (this.__isTablet__P_272_0) {
          this.__masterButton__P_272_5.setLabel(value);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      if (this.__masterPages__P_272_7) {
        for (var i = 0; i < this.__masterPages__P_272_7.length; i++) {
          var masterPage = this.__masterPages__P_272_7[i];
          masterPage.removeListener("start", this._onMasterPageStart, this);
        }
      }

      if (this.___detailPages__P_272_9) {
        for (var j = 0; j < this.___detailPages__P_272_9.length; j++) {
          var detailPage = this.___detailPages__P_272_9[j];
          detailPage.removeListener("start", this._onDetailPageStart, this);
        }
      }

      if (this.__isTablet__P_272_0) {
        this.__masterContainer__P_272_3.removeListener("changeVisibility", this._onMasterChangeVisibility, this);

        this.__masterContainer__P_272_3.removeListener("resize", this._onLayoutChange, this);

        qx.event.Registration.removeListener(window, "orientationchange", this._onLayoutChange, this);
      }

      this.__masterPages__P_272_7 = this.__detailPages__P_272_8 = null;

      this._disposeObjects("__detailNavigation__P_272_1", "__masterNavigation__P_272_2", "__masterButton__P_272_5");
    }
  });
  qx.ui.mobile.page.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1598051415240