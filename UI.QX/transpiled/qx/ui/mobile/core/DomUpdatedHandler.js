  ...
  qx.Class.define("qx.ui.mobile.core.DomUpdatedHandler", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__manager__P_183_0 = manager;
      this.__targets__P_183_1 = {}; // Register

      qx.ui.mobile.core.DomUpdatedHandler.__instances__P_183_2[this.toHashCode()] = this;
    },
    ...
    */
    statics: {
      ...
      refresh: function refresh() {
        var all = this.__instances__P_183_2;
    ...
    */
    members: {
      __manager__P_183_0: null,
      __targets__P_183_1: null,
      ...
      */
      ...
      registerEvent: function registerEvent(target, type, capture) {
        ...
        var targets = this.__targets__P_183_1;
      ...
      refresh: function refresh() {
        ...
        for (var hash in targets) {
          ...
          if (target && !target.$$disposed && target.isSeeable()) {
            ...
            this.__manager__P_183_0.dispatchEvent(target, evt);
          }
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__manager__P_183_0 = this.__targets__P_183_1 = null; // Deregister

      delete qx.ui.mobile.core.DomUpdatedHandler.__instances__P_183_2[this.toHashCode()];
    },
...
//# sourceMappingURL=DomUpdatedHandler.js.map?dt=1598045573229