  ...
  qx.Class.define("qx.ui.mobile.core.Widget", {
    ...
    */
    statics: {
      ...
      __idCounter__P_180_2: 0,

      /** @type {Integer} ID of the timeout for the DOM update */
      __domUpdatedScheduleId__P_180_3: null,
      ...
      onShutdown: function onShutdown() {
        window.clearTimeout(qx.ui.mobile.core.Widget.__domUpdatedScheduleId__P_180_3);
        delete qx.ui.mobile.core.Widget.__registry__P_180_1;
      },
      ...
      getCurrentId: function getCurrentId() {
        return qx.ui.mobile.core.Widget.__idCounter__P_180_2;
      },
      ...
      registerWidget: function registerWidget(widget) {
        var id = widget.getId();
        var registry = qx.ui.mobile.core.Widget.__registry__P_180_1;
        {
      ...
      unregisterWidget: function unregisterWidget(id) {
        delete qx.ui.mobile.core.Widget.__registry__P_180_1[id];
      },
      ...
      getWidgetById: function getWidgetById(id) {
        return qx.ui.mobile.core.Widget.__registry__P_180_1[id];
      },
      ...
      scheduleDomUpdated: function scheduleDomUpdated() {
        if (qx.ui.mobile.core.Widget.__domUpdatedScheduleId__P_180_3 == null) {
          qx.ui.mobile.core.Widget.__domUpdatedScheduleId__P_180_3 = window.setTimeout(qx.ui.mobile.core.Widget.domUpdated, 0);
        }
      },
      ...
      domUpdated: qx.event.GlobalError.observeMethod(function () {
        ...
        window.clearTimeout(clazz.__domUpdatedScheduleId__P_180_3);
        clazz.__domUpdatedScheduleId__P_180_3 = null;
    ...
    */
    members: {
      __containerElement__P_180_4: null,
      __contentElement__P_180_5: null,
      __layoutParent__P_180_6: null,
      __children__P_180_0: null,
      __layoutManager__P_180_7: null,
      ...
      */
      ...
      _transformId: function _transformId(value) {
        if (value == null) {
          var clazz = qx.ui.mobile.core.Widget;
          value = clazz.ID_PREFIX + clazz.__idCounter__P_180_2++;
        }
      ...
      */
      ...
      _add: function _add(child, layoutProperties) {
        ...
        this.__children__P_180_0.push(child);
      ...
      _addAt: function _addAt(child, index, options) {
        ...
        if (child.getLayoutParent() == this) {
          qx.lang.Array.remove(this.__children__P_180_0, child);
        }

        var ref = this.__children__P_180_0[index];
      ...
      _addBefore: function _addBefore(child, beforeWidget, layoutProperties) {
        ...
        qx.lang.Array.insertBefore(this.__children__P_180_0, child, beforeWidget);
      ...
      _addAfter: function _addAfter(child, afterWidget, layoutProperties) {
        ...
        qx.lang.Array.insertAfter(this.__children__P_180_0, child, afterWidget);
      ...
      _removeAt: function _removeAt(index) {
        if (!this.__children__P_180_0) {
          throw new Error("This widget has no children!");
        }

        var child = this.__children__P_180_0[index];
      ...
      _removeAll: function _removeAll() {
        ...
        var children = this.__children__P_180_0.concat();
      ...
      _indexOf: function _indexOf(child) {
        var children = this.__children__P_180_0;
      ...
      setLayoutParent: function setLayoutParent(parent) {
        if (this.__layoutParent__P_180_6 === parent) {
          return;
        }

        var oldParent = this.__layoutParent__P_180_6;

        if (oldParent && !oldParent.$$disposed) {
          this.__layoutParent__P_180_6.removeChild(this);
        }

        this.__layoutParent__P_180_6 = parent || null;
      },
      ...
      getLayoutParent: function getLayoutParent() {
        return this.__layoutParent__P_180_6;
      },
      ...
      _getChildren: function _getChildren() {
        return this.__children__P_180_0;
      },
      ...
      _hasChildren: function _hasChildren() {
        return this.__children__P_180_0 && this.__children__P_180_0.length > 0;
      },
      ...
      _setLayout: function _setLayout(layout) {
        ...
        if (this.__layoutManager__P_180_7) {
          this.__layoutManager__P_180_7.connectToWidget(null);

          for (var i = 0; i < this._getChildren().length; i++) {
            var child = this._getChildren()[i];

            this.__layoutManager__P_180_7.disconnectFromChildWidget(child);
          }
        }
        ...
        this.__layoutManager__P_180_7 = layout;
      ...
      _getLayout: function _getLayout() {
        return this.__layoutManager__P_180_7;
      },
      ...
      */
       ...
       * @param properties {Map} The animation properties to set. Key / value pairs.
       */
      __setVisibility__P_180_8: function __setVisibility__P_180_8(action, properties) {
      ...
      show: function show(properties) {
        this.__setVisibility__P_180_8("visible", properties);
      },
      ...
      hide: function hide(properties) {
        this.__setVisibility__P_180_8("hidden", properties);
      },
      ...
      exclude: function exclude(properties) {
        this.__setVisibility__P_180_8("excluded", properties);
      },
      ...
      */
      ...
      _setContainerElement: function _setContainerElement(element) {
        this.__containerElement__P_180_4 = element;
      },
      ...
      getContainerElement: function getContainerElement() {
        return this.__containerElement__P_180_4;
      },
      ...
      getContentElement: function getContentElement() {
        if (!this.__contentElement__P_180_5) {
          this.__contentElement__P_180_5 = this._getContentElement();
        }

        return this.__contentElement__P_180_5;
      },
      ...
      */
      ...
      destroy: function destroy() {
        ...
        var parent = this.__layoutParent__P_180_6;
    ...
    */
    destruct: function destruct() {
      ...
      this.__layoutParent__P_180_6 = this.__containerElement__P_180_4 = this.__contentElement__P_180_5 = null;

      if (this.__layoutManager__P_180_7) {
        this.__layoutManager__P_180_7.dispose();
      }

      this.__layoutManager__P_180_7 = null;
    },
...
//# sourceMappingURL=Widget.js.map?dt=1598045572791