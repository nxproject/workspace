(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.mobile.core.MResize", {
    ...
    */
    members: {
      __lastHeight__P_257_0: null,
      __lastWidth__P_257_1: null,
      ...
      fixSize: function fixSize() {
        ...
        if (parent && parent.getContainerElement()) {
          ...
          } else if (this.__lastHeight__P_257_0 != height && this.__lastWidth__P_257_1 != width) {
            this._setHeight(height);

            this._setWidth(width);

            this.__lastWidth__P_257_1 = width;
            this.__lastHeight__P_257_0 = height;
...
//# sourceMappingURL=MResize.js.map?dt=1598051413128