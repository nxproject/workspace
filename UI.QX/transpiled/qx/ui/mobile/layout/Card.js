  ...
  qx.Class.define("qx.ui.mobile.layout.Card", {
    ...
    */
    construct: function construct() {
      ...
      this.__cardAnimation__P_270_0 = new qx.ui.mobile.layout.CardAnimation();
    },
    ...
    */
     ...
     */
    members: {
      __nextWidget__P_270_1: null,
      __currentWidget__P_270_2: null,
      __inAnimation__P_270_3: null,
      __animation__P_270_4: null,
      __reverse__P_270_5: null,
      __cardAnimation__P_270_0: null,
      // overridden
      ...
      setCardAnimation: function setCardAnimation(value) {
        this.__cardAnimation__P_270_0 = value;
      },
      ...
      getCardAnimation: function getCardAnimation() {
        return this.__cardAnimation__P_270_0;
      },
      ...
      _showWidget: function _showWidget(widget, properties) {
        if (this.__nextWidget__P_270_1 == widget) {
          return;
        }

        if (this.__inAnimation__P_270_3) {
          this.__stopAnimation__P_270_6();
        }

        this.__nextWidget__P_270_1 = widget;

        if (this.__currentWidget__P_270_2 && this.getShowAnimation() && qx.core.Environment.get("css.transform.3d")) {
          ...
          this.__animation__P_270_4 = properties.animation || this.getDefaultAnimation();

          if (properties.action && properties.action === "back") {
            this.__reverse__P_270_5 = true;
          } else {
            properties.reverse = properties.reverse === null ? false : properties.reverse;
            this.__reverse__P_270_5 = properties.reverse;
          }

          qx.bom.AnimationFrame.request(function () {
            this.__startAnimation__P_270_7(widget);
          }, this);
        } else {
          this._swapWidget();
        }
      ...
      _swapWidget: function _swapWidget() {
        if (this.__currentWidget__P_270_2) {
          this.__currentWidget__P_270_2.removeCssClass("active");

          this.__currentWidget__P_270_2.exclude();
        }

        this.__currentWidget__P_270_2 = this.__nextWidget__P_270_1;

        this.__currentWidget__P_270_2.addCssClass("active");
      },
       ...
       * @param widget {qx.ui.mobile.core.Widget} The target widget
       */
      __startAnimation__P_270_7: function __startAnimation__P_270_7(widget) {
        if (widget.isDisposed()) {
          return;
        } // Fix size of current and next widget, then start animation.


        this.__inAnimation__P_270_3 = true;
        this.fireDataEvent("animationStart", [this.__currentWidget__P_270_2, widget]);

        var fromElement = this.__currentWidget__P_270_2.getContainerElement();
        ...
        var fromCssClasses = this.__getAnimationClasses__P_270_8("out");

        var toCssClasses = this.__getAnimationClasses__P_270_8("in");

        this._widget.addCssClass("animationParent");

        var toElementAnimation = this.__cardAnimation__P_270_0.getAnimation(this.__animation__P_270_4, "in", this.__reverse__P_270_5);

        var fromElementAnimation = this.__cardAnimation__P_270_0.getAnimation(this.__animation__P_270_4, "out", this.__reverse__P_270_5);
      ...
      _onAnimationEnd: function _onAnimationEnd(evt) {
        ...
        this.fireDataEvent("animationEnd", [this.__currentWidget__P_270_2, this.__nextWidget__P_270_1]);
      },

      /**
       * Stops the animation for the page transition.
       */
      __stopAnimation__P_270_6: function __stopAnimation__P_270_6() {
        if (this.__inAnimation__P_270_3) {
          var fromElement = this.__currentWidget__P_270_2.getContainerElement();

          var toElement = this.__nextWidget__P_270_1.getContainerElement();
          ...
          qx.bom.element.Class.removeClasses(fromElement, this.__getAnimationClasses__P_270_8("out"));
          qx.bom.element.Class.removeClasses(toElement, this.__getAnimationClasses__P_270_8("in"));

          this._swapWidget();

          this._widget.removeCssClass("animationParent");

          this.__inAnimation__P_270_3 = false;
        }
      },
       ...
       */
      __getAnimationClasses__P_270_8: function __getAnimationClasses__P_270_8(direction) {
        var classes = ["animationChild", this.__animation__P_270_4, direction];

        if (this.__reverse__P_270_5) {
    ...
    destruct: function destruct() {
      this._disposeObjects("__cardAnimation__P_270_0");
    }
  });
  qx.ui.mobile.layout.Card.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Card.js.map?dt=1598051414647