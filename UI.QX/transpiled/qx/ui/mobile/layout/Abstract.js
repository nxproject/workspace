(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.layout.Abstract", {
    ...
    members: {
      _widget: null,
      __cachedProperties__P_184_0: null,
      __cachedChildLayoutProperties__P_184_1: null,
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__cachedProperties__P_184_0) {
            for (var property in this.__cachedProperties__P_184_0) {
              this.reset(property);
              this.set(property, this.__cachedProperties__P_184_0[property]);
            }
          }
        } else {
          this.__cachedProperties__P_184_0 = null;
        }
      },
      ...
      _addCachedProperty: function _addCachedProperty(property, value) {
        if (!this.__cachedProperties__P_184_0) {
          this.__cachedProperties__P_184_0 = {};
        }

        this.__cachedProperties__P_184_0[property] = value;
      },
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__getChildLayoutPropertyCache__P_184_2(widget);
       ...
       *     Key / value pairs.
       */
      __getChildLayoutPropertyCache__P_184_2: function __getChildLayoutPropertyCache__P_184_2(widget) {
        if (!this.__cachedChildLayoutProperties__P_184_1) {
          this.__cachedChildLayoutProperties__P_184_1 = {};
        }

        var cache = this.__cachedChildLayoutProperties__P_184_1;
...
//# sourceMappingURL=Abstract.js.map?dt=1598045573299