    ...
    */
    members: {
      ...
      _applySource: function _applySource(value, old) {
        ...
        if (source && source.indexOf('data:') != 0) {
          ...
          if (!qx.io.ImageLoader.isFailed(uri) && !qx.io.ImageLoader.isLoaded(uri)) {
            qx.io.ImageLoader.load(uri, this.__loaderCallback__P_251_0, this);
          }
        }
      ...
      */
       ...
       */
      __loaderCallback__P_251_0: function __loaderCallback__P_251_0(source, imageInfo) {
...
//# sourceMappingURL=Image.js.map?dt=1598051412099