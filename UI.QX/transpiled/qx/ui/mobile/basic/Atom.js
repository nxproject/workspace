  ...
  qx.Class.define("qx.ui.mobile.basic.Atom", {
    ...
    */
    ...
    construct: function construct(label, icon) {
      ...
      this.__createChildren__P_250_0(label, icon);
    ...
    */
    ...
    members: {
      __layout__P_250_1: null,
      __label__P_250_2: null,
      __icon__P_250_3: null,
      __childrenContainer__P_250_4: null,
      // property apply
      _applyIconPosition: function _applyIconPosition(value, old) {
        var verticalLayout = ["top", "bottom"].indexOf(value) != -1;
        var hasNoLabel = !this.__label__P_250_2;

        this.__createLayout__P_250_5(verticalLayout, hasNoLabel);

        var isReverse = ["right", "bottom"].indexOf(value) != -1;

        this.__childrenContainer__P_250_4.setLayout(this.__layout__P_250_1);

        this.__layout__P_250_1.setReversed(isReverse);

        this._domUpdated();
      },
      // property apply
      _applyShow: function _applyShow(value, old) {
        if (this.__label__P_250_2) {
          if (value === 'both' || value === 'label') {
            this.__label__P_250_2.show();
          } else if (value === 'icon') {
            this.__label__P_250_2.exclude();
          }
        }

        if (this.__icon__P_250_3) {
          if (value === 'both' || value === 'icon') {
            this.__icon__P_250_3.show();
          } else if (value === 'label') {
            this.__icon__P_250_3.exclude();
          }
        }
      },
      // property apply
      _applyLabel: function _applyLabel(value, old) {
        if (this.__label__P_250_2) {
          this.__label__P_250_2.setValue(value);
        } else {
          this.__label__P_250_2 = this._createLabelWidget(value);
        }
      },
      // property apply
      _applyIcon: function _applyIcon(value, old) {
        if (this.__icon__P_250_3) {
          this.__icon__P_250_3.setSource(value);
        } else {
          this.__icon__P_250_3 = this._createIconWidget(value);
        }
      },
       ...
       */
      __createLayout__P_250_5: function __createLayout__P_250_5(verticalLayout, hasNoLabel) {
        if (verticalLayout || hasNoLabel) {
          if (this.__layout__P_250_1) {
            if (this.__layout__P_250_1.classname !== "qx.ui.mobile.layout.VBox") {
              this.__layout__P_250_1.dispose();

              this.__layout__P_250_1 = new qx.ui.mobile.layout.VBox();
            }
          } // layout == null
          else {
              this.__layout__P_250_1 = new qx.ui.mobile.layout.VBox();
            ...
            if (this.__layout__P_250_1) {
              if (this.__layout__P_250_1.classname !== "qx.ui.mobile.layout.HBox") {
                this.__layout__P_250_1.dispose();

                this.__layout__P_250_1 = new qx.ui.mobile.layout.HBox();
              }
            } // layout == null
            else {
                this.__layout__P_250_1 = new qx.ui.mobile.layout.HBox();
       ...
       *
       */
      __createChildren__P_250_0: function __createChildren__P_250_0(label, icon) {
        this.__label__P_250_2 = this._createLabelWidget(label);

        if (label) {
          this.setLabel(label);
        }

        this.__icon__P_250_3 = this._createIconWidget(icon);
        ...
        if (this.__childrenContainer__P_250_4) {
          this.__childrenContainer__P_250_4.dispose();
        }

        this.__childrenContainer__P_250_4 = new qx.ui.mobile.container.Composite(this.__layout__P_250_1);

        this.__childrenContainer__P_250_4.addCssClass("qx-flex-center");

        this.__childrenContainer__P_250_4.setAnonymous(true);

        if (this.__icon__P_250_3) {
          this.__childrenContainer__P_250_4.add(this.__icon__P_250_3);
        }

        if (this.__label__P_250_2) {
          this.__label__P_250_2.addCssClass("qx-flex-center");

          this.__childrenContainer__P_250_4.add(this.__label__P_250_2);
        } // Show/Hide Label/Icon


        if (this.getShow() === 'icon' && this.__label__P_250_2) {
          this.__label__P_250_2.exclude();
        }

        if (this.getShow() === 'label' && this.__icon__P_250_3) {
          this.__icon__P_250_3.exclude();
        }

        this._add(this.__childrenContainer__P_250_4);
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__layout__P_250_1", "__label__P_250_2", "__icon__P_250_3", "__childrenContainer__P_250_4");
    }
  });
  qx.ui.mobile.basic.Atom.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Atom.js.map?dt=1598051412045