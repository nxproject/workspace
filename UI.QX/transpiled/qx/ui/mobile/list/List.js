  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.List", {
    ...
    construct: function construct(delegate) {
      ...
      this.__provider__P_271_0 = new qx.ui.mobile.list.provider.Provider(this);
     ...
     */
    members: {
      __provider__P_271_0: null,
      __minDeleteDistance__P_271_1: null,
      __isScrollingBlocked__P_271_2: null,
      __trackElement__P_271_3: null,
      // overridden
      ...
      */
      _onTrackStart: function _onTrackStart(evt) {
        this.__isScrollingBlocked__P_271_2 = null;
        this.__trackElement__P_271_3 = null;

        var element = this._getElement(evt);

        if (element && qx.bom.element.Class.has(element, "list-item") && qx.bom.element.Class.has(element, "removable")) {
          this.__trackElement__P_271_3 = element;
          this.__minDeleteDistance__P_271_1 = qx.bom.element.Dimension.getWidth(element) / 2;
      ...
      */
      _onTrack: function _onTrack(evt) {
        if (!this.__trackElement__P_271_3) {
          return;
        }

        var element = this.__trackElement__P_271_3;
        var delta = evt.getDelta();
        var deltaX = Math.round(delta.x * 0.1) / 0.1;

        if (this.__isScrollingBlocked__P_271_2 === null) {
          this.__isScrollingBlocked__P_271_2 = delta.axis == "x";
        }

        if (!this.__isScrollingBlocked__P_271_2) {
          return;
        }

        var opacity = 1 - Math.abs(deltaX) / this.__minDeleteDistance__P_271_1;
      ...
      */
      _onTrackEnd: function _onTrackEnd(evt) {
        ...
        if (Math.abs(evt.getDelta().x) > this.__minDeleteDistance__P_271_1) {
      ...
      */
      ...
      _applyModel: function _applyModel(value, old) {
        if (old != null) {
          old.removeListener("changeBubble", this.__onModelChangeBubble__P_271_4, this);
        }

        if (value != null) {
          value.addListener("changeBubble", this.__onModelChangeBubble__P_271_4, this);
        }

        if (old != null) {
          old.removeListener("change", this.__onModelChange__P_271_5, this);
        }

        if (value != null) {
          value.addListener("change", this.__onModelChange__P_271_5, this);
        }

        if (old != null) {
          old.removeListener("changeLength", this.__onModelChangeLength__P_271_6, this);
        }

        if (value != null) {
          value.addListener("changeLength", this.__onModelChangeLength__P_271_6, this);
        }

        this.__render__P_271_7();
      },
      // property apply
      _applyDelegate: function _applyDelegate(value, old) {
        this.__provider__P_271_0.setDelegate(value);
      },
       ...
       */
      __onModelChangeLength__P_271_6: function __onModelChangeLength__P_271_6(evt) {
        this.__render__P_271_7();
      },
       ...
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __onModelChange__P_271_5: function __onModelChange__P_271_5(evt) {
       ...
       */
      __onModelChangeBubble__P_271_4: function __onModelChangeBubble__P_271_4(evt) {
        if (evt) {
          ...
          if (!isArray || isArray && data.old.length == data.value.length) {
            ...
            for (var i = 0; i < rows.length; i++) {
              this.__renderRow__P_271_8(rows[i]);
            }
          }
        }
      },
       ...
       */
      __renderRow__P_271_8: function __renderRow__P_271_8(index) {
        var renderedItems = qx.bom.Selector.query(".list-item", this.getContentElement());
        var oldNode = renderedItems[index];

        var newNode = this.__provider__P_271_0.getItemElement(this.getModel().getItem(index), index);
      ...
      */
       ...
       * Renders the list.
       */
      __render__P_271_7: function __render__P_271_7() {
        this._setHtml("");
        ...
        for (var index = 0; index < this.getItemCount(); index++) {
          ...
          var itemElement = this.__provider__P_271_0.getItemElement(item, index);
      ...
      */
      _renderGroup: function _renderGroup(itemIndex, groupIndex) {
        var group = this.__getGroup__P_271_10(itemIndex);

        if (itemIndex === 0) {
          return this.__provider__P_271_0.getGroupElement(group, groupIndex);
        } else {
          var previousGroup = this.__getGroup__P_271_10(itemIndex - 1);
      ...
      */
      __hasGroup__P_271_9: function __hasGroup__P_271_9() {
       ...
       */
      __getGroup__P_271_10: function __getGroup__P_271_10(index) {
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__provider__P_271_0");
...
//# sourceMappingURL=List.js.map?dt=1598051414915