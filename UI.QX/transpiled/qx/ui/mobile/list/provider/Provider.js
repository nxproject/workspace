(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.provider.Provider", {
    ...
    members: {
      __itemRenderer__P_324_0: null,
      __groupRenderer__P_324_1: null,
      ...
      _setItemRenderer: function _setItemRenderer(renderer) {
        this.__itemRenderer__P_324_0 = renderer;
      },
      ...
      _getItemRenderer: function _getItemRenderer() {
        return this.__itemRenderer__P_324_0;
      },
      ...
      */
      _setGroupRenderer: function _setGroupRenderer(renderer) {
        this.__groupRenderer__P_324_1 = renderer;
      },
      ...
      */
      _getGroupRenderer: function _getGroupRenderer() {
        return this.__groupRenderer__P_324_1;
      },
      ...
      getItemElement: function getItemElement(data, row) {
        this.__itemRenderer__P_324_0.reset();

        this._configureItem(data, row); // Clone the element and all it's events


        var clone = qx.bom.Element.clone(this.__itemRenderer__P_324_0.getContainerElement(), true);
      ...
      getGroupElement: function getGroupElement(data, group) {
        this.__groupRenderer__P_324_1.reset();

        this._configureGroupItem(data, group); // Clone the element and all it's events


        var clone = qx.bom.Element.clone(this.__groupRenderer__P_324_1.getContainerElement(), true);
      ...
      _configureItem: function _configureItem(data, row) {
        ...
        if (delegate != null && delegate.configureItem != null) {
          delegate.configureItem(this.__itemRenderer__P_324_0, data, row);
        }
      },
      ...
      */
      _configureGroupItem: function _configureGroupItem(data, group) {
        ...
        if (configureGroupItem) {
          configureGroupItem(this.__groupRenderer__P_324_1, data, group);
        }
      },
    ...
    destruct: function destruct() {
      this._disposeObjects("__itemRenderer__P_324_0", "__groupRenderer__P_324_1");
    }
  });
  qx.ui.mobile.list.provider.Provider.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Provider.js.map?dt=1598051422558