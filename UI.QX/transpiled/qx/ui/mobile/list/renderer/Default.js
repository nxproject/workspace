(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.renderer.Default", {
    ...
    members: {
      __image__P_325_0: null,
      __title__P_325_1: null,
      __subtitle__P_325_2: null,
      __rightContainer__P_325_3: null,
      ...
      getSubtitleWidget: function getSubtitleWidget() {
        return this.__subtitle__P_325_2;
      },
      ...
      setImage: function setImage(source) {
        this.__image__P_325_0.setSource(source);
      },
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__title__P_325_1.setValue(title.translate());
        } else {
          this.__title__P_325_1.setValue(title);
        }
      },
      ...
      setSubtitle: function setSubtitle(subtitle) {
        if (subtitle && subtitle.translate) {
          this.__subtitle__P_325_2.setValue(subtitle.translate());
        } else {
          this.__subtitle__P_325_2.setValue(subtitle);
        }
      },
      ...
      _init: function _init() {
        this.__image__P_325_0 = this._createImage();
        this.add(this.__image__P_325_0);
        this.__rightContainer__P_325_3 = this._createRightContainer();
        this.add(this.__rightContainer__P_325_3, {
          flex: 1
        });
        this.__title__P_325_1 = this._createTitle();

        this.__rightContainer__P_325_3.add(this.__title__P_325_1);

        this.__subtitle__P_325_2 = this._createSubtitle();

        this.__rightContainer__P_325_3.add(this.__subtitle__P_325_2);
      },
      ...
      reset: function reset() {
        this.__image__P_325_0.setSource(null);

        this.__title__P_325_1.setValue("");

        this.__subtitle__P_325_2.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__image__P_325_0", "__title__P_325_1", "__subtitle__P_325_2", "__rightContainer__P_325_3");
    }
  });
  qx.ui.mobile.list.renderer.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1598051422659