(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.renderer.group.Default", {
    ...
    members: {
      __image__P_329_0: null,
      __title__P_329_1: null,
      __rightContainer__P_329_2: null,
      ...
      setImage: function setImage(source) {
        this.__image__P_329_0.setSource(source);
      },
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__title__P_329_1.setValue(title.translate());
        } else {
          this.__title__P_329_1.setValue(title);
        }
      },
      ...
      _init: function _init() {
        this.__image__P_329_0 = this._createImage();
        this.add(this.__image__P_329_0);
        this.__rightContainer__P_329_2 = this._createRightContainer();
        this.add(this.__rightContainer__P_329_2, {
          flex: 1
        });
        this.__title__P_329_1 = this._createTitle();

        this.__rightContainer__P_329_2.add(this.__title__P_329_1);
      },
      ...
      reset: function reset() {
        this.__image__P_329_0.setSource(null);

        this.__title__P_329_1.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__image__P_329_0", "__title__P_329_1", "__rightContainer__P_329_2");
    }
  });
  qx.ui.mobile.list.renderer.group.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1598051423041