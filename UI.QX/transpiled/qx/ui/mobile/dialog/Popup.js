(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.dialog.Popup", {
    ...
    members: {
      __isShown__P_261_1: false,
      __childrenContainer__P_261_2: null,
      __percentageTop__P_261_3: null,
      __anchor__P_261_0: null,
      __widget__P_261_4: null,
      __titleWidget__P_261_5: null,
      __lastPopupDimension__P_261_6: null,
      ...
      _updatePosition: function _updatePosition() {
        ...
        if (this.__anchor__P_261_0) {
          ...
          var anchorPosition = qx.bom.element.Location.get(this.__anchor__P_261_0.getContainerElement());
          var popupDimension = qx.bom.element.Dimension.getSize(this.getContainerElement());
          this.__lastPopupDimension__P_261_6 = popupDimension;
        ...
        } else if (this.__childrenContainer__P_261_2) {
          // No Anchor
          this._positionToCenter();
        }
      },
       ...
       */
      show: function show() {
        if (!this.__isShown__P_261_1) {
          qx.core.Init.getApplication().fireEvent("popup");

          this.__registerEventListener__P_261_7(); // Move outside of viewport
      ...
      hide: function hide() {
        if (this.__isShown__P_261_1) {
          this.__unregisterEventListener__P_261_8();

          this.exclude();
        }

        this.__isShown__P_261_1 = false;
      ...
      isShown: function isShown() {
        return this.__isShown__P_261_1;
      },
      ...
      toggleVisibility: function toggleVisibility() {
        if (this.__isShown__P_261_1 == true) {
          this.hide();
        } else {
          this.show();
        }
      ...
      _trackUserTap: function _trackUserTap(evt) {
        ...
        var isOutsideWidget = clientX < popupLocation.left || clientX > popupLocation.left + this.__lastPopupDimension__P_261_6.width || clientY > popupLocation.top + this.__lastPopupDimension__P_261_6.height || clientY < popupLocation.top;
       ...
       */
      __registerEventListener__P_261_7: function __registerEventListener__P_261_7() {
        ...
        if (this.__anchor__P_261_0) {
          this.__anchor__P_261_0.addCssClass("anchor-target");
       ...
       */
      __unregisterEventListener__P_261_8: function __unregisterEventListener__P_261_8() {
        ...
        if (this.__anchor__P_261_0) {
          this.__anchor__P_261_0.removeCssClass("anchor-target");
      ...
      _initializeChild: function _initializeChild(widget) {
        if (this.__childrenContainer__P_261_2 == null) {
          this.__childrenContainer__P_261_2 = new qx.ui.mobile.container.Composite(new qx.ui.mobile.layout.VBox());

          this.__childrenContainer__P_261_2.setDefaultCssClass("popup-content");

          this._add(this.__childrenContainer__P_261_2);
        }

        if (this._createTitleWidget()) {
          this.__childrenContainer__P_261_2.remove(this._createTitleWidget());

          this.__childrenContainer__P_261_2.add(this._createTitleWidget());
        }

        this.__childrenContainer__P_261_2.add(widget, {
          flex: 1
        });

        widget.addListener("domupdated", this._updatePosition, this);
        this.__widget__P_261_4 = widget;
      },
      ...
      _createTitleWidget: function _createTitleWidget() {
        if (this.__titleWidget__P_261_5) {
          return this.__titleWidget__P_261_5;
        }

        if (this.getTitle() || this.getIcon()) {
          this.__titleWidget__P_261_5 = new qx.ui.mobile.basic.Atom(this.getTitle(), this.getIcon());

          this.__titleWidget__P_261_5.addCssClass('popup-title');
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (value) {
          if (this.__titleWidget__P_261_5) {
            this.__titleWidget__P_261_5.setLabel(value);
          } else {
            this.__titleWidget__P_261_5 = new qx.ui.mobile.basic.Atom(value, this.getIcon());

            this.__titleWidget__P_261_5.addCssClass('popup-title');

            if (this.__widget__P_261_4) {
              this.__childrenContainer__P_261_2.addBefore(this._createTitleWidget(), this.__widget__P_261_4);
            } else {
              if (this.__childrenContainer__P_261_2) {
                this.__childrenContainer__P_261_2.add(this._createTitleWidget());
              }
            }
          }
      ...
      _applyIcon: function _applyIcon(value, old) {
        if (value) {
          if (this.__titleWidget__P_261_5) {
            this.__titleWidget__P_261_5.setIcon(value);
          } else {
            this.__titleWidget__P_261_5 = new qx.ui.mobile.basic.Atom(this.getTitle(), value);
      ...
      removeWidget: function removeWidget() {
        if (this.__widget__P_261_4) {
          this.__widget__P_261_4.removeListener("domupdated", this._updatePosition, this);

          this.__childrenContainer__P_261_2.remove(this.__widget__P_261_4);

          return this.__widget__P_261_4;
        } else {
          {
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__childrenContainer__P_261_2");

      this.__isShown__P_261_1 = this.__percentageTop__P_261_3 = this._anchor = this.__widget__P_261_4 = this.__lastPopupDimension__P_261_6 = null;
    }
  });
  qx.ui.mobile.dialog.Popup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Popup.js.map?dt=1598051413458