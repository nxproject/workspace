  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.dialog.Menu", {
    ...
    construct: function construct(itemsModel, anchor) {
      ...
      this.__selectionList__P_260_0 = this._createSelectionList();

      if (itemsModel) {
        this.__selectionList__P_260_0.setModel(itemsModel);
      }

      this.__menuContainer__P_260_1 = new qx.ui.mobile.container.Composite();
      this.__clearButton__P_260_2 = this._createClearButton();
      this.__listScroller__P_260_3 = this._createListScroller(this.__selectionList__P_260_0);

      this.__menuContainer__P_260_1.add(this.__listScroller__P_260_3);

      this.__menuContainer__P_260_1.add(this.__clearButton__P_260_2);

      qx.ui.mobile.dialog.Popup.constructor.call(this, this.__menuContainer__P_260_1, anchor);
    ...
    */
    members: {
      __selectionList__P_260_0: null,
      __clearButton__P_260_2: null,
      __listScroller__P_260_3: null,
      __menuContainer__P_260_1: null,
      // overridden
      show: function show() {
      ...
      _createClearButton: function _createClearButton() {
        ...
        clearButton.addListener("tap", this.__onClearButtonTap__P_260_4, this);
        clearButton.exclude();
        return clearButton;
      },
      ...
      */
      _getListScroller: function _getListScroller() {
        return this.__listScroller__P_260_3;
      },
      // overridden
      _updatePosition: function _updatePosition() {
        ...
        if (this.getVisibleListItems() !== null) {
          var newListScrollerHeight = this.__selectionList__P_260_0.getListItemHeight() * this.getVisibleListItems();
          listScrollerHeight = Math.min(newListScrollerHeight, listScrollerHeight);
        }

        qx.bom.element.Style.set(this.__listScroller__P_260_3.getContainerElement(), "maxHeight", listScrollerHeight + "px");
      ...
      _createSelectionList: function _createSelectionList() {
        ...
        selectionList.addListener("changeSelection", this.__onListChangeSelection__P_260_5, this);
      ...
      */
      getSelectionList: function getSelectionList() {
        return this.__selectionList__P_260_0;
      },
      ...
      setItems: function setItems(itemsModel) {
        if (this.__selectionList__P_260_0) {
          this.__selectionList__P_260_0.setModel(null);
       ...
       */
      __onListChangeSelection__P_260_5: function __onListChangeSelection__P_260_5(evt) {
       ...
       */
      __onClearButtonTap__P_260_4: function __onClearButtonTap__P_260_4() {
      ...
      _applySelectedIndex: function _applySelectedIndex(value, old) {
        var listModel = this.__selectionList__P_260_0.getModel();
      ...
      _applyNullable: function _applyNullable(value, old) {
        if (value) {
          this.__clearButton__P_260_2.setVisibility("visible");
        } else {
          this.__clearButton__P_260_2.setVisibility("excluded");
        }
      },
      // property apply
      _applyClearButtonLabel: function _applyClearButtonLabel(value, old) {
        this.__clearButton__P_260_2.setValue(value);
      },
      ...
      _render: function _render() {
        var tmpModel = this.__selectionList__P_260_0.getModel();

        this.__selectionList__P_260_0.setModel(null);

        this.__selectionList__P_260_0.setModel(tmpModel);
      },
      ...
      scrollToItem: function scrollToItem(index) {
        if (index !== null && this.__selectionList__P_260_0.getModel() != null) {
          var listItems = qxWeb("#" + this.__listScroller__P_260_3.getId() + " .list-item");
          var targetListItemElement = listItems[index];

          this.__listScroller__P_260_3.scrollToElement(targetListItemElement);
        }
      }
    },
    destruct: function destruct() {
      this.__selectionList__P_260_0.removeListener("tap", this._onSelectionListTap, this);

      this._disposeObjects("__selectionList__P_260_0", "__clearButton__P_260_2", "__listScroller__P_260_3", "__menuContainer__P_260_1");
    }
  });
  qx.ui.mobile.dialog.Menu.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Menu.js.map?dt=1598051413361