    ...
    members: {
      ...
      alert: function alert(title, text, handler, scope, button) {
        ...
        if (qx.core.Environment.get("phonegap") && qx.core.Environment.get("phonegap.notification")) {
          ...
          var button = this.__processDialogButtons__P_259_0(button);

          return navigator.notification.alert(text, callback, title, button);
        } else {
          return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, [button], qx.ui.mobile.dialog.Manager.MESSAGE_DIALOG);
        }
      },
      ...
      confirm: function confirm(title, text, handler, scope, buttons) {
        if (qx.core.Environment.get("phonegap") && qx.core.Environment.get("phonegap.notification")) {
          ...
          var buttons = this.__processDialogButtons__P_259_0(buttons);

          return navigator.notification.confirm(text, callback, title, buttons);
        } else {
          return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, buttons, qx.ui.mobile.dialog.Manager.MESSAGE_DIALOG);
        }
      },
      ...
      input: function input(title, text, handler, scope, buttons) {
        return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, buttons, qx.ui.mobile.dialog.Manager.INPUT_DIALOG);
      },
      ...
      error: function error(title, text, handler, scope, button) {
        if (qx.core.Environment.get("phonegap") && qx.core.Environment.get("phonegap.notification")) {
          ...
          return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, button, qx.ui.mobile.dialog.Manager.ERROR_DIALOG);
        }
      },
      ...
      warning: function warning(title, text, handler, scope, button) {
        if (qx.core.Environment.get("phonegap") && qx.core.Environment.get("phonegap.notification")) {
          ...
          return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, button, qx.ui.mobile.dialog.Manager.WARNING_DIALOG);
        }
      },
      ...
      wait: function wait(title, text, handler, scope, buttons) {
        return this.__showNonNativeDialog__P_259_1(title, text, handler, scope, buttons, qx.ui.mobile.dialog.Manager.WAITING_DIALOG);
      },
       ...
       */
      __processDialogButtons__P_259_0: function __processDialogButtons__P_259_0(buttons) {
        if (buttons) {
       ...
       */
      __showNonNativeDialog__P_259_1: function __showNonNativeDialog__P_259_1(title, text, handler, scope, buttons, dialogType) {
...
//# sourceMappingURL=Manager.js.map?dt=1598051413261