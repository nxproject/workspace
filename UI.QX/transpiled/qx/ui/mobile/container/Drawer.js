  ...
  qx.Class.define("qx.ui.mobile.container.Drawer", {
    ...
    */
    ...
    construct: function construct(parent, layout) {
      ...
      this.__parent__P_253_0 = this.getLayoutParent();

      this.__parent__P_253_0.addCssClass("drawer-parent");

      this.__parent__P_253_0.addListener("swipe", this._onParentSwipe, this);

      this.__parent__P_253_0.addListener("pointerdown", this._onParentPointerDown, this);

      this.__pointerStartPosition__P_253_1 = [0, 0];
      this.forceHide();
    },
    ...
    */
    members: {
      __pointerStartPosition__P_253_1: null,
      __parent__P_253_0: null,
      __transitionEnabled__P_253_2: null,
      __inTransition__P_253_3: null,
      // property apply
      ...
      _applyPositionZ: function _applyPositionZ(value, old) {
        ...
        if (this.__parent__P_253_0) {
          this.__parent__P_253_0.setTranslateX(0);

          this.__parent__P_253_0.setTranslateY(0);
        }
      },
      // property apply
      ...
      _applyTransitionDuration: function _applyTransitionDuration(value, old) {
        this.__transitionEnabled__P_253_2 = value > 0;
      },
       ...
       */
      show: function show() {
        if (!this.isHidden() || this.__inTransition__P_253_3 === true) {
          return;
        }

        this.__inTransition__P_253_3 = true; // Make drawer visible before "changeVisibility" event is fired, after transition.

        this._setStyle("visibility", "visible");

        this.__parent__P_253_0.addCssClass("blocked");

        if (this.getPositionZ() == "below") {
          if (this.getOrientation() == "left") {
            this.__parent__P_253_0.setTranslateX(this.getSize());
          } else if (this.getOrientation() == "right") {
            this.__parent__P_253_0.setTranslateX(-this.getSize());
          } else if (this.getOrientation() == "top") {
            this.__parent__P_253_0.setTranslateY(this.getSize());
        ...
        if (this.getTransitionDuration() > 0) {
          ...
          var listenerId = qx.bom.Element.addListener(transitionTarget, "transitionEnd", function (evt) {
            ...
            this.__inTransition__P_253_3 = false;
      ...
      hide: function hide() {
        ...
        this.__inTransition__P_253_3 = true;
        ...
        if (this.getTransitionDuration() > 0) {
          ...
          var listenerId = qx.bom.Element.addListener(transitionTarget, "transitionEnd", function (evt) {
            ...
            this.__parent__P_253_0.removeCssClass("blocked");
      ...
      */
      ...
      _onParentPointerDown: function _onParentPointerDown(evt) {
        this.__pointerStartPosition__P_253_1 = [evt.getViewportLeft(), evt.getViewportTop()];
        ...
        if (isShown && this.isHideOnParentTap()) {
          ...
          if (orientation == "left" && this.__pointerStartPosition__P_253_1[0] > location.right || orientation == "top" && this.__pointerStartPosition__P_253_1[1] > location.bottom || orientation == "bottom" && this.__pointerStartPosition__P_253_1[1] < location.top || orientation == "right" && this.__pointerStartPosition__P_253_1[0] < location.left) {
      ...
      _onParentSwipe: function _onParentSwipe(evt) {
        ...
        if (isHidden) {
          ...
          if (direction == "right" && this.getOrientation() == "left" && this.__pointerStartPosition__P_253_1[0] < location.right + this.getTapOffset() && this.__pointerStartPosition__P_253_1[0] > location.right || direction == "left" && this.getOrientation() == "right" && this.__pointerStartPosition__P_253_1[0] > location.left - this.getTapOffset() && this.__pointerStartPosition__P_253_1[0] < location.left || direction == "down" && this.getOrientation() == "top" && this.__pointerStartPosition__P_253_1[1] < this.getTapOffset() + location.bottom && this.__pointerStartPosition__P_253_1[1] > location.bottom || direction == "up" && this.getOrientation() == "bottom" && this.__pointerStartPosition__P_253_1[1] > location.top - this.getTapOffset() && this.__pointerStartPosition__P_253_1[1] < location.top) {
            this.show();
          }
        }
      }
    ...
    destruct: function destruct() {
      ...
      this.__parent__P_253_0.removeListener("swipe", this._onParentSwipe, this);

      this.__parent__P_253_0.removeListener("pointerdown", this._onParentPointerDown, this);

      qx.util.DisposeUtil.destroyContainer(this);
      this.__pointerStartPosition__P_253_1 = this.__parent__P_253_0 = this.__transitionEnabled__P_253_2 = null;
    }
  });
  qx.ui.mobile.container.Drawer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Drawer.js.map?dt=1598051412472