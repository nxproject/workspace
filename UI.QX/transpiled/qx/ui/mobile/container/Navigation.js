  ...
  qx.Class.define("qx.ui.mobile.container.Navigation", {
    ...
    */
    construct: function construct() {
      ...
      this.__navigationBar__P_255_0 = this._createNavigationBar();

      if (this.__navigationBar__P_255_0) {
        this._add(this.__navigationBar__P_255_0);
      }

      this.__content__P_255_1 = this._createContent();

      this._add(this.__content__P_255_1, {
        flex: 1
      });
    },
    ...
    */
    members: {
      __navigationBar__P_255_0: null,
      __content__P_255_1: null,
      __layout__P_255_2: null,
      // overridden
      ...
      getContent: function getContent() {
        return this.__content__P_255_1;
      },
      ...
      getNavigationBar: function getNavigationBar() {
        return this.__navigationBar__P_255_0;
      },
      ...
      _createContent: function _createContent() {
        this.__layout__P_255_2 = new qx.ui.mobile.layout.Card();

        this.__layout__P_255_2.addListener("updateLayout", this._onUpdateLayout, this);

        this.__layout__P_255_2.addListener("animationStart", this._onAnimationStart, this);

        this.__layout__P_255_2.addListener("animationEnd", this._onAnimationEnd, this);

        return new qx.ui.mobile.container.Composite(this.__layout__P_255_2);
      },
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__navigationBar__P_255_0", "__content__P_255_1", "__layout__P_255_2");

      this.__navigationBar__P_255_0 = this.__content__P_255_1 = this.__layout__P_255_2 = null;
    }
  });
  qx.ui.mobile.container.Navigation.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Navigation.js.map?dt=1598051412820