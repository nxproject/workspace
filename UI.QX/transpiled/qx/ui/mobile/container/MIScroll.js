  ...
  qx.Mixin.define("qx.ui.mobile.container.MIScroll", {
    ...
    */
    construct: function construct() {
      this.__initScroll__P_254_0();

      this.__registerEventListeners__P_254_1();
    },
      ...
      */
      _scrollTo: function _scrollTo(x, y, time) {
        if (this._isScrollable()) {
          ...
          if (this.__scroll__P_254_2) {
            this.__scroll__P_254_2.scrollTo(-x, -y, time);
          } else {
       ...
       * @ignore(iScroll)
       */
      __initScroll__P_254_0: function __initScroll__P_254_0() {
        if (!window.iScroll) {
          {
          ...
          loader.on("load", this.__onScrollLoaded__P_254_3, this);
          loader.open("GET", path);
          loader.send();
        } else {
          this.addListenerOnce("appear", function () {
            this._setScroll(this.__createScrollInstance__P_254_4());
          }, this);
        }
      },
       ...
       * @ignore(iScroll)
       */
      __createScrollInstance__P_254_4: function __createScrollInstance__P_254_4() {
       ...
       */
      __registerEventListeners__P_254_1: function __registerEventListeners__P_254_1() {
       ...
       */
      __unregisterEventListeners__P_254_5: function __unregisterEventListeners__P_254_5() {
       ...
       */
      __onScrollLoaded__P_254_3: function __onScrollLoaded__P_254_3(request) {
      ...
      disable: function disable() {
        if (this.__scroll__P_254_2) {
          this.__scroll__P_254_2.disable();
        }
      },
      ...
      _refresh: function _refresh() {
        if (this.__scroll__P_254_2) {
          this.__scroll__P_254_2.refresh();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__unregisterEventListeners__P_254_5(); // Cleanup iScroll


      if (this.__scroll__P_254_2) {
        this.__scroll__P_254_2.destroy();
      }

      this.__scroll__P_254_2 = null;
    }
  });
  qx.ui.mobile.container.MIScroll.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MIScroll.js.map?dt=1598051412633