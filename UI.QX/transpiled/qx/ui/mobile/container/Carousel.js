  ...
  qx.Class.define("qx.ui.mobile.container.Carousel", {
    ...
    */
    construct: function construct(transitionDuration) {
      ...
      this.__snapPointsX__P_252_0 = [];
      this.__onMoveOffset__P_252_1 = [0, 0];
      this.__lastOffset__P_252_2 = [0, 0];
      this.__boundsX__P_252_3 = [0, 0];
      this.__pages__P_252_4 = [];
      this.__paginationLabels__P_252_5 = [];
      var carouselScroller = this.__carouselScroller__P_252_6 = new qx.ui.mobile.container.Composite(new qx.ui.mobile.layout.HBox());
      ...
      qx.event.Registration.addListener(this.__carouselScroller__P_252_6.getContainerElement(), "transitionEnd", this._onScrollerTransitionEnd, this);
      ...
      var pagination = this.__pagination__P_252_7 = new qx.ui.mobile.container.Composite();
    ...
    */
    members: {
      __carouselScroller__P_252_6: null,
      __carouselScrollerWidth__P_252_8: null,
      __carouselWidth__P_252_9: null,
      __paginationLabels__P_252_5: null,
      __pagination__P_252_7: null,
      __snapPointsX__P_252_0: null,
      __onMoveOffset__P_252_1: null,
      __lastOffset__P_252_2: null,
      __boundsX__P_252_3: null,
      __pages__P_252_4: null,
      __showTransition__P_252_10: null,
      __isPageScrollTarget__P_252_11: null,
      __deltaX__P_252_12: null,
      __deltaY__P_252_13: null,
      // overridden
      ...
      add: function add(page) {
        ...
        this.__pages__P_252_4.push(page);

        this.__carouselScroller__P_252_6.add(page, {
          flex: 1
        });

        var paginationLabel = this._createPaginationLabel();

        this.__paginationLabels__P_252_5.push(paginationLabel);

        this.__pagination__P_252_7.add(paginationLabel);
      ...
      removePageByIndex: function removePageByIndex(pageIndex) {
        if (this.__pages__P_252_4 && this.__pages__P_252_4.length > pageIndex) {
          if (pageIndex <= this.getCurrentIndex() && this.getCurrentIndex() !== 0) {
            this.setCurrentIndex(this.getCurrentIndex() - 1);
          }

          var targetPage = this.__pages__P_252_4[pageIndex];
          var paginationLabel = this.__paginationLabels__P_252_5[pageIndex];

          this.__carouselScroller__P_252_6.remove(targetPage);

          this.__pagination__P_252_7.remove(paginationLabel);
          ...
          this.__pages__P_252_4.splice(pageIndex, 1);

          this.__paginationLabels__P_252_5.splice(pageIndex, 1);
      ...
      removeAll: function removeAll() {
        ...
        if (this.__pages__P_252_4) {
          for (var i = this.__pages__P_252_4.length - 1; i >= 0; i--) {
      ...
      nextPage: function nextPage() {
        if (this.getCurrentIndex() == this.__pages__P_252_4.length - 1) {
          if (this.isScrollLoop() && this.__pages__P_252_4.length > 1) {
            this._doScrollLoop();
          }
        } else {
          this.setCurrentIndex(this.getCurrentIndex() + 1);
      ...
      */
      getPageCount: function getPageCount() {
        if (this.__pages__P_252_4) {
          return this.__pages__P_252_4.length;
        }
      ...
      _scrollToPage: function _scrollToPage(pageIndex, showTransition) {
        if (pageIndex >= this.__pages__P_252_4.length || pageIndex < 0) {
          return;
        }

        this._updatePagination(pageIndex);

        var snapPoint = -pageIndex * this.__carouselWidth__P_252_9;

        this._updateScrollerPosition(snapPoint); // Update lastOffset, because snapPoint has changed.


        this.__lastOffset__P_252_2[0] = snapPoint;
      },
      ...
      */
      _onScrollerTransitionEnd: function _onScrollerTransitionEnd() {
        var opacity = qx.bom.element.Style.get(this.__carouselScroller__P_252_6.getContainerElement(), "opacity");
        ...
        if (opacity === 0) {
          ...
          if (this.getCurrentIndex() === 0) {
            pageIndex = this.__pages__P_252_4.length - 1;
          }
      ...
      _createPaginationLabel: function _createPaginationLabel() {
        var paginationIndex = this.__pages__P_252_4.length;
      ...
      _setScrollersOpacity: function _setScrollersOpacity(opacity) {
        if (this.__carouselScroller__P_252_6) {
          qx.bom.element.Style.set(this.__carouselScroller__P_252_6.getContainerElement(), "opacity", opacity);
        }
      },
      ...
      _applyShowPagination: function _applyShowPagination(value, old) {
        if (value) {
          if (this.__pages__P_252_4.length > 1) {
            this.__pagination__P_252_7.show();
          }
        } else {
          this.__pagination__P_252_7.hide();
        }
      },
      ...
      _updateCarouselLayout: function _updateCarouselLayout() {
        ...
        this.__carouselWidth__P_252_9 = carouselSize.width;
        ...
        qx.bom.element.Style.set(this.__carouselScroller__P_252_6.getContentElement(), "width", this.__pages__P_252_4.length * carouselSize.width + "px");

        for (var i = 0; i < this.__pages__P_252_4.length; i++) {
          var pageContentElement = this.__pages__P_252_4[i].getContentElement();
        ...
        if (this.__pages__P_252_4.length == 1) {
          this.__pagination__P_252_7.exclude();
        } else {
      ...
      _refreshScrollerPosition: function _refreshScrollerPosition() {
        this.__carouselScrollerWidth__P_252_8 = qx.bom.element.Dimension.getWidth(this.__carouselScroller__P_252_6.getContentElement());
      ...
      _getScrollerOffset: function _getScrollerOffset() {
        var transformMatrix = qx.bom.element.Style.get(this.__carouselScroller__P_252_6.getContentElement(), "transform");
      ...
      _onPointerDown: function _onPointerDown(evt) {
        ...
        this.__lastOffset__P_252_2[0] = this._getScrollerOffset();
        this.__isPageScrollTarget__P_252_11 = null;
        this.__boundsX__P_252_3[0] = -this.__carouselScrollerWidth__P_252_8 + this.__carouselWidth__P_252_9;

        this._updateScrollerPosition(this.__lastOffset__P_252_2[0]);
      },
      ...
      _onTrack: function _onTrack(evt) {
        ...
        this.__deltaX__P_252_12 = evt.getDelta().x;
        this.__deltaY__P_252_13 = evt.getDelta().y;

        if (this.__isPageScrollTarget__P_252_11 === null) {
          this.__isPageScrollTarget__P_252_11 = evt.getDelta().axis == "y";
        }

        if (!this.__isPageScrollTarget__P_252_11) {
          this.__onMoveOffset__P_252_1[0] = Math.floor(this.__deltaX__P_252_12 + this.__lastOffset__P_252_2[0]);

          if (this.__onMoveOffset__P_252_1[0] >= this.__boundsX__P_252_3[1]) {
            this.__onMoveOffset__P_252_1[0] = this.__boundsX__P_252_3[1];
          }

          if (this.__onMoveOffset__P_252_1[0] <= this.__boundsX__P_252_3[0]) {
            this.__onMoveOffset__P_252_1[0] = this.__boundsX__P_252_3[0];
          }

          this._updateScrollerPosition(this.__onMoveOffset__P_252_1[0]);
      ...
      */
      ...
      _onSwipe: function _onSwipe(evt) {
        ...
        if (evt.getDuration() < 750 && Math.abs(evt.getDistance()) > 50) {
          var duration = this._calculateTransitionDuration(this.__deltaX__P_252_12, evt.getDuration());
      ...
      */
      _calculateTransitionDuration: function _calculateTransitionDuration(deltaX, duration) {
        var distanceX = this.__carouselWidth__P_252_9 - Math.abs(deltaX);
      ...
      */
      _setTransitionDuration: function _setTransitionDuration(value) {
        qx.bom.element.Style.set(this.__carouselScroller__P_252_6.getContentElement(), "transitionDuration", value + "s");
      },
      ...
      _snapCarouselPage: function _snapCarouselPage() {
        ...
        for (var i = 0; i < this.__pages__P_252_4.length; i++) {
          var snapPoint = -i * this.__carouselWidth__P_252_9;
          var distance = this.__onMoveOffset__P_252_1[0] - snapPoint;
      ...
      _updatePagination: function _updatePagination(newActiveIndex) {
        for (var i = 0; i < this.__paginationLabels__P_252_5.length; i++) {
          this.__paginationLabels__P_252_5[i].removeCssClass("active");
        }

        var newActiveLabel = this.__paginationLabels__P_252_5[newActiveIndex];

        if (newActiveLabel && newActiveLabel.getContainerElement()) {
          newActiveLabel.addCssClass("active");
        }

        if (this.__paginationLabels__P_252_5.length) {
          var paginationStyle = window.getComputedStyle(this.__pagination__P_252_7.getContentElement());
          ...
          var paginationLabelWidth = paginationWidth / this.__paginationLabels__P_252_5.length;
          var left = null;
          var translate = this.__carouselWidth__P_252_9 / 2 - newActiveIndex * paginationLabelWidth - paginationLabelWidth / 2;

          if (paginationWidth < this.__carouselWidth__P_252_9) {
            left = this.__carouselWidth__P_252_9 / 2 - paginationWidth / 2 + "px";
            translate = 0;
          }

          qx.bom.element.Style.set(this.__pagination__P_252_7.getContentElement(), "left", left);

          this.__pagination__P_252_7.setTranslateX(translate);
        }
      },
      ...
      _updateScrollerPosition: function _updateScrollerPosition(x) {
        if (isNaN(x) || this.__carouselScroller__P_252_6.getContentElement() === null) {
          return;
        }

        this.__carouselScroller__P_252_6.setTranslateX(x);
      },
      ...
      _removeListeners: function _removeListeners() {
        this.__carouselScroller__P_252_6.removeListener("pointerdown", this._onPointerDown, this);

        this.__carouselScroller__P_252_6.removeListener("track", this._onTrack, this);

        this.__carouselScroller__P_252_6.removeListener("pointerup", this._onPointerUp, this);

        this.__carouselScroller__P_252_6.removeListener("swipe", this._onSwipe, this);

        this.__carouselScroller__P_252_6.removeListener("touchmove", qx.bom.Event.preventDefault, this);
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__carouselScroller__P_252_6", " __pagination");

      qx.util.DisposeUtil.destroyContainer(this);
      qx.util.DisposeUtil.disposeArray(this, "__paginationLabels__P_252_5");
      this.__pages__P_252_4 = this.__paginationLabels__P_252_5 = this.__snapPointsX__P_252_0 = this.__onMoveOffset__P_252_1 = this.__lastOffset__P_252_2 = this.__boundsX__P_252_3 = this.__isPageScrollTarget__P_252_11 = null;
    }
  });
  qx.ui.mobile.container.Carousel.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Carousel.js.map?dt=1598051412302