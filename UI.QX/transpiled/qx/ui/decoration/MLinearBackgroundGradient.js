  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function _styleLinearBackgroundGradient(styles) {
        ...
        var styleImpl = this.__styleLinearBackgroundGradientAccordingToSpec__P_138_0;

        if (qx.core.Environment.get("css.gradient.legacywebkit")) {
          styleImpl = this.__styleLinearBackgroundGradientForLegacyWebkit__P_138_1;
        } else if (!qx.core.Environment.get("css.gradient.linear") && qx.core.Environment.get("css.borderradius")) {
          styleImpl = this.__styleLinearBackgroundGradientWithCanvas__P_138_2;
        } else if (!qx.core.Environment.get("css.gradient.linear")) {
          styleImpl = this.__styleLinearBackgroundGradientWithMSFilter__P_138_3;
        }
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__getColor__P_138_4(startColors[i]);

            var endColor = this.__getColor__P_138_4(endColors[i]);
       ...
       */
      __styleLinearBackgroundGradientForLegacyWebkit__P_138_1: function __styleLinearBackgroundGradientForLegacyWebkit__P_138_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __styleLinearBackgroundGradientWithCanvas__P_138_2: function me(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        if (!me.__canvas__P_138_5) {
          me.__canvas__P_138_5 = document.createElement("canvas");
        }
        ...
        me.__canvas__P_138_5.width = width;
        me.__canvas__P_138_5.height = height;

        var ctx = me.__canvas__P_138_5.getContext('2d');
        ...
        backgroundStyle.push("url(" + me.__canvas__P_138_5.toDataURL() + ") " + size);
        return true;
      },
       ...
       */
      __styleLinearBackgroundGradientWithMSFilter__P_138_3: function __styleLinearBackgroundGradientWithMSFilter__P_138_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __styleLinearBackgroundGradientAccordingToSpec__P_138_0: function __styleLinearBackgroundGradientAccordingToSpec__P_138_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       */
      __getColor__P_138_4: function __getColor__P_138_4(color) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1598045177975