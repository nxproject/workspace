  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
      ...
      getCellWidget: function getCellWidget(data, states) {
        var widget = this.__getWidgetFromPool__P_307_1();
      ...
      pool: function pool(widget) {
        this.__pool__P_307_0.push(widget);
      },
      ...
      _cleanupPool: function _cleanupPool() {
        var widget = this.__pool__P_307_0.pop();

        while (widget) {
          widget.destroy();
          widget = this.__pool__P_307_0.pop();
        }
      },
       ...
       */
      __getWidgetFromPool__P_307_1: function __getWidgetFromPool__P_307_1() {
        var widget = this.__pool__P_307_0.shift();
    ...
    destruct: function destruct() {
      ...
      this.__pool__P_307_0 = null;
    }
  });
  qx.ui.virtual.cell.AbstractWidget.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractWidget.js.map?dt=1598051420047