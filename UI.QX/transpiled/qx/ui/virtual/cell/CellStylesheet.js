  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.CellStylesheet", {
    ...
    construct: function construct() {
      ...
      this.__stylesheet__P_310_0 = qx.bom.Stylesheet.createElement(stylesheet);
      this.__classes__P_310_1 = {};
      this.__styles__P_310_2 = {};
    },
    members: {
      __stylesheet__P_310_0: null,
      __classes__P_310_1: null,
      __styles__P_310_2: null,
      ...
      getStylesheet: function getStylesheet() {
        return this.__stylesheet__P_310_0;
      },
      ...
      getCssClass: function getCssClass(key) {
        return this.__classes__P_310_1[key] || null;
      },
      ...
      computeClassForStyles: function computeClassForStyles(key, styleString) {
        var cssClass = this.__styles__P_310_2[styleString];

        if (!cssClass) {
          // generate stylesheet rule
          var cssClass = this.__getNextClassname__P_310_3();

          qx.bom.Stylesheet.addRule(this.__stylesheet__P_310_0, "." + cssClass, styleString);
          this.__styles__P_310_2[styleString] = cssClass;
        }

        this.__classes__P_310_1[key] = cssClass;
        return cssClass;
      },
       ...
       */
      __getNextClassname__P_310_3: function __getNextClassname__P_310_3() {
        return "qx-cell-" + this.toHashCode() + "-" + this.__classCounter__P_310_4++;
      },
      __classCounter__P_310_4: 0
    },
    destruct: function destruct() {
      this.__stylesheet__P_310_0 = this.__classes__P_310_1 = this.__styles__P_310_2 = null;
    }
  });
  qx.ui.virtual.cell.CellStylesheet.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=CellStylesheet.js.map?dt=1598051420324