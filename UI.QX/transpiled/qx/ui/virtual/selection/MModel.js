  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__selection__P_322_0 = new qx.data.Array();

      this.__selection__P_322_0.addListener("change", this._onChangeSelection, this);

      this._applySelection(this.__selection__P_322_0, null);
    },
    properties: {
    ...
    members: {
      ...
      __ignoreChangeSelection__P_322_1: false,

      /** @type {Boolean} flag to ignore the selection change from <code>_manager</code> */
      __ignoreManagerChangeSelection__P_322_2: false,
      __selection__P_322_0: null,
      ...
      */
      ...
      setSelection: function setSelection(value) {
        if (value) {
          this.__selection__P_322_0.replace(value);
        } else {
          this.__selection__P_322_0.removeAll();
        }
      },
      ...
      getSelection: function getSelection() {
        return this.__selection__P_322_0;
      },
      ...
      */
      ...
      _onChangeSelection: function _onChangeSelection(e) {
        if (this.__ignoreManagerChangeSelection__P_322_2 == true) {
          return;
        }

        this.__ignoreChangeSelection__P_322_1 = true;
      ...
      _onManagerChangeSelection: function _onManagerChangeSelection(e) {
        if (this.__ignoreChangeSelection__P_322_1 == true) {
          return;
        }

        this.__ignoreManagerChangeSelection__P_322_2 = true;

        this.__synchronizeSelection__P_322_3();

        this.__ignoreManagerChangeSelection__P_322_2 = false;
       ...
       */
      __synchronizeSelection__P_322_3: function __synchronizeSelection__P_322_3() {
        if (this.__isSelectionEquals__P_322_4()) {
          return;
        }
        ...
        this.__replaceSelection__P_322_5(newSelection);
      },
       ...
       */
      __replaceSelection__P_322_5: function __replaceSelection__P_322_5(newSelection) {
        var selection = this.getSelection();
       ...
       */
      __isSelectionEquals__P_322_4: function __isSelectionEquals__P_322_4() {
        var selection = this.getSelection();
    ...
    destruct: function destruct() {
      ...
      if (this.__selection__P_322_0) {
        this.__selection__P_322_0.dispose();
      }
    }
  });
...
//# sourceMappingURL=MModel.js.map?dt=1598051422243