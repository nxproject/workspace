  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.layer.GridLines", {
    ...
    construct: function construct(orientation, lineColor, lineSize) {
      ...
      this.__lineColors__P_317_0 = [];
      this.__lineSizes__P_317_1 = [];
    ...
    */
    members: {
      ...
      __lineColors__P_317_0: null,

      /** Stores the width/height for deviant grid lines. */
      __lineSizes__P_317_1: null,
      ...
      setLineColor: function setLineColor(index, color) {
        ...
        this.__lineColors__P_317_0[index] = color;

        if (this.__isLineRendered__P_317_2(index)) {
      ...
      setLineSize: function setLineSize(index, size) {
        ...
        this.__lineSizes__P_317_1[index] = size;
       ...
       */
      __isLineRendered__P_317_2: function __isLineRendered__P_317_2(index) {
      ...
      getLineSize: function getLineSize(index) {
        return this.__lineSizes__P_317_1[index] || this.getDefaultLineSize();
      },
      ...
      getLineColor: function getLineColor(index) {
        return this.__lineColors__P_317_0[index] || this.getDefaultLineColor();
      },
       ...
       */
      __renderHorizontalLines__P_317_3: function __renderHorizontalLines__P_317_3(htmlArr, firstRow, rowSizes) {
        var top = 0;
        var color, height;
       ...
       */
      __renderVerticalLines__P_317_4: function __renderVerticalLines__P_317_4(htmlArr, firstColumn, columnSizes) {
        var left = 0;
        var color, width;
      ...
      _fullUpdate: function _fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        ...
        if (this._isHorizontal) {
          this.__renderHorizontalLines__P_317_3(html, firstRow, rowSizes);
        } else {
          this.__renderVerticalLines__P_317_4(html, firstColumn, columnSizes);
        }
    ...
    destruct: function destruct() {
      this.__lineColors__P_317_0 = this.__lineSizes__P_317_1 = null;
    }
  });
  qx.ui.virtual.layer.GridLines.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=GridLines.js.map?dt=1598051421545