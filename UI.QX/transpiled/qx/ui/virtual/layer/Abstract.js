(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.layer.Abstract", {
    ...
    */
    members: {
      __jobs__P_314_0: null,
      __arguments__P_314_1: null,
      __firstRow__P_314_2: null,
      __firstColumn__P_314_3: null,
      __rowSizes__P_314_4: null,
      __columnSizes__P_314_5: null,
      ...
      getFirstRow: function getFirstRow() {
        return this.__firstRow__P_314_2;
      },
      ...
      getFirstColumn: function getFirstColumn() {
        return this.__firstColumn__P_314_3;
      },
      ...
      getRowSizes: function getRowSizes() {
        return this.__rowSizes__P_314_4 || [];
      },
      ...
      getColumnSizes: function getColumnSizes() {
        return this.__columnSizes__P_314_5 || [];
      },
      // overridden
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__jobs__P_314_0.fullUpdate || this.__jobs__P_314_0.updateLayerWindow && this.__jobs__P_314_0.updateLayerData) {
          this._fullUpdate.apply(this, this.__arguments__P_314_1);
        } else if (this.__jobs__P_314_0.updateLayerWindow) {
          this._updateLayerWindow.apply(this, this.__arguments__P_314_1);
        } else if (this.__jobs__P_314_0.updateLayerData && this.__rowSizes__P_314_4) {
          this._updateLayerData();
        }

        if (this.__jobs__P_314_0.fullUpdate || this.__jobs__P_314_0.updateLayerWindow) {
          var args = this.__arguments__P_314_1;
          this.__firstRow__P_314_2 = args[0];
          this.__firstColumn__P_314_3 = args[1];
          this.__rowSizes__P_314_4 = args[2];
          this.__columnSizes__P_314_5 = args[3];
        }
      ...
      _updateLayerData: function _updateLayerData() {
        this._fullUpdate(this.__firstRow__P_314_2, this.__firstColumn__P_314_3, this.__rowSizes__P_314_4, this.__columnSizes__P_314_5);
      },
    ...
    */
    destruct: function destruct() {
      this.__jobs__P_314_0 = this.__arguments__P_314_1 = this.__rowSizes__P_314_4 = this.__columnSizes__P_314_5 = null;
    }
  });
  qx.ui.virtual.layer.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1598051421292