  ...
  qx.Class.define("qx.ui.virtual.layer.WidgetCellSpan", {
    ...
    * @param widgetCellProvider {qx.ui.virtual.core.IWidgetCellProvider} This
    ...
    construct: function construct(widgetCellProvider, rowConfig, columnConfig) {
      ...
      this.__spacerPool__P_321_0 = [];
      this._cellLayer = new qx.ui.virtual.layer.WidgetCell(this.__getCellProviderForNonSpanningCells__P_321_1());
    ...
    */
    members: {
      ...
      _getSpacer: function _getSpacer() {
        var spacer = this.__spacerPool__P_321_0.pop();
       ...
       */
      __getCellProviderForNonSpanningCells__P_321_1: function __getCellProviderForNonSpanningCells__P_321_1() {
        var self = this;
        var cellProvider = this._cellProvider;
        var spacerPool = this.__spacerPool__P_321_0;
       ...
       */
      __updateCellSpanData__P_321_2: function __updateCellSpanData__P_321_2(firstRow, firstColumn, rowCount, columnCount) {
       ...
       */
      __updateCellSpanWidgets__P_321_3: function __updateCellSpanWidgets__P_321_3() {
      ...
      _fullUpdate: function _fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        this.__updateCellSpanData__P_321_2(firstRow, firstColumn, rowSizes.length, columnSizes.length);

        this.__updateCellSpanWidgets__P_321_3();
    ...
    destruct: function destruct() {
      ...
      this._cellProvider = this.__spacerPool__P_321_0 = this._cells = this._bounds = this._spanMap = null;
    }
  });
  qx.ui.virtual.layer.WidgetCellSpan.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=WidgetCellSpan.js.map?dt=1598051421846