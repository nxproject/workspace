  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.layer.AbstractBackground", {
    ...
    construct: function construct(colorEven, colorOdd) {
      ...
      this.__customColors__P_315_0 = {};
      this.__decorators__P_315_1 = {};
    },
    ...
    */
    members: {
      __colorEven__P_315_2: null,
      __colorOdd__P_315_3: null,
      __customColors__P_315_0: null,
      __decorators__P_315_1: null,
      ...
      */
      ...
      setColor: function setColor(index, color) {
        if (color) {
          this.__customColors__P_315_0[index] = qx.theme.manager.Color.getInstance().resolve(color);
        } else {
          delete this.__customColors__P_315_0[index];
        }
      },
      ...
      getColor: function getColor(index) {
        var customColor = this.__customColors__P_315_0[index];

        if (customColor) {
          return customColor;
        } else {
          return index % 2 == 0 ? this.__colorEven__P_315_2 : this.__colorOdd__P_315_3;
        }
      },
      // property apply
      _applyColorEven: function _applyColorEven(value, old) {
        if (value) {
          this.__colorEven__P_315_2 = qx.theme.manager.Color.getInstance().resolve(value);
        } else {
          this.__colorEven__P_315_2 = null;
        }
      ...
      _applyColorOdd: function _applyColorOdd(value, old) {
        if (value) {
          this.__colorOdd__P_315_3 = qx.theme.manager.Color.getInstance().resolve(value);
        } else {
          this.__colorOdd__P_315_3 = null;
        }
      ...
      setBackground: function setBackground(index, decorator) {
        if (decorator) {
          this.__decorators__P_315_1[index] = qx.theme.manager.Decoration.getInstance().resolve(decorator);
        } else {
          delete this.__decorators__P_315_1[index];
        }
      ...
      getBackground: function getBackground(index) {
        return this.__decorators__P_315_1[index];
      }
    },
    ...
    destruct: function destruct() {
      this.__customColors__P_315_0 = this.__decorators__P_315_1 = null;
    }
  });
  qx.ui.virtual.layer.AbstractBackground.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractBackground.js.map?dt=1598051421338