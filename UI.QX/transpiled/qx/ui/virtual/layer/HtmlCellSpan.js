  ...
  qx.Class.define("qx.ui.virtual.layer.HtmlCellSpan", {
    ...
    */
    members: {
       ...
       */
      __renderCell__P_318_0: function __renderCell__P_318_0(htmlArr, row, column, left, top, width, height) {
      ...
      _fullUpdate: function _fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        ...
        if (cells.length > 0) {
          ...
          for (var i = 0, l = cells.length; i < l; i++) {
            ...
            this.__renderCell__P_318_0(html, cell.firstRow, cell.firstColumn, cellBounds.left, cellBounds.top, cellBounds.width, cellBounds.height);
          }
        } else {
        ...
        for (var x = 0; x < rowSizes.length; x++) {
          ...
          for (var y = 0; y < columnSizes.length; y++) {
            ...
            if (!spanMap[row][column]) {
              this.__renderCell__P_318_0(html, row, column, left, top, width, height);
            }
...
//# sourceMappingURL=HtmlCellSpan.js.map?dt=1598051421640