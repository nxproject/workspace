  ...
  qx.Class.define("qx.ui.virtual.behavior.Prefetch", {
    ...
    */
    ...
    construct: function construct(scroller, settings) {
      ...
      this.__timer__P_305_0 = new qx.event.Timer(this.getInterval());

      this.__timer__P_305_0.addListener("interval", this._onInterval, this);
    ...
    */
    members: {
      __prefetchX__P_305_1: null,
      __prefetchY__P_305_2: null,
      __timer__P_305_0: null,
      __onScrollXId__P_305_3: null,
      __onScrollYId__P_305_4: null,
      ...
      setPrefetchX: function setPrefetchX(minLeft, maxLeft, minRight, maxRight) {
        this.__prefetchX__P_305_1 = [minLeft, maxLeft, minRight, maxRight];
      },
      ...
      setPrefetchY: function setPrefetchY(minAbove, maxAbove, minBelow, maxBelow) {
        this.__prefetchY__P_305_2 = [minAbove, maxAbove, minBelow, maxBelow];
      },
      ...
      _onInterval: function _onInterval() {
        var px = this.__prefetchX__P_305_1;
        ...
        var py = this.__prefetchY__P_305_2;
      ...
      _applyScroller: function _applyScroller(value, old) {
        if (old) {
          if (this.__onScrollXId__P_305_3) {
            old.getChildControl("scrollbar-x").removeListenerById(this.__onScrollXId__P_305_3);
          }

          if (this.__onScrollYId__P_305_4) {
            old.getChildControl("scrollbar-y").removeListenerById(this.__onScrollYId__P_305_4);
          }
        }

        if (value) {
          if (!value.getContentElement().getDomElement()) {
            this.__timer__P_305_0.stop();

            value.addListenerOnce("appear", this.__timer__P_305_0.start, this.__timer__P_305_0);
          } else {
            this.__timer__P_305_0.restart();
          } //        if (value.hasChildControl("scrollbar-x"))
          //        {


          this.__onScrollXId__P_305_3 = value.getChildControl("scrollbar-x").addListener("scroll", this.__timer__P_305_0.restart, this.__timer__P_305_0); //        }
          //        if (value.hasChildControl("scrollbar-y"))
          //        {

          this.__onScrollYId__P_305_4 = value.getChildControl("scrollbar-y").addListener("scroll", this.__timer__P_305_0.restart, this.__timer__P_305_0); //        }
        } else {
          this.__timer__P_305_0.stop();
        }
      },
      ...
      _applyInterval: function _applyInterval(value, old) {
        this.__timer__P_305_0.setInterval(value);
      }
    },
    ...
    destruct: function destruct() {
      ...
      this.__prefetchX__P_305_1 = this.__prefetchY__P_305_2 = null;

      this._disposeObjects("__timer__P_305_0");
    }
  });
  qx.ui.virtual.behavior.Prefetch.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Prefetch.js.map?dt=1598051419903