  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Pane", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__rowConfig__P_312_0 = new qx.ui.virtual.core.Axis(cellHeight, rowCount);
      this.__columnConfig__P_312_1 = new qx.ui.virtual.core.Axis(cellWidth, columnCount);
      this.__scrollTop__P_312_2 = 0;
      this.__scrollLeft__P_312_3 = 0;
      this.__paneHeight__P_312_4 = 0;
      this.__paneWidth__P_312_5 = 0;
      this.__layerWindow__P_312_6 = {};
      this.__jobs__P_312_7 = {}; // create layer container. The container does not have a layout manager
      // layers are positioned using "setUserBounds"

      this.__layerContainer__P_312_8 = new qx.ui.container.Composite();

      this.__layerContainer__P_312_8.setUserBounds(0, 0, 0, 0);

      this._add(this.__layerContainer__P_312_8);

      this.__layers__P_312_9 = [];

      this.__rowConfig__P_312_0.addListener("change", this.fullUpdate, this);

      this.__columnConfig__P_312_1.addListener("change", this.fullUpdate, this);
    ...
    members: {
      __rowConfig__P_312_0: null,
      __columnConfig__P_312_1: null,
      __scrollTop__P_312_2: null,
      __scrollLeft__P_312_3: null,
      __paneHeight__P_312_4: null,
      __paneWidth__P_312_5: null,
      __layerWindow__P_312_6: null,
      __jobs__P_312_7: null,
      __layerContainer__P_312_8: null,
      __layers__P_312_9: null,
      __dontFireUpdate__P_312_10: null,
      __columnSizes__P_312_11: null,
      __rowSizes__P_312_12: null,
      __pointerDownCoords__P_312_13: null,
      ...
      */
      ...
      getRowConfig: function getRowConfig() {
        return this.__rowConfig__P_312_0;
      },
      ...
      getColumnConfig: function getColumnConfig() {
        return this.__columnConfig__P_312_1;
      },
      ...
      */
      ...
      getChildren: function getChildren() {
        return [this.__layerContainer__P_312_8];
      },
      ...
      addLayer: function addLayer(layer) {
        ...
        this.__layers__P_312_9.push(layer);

        layer.setUserBounds(0, 0, 0, 0);

        this.__layerContainer__P_312_8.add(layer);
      },
      ...
      getVisibleLayers: function getVisibleLayers() {
        ...
        for (var i = 0; i < this.__layers__P_312_9.length; i++) {
          var layer = this.__layers__P_312_9[i];
      ...
      */
      ...
      getScrollMaxX: function getScrollMaxX() {
        ...
        if (paneSize) {
          return Math.max(0, this.__columnConfig__P_312_1.getTotalSize() - paneSize.width);
        }
      ...
      getScrollMaxY: function getScrollMaxY() {
        ...
        if (paneSize) {
          return Math.max(0, this.__rowConfig__P_312_0.getTotalSize() - paneSize.height);
        }
      ...
      setScrollY: function setScrollY(value) {
        ...
        if (this.__scrollTop__P_312_2 !== value) {
          var old = this.__scrollTop__P_312_2;
          this.__scrollTop__P_312_2 = value;
      ...
      getScrollY: function getScrollY() {
        return this.__scrollTop__P_312_2;
      },
      ...
      setScrollX: function setScrollX(value) {
        ...
        if (value !== this.__scrollLeft__P_312_3) {
          var old = this.__scrollLeft__P_312_3;
          this.__scrollLeft__P_312_3 = value;
      ...
      getScrollX: function getScrollX() {
        return this.__scrollLeft__P_312_3;
      },
      ...
      getScrollSize: function getScrollSize() {
        return {
          width: this.__columnConfig__P_312_1.getTotalSize(),
          height: this.__rowConfig__P_312_0.getTotalSize()
        };
      },
      ...
      */
      ...
      scrollRowIntoView: function scrollRowIntoView(row) {
        ...
        var itemTop = this.__rowConfig__P_312_0.getItemPosition(row);

        var itemBottom = itemTop + this.__rowConfig__P_312_0.getItemSize(row);
      ...
      scrollColumnIntoView: function scrollColumnIntoView(column) {
        ...
        var itemLeft = this.__columnConfig__P_312_1.getItemPosition(column);

        var itemRight = itemLeft + this.__columnConfig__P_312_1.getItemSize(column);
      ...
      */
      ...
      getCellAtPosition: function getCellAtPosition(documentX, documentY) {
        ...
        rowData = this.__rowConfig__P_312_0.getItemAtPosition(this.getScrollY() + documentY - paneLocation.top);
        columnData = this.__columnConfig__P_312_1.getItemAtPosition(this.getScrollX() + documentX - paneLocation.left);
      ...
      */
      ...
      prefetchX: function prefetchX(minLeft, maxLeft, minRight, maxRight) {
        ...
        var paneRight = this.__scrollLeft__P_312_3 + bounds.width;
        var rightAvailable = this.__paneWidth__P_312_5 - paneRight;

        if (this.__scrollLeft__P_312_3 - this.__layerWindow__P_312_6.left < Math.min(this.__scrollLeft__P_312_3, minLeft) || this.__layerWindow__P_312_6.right - paneRight < Math.min(rightAvailable, minRight)) {
          var left = Math.min(this.__scrollLeft__P_312_3, maxLeft);
          var right = Math.min(rightAvailable, maxRight);

          this._setLayerWindow(layers, this.__scrollLeft__P_312_3 - left, this.__scrollTop__P_312_2, bounds.width + left + right, bounds.height, false);
        }
      },
      ...
      prefetchY: function prefetchY(minAbove, maxAbove, minBelow, maxBelow) {
        ...
        var paneBottom = this.__scrollTop__P_312_2 + bounds.height;
        var belowAvailable = this.__paneHeight__P_312_4 - paneBottom;

        if (this.__scrollTop__P_312_2 - this.__layerWindow__P_312_6.top < Math.min(this.__scrollTop__P_312_2, minAbove) || this.__layerWindow__P_312_6.bottom - paneBottom < Math.min(belowAvailable, minBelow)) {
          var above = Math.min(this.__scrollTop__P_312_2, maxAbove);
          var below = Math.min(belowAvailable, maxBelow);

          this._setLayerWindow(layers, this.__scrollLeft__P_312_3, this.__scrollTop__P_312_2 - above, bounds.width, bounds.height + above + below, false);
        }
      },
      ...
      */
      ...
      _onResize: function _onResize() {
        if (this.getContentElement().getDomElement()) {
          this.__dontFireUpdate__P_312_10 = true;

          this._updateScrollPosition();

          this.__dontFireUpdate__P_312_10 = null;
      ...
      _onPointerDown: function _onPointerDown(e) {
        this.__pointerDownCoords__P_312_13 = this.getCellAtPosition(e.getDocumentLeft(), e.getDocumentTop());
      },
      ...
      _onTap: function _onTap(e) {
        this.__handlePointerCellEvent__P_312_14(e, "cellTap");
      },
      ...
      _onContextmenu: function _onContextmenu(e) {
        this.__handlePointerCellEvent__P_312_14(e, "cellContextmenu");
      },
      ...
      _onDbltap: function _onDbltap(e) {
        this.__handlePointerCellEvent__P_312_14(e, "cellDbltap");
      },
      ...
      _checkScrollBounds: function _checkScrollBounds() {
        ...
        if (this.__scrollLeft__P_312_3 < 0) {
          this.__scrollLeft__P_312_3 = 0;
        } else if (this.__scrollLeft__P_312_3 > maxx) {
          this.__scrollLeft__P_312_3 = maxx;
        }

        if (this.__scrollTop__P_312_2 < 0) {
          this.__scrollTop__P_312_2 = 0;
        } else if (this.__scrollTop__P_312_2 > maxy) {
          this.__scrollTop__P_312_2 = maxy;
        }
      },
       ...
       */
      __handlePointerCellEvent__P_312_14: function __handlePointerCellEvent__P_312_14(e, cellEventType) {
        ...
        var pointerDownCoords = this.__pointerDownCoords__P_312_13;
      ...
      */
      ...
      syncWidget: function syncWidget(jobs) {
        if (this.__jobs__P_312_7._fullUpdate) {
          this._checkScrollBounds();

          this._fullUpdate();
        } else if (this.__jobs__P_312_7._updateScrollPosition) {
          this._checkScrollBounds();

          this._updateScrollPosition();
        }

        this.__jobs__P_312_7 = {};
      },
      ...
      _setLayerWindow: function _setLayerWindow(layers, left, top, minWidth, minHeight, doFullUpdate) {
        var rowCellData = this.__rowConfig__P_312_0.getItemAtPosition(top);

        if (rowCellData) {
          var firstRow = rowCellData.index;

          var rowSizes = this.__rowConfig__P_312_0.getItemSizes(firstRow, minHeight + rowCellData.offset);
        ...
        var columnCellData = this.__columnConfig__P_312_1.getItemAtPosition(left);

        if (columnCellData) {
          var firstColumn = columnCellData.index;

          var columnSizes = this.__columnConfig__P_312_1.getItemSizes(firstColumn, minWidth + columnCellData.offset);
        ...
        this.__layerContainer__P_312_8.setUserBounds((this.getPaddingLeft() || 0) + (this.__layerWindow__P_312_6.left - this.__scrollLeft__P_312_3), (this.getPaddingTop() || 0) + (this.__layerWindow__P_312_6.top - this.__scrollTop__P_312_2), layerWidth, layerHeight);

        this.__columnSizes__P_312_11 = columnSizes;
        this.__rowSizes__P_312_12 = rowSizes;
       ...
       * it was.
       */
      __checkPaneResize__P_312_15: function __checkPaneResize__P_312_15() {
        if (this.__dontFireUpdate__P_312_10) {
          return;
        }

        var scrollSize = this.getScrollSize();

        if (this.__paneHeight__P_312_4 !== scrollSize.height || this.__paneWidth__P_312_5 !== scrollSize.width) {
          this.__paneHeight__P_312_4 = scrollSize.height;
          this.__paneWidth__P_312_5 = scrollSize.width;
          this.fireEvent("update");
        }
      },
      ...
      fullUpdate: function fullUpdate() {
        this.__jobs__P_312_7._fullUpdate = 1;
      ...
      isUpdatePending: function isUpdatePending() {
        return !!this.__jobs__P_312_7._fullUpdate;
      },
      ...
      _fullUpdate: function _fullUpdate() {
        ...
        if (layers.length == 0) {
          this.__checkPaneResize__P_312_15();
        ...
        this._setLayerWindow(layers, this.__scrollLeft__P_312_3, this.__scrollTop__P_312_2, bounds.width, bounds.height, true);
      ...
      _deferredUpdateScrollPosition: function _deferredUpdateScrollPosition() {
        this.__jobs__P_312_7._updateScrollPosition = 1;
        qx.ui.core.queue.Widget.add(this);
      },
      ...
      _updateScrollPosition: function _updateScrollPosition() {
        ...
        var paneWindow = {
          top: this.__scrollTop__P_312_2,
          bottom: this.__scrollTop__P_312_2 + bounds.height,
          left: this.__scrollLeft__P_312_3,
          right: this.__scrollLeft__P_312_3 + bounds.width
        };

        if (this.__layerWindow__P_312_6.top <= paneWindow.top && this.__layerWindow__P_312_6.bottom >= paneWindow.bottom && this.__layerWindow__P_312_6.left <= paneWindow.left && this.__layerWindow__P_312_6.right >= paneWindow.right) {
          // only update layer container offset
          this.__layerContainer__P_312_8.setUserBounds((this.getPaddingLeft() || 0) + (this.__layerWindow__P_312_6.left - paneWindow.left), (this.getPaddingTop() || 0) + (this.__layerWindow__P_312_6.top - paneWindow.top), this.__layerWindow__P_312_6.right - this.__layerWindow__P_312_6.left, this.__layerWindow__P_312_6.bottom - this.__layerWindow__P_312_6.top);
        } else {
          this._setLayerWindow(layers, this.__scrollLeft__P_312_3, this.__scrollTop__P_312_2, bounds.width, bounds.height, false);
        }
    ...
    destruct: function destruct() {
      this._disposeArray("__layers__P_312_9");

      this._disposeObjects("__rowConfig__P_312_0", "__columnConfig__P_312_1", "__layerContainer__P_312_8");

      this.__layerWindow__P_312_6 = this.__jobs__P_312_7 = this.__columnSizes__P_312_11 = this.__rowSizes__P_312_12 = null;
    }
  });
  qx.ui.virtual.core.Pane.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Pane.js.map?dt=1598051421166