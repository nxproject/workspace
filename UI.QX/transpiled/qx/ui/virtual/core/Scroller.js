  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Scroller", {
    ...
    construct: function construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__pane__P_313_0 = new qx.ui.virtual.core.Pane(rowCount, columnCount, cellHeight, cellWidth);

      this.__pane__P_313_0.addListener("update", this._computeScrollbars, this);

      this.__pane__P_313_0.addListener("scrollX", this._onScrollPaneX, this);

      this.__pane__P_313_0.addListener("scrollY", this._onScrollPaneY, this);

      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this._add(this.__pane__P_313_0, {
          edge: 0
        });
      } else {
        this._add(this.__pane__P_313_0, {
    ...
    members: {
      ...
      */
      ...
      _onScrollBarX: function _onScrollBarX(e) {
        this.__pane__P_313_0.setScrollX(e.getData());
      },
      // overridden
      _onScrollBarY: function _onScrollBarY(e) {
        this.__pane__P_313_0.setScrollY(e.getData());
      }
    },
    destruct: function destruct() {
      this.__pane__P_313_0.dispose();

      this.__pane__P_313_0 = null;
    }
  });
  qx.ui.virtual.core.Scroller.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Scroller.js.map?dt=1598051421230