  ...
  qx.Mixin.define("qx.ui.tree.core.MWidgetController", {
    ...
    members: {
      ...
      bindDefaultProperties: function bindDefaultProperties(item, index) {
        ...
        var bindPath = this.__getBindPath__P_303_1(index);
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        var bindPath = this.__getBindPath__P_303_1(index, sourcePath);

        var bindTarget = this._tree.getLookupTable();

        var id = bindTarget.bind(bindPath, targetWidget, targetProperty, options);

        this.__addBinding__P_303_2(targetWidget, id);
      },
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourceProperty, options, sourceWidget, index) {
        var bindPath = this.__getBindPath__P_303_1(index, targetPath);

        var bindTarget = this._tree.getLookupTable();

        var id = sourceWidget.bind(sourceProperty, bindTarget, bindPath, options);

        this.__addBinding__P_303_2(sourceWidget, id);
      },
      ...
      removeBindings: function removeBindings() {
        while (this.__boundItems__P_303_0.length > 0) {
          var item = this.__boundItems__P_303_0.pop();
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        var bindings = this.__getBindings__P_303_3(item);
        ...
        if (this.__boundItems__P_303_0.includes(item)) {
          qx.lang.Array.remove(this.__boundItems__P_303_0, item);
        }
      },
       ...
       */
      __getBindPath__P_303_1: function __getBindPath__P_303_1(index, path) {
        var bindPath = "[" + index + "]";
       ...
       */
      __addBinding__P_303_2: function __addBinding__P_303_2(widget, id) {
        var bindings = this.__getBindings__P_303_3(widget);

        if (!bindings.includes(id)) {
          bindings.push(id);
        }

        if (!this.__boundItems__P_303_0.includes(widget)) {
          this.__boundItems__P_303_0.push(widget);
        }
      },
       ...
       */
      __getBindings__P_303_3: function __getBindings__P_303_3(widget) {
    ...
    destruct: function destruct() {
      this.__boundItems__P_303_0 = null;
    }
  });
  qx.ui.tree.core.MWidgetController.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MWidgetController.js.map?dt=1598051419503