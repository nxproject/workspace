(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.core.AbstractItem", {
    ...
    members: {
      __labelAdded__P_301_0: null,
      __iconAdded__P_301_1: null,
      __spacer__P_301_2: null,
      ...
      */
      ...
      addSpacer: function addSpacer() {
        if (!this.__spacer__P_301_2) {
          this.__spacer__P_301_2 = new qx.ui.core.Spacer();
        } else {
          this._remove(this.__spacer__P_301_2);
        }

        this._add(this.__spacer__P_301_2);
      },
      ...
      addIcon: function addIcon() {
        ...
        if (this.__iconAdded__P_301_1) {
          this._remove(icon);
        }

        this._add(icon);

        this.__iconAdded__P_301_1 = true;
      },
      ...
      addLabel: function addLabel(text) {
        ...
        this.__labelAdded__P_301_0 = true;
      },
      ...
      */
      ...
      _applyIcon: function _applyIcon(value, old) {
        ...
        // user-defined
        if (!this.__getUserValueIconOpened__P_301_3()) {
          this.__setIconSource__P_301_4(value);
        } else if (!this.isOpen()) {
          this.__setIconSource__P_301_4(value);
        }
      },
      ...
      _applyIconOpened: function _applyIconOpened(value, old) {
        if (this.isOpen()) {
          ...
          if (this.__getUserValueIcon__P_301_5() && this.__getUserValueIconOpened__P_301_3()) {
            this.__setIconSource__P_301_4(value);
          } // .. only "opened" icon was user-defined
          else if (!this.__getUserValueIcon__P_301_5() && this.__getUserValueIconOpened__P_301_3()) {
              this.__setIconSource__P_301_4(value);
            }
        }
      },
      ...
      _applyOpen: function _applyOpen(value, old) {
        ...
        if (value) {
          ...
          source = this.__getUserValueIconOpened__P_301_3() ? this.getIconOpened() : null;
        } // Closed
        else {
            source = this.getIcon();
          }
        ...
        if (source) {
          this.__setIconSource__P_301_4(source);
        }
      ...
      */
      __getUserValueIcon__P_301_5: function __getUserValueIcon__P_301_5() {
      ...
      */
      __getUserValueIconOpened__P_301_3: function __getUserValueIconOpened__P_301_3() {
      ...
      */
      __setIconSource__P_301_4: function __setIconSource__P_301_4(url) {
      ...
      */
      ...
      _updateIndent: function _updateIndent() {
        ...
        if (this.__spacer__P_301_2) {
          this.__spacer__P_301_2.setWidth((this.getLevel() + 1) * this.getIndent() - openWidth);
        }
      },
      // property apply
    ...
    destruct: function destruct() {
      this._disposeObjects("__spacer__P_301_2");
    }
  });
  qx.ui.tree.core.AbstractItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractItem.js.map?dt=1598051419187