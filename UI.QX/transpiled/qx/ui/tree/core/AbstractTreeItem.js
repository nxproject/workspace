(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.core.AbstractTreeItem", {
    ...
    members: {
      __children__P_302_0: null,
      __childrenContainer__P_302_1: null,
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        if (!this.__childrenContainer__P_302_1) {
          this.__childrenContainer__P_302_1 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
            visibility: this.isOpen() ? "visible" : "excluded"
          });
        }

        return this.__childrenContainer__P_302_1;
      },
      ...
      */
      ...
      getChildren: function getChildren() {
        return this.__children__P_302_0;
      },
      // overridden
      hasChildren: function hasChildren() {
        return this.__children__P_302_0 ? this.__children__P_302_0.length > 0 : false;
      },
       ...
       */
      __addChildrenToParent__P_302_2: function __addChildrenToParent__P_302_2() {
      ...
      add: function add(varargs) {
        ...
        for (var i = 0, l = arguments.length; i < l; i++) {
          ...
          this.__children__P_302_0.push(treeItem);

          if (!hasChildren) {
            this.__addChildrenToParent__P_302_2();
          }
      ...
      addAt: function addAt(treeItem, index) {
        {
          this.assert(index <= this.__children__P_302_0.length && index >= 0, "Invalid child index: " + index);
        }

        if (index == this.__children__P_302_0.length) {
          this.add(treeItem);
          return;
        }
        ...
        treeItem.setParent(this);
        var hasChildren = this.hasChildren();
        var nextItem = this.__children__P_302_0[index];
        ...
        qx.lang.Array.insertAt(this.__children__P_302_0, treeItem, index);
      ...
      addBefore: function addBefore(treeItem, before) {
        {
          this.assert(this.__children__P_302_0.indexOf(before) >= 0);
        ...
        this.addAt(treeItem, this.__children__P_302_0.indexOf(before));
      },
      ...
      addAfter: function addAfter(treeItem, after) {
        {
          this.assert(this.__children__P_302_0.indexOf(after) >= 0);
        } // It's important to remove the item before the addAt is called
        // otherwise the index calculation could be wrong
        ...
        this.addAt(treeItem, this.__children__P_302_0.indexOf(after) + 1);
      },
      ...
      remove: function remove(varargs) {
        for (var i = 0, l = arguments.length; i < l; i++) {
          ...
          if (this.__children__P_302_0.indexOf(treeItem) == -1) {
          ...
          qx.lang.Array.remove(this.__children__P_302_0, treeItem);
      ...
      removeAt: function removeAt(index) {
        var item = this.__children__P_302_0[index];
      ...
      removeAll: function removeAll() {
        ...
        var children = this.__children__P_302_0.concat();

        for (var i = this.__children__P_302_0.length - 1; i >= 0; i--) {
          this.remove(this.__children__P_302_0[i]);
        }
    ...
    destruct: function destruct() {
      this._disposeArray("__children__P_302_0");

      this._disposeObjects("__childrenContainer__P_302_1");
    }
  });
  qx.ui.tree.core.AbstractTreeItem.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractTreeItem.js.map?dt=1598051419281