  ...
  qx.Class.define("qx.ui.tree.Tree", {
    ...
    */
    construct: function construct() {
      ...
      this.__content__P_228_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
        allowShrinkY: false,
        allowGrowX: true
      });
      this.getChildControl("pane").add(this.__content__P_228_0);
      this.initOpenMode();
    ...
    members: {
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        return this.__content__P_228_0;
      },
      // property apply
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__content__P_228_0");
    }
  });
  qx.ui.tree.Tree.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Tree.js.map?dt=1598051407607