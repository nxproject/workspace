(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.control.DateChooser", {
    ...
    */
    members: {
      __weekdayLabelArr__P_189_0: null,
      __dayLabelArr__P_189_1: null,
      __weekLabelArr__P_189_2: null,
      // overridden
      ...
      */
      ...
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          ...
          case "date-pane":
            ...
            this.__weekdayLabelArr__P_189_0 = [];
            ...
            for (var i = 0; i < 7; i++) {
              ...
              this.__weekdayLabelArr__P_189_0.push(label);
            } // Add the days


            this.__dayLabelArr__P_189_1 = [];
            this.__weekLabelArr__P_189_2 = [];
            ...
            for (var y = 0; y < 6; y++) {
              ...
              this.__weekLabelArr__P_189_2.push(label); // Add the day labels
              ...
              for (var x = 0; x < 7; x++) {
                ...
                this.__dayLabelArr__P_189_1.push(label);
              }
            }
      ...
      _applyValue: function _applyValue(value, old) {
        if (value != null && (this.getShownMonth() != value.getMonth() || this.getShownYear() != value.getFullYear())) {
          ...
          for (var i = 0; i < 42; i++) {
            var dayLabel = this.__dayLabelArr__P_189_1[i];
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var i = 0; i < 7; i++) {
          ...
          var dayLabel = this.__weekdayLabelArr__P_189_0[i];
        ...
        for (var week = 0; week < 6; week++) {
          this.__weekLabelArr__P_189_2[week].setValue(weekFormat.format(helpDate));

          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__dayLabelArr__P_189_1[week * 7 + i];
    ...
    */
    destruct: function destruct() {
      ...
      this.__weekdayLabelArr__P_189_0 = this.__dayLabelArr__P_189_1 = this.__weekLabelArr__P_189_2 = null;
    }
  });
  qx.ui.control.DateChooser.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DateChooser.js.map?dt=1598051400423