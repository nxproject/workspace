(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.control.ColorPopup", {
    ...
    */
    members: {
      __minZIndex__P_187_0: 1e5,
      __boxes__P_187_1: null,
      __colorSelectorWindow__P_187_2: null,
      __colorSelector__P_187_3: null,
      __buttonBar__P_187_4: null,
      __recentTableId__P_187_5: "recent",
      __fieldNumber__P_187_6: 12,
      // overridden
      ...
      */
      ...
      _createBoxes: function _createBoxes() {
        ...
        for (var tableId in tables) {
          ...
          this.__boxes__P_187_1[tableId] = box;
          this.add(box);

          for (var i = 0; i < this.__fieldNumber__P_187_6; i++) {
      ...
      _createColorSelector: function _createColorSelector() {
        if (this.__colorSelector__P_187_3) {
          return;
        }

        var win = new qx.ui.window.Window(this.tr("Color Selector"));
        this.__colorSelectorWindow__P_187_2 = win;
        win.setLayout(new qx.ui.layout.VBox(16));
        win.setResizable(false);
        win.moveTo(20, 20);
        this.__colorSelector__P_187_3 = new qx.ui.control.ColorSelector();
        win.add(this.__colorSelector__P_187_3);
        this.__buttonBar__P_187_4 = new qx.ui.container.Composite(new qx.ui.layout.HBox(8, "right"));
        win.add(this.__buttonBar__P_187_4);
        ...
        this.__buttonBar__P_187_4.add(btnCancel);

        this.__buttonBar__P_187_4.add(btnOk);
      },
      ...
      */
      ...
      _rotatePreviousColors: function _rotatePreviousColors() {
        ...
        var vRecentTable = this._tables[this.__recentTableId__P_187_5].values;
        var vRecentBox = this.__boxes__P_187_1[this.__recentTableId__P_187_5];
        ...
        } else if (vRecentTable.length == this.__fieldNumber__P_187_6) {
          vRecentTable.shift();
        }
      ...
      */
      ...
      _onSelectorButtonExecute: function _onSelectorButtonExecute() {
        ...
        this.__colorSelector__P_187_3.setRed(red);

        this.__colorSelector__P_187_3.setGreen(green);

        this.__colorSelector__P_187_3.setBlue(blue);

        this.__colorSelectorWindow__P_187_2.open();
      },
    ...
    */
    destruct: function destruct() {
      if (this.__colorSelectorWindow__P_187_2) {
        this.__colorSelectorWindow__P_187_2.destroy();

        this.__colorSelector__P_187_3.destroy();

        this.__buttonBar__P_187_4.destroy();
      }

      this._tables = this.__boxes__P_187_1 = null;
    }
  });
  qx.ui.control.ColorPopup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ColorPopup.js.map?dt=1598051399907