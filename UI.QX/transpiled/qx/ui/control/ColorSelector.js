    ...
    */
    members: {
      ...
      */
       ...
       */
      __updateContext__P_188_0: null,

      /**
       * @type {Array} Map containing the preset colors.
       * @lint ignoreReferenceField(__presetTable)
       */
      __presetTable__P_188_1: ["maroon", "red", "orange", "yellow", "olive", "purple", "fuchsia", "lime", "green", "navy", "blue", "aqua", "teal", "black", "#333", "#666", "#999", "#BBB", "#EEE", "white"],
          ...
          case "preset-grid":
            ...
            for (var i = 0; i < 2; i++) {
              for (var j = 0; j < 10; j++) {
                ...
                colorField.setBackgroundColor(this.__presetTable__P_188_1[colorPos]);
      ...
      setValue: function setValue(value) {
        ...
        if (value == null) {
          this.__nullValue__P_188_6 = true;
          rgb = [255, 255, 255];
        } else {
          rgb = qx.util.ColorUtil.stringToRgb(value);
          this.__nullValue__P_188_6 = false;
        } // block the first tow events


        this.__preventChangeValueEvent__P_188_7 = true;
        this.setRed(rgb[0]);
        this.setGreen(rgb[1]); // only allow the final change event

        this.__preventChangeValueEvent__P_188_7 = false;
        this.setBlue(rgb[2]);
      },
      ...
      getValue: function getValue() {
        return this.__nullValue__P_188_6 ? null : qx.util.ColorUtil.rgbToHexString([this.getRed(), this.getGreen(), this.getBlue()]);
      },
       ...
       */
      __fireChangeValueEvent__P_188_8: function __fireChangeValueEvent__P_188_8() {
        if (!this.__preventChangeValueEvent__P_188_7) {
          this.__nullValue__P_188_6 = false;
      ...
      */
      ...
      _applyRed: function _applyRed(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "redModifier";
        }

        if (this.__updateContext__P_188_0 !== "rgbSpinner") {
          this.getChildControl("rgb-spinner-red").setValue(value);
        }

        if (this.__updateContext__P_188_0 !== "hexField") {
          this._setHexFromRgb();
        }

        switch (this.__updateContext__P_188_0) {
          case "rgbSpinner":
          case "hexField":
          case "redModifier":
            this._setHueFromRgb();
        ...
        this.__fireChangeValueEvent__P_188_8();

        if (this.__updateContext__P_188_0 === "redModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      // property apply
      _applyGreen: function _applyGreen(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "greenModifier";
        }
        ...
        if (this.__updateContext__P_188_0 === "greenModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      // property apply
      _applyBlue: function _applyBlue(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "blueModifier";
        }
        ...
        if (this.__updateContext__P_188_0 === "blueModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      ...
      */
      ...
      _applyHue: function _applyHue(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "hueModifier";
        }

        if (this.__updateContext__P_188_0 !== "hsbSpinner") {
          this.getChildControl("hsb-spinner-hue").setValue(value);
        }

        if (this.__updateContext__P_188_0 !== "hueSaturationField") {
        ...
        if (this.__updateContext__P_188_0 === "hueModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      // property apply
      _applySaturation: function _applySaturation(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "saturationModifier";
        }
        ...
        if (this.__updateContext__P_188_0 === "saturationModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      // property apply
      _applyBrightness: function _applyBrightness(value, old) {
        if (this.__updateContext__P_188_0 === null) {
          this.__updateContext__P_188_0 = "brightnessModifier";
        }
        ...
        if (this.__updateContext__P_188_0 !== "brightnessField") {
        ...
        if (this.__updateContext__P_188_0 === "brightnessModifier") {
          this.__updateContext__P_188_0 = null;
        }
      },
      ...
      */
      ...
      _onBrightnessHandlePointerDown: function _onBrightnessHandlePointerDown(e) {
        ...
        this.__capture__P_188_2 = "brightness-handle"; // Calculate subtract: Position of Brightness Field - Current Pointer Offset
        ...
        this.__brightnessSubtract__P_188_3 = locationBrightnessField.top + (e.getDocumentTop() - locationBrightnessHandle.top) - fieldBounds.top; // Block field event handling
      ...
      _onBrightnessHandlePointerMove: function _onBrightnessHandlePointerMove(e) {
        ...
        if (this.__capture__P_188_2 === "brightness-handle") {
      ...
      _onBrightnessFieldPointerDown: function _onBrightnessFieldPointerDown(e) {
        ...
        this.__brightnessSubtract__P_188_3 = location.top + bounds.height / 2; // Update

        this._setBrightnessOnFieldEvent(e); // Afterwards: Activate Capturing for handle


        this.getChildControl("brightness-handle").capture();
        this.__capture__P_188_2 = "brightness-handle";
      },
      ...
      _setBrightnessOnFieldEvent: function _setBrightnessOnFieldEvent(e) {
        var value = qx.lang.Number.limit(e.getDocumentTop() - this.__brightnessSubtract__P_188_3, 0, 256);
        this.__updateContext__P_188_0 = "brightnessField";
      ...
      */
      ...
      _onHueSaturationHandlePointerMove: function _onHueSaturationHandlePointerMove(e) {
        // Update if captured currently (through previous pointerdown)
        if (this.__capture__P_188_2 === "hue-saturation-handle") {
      ...
      _onHueSaturationFieldPointerDown: function _onHueSaturationFieldPointerDown(e) {
        ...
        this.__hueSaturationSubtractTop__P_188_4 = location.top + handleBounds.height / 2 - fieldBounds.top;
        this.__hueSaturationSubtractLeft__P_188_5 = location.left + handleBounds.width / 2 - fieldBounds.left; // Update
        ...
        this.__capture__P_188_2 = "hue-saturation-handle";
      },
      ...
      _setHueSaturationOnFieldEvent: function _setHueSaturationOnFieldEvent(e) {
        var vTop = qx.lang.Number.limit(e.getDocumentTop() - this.__hueSaturationSubtractTop__P_188_4, 0, 256);
        var vLeft = qx.lang.Number.limit(e.getDocumentLeft() - this.__hueSaturationSubtractLeft__P_188_5, 0, 256);
        this.getChildControl("hue-saturation-handle").setDomPosition(vLeft, vTop);
        this.__updateContext__P_188_0 = "hueSaturationField";
      ...
      */
      ...
      _setRedFromSpinner: function _setRedFromSpinner() {
        ...
        this.__updateContext__P_188_0 = "rgbSpinner";
      ...
      */
      ...
      _setHueFromSpinner: function _setHueFromSpinner() {
        ...
        this.__updateContext__P_188_0 = "hsbSpinner";
      ...
      */
      ...
      _onHexFieldChange: function _onHexFieldChange(e) {
        ...
        ;
        this.__updateContext__P_188_0 = "hexField";
        this.setRed(rgb[0]);
        this.setGreen(rgb[1]);
        this.setBlue(rgb[2]);
        this.__updateContext__P_188_0 = null;
...
//# sourceMappingURL=ColorSelector.js.map?dt=1598051400201