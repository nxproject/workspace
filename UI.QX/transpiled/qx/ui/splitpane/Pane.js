  ...
  qx.Class.define("qx.ui.splitpane.Pane", {
    ...
    */
    ...
    construct: function construct(orientation) {
      ...
      this.__children__P_224_0 = []; // Initialize orientation
      ...
      this.__blocker__P_224_1.addListener("pointerdown", this._onPointerDown, this);

      this.__blocker__P_224_1.addListener("pointerup", this._onPointerUp, this);

      this.__blocker__P_224_1.addListener("pointermove", this._onPointerMove, this);

      this.__blocker__P_224_1.addListener("pointerout", this._onPointerOut, this);

      this.__blocker__P_224_1.addListener("losecapture", this._onPointerUp, this);
    },
    ...
    */
    members: {
      __splitterOffset__P_224_2: null,
      __activeDragSession__P_224_3: false,
      __lastPointerX__P_224_4: null,
      __lastPointerY__P_224_5: null,
      __isHorizontal__P_224_6: null,
      __beginSize__P_224_7: null,
      __endSize__P_224_8: null,
      __children__P_224_0: null,
      __blocker__P_224_1: null,
      // overridden
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          ...
          case "splitter":
            ...
            control.addListener("move", this.__onSplitterMove__P_224_9, this);
            break;
        }
       ...
       */
      __onSplitterMove__P_224_9: function __onSplitterMove__P_224_9(e) {
        this.__setBlockerPosition__P_224_10(e.getData());
      },
       ...
       */
      __createBlocker__P_224_11: function __createBlocker__P_224_11(orientation) {
        this.__blocker__P_224_1 = new qx.ui.splitpane.Blocker(orientation);
        this.getContentElement().add(this.__blocker__P_224_1);
        var splitter = this.getChildControl("splitter");
        var splitterWidth = splitter.getWidth();

        if (!splitterWidth) {
          splitter.addListenerOnce("appear", function () {
            this.__setBlockerPosition__P_224_10();
          }, this);
        ...
        splitter.addListener("resize", function (e) {
          ...
          if (this.getChildControl("splitter").isKnobVisible() && (bounds.height == 0 || bounds.width == 0)) {
            this.__blocker__P_224_1.hide();
          } else {
            this.__blocker__P_224_1.show();
          }
        }, this);
      },
      ...
      getBlocker: function getBlocker() {
        return this.__blocker__P_224_1;
      },
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__isHorizontal__P_224_6 = value === "horizontal";

        if (!this.__blocker__P_224_1) {
          this.__createBlocker__P_224_11(value);
        } // update the blocker


        this.__blocker__P_224_1.setOrientation(value); // Dispose old layout
       ...
       *   they can be added.
       */
      __setBlockerPosition__P_224_10: function __setBlockerPosition__P_224_10(bounds) {
        var splitter = this.getChildControl("splitter");
        ...
        if (this.__isHorizontal__P_224_6) {
          ...
          if (width || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__blocker__P_224_1.setWidth(offset, width || 6);

            this.__blocker__P_224_1.setLeft(offset, left);
          } // vertical case
          ...
          if (height || !this.getChildControl("splitter").isKnobVisible()) {
            ...
            this.__blocker__P_224_1.setHeight(offset, height || 6);

            this.__blocker__P_224_1.setTop(offset, top);
          }
        }
      },
      ...
      */
      ...
      add: function add(widget, flex) {
        ...
        this.__children__P_224_0.push(widget);
      },
      ...
      remove: function remove(widget) {
        ...
        qx.lang.Array.remove(this.__children__P_224_0, widget);
      },
      ...
      getChildren: function getChildren() {
        return this.__children__P_224_0;
      },
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        this.__splitterOffset__P_224_2 = this.__isHorizontal__P_224_6 ? e.getDocumentLeft() - splitterLocation.left + paneLocation.left : e.getDocumentTop() - splitterLocation.top + paneLocation.top; // Synchronize slider to splitter size and show it
        ...
        this.__activeDragSession__P_224_3 = true;

        this.__blocker__P_224_1.capture();
      ...
      _onPointerMove: function _onPointerMove(e) {
        ...
        if (this.__activeDragSession__P_224_3) {
          // Compute new children sizes
          this.__computeSizes__P_224_12(); // Update slider position


          var slider = this.getChildControl("slider");
          var pos = this.__beginSize__P_224_7;

          if (this.__isHorizontal__P_224_6) {
            slider.setDomLeft(pos);

            this.__blocker__P_224_1.setStyle("left", pos - this.getOffset() + "px");
          } else {
            slider.setDomTop(pos);

            this.__blocker__P_224_1.setStyle("top", pos - this.getOffset() + "px");
          }
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        this.__activeDragSession__P_224_3 = false;
        this.releaseCapture();
        e.stop();
      },
      ...
      */
      ...
      _finalizeSizes: function _finalizeSizes() {
        var beginSize = this.__beginSize__P_224_7;
        var endSize = this.__endSize__P_224_8;
       ...
       */
      __computeSizes__P_224_12: function __computeSizes__P_224_12() {
        if (this.__isHorizontal__P_224_6) {
          var min = "minWidth",
              size = "width",
              max = "maxWidth",
              pointer = this.__lastPointerX__P_224_4;
        } else {
          var min = "minHeight",
              size = "height",
              max = "maxHeight",
              pointer = this.__lastPointerY__P_224_5;
        }
        ...
        var beginSize = pointer - this.__splitterOffset__P_224_2;
        ...
        this.__beginSize__P_224_7 = beginSize;
        this.__endSize__P_224_8 = endSize;
      },
      ...
      _isActiveDragSession: function _isActiveDragSession() {
        return this.__activeDragSession__P_224_3;
      },
      ...
      _setLastPointerPosition: function _setLastPointerPosition(x, y) {
        this.__lastPointerX__P_224_4 = x;
        this.__lastPointerY__P_224_5 = y;
      }
    },
    destruct: function destruct() {
      this.__children__P_224_0 = null;
    }
  });
  qx.ui.splitpane.Pane.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Pane.js.map?dt=1598051406115