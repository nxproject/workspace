  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.treevirtual.SimpleTreeDataCellRenderer", {
    ...
    construct: function construct() {
      ...
      if (STDCR.__bVirgin__P_231_0) {
        STDCR.__preloadImages__P_231_1();

        STDCR.__bVirgin__P_231_0 = false;
      }

      qx.ui.table.cellrenderer.Abstract.constructor.call(this);
      this.__am__P_231_2 = qx.util.AliasManager.getInstance();
      this.__rm__P_231_3 = qx.util.ResourceManager.getInstance();
      this.__tm__P_231_4 = qx.theme.manager.Appearance.getInstance(); // Base URL used for indentation

      this.BLANK = this.__rm__P_231_3.toUri(this.__am__P_231_2.resolve("static/blank.png"));
    },
    statics: {
      ...
      __bVirgin__P_231_0: true,

      /**
       * Request preloading of images so they appear immediately upon rendering
       */
      __preloadImages__P_231_1: function __preloadImages__P_231_1() {
        ...
        STDCR.__icon__P_231_5.line = tm.styleFrom("treevirtual-line");
        loadImage(STDCR.__icon__P_231_5.line.icon);
        STDCR.__icon__P_231_5.contract = tm.styleFrom("treevirtual-contract");
        loadImage(STDCR.__icon__P_231_5.contract.icon);
        STDCR.__icon__P_231_5.expand = tm.styleFrom("treevirtual-expand");
        loadImage(STDCR.__icon__P_231_5.expand.icon);
        STDCR.__icon__P_231_5.onlyContract = tm.styleFrom("treevirtual-only-contract");
        loadImage(STDCR.__icon__P_231_5.onlyContract.icon);
        STDCR.__icon__P_231_5.onlyExpand = tm.styleFrom("treevirtual-only-expand");
        loadImage(STDCR.__icon__P_231_5.onlyExpand.icon);
        STDCR.__icon__P_231_5.startContract = tm.styleFrom("treevirtual-start-contract");
        loadImage(STDCR.__icon__P_231_5.startContract.icon);
        STDCR.__icon__P_231_5.startExpand = tm.styleFrom("treevirtual-start-expand");
        loadImage(STDCR.__icon__P_231_5.startExpand.icon);
        STDCR.__icon__P_231_5.endContract = tm.styleFrom("treevirtual-end-contract");
        loadImage(STDCR.__icon__P_231_5.endContract.icon);
        STDCR.__icon__P_231_5.endExpand = tm.styleFrom("treevirtual-end-expand");
        loadImage(STDCR.__icon__P_231_5.endExpand.icon);
        STDCR.__icon__P_231_5.crossContract = tm.styleFrom("treevirtual-cross-contract");
        loadImage(STDCR.__icon__P_231_5.crossContract.icon);
        STDCR.__icon__P_231_5.crossExpand = tm.styleFrom("treevirtual-cross-expand");
        loadImage(STDCR.__icon__P_231_5.crossExpand.icon);
        STDCR.__icon__P_231_5.end = tm.styleFrom("treevirtual-end");
        loadImage(STDCR.__icon__P_231_5.end.icon);
        STDCR.__icon__P_231_5.cross = tm.styleFrom("treevirtual-cross");
        loadImage(STDCR.__icon__P_231_5.cross.icon);
      }
    },
    properties: {
      /**
    ...
    */
    members: {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        qx.ui.treevirtual.SimpleTreeDataCellRenderer.__preloadImages__P_231_1();
      },
      // overridden
      ...
      _addImage: function _addImage(imageInfo) {
        ...
        var source = this.__rm__P_231_3.toUri(this.__am__P_231_2.resolve(imageInfo.url)); // If we've been given positioning attributes, enclose image in a div
      ...
      _addIcon: function _addIcon(cellInfo, pos) {
        ...
        if (!imageUrl) {
          if (node.type == qx.ui.treevirtual.SimpleTreeDataModel.Type.LEAF) {
            var o = this.__tm__P_231_4.styleFrom("treevirtual-file");
          } else {
            var states = {
              opened: node.bOpened
            };

            var o = this.__tm__P_231_4.styleFrom("treevirtual-folder", states);
          }
      ...
      _getIndentSymbol: function _getIndentSymbol(column, node, bUseTreeLines, bAlwaysShowOpenCloseSymbol, bExcludeFirstLevelTreeLines) {
        ...
        if (column < node.level - 1) {
          ...
          // bUseTreeLines
          return bUseTreeLines && !node.lastChild[column] ? STDCR.__icon__P_231_5.line : {
            icon: this.BLANK
          };
        }
        ...
        if (node.type == qx.ui.treevirtual.SimpleTreeDataModel.Type.BRANCH && !node.bHideOpenClose) {
          ...
          if (node.children.length > 0 || bAlwaysShowOpenCloseSymbol) {
            ...
            if (!bUseTreeLines) {
              ...
              return node.bOpened ? STDCR.__icon__P_231_5.contract : STDCR.__icon__P_231_5.expand;
            ...
            if (column == 0 && node.bFirstChild) {
              ...
              if (bLastChild) {
                ...
                return node.bOpened ? STDCR.__icon__P_231_5.onlyContract : STDCR.__icon__P_231_5.onlyExpand;
              } else {
                // otherwise, use descender lines but no ascender.
                return node.bOpened ? STDCR.__icon__P_231_5.startContract : STDCR.__icon__P_231_5.startExpand;
              }
            ...
            if (bLastChild) {
              ...
              return node.bOpened ? STDCR.__icon__P_231_5.endContract : STDCR.__icon__P_231_5.endExpand;
            } // Otherwise, return a crossing expand or contract.


            return node.bOpened ? STDCR.__icon__P_231_5.crossContract : STDCR.__icon__P_231_5.crossExpand;
          }
        ...
        if (bUseTreeLines) {
          ...
          if (node.parentNodeId == 0) {
            ...
            if (bLastChild) {
              ...
              return STDCR.__icon__P_231_5.end;
          ...
          return bLastChild ? STDCR.__icon__P_231_5.end : STDCR.__icon__P_231_5.cross;
        }
    ...
    destruct: function destruct() {
      this.__am__P_231_2 = this.__rm__P_231_3 = this.__tm__P_231_4 = null;
    }
  });
  qx.ui.treevirtual.SimpleTreeDataCellRenderer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SimpleTreeDataCellRenderer.js.map?dt=1598051408359