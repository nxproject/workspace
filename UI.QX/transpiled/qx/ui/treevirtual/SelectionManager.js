  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.treevirtual.SelectionManager", {
    ...
    construct: function construct(table) {
      ...
      this.__table__P_230_0 = table;
    },
    members: {
      __table__P_230_0: null,
      ...
      _handleSelectEvent: function _handleSelectEvent(index, evt) {
        ...
        var bNoSelect = handleButtonClick(this.__table__P_230_0, index, evt); // If we haven't been told not to do the selection...
    ...
    destruct: function destruct() {
      this.__table__P_230_0 = null;
    }
  });
  qx.ui.treevirtual.SelectionManager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=SelectionManager.js.map?dt=1598051408212