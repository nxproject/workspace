  ...
  qx.Class.define("qx.ui.treevirtual.SimpleTreeDataModel", {
    ...
    */
    construct: function construct() {
      ...
      this.__editableColArr__P_232_0 = null;
    },
    properties: {
      /**
    ...
    */
    members: {
      __tree__P_232_1: null,
      __editableColArr__P_232_0: null,
      __tempTreeData__P_232_2: null,
      __recalculateLastChildFlags__P_232_3: null,
      ...
      setEditable: function setEditable(editable) {
        this.__editableColArr__P_232_0 = [];

        for (var col = 0; col < this.getColumnCount(); col++) {
          this.__editableColArr__P_232_0[col] = editable;
        }
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__editableColArr__P_232_0 == null) {
            this.__editableColArr__P_232_0 = [];
          }

          this.__editableColArr__P_232_0[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        if (columnIndex == this._treeColumn) {
          return this.__tree__P_232_1.getAllowNodeEdit();
        }

        return this.__editableColArr__P_232_0 ? this.__editableColArr__P_232_0[columnIndex] == true : false;
      },
      // overridden
      ...
      setValue: function setValue(columnIndex, rowIndex, value) {
        ...
        if (columnIndex === this._treeColumn) {
          if (!this.__tree__P_232_1.getAllowNodeEdit() || value["label"] === undefined) {
            return;
       ...
       */
      __inorder__P_232_4: function __inorder__P_232_4(nodeId, level) {
        ...
        var index = 0;
        var children = this.__tempTreeData__P_232_2[nodeId] = [];
        ...
        for (var i = 0; i < numChildren; i++) {
          ...
          if (child == null || filter && !filter.call(this, child)) {
            this.__recalculateLastChildFlags__P_232_3 = true;
            continue;
          ...
          if (!this.__recalculateLastChildFlags__P_232_3) {
            this.__setLastChildFlag__P_232_5(child, i == numChildren - 1);
          ...
          if (child.bOpened) {
            ...
            this.__inorder__P_232_4(childNodeId, level + 1);
          }
       ...
       *   {@link #addLeaf}.
       */
      __calculateLastChildFlags__P_232_6: function __calculateLastChildFlags__P_232_6(nodeId) {
        var tempTreeData = this.__tempTreeData__P_232_2;
        ...
        for (var i = 0; i < numChildren; i++) {
          ...
          if (hasChildren) {
            this.__calculateLastChildFlags__P_232_6(child.nodeId);
          }
        }
      },
       ...
       */
      __setLastChildFlag__P_232_5: function __setLastChildFlag__P_232_5(node, isLastChild) {
       ...
       */
      __render__P_232_7: function __render__P_232_7() {
        // Reset the __tempTreeData
        this.__tempTreeData__P_232_2 = [];
        this.__recalculateLastChildFlags__P_232_3 = false; // Reset the row array
        ...
        this.__inorder__P_232_4(0, 1); // Reset the lastChild flags when needed, so that the tree can render the
        // tree lines right.


        if (this.__recalculateLastChildFlags__P_232_3) {
          this.__calculateLastChildFlags__P_232_6(0);
        } // Give the memory free


        this.__tempTreeData__P_232_2 = null; // Inform the listeners
      ...
      setData: function setData(nodeArr) {
        ...
        this.__render__P_232_7(); // Set selections in the selection model now
        ...
        for (var attribute in attributes) {
          ...
          switch (attribute) {
            ...
            case "bOpened":
              ...
              var tree = this.__tree__P_232_1; // Are we opening or closing?
    ...
    destruct: function destruct() {
      this._rowArr = this._nodeArr = this._nodeRowMap = this._selections = this.__tree__P_232_1 = this.__tempTreeData__P_232_2 = null;
    },
...
//# sourceMappingURL=SimpleTreeDataModel.js.map?dt=1598051408534