(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.embed.ThemedIframe", {
    ...
    members: {
      __iframeSize__P_199_0: null,
      __iframeObserverId__P_199_1: null,
      // overridden
      ...
      */
      ...
      _startIframeObserver: function _startIframeObserver() {
        if (this.__iframeObserverId__P_199_1) {
          this._stopIframeObserver();
        }

        var idle = qx.event.Idle.getInstance();
        this.__iframeObserverId__P_199_1 = idle.addListener("interval", this._onIframeObserverInterval, this);
      },
      ...
      _stopIframeObserver: function _stopIframeObserver() {
        this.__iframeSize__P_199_0 = null;
        ...
        var idle = qx.event.Idle.getInstance();
        idle.removeListenerById(this.__iframeObserverId__P_199_1);
      },
      ...
      _onIframeObserverInterval: function _onIframeObserverInterval() {
        ...
        if (this.__iframeSize__P_199_0 && iframeSize.width == this.__iframeSize__P_199_0.width && iframeSize.height == this.__iframeSize__P_199_0.height) {
          return;
        }

        this.__iframeSize__P_199_0 = iframeSize;
      ...
      _updateScrollbars: function _updateScrollbars() {
        var iframeSize = this.__iframeSize__P_199_0;
...
//# sourceMappingURL=ThemedIframe.js.map?dt=1598051401689