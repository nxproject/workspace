    ...
    members: {
      ...
      */
      ...
      _checkLoading: function _checkLoading() {
        ...
        if (source != "" && source != null && source != "undefined") {
          if (!this.isLoaded()) {
            if (!this.__time__P_197_0) {
              this.__time__P_197_0 = new Date().getTime();
            }

            var timeDiff = new Date().getTime() - this.__time__P_197_0;
      ...
      */
      ...
      _applyQuality: function _applyQuality(value, old) {
        this.__flashParamHelper__P_197_1("quality", value);
      },
      // property apply
      _applyScale: function _applyScale(value, old) {
        this.__flashParamHelper__P_197_1("scale", value);
      },
      // property apply
      _applyWmode: function _applyWmode(value, old) {
        this.__flashParamHelper__P_197_1("wmode", value);
      },
      // property apply
      _applyPlay: function _applyPlay(value, old) {
        this.__flashParamHelper__P_197_1("play", value);
      },
      // property apply
      _applyLoop: function _applyLoop(value, old) {
        this.__flashParamHelper__P_197_1("loop", value);
      },
      // property apply
      _applyMenu: function _applyMenu(value, old) {
        this.__flashParamHelper__P_197_1("menu", value);
      },
      // property apply
      _applyAllowScriptAccess: function _applyAllowScriptAccess(value, old) {
        this.__flashParamHelper__P_197_1("allowScriptAccess", value);
      },
      // property apply
      _applyLiveConnect: function _applyLiveConnect(value, old) {
        this.__flashParamHelper__P_197_1("swLiveConnect", value);
      },
      ...
      */
       ...
       */
      __flashParamHelper__P_197_1: function __flashParamHelper__P_197_1(key, value) {
...
//# sourceMappingURL=Flash.js.map?dt=1598051401371