  ...
  qx.Class.define("qx.ui.embed.Iframe", {
    ...
    */
    ...
    construct: function construct(source) {
      ...
      this.__blockerElement__P_198_1 = this._createBlockerElement();
    ...
    */
    members: {
      __source__P_198_0: null,
      __blockerElement__P_198_1: null,
      // overridden
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        this.__blockerElement__P_198_1.setStyles({
      ...
      _createContentElement: function _createContentElement() {
        var iframe = new qx.html.Iframe(this.__source__P_198_0);
      ...
      */
      ...
      block: function block() {
        this.__blockerElement__P_198_1.setStyle("display", "block");
      },
      ...
      release: function release() {
        this.__blockerElement__P_198_1.setStyle("display", "none");
      },
      ...
      */
      ...
      setLayoutParent: function setLayoutParent(parent) {
        ...
        if (parent) {
          this.getLayoutParent().getContentElement().add(this.__blockerElement__P_198_1);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      if (this.getLayoutParent() && this.__blockerElement__P_198_1.getParent()) {
        this.getLayoutParent().getContentElement().remove(this.__blockerElement__P_198_1);
      }

      this._disposeObjects("__blockerElement__P_198_1");
...
//# sourceMappingURL=Iframe.js.map?dt=1598051401566