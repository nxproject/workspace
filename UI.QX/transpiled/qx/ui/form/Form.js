  ...
  qx.Class.define("qx.ui.form.Form", {
    ...
    members: {
      ...
      */
      ...
      add: function add(item, label, validator, name, validatorContext, options) {
        if (this.__isFirstAdd__P_203_1()) {
          this.__groups__P_203_0.push({
            title: null,
            items: [],
            labels: [],
            names: [],
        ...
        this.__groups__P_203_0[this._groupCounter].items.push(item);

        this.__groups__P_203_0[this._groupCounter].labels.push(label);

        this.__groups__P_203_0[this._groupCounter].options.push(options); // if no name is given, use the label without not working character
        ...
        this.__groups__P_203_0[this._groupCounter].names.push(name); // add the item to the validation manager
       ...
       */
      __isFirstAdd__P_203_1: function __isFirstAdd__P_203_1() {
        return this.__groups__P_203_0.length === 0;
      },
      ...
      */
      ...
      remove: function remove(item) {
        for (var i = 0; i < this.__groups__P_203_0.length; i++) {
          var group = this.__groups__P_203_0[i];
        ...
        for (var i = 0; i < this.__groups__P_203_0.length; i++) {
          ...
          if (group.title === title) {
            ...
            if (i == 0) {
              ...
              if (this.__groups__P_203_0.length == 1) {
                ...
                // add to the next
                targetGroup = this.__groups__P_203_0[i + 1];
              }
            } else {
            ...
            this.__groups__P_203_0.splice(i, 1);
      ...
      getItems: function getItems() {
        ...
        for (var i = 0; i < this.__groups__P_203_0.length; i++) {
          var group = this.__groups__P_203_0[i]; // get all items
    ...
    */
    destruct: function destruct() {
      ...
      this.__groups__P_203_0 = this._buttons = this._buttonOptions = null;
...
//# sourceMappingURL=Form.js.map?dt=1598051402402