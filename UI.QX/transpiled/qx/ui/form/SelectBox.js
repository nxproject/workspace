  ...
  qx.Class.define("qx.ui.form.SelectBox", {
    ...
    */
    construct: function construct() {
      ...
      this.addListener("changeSelection", this.__onChangeSelection__P_210_0, this);
    },
    ...
    */
    members: {
      ...
      __preSelectedItem__P_210_1: null,
      ...
      */
       ...
       */
      __onChangeSelection__P_210_0: function __onChangeSelection__P_210_0(e) {
        ...
        this.__updateIcon__P_210_2();

        this.__updateLabel__P_210_3();
      },

      /**
       * Sets the icon inside the list to match the selected ListItem.
       */
      __updateIcon__P_210_2: function __updateIcon__P_210_2() {
       ...
       */
      __updateLabel__P_210_3: function __updateLabel__P_210_3() {
        var listItem = this.getChildControl("list").getSelection()[0];
        var atom = this.getChildControl("atom");
      ...
      */
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        if (iden == "Enter" || iden == "Space") {
          ...
          if (this.__preSelectedItem__P_210_1) {
            this.setSelection([this.__preSelectedItem__P_210_1]);
            this.__preSelectedItem__P_210_1 = null;
          }
      ...
      _onListChangeSelection: function _onListChangeSelection(e) {
        ...
        if (old && old.length > 0) {
          old[0].removeListener("changeIcon", this.__updateIcon__P_210_2, this);
          old[0].removeListener("changeLabel", this.__updateLabel__P_210_3, this);
        }
        ...
        if (current.length > 0) {
          ...
          if (popup.isVisible() && (context == "quick" || context == "key")) {
            this.__preSelectedItem__P_210_1 = current[0];
          } else {
          ...
          current[0].addListener("changeIcon", this.__updateIcon__P_210_2, this);
          current[0].addListener("changeLabel", this.__updateLabel__P_210_3, this);
        } else {
          this.resetSelection();
        }
      },
...
//# sourceMappingURL=SelectBox.js.map?dt=1598051403652