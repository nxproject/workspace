  ...
  qx.Class.define("qx.ui.form.core.AbstractVirtualBox", {
    ...
    construct: function construct(model) {
      ...
      if (model != null) {
        ...
        this.__defaultModel__P_244_0 = new qx.data.Array();
        this.initModel(this.__defaultModel__P_244_0);
      }
    },
    properties: {
      // overridden
    ...
    destruct: function destruct() {
      if (this.__defaultModel__P_244_0) {
        this.__defaultModel__P_244_0.dispose();
      }
    }
  });
...
//# sourceMappingURL=AbstractVirtualBox.js.map?dt=1598051411124