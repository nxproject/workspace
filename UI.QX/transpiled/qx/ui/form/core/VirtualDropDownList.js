  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__onChangeVisibility__P_245_0, this);
      this.__defaultSelection__P_245_1 = new qx.data.Array();
      this.initSelection(this.__defaultSelection__P_245_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
       ...
       * @type {Number}
       */
      __cachedMaxListItemWidth__P_245_4: 0,
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__ignoreListSelection__P_245_3 = true;
        var listSelection = this.getChildControl("list").getSelection();
        var helper = new qx.data.Array([modelItem]);

        this.__synchronizeSelection__P_245_5(helper, listSelection);

        helper.dispose();
        this.__ignoreListSelection__P_245_3 = false;
      },
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        if (this.isVisible() && event.getKeyIdentifier() === "Enter") {
          this.__selectPreselected__P_245_6();
       ...
       */
      __onChangeSelection__P_245_7: function __onChangeSelection__P_245_7(event) {
        if (this.__ignoreSelection__P_245_2) {
          return;
        }
        ...
        this.__synchronizeSelection__P_245_5(selection, listSelection);

        this.__ignoreListSelection__P_245_3 = false;
        this.__ignoreSelection__P_245_2 = true;

        this.__synchronizeSelection__P_245_5(listSelection, selection);

        this.__ignoreSelection__P_245_2 = false;
      },
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        if (this.__ignoreListSelection__P_245_3) {
          return;
        }
        ...
        if (this.isVisible()) {
          ...
          this.__synchronizeSelection__P_245_5(listSelection, this.getSelection());
       ...
       */
      __onChangeVisibility__P_245_0: function __onChangeVisibility__P_245_0(event) {
        if (this.isVisible()) {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__onChangeSelection__P_245_7, this);

        if (old != null) {
          old.removeListener("change", this.__onChangeSelection__P_245_7, this);
        }

        this.__synchronizeSelection__P_245_5(value, this.getChildControl("list").getSelection(value));
      },
      ...
      */
       ...
       * drop-down.
       */
      __selectPreselected__P_245_6: function __selectPreselected__P_245_6() {
        if (this._preselected != null) {
          var selection = this.getSelection();
       ...
       */
      __synchronizeSelection__P_245_5: function __synchronizeSelection__P_245_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          if (this.__cachedMaxListItemWidth__P_245_4 > 0) {
            uiList.setWidth(this.__cachedMaxListItemWidth__P_245_4);
          } else {
      ...
      _recalculateMaxListItemWidth: function _recalculateMaxListItemWidth() {
        ...
        this.__cachedMaxListItemWidth__P_245_4 = maxWidth;
      },
      ...
      _getMaxListItemWidth: function _getMaxListItemWidth() {
        return this.__cachedMaxListItemWidth__P_245_4;
      }
    },
    destruct: function destruct() {
      if (this.__defaultSelection__P_245_1) {
        this.__defaultSelection__P_245_1.dispose();
      }
    }
  });
...
//# sourceMappingURL=VirtualDropDownList.js.map?dt=1598051411247