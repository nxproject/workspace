  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.validation.Manager", {
    ...
    construct: function construct() {
      ...
      this.__formItems__P_247_0 = []; // storage for all results of async validation calls

      this.__asyncResults__P_247_1 = {}; // set the default required field message
    ...
    members: {
      __formItems__P_247_0: null,
      __valid__P_247_2: null,
      __asyncResults__P_247_1: null,
      __syncValid__P_247_3: null,
      ...
      add: function add(formItem, validator, context) {
        ...
        if (!this.__supportsInvalid__P_247_4(formItem)) {
          throw new Error("Added widget not supported.");
        } // check for the data type


        if (this.__supportsSingleSelection__P_247_5(formItem) && !formItem.getValue) {
        ...
        this.__formItems__P_247_0.push(dataEntry);
      },
      ...
      remove: function remove(formItem) {
        var items = this.__formItems__P_247_0;
      ...
      getItems: function getItems() {
        ...
        for (var i = 0; i < this.__formItems__P_247_0.length; i++) {
          items.push(this.__formItems__P_247_0[i].item);
        }
      ...
      validate: function validate() {
        var valid = true;
        this.__syncValid__P_247_3 = true; // collaboration of all synchronous validations

        var items = []; // check all validators for the added form items

        for (var i = 0; i < this.__formItems__P_247_0.length; i++) {
          var formItem = this.__formItems__P_247_0[i].item;
          var validator = this.__formItems__P_247_0[i].validator; // store the items in case of form validation
          ...
          if (validator == null) {
            ...
            this.__syncValid__P_247_3 = validatorResult && this.__syncValid__P_247_3;
            continue;
          }

          var validatorResult = this._validateItem(this.__formItems__P_247_0[i], formItem.getValue()); // keep that order to ensure that null is returned on async cases
        ...
        var formValid = this.__validateForm__P_247_6(items);

        if (qx.lang.Type.isBoolean(formValid)) {
          this.__syncValid__P_247_3 = formValid && this.__syncValid__P_247_3;
        }
        ...
        if (qx.lang.Object.isEmpty(this.__asyncResults__P_247_1)) {
      ...
      _validateRequired: function _validateRequired(formItem) {
        if (formItem.getRequired()) {
          ...
          if (this.__supportsSingleSelection__P_247_5(formItem)) {
            validatorResult = !!formItem.getSelection()[0];
          } else if (this.__supportsDataBindingSelection__P_247_7(formItem)) {
      ...
      _validateItem: function _validateItem(dataEntry, value) {
        ...
        if (this.__isAsyncValidator__P_247_8(validator)) {
          // used to check if all async validations are done
          this.__asyncResults__P_247_1[formItem.toHashCode()] = null;
       ...
       */
      __validateForm__P_247_6: function __validateForm__P_247_6(items) {
        ...
        if (this.__isAsyncValidator__P_247_8(formValidator)) {
          this.__asyncResults__P_247_1[this.toHashCode()] = null;
       ...
       */
      __isAsyncValidator__P_247_8: function __isAsyncValidator__P_247_8(validator) {
        var async = false;
       ...
       *   necessary interface.
       */
      __supportsInvalid__P_247_4: function __supportsInvalid__P_247_4(formItem) {
       ...
       *   necessary interface.
       */
      __supportsSingleSelection__P_247_5: function __supportsSingleSelection__P_247_5(formItem) {
        var clazz = formItem.constructor;
       ...
       *   necessary interface.
       */
      __supportsDataBindingSelection__P_247_7: function __supportsDataBindingSelection__P_247_7(formItem) {
        var clazz = formItem.constructor;
      ...
      _setValid: function _setValid(value) {
        ...
        var oldValue = this.__valid__P_247_2;
        this.__valid__P_247_2 = value; // check for the change event
      ...
      _showToolTip: function _showToolTip(valid) {
        ...
        if (!valid) {
          ...
          for (var i = 0; i < this.__formItems__P_247_0.length; i++) {
            var item = this.__formItems__P_247_0[i].item;
      ...
      reset: function reset() {
        ...
        for (var i = 0; i < this.__formItems__P_247_0.length; i++) {
          var dataEntry = this.__formItems__P_247_0[i]; // set the field to valid

          dataEntry.item.setValid(true);
        } // set the manager to its initial valid value


        this.__valid__P_247_2 = null;
      ...
      setItemValid: function setItemValid(formItem, valid) {
        // store the result
        this.__asyncResults__P_247_1[formItem.toHashCode()] = valid;
        formItem.setValid(valid);

        this.__checkValidationComplete__P_247_9();
      },
      ...
      setFormValid: function setFormValid(valid) {
        this.__asyncResults__P_247_1[this.toHashCode()] = valid;
       ...
       */
      __checkValidationComplete__P_247_9: function __checkValidationComplete__P_247_9() {
        var valid = this.__syncValid__P_247_3; // check if all async validators are done

        for (var hash in this.__asyncResults__P_247_1) {
          var currentResult = this.__asyncResults__P_247_1[hash];
        ...
        this.__asyncResults__P_247_1 = {}; // fire the complete event (no entry in the results with null)
    ...
    */
    destruct: function destruct() {
      ...
      this.__formItems__P_247_0 = null;
    }
  });
  qx.ui.form.validation.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1598051411729