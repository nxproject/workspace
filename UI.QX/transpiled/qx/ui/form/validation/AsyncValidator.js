  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.validation.AsyncValidator", {
    ...
    construct: function construct(validator) {
      ...
      this.__validatorFunction__P_246_0 = validator;
    },
    members: {
      __validatorFunction__P_246_0: null,
      __item__P_246_1: null,
      __manager__P_246_2: null,
      __usedForForm__P_246_3: null,
      ...
      validate: function validate(item, value, manager, context) {
        ...
        this.__usedForForm__P_246_3 = false; // store the item and the manager

        this.__item__P_246_1 = item;
        this.__manager__P_246_2 = manager; // invoke the user set validator function

        this.__validatorFunction__P_246_0.call(context || this, this, value);
      },
      ...
      validateForm: function validateForm(items, manager, context) {
        this.__usedForForm__P_246_3 = true;
        this.__manager__P_246_2 = manager;

        this.__validatorFunction__P_246_0.call(context, items, this);
      },
      ...
      setValid: function setValid(valid, message) {
        // valid processing
        if (this.__usedForForm__P_246_3) {
          // message processing
          if (message !== undefined) {
            this.__manager__P_246_2.setInvalidMessage(message);
          }

          this.__manager__P_246_2.setFormValid(valid);
        } else {
          // message processing
          if (message !== undefined) {
            this.__item__P_246_1.setInvalidMessage(message);
          }

          this.__manager__P_246_2.setItemValid(this.__item__P_246_1, valid);
        }
      }
    },
    ...
    destruct: function destruct() {
      this.__manager__P_246_2 = this.__item__P_246_1 = null;
    }
  });
  qx.ui.form.validation.AsyncValidator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AsyncValidator.js.map?dt=1598051411602