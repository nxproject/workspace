  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.Resetter", {
    ...
    construct: function construct() {
      ...
      this.__items__P_209_0 = [];
    },
    members: {
      __items__P_209_0: null,
      ...
      add: function add(field) {
        this.__typeCheck__P_209_1(field);

        this.__items__P_209_0.push({
          item: field,
          init: field.getValue()
        });
      },
      ...
      remove: function remove(field) {
        ...
        for (var i = 0; i < this.__items__P_209_0.length; i++) {
          var storedItem = this.__items__P_209_0[i];

          if (storedItem.item === field) {
            this.__items__P_209_0.splice(i, 1);
      ...
      reset: function reset() {
        ...
        for (var i = 0; i < this.__items__P_209_0.length; i++) {
          dataEntry = this.__items__P_209_0[i];
      ...
      resetItem: function resetItem(field) {
        ...
        for (var i = 0; i < this.__items__P_209_0.length; i++) {
          var dataEntry = this.__items__P_209_0[i];
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__items__P_209_0.length; i++) {
          var item = this.__items__P_209_0[i].item; // set the new init value for the item

          this.__items__P_209_0[i].init = item.getValue();
        }
      },
      ...
      redefineItem: function redefineItem(field) {
        this.__typeCheck__P_209_1(field); // get the data entry


        var dataEntry;

        for (var i = 0; i < this.__items__P_209_0.length; i++) {
          if (this.__items__P_209_0[i].item === field) {
            dataEntry = this.__items__P_209_0[i];
       ...
       * @private
       */
      __typeCheck__P_209_1: function __typeCheck__P_209_1(field) {
    ...
    */
    destruct: function destruct() {
      ...
      this.__items__P_209_0 = null;
    }
  });
  qx.ui.form.Resetter.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resetter.js.map?dt=1598051403531