  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__modelSelection__P_206_0 = new qx.data.Array(); // listen to the changes

      this.__modelSelection__P_206_0.addListener("change", this.__onModelSelectionArrayChange__P_206_1, this);

      this.addListener("changeSelection", this.__onModelSelectionChange__P_206_2, this);
    },
    events: {
      /**
    ...
    members: {
      __modelSelection__P_206_0: null,
      __inSelectionChange__P_206_3: false,
       ...
       */
      __onModelSelectionChange__P_206_2: function __onModelSelectionChange__P_206_2() {
        if (this.__inSelectionChange__P_206_3) {
          return;
        }
       ...
       */
      __onModelSelectionArrayChange__P_206_1: function __onModelSelectionArrayChange__P_206_1() {
        this.__inSelectionChange__P_206_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];

        var modelSelection = this.__modelSelection__P_206_0.toArray();
        ...
        this.__inSelectionChange__P_206_3 = false; // check if the setting has worked

        var currentSelection = this.getSelection();

        if (!qx.lang.Array.equals(currentSelection, itemSelection)) {
          // if not, set the actual selection
          this.__onModelSelectionChange__P_206_2();
        }
      },
      ...
      getModelSelection: function getModelSelection() {
        return this.__modelSelection__P_206_0;
      },
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        if (!modelSelection) {
          this.__modelSelection__P_206_0.removeAll();
        ...
        modelSelection.unshift(this.__modelSelection__P_206_0.getLength()); // remove index

        modelSelection.unshift(0); // start index

        var returnArray = this.__modelSelection__P_206_0.splice.apply(this.__modelSelection__P_206_0, modelSelection);

        returnArray.dispose();
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__modelSelection__P_206_0");
    }
  });
  qx.ui.form.MModelSelection.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MModelSelection.js.map?dt=1598051403067