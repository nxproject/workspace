    ...
    members: {
      ...
      */
      ...
      _applyValue: function _applyValue(value, old) {
        ...
        this.__lastValidValue__P_212_0 = value; // write the value of the spinner to the textfield
      ...
      _applyNumberFormat: function _applyNumberFormat(value, old) {
        ...
        this._applyValue(this.__lastValidValue__P_212_0, undefined);
      },
      ...
      _onKeyDown: function _onKeyDown(e) {
        switch (e.getKeyIdentifier()) {
          case "PageUp":
            ...
            this.__pageUpMode__P_212_1 = true;
          ...
          case "PageDown":
            // mark that the spinner is in page mode and process further
            this.__pageDownMode__P_212_2 = true;
      ...
      _onKeyUp: function _onKeyUp(e) {
        switch (e.getKeyIdentifier()) {
          case "PageUp":
            ...
            this.__pageUpMode__P_212_1 = false;
            break;
          ...
          case "PageDown":
            ...
            this.__pageDownMode__P_212_2 = false;
            break;
      ...
      */
      ...
      _onTextChange: function _onTextChange(e) {
        ...
        if (!isNaN(value)) {
          ...
          if (value === this.__lastValidValue__P_212_0) {
            this._applyValue(this.__lastValidValue__P_212_0);
          } else {
            this.setValue(value);
          }
        } else {
      ...
      */
      ...
      _countDown: function _countDown() {
        if (this.__pageDownMode__P_212_2) {
          var newValue = this.getValue() - this.getPageStep();
        } else {
          var newValue = this.getValue() - this.getSingleStep();
        } // handle the case where wrapping is enabled
...
//# sourceMappingURL=Spinner.js.map?dt=1598051404044