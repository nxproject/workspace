(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.DateField", {
    ...
    */
    statics: {
      __dateFormat__P_202_0: null,
      __formatter__P_202_1: null,
      ...
      getDefaultDateFormatter: function getDefaultDateFormatter() {
        ...
        if (format == this.__dateFormat__P_202_0) {
          return this.__formatter__P_202_1;
        }

        if (this.__formatter__P_202_1) {
          this.__formatter__P_202_1.dispose();
        }

        this.__formatter__P_202_1 = new qx.util.format.DateFormat(format, qx.locale.Manager.getInstance().getLocale());
        this.__dateFormat__P_202_0 = format;
        return this.__formatter__P_202_1;
      }
    },
    ...
    */
    members: {
      __localeListenerId__P_202_2: null,
      ...
      */
      ...
      _addLocaleChangeListener: function _addLocaleChangeListener() {
        ...
        {
          this.__localeListenerId__P_202_2 = qx.locale.Manager.getInstance().addListener("changeLocale", function () {
    ...
    destruct: function destruct() {
      // listen for locale changes
      {
        if (this.__localeListenerId__P_202_2) {
          qx.locale.Manager.getInstance().removeListenerById(this.__localeListenerId__P_202_2);
        }
      }
    }
  });
...
//# sourceMappingURL=DateField.js.map?dt=1598051402288