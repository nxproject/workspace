  ...
  qx.Class.define("qx.ui.form.List", {
    ...
    */
    ...
    construct: function construct(horizontal) {
      ...
      this.__content__P_204_0 = this._createListItemContainer(); // Used to fire item add/remove events

      this.__content__P_204_0.addListener("addChildWidget", this._onAddChild, this);

      this.__content__P_204_0.addListener("removeChildWidget", this._onRemoveChild, this); // Add to scrollpane


      this.getChildControl("pane").add(this.__content__P_204_0); // Apply orientation
    ...
    */
    members: {
      __pressedString__P_204_1: null,
      __lastKeyPress__P_204_2: null,

      /** @type {qx.ui.core.Widget} The children container */
      __content__P_204_0: null,
      ...
      */
      ...
      getChildrenContainer: function getChildrenContainer() {
        return this.__content__P_204_0;
      },
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        var content = this.__content__P_204_0; // save old layout for disposal
      ...
      _applySpacing: function _applySpacing(value, old) {
        this.__content__P_204_0.getLayout().setSpacing(value);
      },
      ...
      */
      ...
      _onKeyInput: function _onKeyInput(e) {
        ...
        if (new Date().valueOf() - this.__lastKeyPress__P_204_2 > 1000) {
          this.__pressedString__P_204_1 = "";
        } // Combine keys the user pressed to a string


        this.__pressedString__P_204_1 += e.getChar(); // Find matching item

        var matchedItem = this.findItemByLabelFuzzy(this.__pressedString__P_204_1); // if an item was found, select it
        ...
        this.__lastKeyPress__P_204_2 = new Date().valueOf();
      },
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__content__P_204_0");
    }
  });
  qx.ui.form.List.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=List.js.map?dt=1598051402899