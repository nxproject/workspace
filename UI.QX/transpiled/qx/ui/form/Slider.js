(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.Slider", {
    ...
    */
    members: {
      __sliderLocation__P_211_0: null,
      __knobLocation__P_211_1: null,
      __knobSize__P_211_2: null,
      __dragMode__P_211_3: null,
      __dragOffset__P_211_4: null,
      __trackingMode__P_211_5: null,
      __trackingDirection__P_211_6: null,
      __trackingEnd__P_211_7: null,
      __timer__P_211_8: null,
      // event delay stuff during drag
      __dragTimer__P_211_9: null,
      __lastValueEvent__P_211_10: null,
      __dragValue__P_211_11: null,
      __scrollAnimationframe__P_211_12: null,
      // overridden
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__dragMode__P_211_3) {
          return;
        }

        var isHorizontal = this.__isHorizontal__P_211_13;
        ...
        var sliderLocation = this.__sliderLocation__P_211_0 = qx.bom.element.Location.get(this.getContentElement().getDomElement())[locationProperty];
        sliderLocation += padding;
        var knobLocation = this.__knobLocation__P_211_1 = qx.bom.element.Location.get(knob.getContentElement().getDomElement())[locationProperty];

        if (e.getTarget() === knob) {
          // Switch into drag mode
          this.__dragMode__P_211_3 = true;

          if (!this.__dragTimer__P_211_9) {
            // create a timer to fire delayed dragging events if dragging stops.
            this.__dragTimer__P_211_9 = new qx.event.Timer(100);

            this.__dragTimer__P_211_9.addListener("interval", this._fireValue, this);
          }

          this.__dragTimer__P_211_9.start(); // Compute dragOffset (includes both: inner position of the widget and
          // cursor position on knob)


          this.__dragOffset__P_211_4 = cursorLocation + sliderLocation - knobLocation; // add state

          knob.addState("pressed");
        } else {
          // Switch into tracking mode
          this.__trackingMode__P_211_5 = true; // Detect tracking direction

          this.__trackingDirection__P_211_6 = cursorLocation <= knobLocation ? -1 : 1; // Compute end value

          this.__computeTrackingEnd__P_211_14(e); // Directly call interval method once


          this._onInterval(); // Initialize timer (when needed)


          if (!this.__timer__P_211_8) {
            this.__timer__P_211_8 = new qx.event.Timer(100);

            this.__timer__P_211_8.addListener("interval", this._onInterval, this);
          } // Start timer


          this.__timer__P_211_8.start();
      ...
      _onPointerUp: function _onPointerUp(e) {
        if (this.__dragMode__P_211_3) {
          ...
          delete this.__dragMode__P_211_3; // as we come out of drag mode, make
          // sure content gets synced

          this.__dragTimer__P_211_9.stop();

          this._fireValue();

          delete this.__dragOffset__P_211_4; // remove state
          ...
          if (e.getType() === "pointerup") {
            ...
            if (this.__isHorizontal__P_211_13) {
              deltaSlider = e.getDocumentLeft() - (this._valueToPosition(this.getValue()) + this.__sliderLocation__P_211_0);
              ...
              deltaSlider = e.getDocumentTop() - (this._valueToPosition(this.getValue()) + this.__sliderLocation__P_211_0);
            ...
            if (deltaPosition < 0 || deltaPosition > this.__knobSize__P_211_2 || deltaSlider < 0 || deltaSlider > this.__knobSize__P_211_2) {
              this.getChildControl("knob").removeState("hovered");
            }
          }
        } else if (this.__trackingMode__P_211_5) {
          // Stop timer interval
          this.__timer__P_211_8.stop(); // Release capture mode


          this.releaseCapture(); // Cleanup status flags

          delete this.__trackingMode__P_211_5;
          delete this.__trackingDirection__P_211_6;
          delete this.__trackingEnd__P_211_7;
      ...
      _onPointerMove: function _onPointerMove(e) {
        if (this.__dragMode__P_211_3) {
          var dragStop = this.__isHorizontal__P_211_13 ? e.getDocumentLeft() : e.getDocumentTop();
          var position = dragStop - this.__dragOffset__P_211_4;
          this.slideTo(this._positionToValue(position));
        } else if (this.__trackingMode__P_211_5) {
          // Update tracking end on pointermove
          this.__computeTrackingEnd__P_211_14(e);
        } // Stop event
      ...
      _onInterval: function _onInterval(e) {
        // Compute new value
        var value = this.getValue() + this.__trackingDirection__P_211_6 * this.getPageStep(); // Limit value
        ...
        var slideBack = this.__trackingDirection__P_211_6 == -1;

        if (slideBack && value <= this.__trackingEnd__P_211_7 || !slideBack && value >= this.__trackingEnd__P_211_7) {
          value = this.__trackingEnd__P_211_7;
      ...
      _onUpdate: function _onUpdate(e) {
        ...
        var sizeProperty = this.__isHorizontal__P_211_13 ? "width" : "height"; // Sync knob size

        this._updateKnobSize(); // Store knob size


        this.__slidingSpace__P_211_15 = availSize[sizeProperty] - knobSize[sizeProperty];
        this.__knobSize__P_211_2 = knobSize[sizeProperty]; // Update knob position (sliding space must be updated first)
      ...
      */
       ...
       * @param e {qx.event.type.Pointer} Incoming pointer event
       */
      __computeTrackingEnd__P_211_14: function __computeTrackingEnd__P_211_14(e) {
        var isHorizontal = this.__isHorizontal__P_211_13;
        var cursorLocation = isHorizontal ? e.getDocumentLeft() : e.getDocumentTop();
        var sliderLocation = this.__sliderLocation__P_211_0;
        var knobLocation = this.__knobLocation__P_211_1;
        var knobSize = this.__knobSize__P_211_2; // Compute relative position
        ...
        if (value < min) {
          ...
          var method = this.__trackingDirection__P_211_6 < 0 ? "floor" : "ceil"; // Fix to page step
        ...
        if (this.__trackingEnd__P_211_7 == null || this.__trackingDirection__P_211_6 == -1 && value <= this.__trackingEnd__P_211_7 || this.__trackingDirection__P_211_6 == 1 && value >= this.__trackingEnd__P_211_7) {
          this.__trackingEnd__P_211_7 = value;
        }
      },
      ...
      _positionToValue: function _positionToValue(position) {
        ...
        var avail = this.__slidingSpace__P_211_15; // Protect undefined value (before initial resize) and division by zero
      ...
      _valueToPosition: function _valueToPosition(value) {
        // Reading available space
        var avail = this.__slidingSpace__P_211_15;
      ...
      */
      ...
      slideTo: function slideTo(value, duration) {
        ...
        if (duration) {
          this.__animateTo__P_211_16(value, duration);
        } else {
      ...
      updatePosition: function updatePosition(value) {
        this.setValue(this.__normalizeValue__P_211_17(value));
      },
      ...
      stopSlideAnimation: function stopSlideAnimation() {
        if (this.__scrollAnimationframe__P_211_12) {
          this.__scrollAnimationframe__P_211_12.cancelSequence();

          this.__scrollAnimationframe__P_211_12 = null;
        }
      },
       ...
       */
      __normalizeValue__P_211_17: function __normalizeValue__P_211_17(value) {
       ...
       * @param duration {Number} The time in milliseconds the slide to should take.
       */
      __animateTo__P_211_16: function __animateTo__P_211_16(to, duration) {
        to = this.__normalizeValue__P_211_17(to);
        var from = this.getValue();
        this.__scrollAnimationframe__P_211_12 = new qx.bom.AnimationFrame();

        this.__scrollAnimationframe__P_211_12.on("frame", function (timePassed) {
          this.setValue(parseInt(timePassed / duration * (to - from) + from));
        }, this);

        this.__scrollAnimationframe__P_211_12.on("end", function () {
          this.setValue(to);
          this.__scrollAnimationframe__P_211_12 = null;
          this.fireEvent("slideAnimationEnd");
        }, this);

        this.__scrollAnimationframe__P_211_12.startSequence(duration);
      },
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__isHorizontal__P_211_13 = value === "horizontal"; // Toggle states and knob layout
      ...
      _applyValue: function _applyValue(value, old) {
        if (value != null) {
          ...
          if (this.__dragMode__P_211_3) {
            this.__dragValue__P_211_11 = [value, old];
          } else {
      ...
      _fireValue: function _fireValue() {
        if (!this.__dragValue__P_211_11) {
          return;
        }

        var tmp = this.__dragValue__P_211_11;
        this.__dragValue__P_211_11 = null;
...
//# sourceMappingURL=Slider.js.map?dt=1598051403893