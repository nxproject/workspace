  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.__items__P_208_0 = []; // add listener before call add!!!

      this.addListener("changeSelection", this.__onChangeSelection__P_208_1, this);
    ...
    members: {
      ...
      */
      ...
      add: function add(varargs) {
        var items = this.__items__P_208_0;
        var item;
      ...
      */
      ...
      _applyGroupedProperty: function _applyGroupedProperty(value, old) {
        ...
        for (var i = 0; i < this.__items__P_208_0.length; i++) {
          item = this.__items__P_208_0[i]; // remove the listener for the old change event
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__items__P_208_0.length; i++) {
          this.__items__P_208_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__items__P_208_0.length; i++) {
          this.__items__P_208_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__items__P_208_0.indexOf(item) != -1;
      },
       ...
       * @param e {qx.event.type.Data} Data event.
       */
      __onChangeSelection__P_208_1: function __onChangeSelection__P_208_1(e) {
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__items__P_208_0");
    }
  });
  qx.ui.form.RadioGroup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RadioGroup.js.map?dt=1598051403459