  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RadioButtonGroup", {
    ...
    construct: function construct(layout) {
      ...
      this.__radioGroup__P_207_0 = new qx.ui.form.RadioGroup(); // attach the listener

      this.__radioGroup__P_207_0.addListener("changeSelection", this._onChangeSelection, this);
    },
    properties: {
      /**
    ...
    members: {
      ...
      */
      ...
      getRadioGroup: function getRadioGroup() {
        return this.__radioGroup__P_207_0;
      },
      ...
      add: function add(child, options) {
        this.__radioGroup__P_207_0.add(child);
      ...
      remove: function remove(child) {
        this.__radioGroup__P_207_0.remove(child);
      ...
      removeAll: function removeAll() {
        ...
        var radioItems = this.__radioGroup__P_207_0.getItems();

        for (var i = radioItems.length - 1; i >= 0; i--) {
          this.__radioGroup__P_207_0.remove(radioItems[i]);
        }
      ...
      */
      ...
      getSelection: function getSelection() {
        return this.__radioGroup__P_207_0.getSelection();
      },
      ...
      setSelection: function setSelection(items) {
        this.__radioGroup__P_207_0.setSelection(items);
      },
      ...
      resetSelection: function resetSelection() {
        this.__radioGroup__P_207_0.resetSelection();
      },
      ...
      isSelected: function isSelected(item) {
        return this.__radioGroup__P_207_0.isSelected(item);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__radioGroup__P_207_0.isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__radioGroup__P_207_0.getSelectables(all);
      },
      ...
      setValue: function setValue(item) {
        if (item && 'object' === _typeof(item) && item instanceof qx.ui.form.IRadioItem) {
          return this.__radioGroup__P_207_0.setValue(item);
        } else {
      ...
      getValue: function getValue() {
        return this.__radioGroup__P_207_0.getValue();
      },
      ...
      resetValue: function resetValue() {
        this.__radioGroup__P_207_0.resetValue();
      },
    ...
    destruct: function destruct() {
      this.__radioGroup__P_207_0.removeListener("changeSelection", this._onChangeSelection, this);

      this._disposeObjects("__radioGroup__P_207_0");
    }
  });
  qx.ui.form.RadioButtonGroup.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RadioButtonGroup.js.map?dt=1598051403332