(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.TextArea", {
    ...
    */
    members: {
      __areaClone__P_214_0: null,
      __areaHeight__P_214_1: null,
      __originalAreaHeight__P_214_2: null,
      // overridden
      setValue: function setValue(value) {
        value = qx.ui.form.TextArea.prototype.setValue.base.call(this, value);

        this.__autoSize__P_214_3();
      ...
      _onResize: function _onResize(e) {
        if (this.__areaClone__P_214_0) {
          this.__areaClone__P_214_0.dispose();

          this.__areaClone__P_214_0 = null;
      ...
      *
      */
      __autoSize__P_214_3: function __autoSize__P_214_3() {
        if (this.isAutoSize()) {
          var clone = this.__getAreaClone__P_214_4();

          if (clone && this.getBounds()) {
            // Remember original area height
            this.__originalAreaHeight__P_214_2 = this.__originalAreaHeight__P_214_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__originalAreaHeight__P_214_2); // Set new height
      ...
      */
      _setAreaHeight: function _setAreaHeight(height) {
        if (this._getAreaHeight() !== height) {
          this.__areaHeight__P_214_1 = height;
      ...
      */
      _getScrolledAreaHeight: function _getScrolledAreaHeight() {
        ...
        if (cloneDom) {
          ...
          this.__scrollCloneToBottom__P_214_6(clone);
      ...
      * original element
      */
      __getAreaClone__P_214_4: function __getAreaClone__P_214_4() {
        this.__areaClone__P_214_0 = this.__areaClone__P_214_0 || this.__createAreaClone__P_214_7();
        return this.__areaClone__P_214_0;
      },
      ...
      */
      __createAreaClone__P_214_7: function __createAreaClone__P_214_7() {
      ...
      */
      __scrollCloneToBottom__P_214_6: function __scrollCloneToBottom__P_214_6(clone) {
      ...
      */
      ...
      _applyAutoSize: function _applyAutoSize(value, old) {
        {
          this.__warnAutoSizeAndHeight__P_214_8();
        }

        if (value) {
          this.__autoSize__P_214_3();

          this.addListener("input", this.__autoSize__P_214_3, this); // This is done asynchronously on purpose. The style given would
          ...
          this.removeListener("input", this.__autoSize__P_214_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
       ...
       */
      __forceRewrap__P_214_5: function __forceRewrap__P_214_5() {
       ...
       *
       */
      __warnAutoSizeAndHeight__P_214_8: function __warnAutoSizeAndHeight__P_214_8() {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__areaHeight__P_214_1 || hint.height;
        }
...
//# sourceMappingURL=TextArea.js.map?dt=1598051404260