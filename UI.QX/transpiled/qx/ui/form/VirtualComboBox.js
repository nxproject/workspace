  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct: function construct(model) {
      ...
      this.__selection__P_215_0 = dropdown.getSelection();

      this.__selection__P_215_0.addListener("change", this.__onSelectionChange__P_215_1, this);
    ...
    members: {
      ...
      */
      ...
      _beforeOpen: function _beforeOpen() {
        this.__selectFirstMatch__P_215_5();
      },
      // overridden
      ...
      */
       ...
       */
      __onSelectionChange__P_215_1: function __onSelectionChange__P_215_1(event) {
        if (this.__ignoreChangeSelection__P_215_4 == true) {
          return;
        }

        var selected = this.__selection__P_215_0.getItem(0);

        if (selected) {
          selected = this.__convertValue__P_215_6(selected);
      ...
      */
       ...
       */
      __selectFirstMatch__P_215_5: function __selectFirstMatch__P_215_5() {
        ...
        if (selected === undefined || this.__convertValue__P_215_6(selected) !== value) {
          // only reset the old selection if there is one
          if (selected !== undefined) {
            // reset the old selection
            this.__ignoreChangeSelection__P_215_4 = true;
            selection.removeAll();
            this.__ignoreChangeSelection__P_215_4 = false;
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__convertValue__P_215_6(modelItem);
       ...
       */
      __convertValue__P_215_6: function __convertValue__P_215_6(modelItem) {
    ...
    destruct: function destruct() {
      ...
      this.__selection__P_215_0.removeListener("change", this.__onSelectionChange__P_215_1, this);

      this.__selection__P_215_0 = null;
    }
  });
  qx.ui.form.VirtualComboBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VirtualComboBox.js.map?dt=1598051404481