  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__timer__P_170_0 = new qx.event.AcceleratingTimer();

      this.__timer__P_170_0.addListener("interval", this._onInterval, this);
    },
    events: {
      /**
    ...
    members: {
      __executed__P_170_1: null,
      __timer__P_170_0: null,
      ...
      press: function press() {
        ...
        if (this.isEnabled()) {
          ...
          if (!this.hasState("pressed")) {
            // start the timer
            this.__startInternalTimer__P_170_2();
          } // set the states
      ...
      release: function release(fireExecuteEvent) {
        ...
        this.__stopInternalTimer__P_170_3();
      },
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          ...
          if (this.hasState("pressed") && !this.__executed__P_170_1) {
            this.execute();
          }
        }
      ...
      */
       ...
       *
       */
      __startInternalTimer__P_170_2: function __startInternalTimer__P_170_2() {
        this.fireEvent("press");
        this.__executed__P_170_1 = false;

        this.__timer__P_170_0.set({
       ...
       *
       */
      __stopInternalTimer__P_170_3: function __stopInternalTimer__P_170_3() {
    ...
    destruct: function destruct() {
      this._disposeObjects("__timer__P_170_0");
    }
  });
  qx.ui.form.RepeatButton.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=RepeatButton.js.map?dt=1598045326991