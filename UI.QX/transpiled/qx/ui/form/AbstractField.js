  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.AbstractField", {
    ...
    statics: {
      ...
      __stylesheet__P_200_0: null,

      /**
       * Adds the CSS rules needed to style the native placeholder element.
       */
      __addPlaceholderRules__P_200_1: function __addPlaceholderRules__P_200_1() {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.__useQxPlaceholder__P_200_2 = !qx.core.Environment.get("css.placeholder");
      ...
      if (this.__useQxPlaceholder__P_200_2) {
        // assign the placeholder text after the appearance has been applied
        this.addListener("syncAppearance", this._syncPlaceholder, this);
      } else {
        // add rules for native placeholder color
        qx.ui.form.AbstractField.__addPlaceholderRules__P_200_1(); // add a class to the input to restrict the placeholder color
    ...
    */
    members: {
      __nullValue__P_200_3: true,
      _placeholder: null,
      __oldValue__P_200_4: null,
      __oldInputValue__P_200_5: null,
      __useQxPlaceholder__P_200_2: true,
      __font__P_200_6: null,
      __webfontListenerId__P_200_7: null,
      ...
      */
      ...
      renderLayout: function renderLayout(left, top, width, height) {
        ...
        if (updateInsets && this.__useQxPlaceholder__P_200_2) {
          if (this.__useQxPlaceholder__P_200_2) {
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__textSize__P_200_8.width * 10,
          height: this.__textSize__P_200_8.height || 16
        };
      },
      // overridden
      _applyFont: function _applyFont(value, old) {
        if (old && this.__font__P_200_6 && this.__webfontListenerId__P_200_7) {
          this.__font__P_200_6.removeListenerById(this.__webfontListenerId__P_200_7);

          this.__webfontListenerId__P_200_7 = null;
        } // Apply
        ...
        if (value) {
          this.__font__P_200_6 = qx.theme.manager.Font.getInstance().resolve(value);

          if (this.__font__P_200_6 instanceof qx.bom.webfonts.WebFont) {
            this.__webfontListenerId__P_200_7 = this.__font__P_200_6.addListener("changeStatus", this._onWebFontStatusChange, this);
          }

          styles = this.__font__P_200_6.getStyles();
        } else {
        ...
        if (value) {
          this.__textSize__P_200_8 = qx.bom.Label.getTextSize("A", styles);
        } else {
          delete this.__textSize__P_200_8;
        } // Update layout
      ...
      _getTextSize: function _getTextSize() {
        return this.__textSize__P_200_8;
      },
      ...
      */
      ...
      _onHtmlInput: function _onHtmlInput(e) {
        var value = e.getData();
        var fireEvents = true;
        this.__nullValue__P_200_3 = false; // value unchanged; Firefox fires "input" when pressing ESC [BUG #5309]

        if (this.__oldInputValue__P_200_5 && this.__oldInputValue__P_200_5 === value) {
          fireEvents = false;
        ...
        if (this.getFilter() != null) {
          ...
          if (filteredValue != value) {
            fireEvents = this.__oldInputValue__P_200_5 !== filteredValue;
            value = filteredValue;
        ...
        if (fireEvents) {
          ...
          this.fireDataEvent("input", value, this.__oldInputValue__P_200_5);
          this.__oldInputValue__P_200_5 = value; // check for the live change event

          if (this.getLiveUpdate()) {
            this.__fireChangeValueEvent__P_200_9(value);
      ...
      _onWebFontStatusChange: function _onWebFontStatusChange(ev) {
        if (ev.getData().valid === true) {
          var styles = this.__font__P_200_6.getStyles();
       ...
       */
      __fireChangeValueEvent__P_200_9: function __fireChangeValueEvent__P_200_9(value) {
        var old = this.__oldValue__P_200_4;
        this.__oldValue__P_200_4 = value;
      ...
      */
      ...
      setValue: function setValue(value) {
        ...
        if (value === null) {
          ...
          if (this.__nullValue__P_200_3) {
            return value;
          }

          value = "";
          this.__nullValue__P_200_3 = true;
        } else {
          this.__nullValue__P_200_3 = false; // native placeholders will be removed by the browser
        ...
        if (qx.lang.Type.isString(value)) {
          ...
          if (elem.getValue() != value) {
            ...
            elem.setValue(value);
            var data = this.__nullValue__P_200_3 ? null : value;
            this.__oldValue__P_200_4 = oldValue;

            this.__fireChangeValueEvent__P_200_9(data); // reset the input value on setValue calls [BUG #6892]


            this.__oldInputValue__P_200_5 = this.__oldValue__P_200_4;
      ...
      getValue: function getValue() {
        return this.isDisposed() || this.__nullValue__P_200_3 ? null : this.getContentElement().getValue();
      },
      ...
      _onChangeContent: function _onChangeContent(e) {
        this.__nullValue__P_200_3 = e.getData() === null;

        this.__fireChangeValueEvent__P_200_9(e.getData());
      },
      ...
      */
      ...
      _syncPlaceholder: function _syncPlaceholder() {
        if (this.hasState("showingPlaceholder") && this.__useQxPlaceholder__P_200_2) {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        if (!this.__useQxPlaceholder__P_200_2 && qx.ui.form.AbstractField.__stylesheet__P_200_0) {
          qx.bom.Stylesheet.removeSheet(qx.ui.form.AbstractField.__stylesheet__P_200_0);
          qx.ui.form.AbstractField.__stylesheet__P_200_0 = null;

          qx.ui.form.AbstractField.__addPlaceholderRules__P_200_1();
        }
      },
    ...
    */
    destruct: function destruct() {
      ...
      this._placeholder = this.__font__P_200_6 = null;
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this._onChangeLocale, this);
      }

      if (this.__font__P_200_6 && this.__webfontListenerId__P_200_7) {
        this.__font__P_200_6.removeListenerById(this.__webfontListenerId__P_200_7);
      }
...
//# sourceMappingURL=AbstractField.js.map?dt=1598051401918