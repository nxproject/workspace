  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct: function construct(model) {
      ...
      this.__bindings__P_216_0 = [];
      this.initSelection(this.getChildControl("dropdown").getSelection());
      this.__searchTimer__P_216_1 = new qx.event.Timer(500);

      this.__searchTimer__P_216_1.addListener("interval", this.__preselect__P_216_2, this);
    ...
    members: {
      ...
      */
      ...
      _addBindings: function _addBindings() {
        ...
        this.__bindings__P_216_0.push(id);
      ...
      _removeBindings: function _removeBindings() {
        while (this.__bindings__P_216_0.length > 0) {
          var id = this.__bindings__P_216_0.pop();
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            this.__searchValue__P_216_3 += this.__convertKeyIdentifier__P_216_4(event.getKeyIdentifier());

            this.__searchTimer__P_216_1.restart();
      ...
      */
       ...
       * __searchValue value.
       */
      __preselect__P_216_2: function __preselect__P_216_2() {
        this.__searchTimer__P_216_1.stop();

        var searchValue = this.__searchValue__P_216_3;
       ...
       */
      __convertKeyIdentifier__P_216_4: function __convertKeyIdentifier__P_216_4(keyIdentifier) {
    ...
    destruct: function destruct() {
      ...
      this.__searchTimer__P_216_1.removeListener("interval", this.__preselect__P_216_2, this);

      this.__searchTimer__P_216_1.dispose();

      this.__searchTimer__P_216_1 = null;
    }
  });
  qx.ui.form.VirtualSelectBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VirtualSelectBox.js.map?dt=1598051404587