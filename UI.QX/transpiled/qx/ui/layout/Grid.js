  ...
  qx.Class.define("qx.ui.layout.Grid", {
    ...
    */
    ...
    construct: function construct(spacingX, spacingY) {
      ...
      this.__rowData__P_84_0 = [];
      this.__colData__P_84_1 = [];
    ...
    */
    members: {
      ...
      __grid__P_84_2: null,
      __rowData__P_84_0: null,
      __colData__P_84_1: null,
      __colSpans__P_84_3: null,
      __rowSpans__P_84_4: null,
      __maxRowIndex__P_84_5: null,
      __maxColIndex__P_84_6: null,

      /** @type {Array} cached row heights */
      __rowHeights__P_84_7: null,

      /** @type {Array} cached column widths */
      __colWidths__P_84_8: null,
      // overridden
       ...
       */
      __buildGrid__P_84_9: function __buildGrid__P_84_9() {
        var grid = [];
        var colSpans = [];
        var rowSpans = [];
        var maxRowIndex = -1;
        ...
        this.__grid__P_84_2 = grid;
        this.__colSpans__P_84_3 = colSpans;
        this.__rowSpans__P_84_4 = rowSpans;
        this.__maxRowIndex__P_84_5 = maxRowIndex;
        this.__maxColIndex__P_84_6 = maxColIndex;
        this.__rowHeights__P_84_7 = null;
        this.__colWidths__P_84_8 = null; // Clear invalidation marker
      ...
      _setRowData: function _setRowData(row, key, value) {
        var rowData = this.__rowData__P_84_0[row];

        if (!rowData) {
          this.__rowData__P_84_0[row] = {};
          this.__rowData__P_84_0[row][key] = value;
        } else {
          rowData[key] = value;
        }
      },
      ...
      _setColumnData: function _setColumnData(column, key, value) {
        var colData = this.__colData__P_84_1[column];

        if (!colData) {
          this.__colData__P_84_1[column] = {};
          this.__colData__P_84_1[column][key] = value;
        } else {
          colData[key] = value;
        }
      },
      ...
      getCellWidget: function getCellWidget(row, column) {
        if (this._invalidChildrenCache) {
          this.__buildGrid__P_84_9();
        }

        var row = this.__grid__P_84_2[row] || {};
      ...
      getRowCount: function getRowCount() {
        ...
        return this.__maxRowIndex__P_84_5 + 1;
      },
      ...
      getColumnCount: function getColumnCount() {
        ...
        return this.__maxColIndex__P_84_6 + 1;
      },
      ...
      getCellAlign: function getCellAlign(row, column) {
        ...
        var rowData = this.__rowData__P_84_0[row];
        var colData = this.__colData__P_84_1[column];
        var widget = this.__grid__P_84_2[row][column];
      ...
      _fixHeightsRowSpan: function _fixHeightsRowSpan(rowHeights) {
        ...
        for (var i = 0, l = this.__rowSpans__P_84_4.length; i < l; i++) {
          var widget = this.__rowSpans__P_84_4[i];
      ...
      _getRowHeights: function _getRowHeights() {
        if (this.__rowHeights__P_84_7 != null) {
          return this.__rowHeights__P_84_7;
        }

        var rowHeights = [];
        var maxRowIndex = this.__maxRowIndex__P_84_5;
        var maxColIndex = this.__maxColIndex__P_84_6;
        ...
        for (var row = 0; row <= maxRowIndex; row++) {
          ...
          for (var col = 0; col <= maxColIndex; col++) {
            var widget = this.__grid__P_84_2[row][col];
        ...
        if (this.__rowSpans__P_84_4.length > 0) {
          this._fixHeightsRowSpan(rowHeights);
        }

        this.__rowHeights__P_84_7 = rowHeights;
        return rowHeights;
      },
      ...
      _getColWidths: function _getColWidths() {
        if (this.__colWidths__P_84_8 != null) {
          return this.__colWidths__P_84_8;
        }
        ...
        this.__colWidths__P_84_8 = colWidths;
        return colWidths;
      },
      ...
      _getColSpans: function _getColSpans() {
        return this.__colSpans__P_84_3;
      },
      // overridden
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        for (var col = 0; col <= maxColIndex; col++) {
          ...
          for (var row = 0; row <= maxRowIndex; row++) {
            var widget = this.__grid__P_84_2[row][col]; // ignore empty cells
    ...
    */
    destruct: function destruct() {
      this.__grid__P_84_2 = this.__rowData__P_84_0 = this.__colData__P_84_1 = this.__colSpans__P_84_3 = this.__rowSpans__P_84_4 = this.__colWidths__P_84_8 = this.__rowHeights__P_84_7 = null;
    }
  });
  qx.ui.layout.Grid.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Grid.js.map?dt=1598045172193