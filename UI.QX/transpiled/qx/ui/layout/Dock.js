(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.Dock", {
    ...
    */
    members: {
      __children__P_217_0: null,
      __edges__P_217_1: null,
      // overridden
       ...
       *
       */
      __rebuildCache__P_217_4: function __rebuildCache__P_217_4() {
        ...
        this.__children__P_217_0 = result; // Cache edges for faster access

        var edges = [];

        for (var i = 0; i < length; i++) {
          edge = result[i].getLayoutProperties().edge;
          edges[i] = this.__edgeMap__P_217_2[edge] || 5;
        }

        this.__edges__P_217_1 = edges; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this._invalidChildrenCache) {
          this.__rebuildCache__P_217_4();
        }

        var util = qx.ui.layout.Util;
        var children = this.__children__P_217_0;
        var edges = this.__edges__P_217_1;
        ...
        var alignMap = this.__alignMap__P_217_3;
    ...
    */
    destruct: function destruct() {
      this.__edges__P_217_1 = this.__children__P_217_0 = null;
    }
  });
  qx.ui.layout.Dock.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Dock.js.map?dt=1598051405137