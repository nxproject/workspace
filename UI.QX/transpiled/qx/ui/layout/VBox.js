(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    */
    members: {
      __heights__P_81_0: null,
      __flexs__P_81_1: null,
      __enableFlex__P_81_2: null,
      __children__P_81_3: null,
      ...
      */
       ...
       */
      __rebuildCache__P_81_4: function __rebuildCache__P_81_4() {
        var children = this._getLayoutChildren();

        var length = children.length;
        var enableFlex = false;
        var reuse = this.__heights__P_81_0 && this.__heights__P_81_0.length != length && this.__flexs__P_81_1 && this.__heights__P_81_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__heights__P_81_0 : new Array(length);
        var flexs = reuse ? this.__flexs__P_81_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__heights__P_81_0 = heights;
          this.__flexs__P_81_1 = flexs;
        }

        this.__enableFlex__P_81_2 = enableFlex;
        this.__children__P_81_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this._invalidChildrenCache) {
          this.__rebuildCache__P_81_4();
        } // Cache children


        var children = this.__children__P_81_3;
        var length = children.length;
        ...
        for (i = 0; i < length; i += 1) {
          percent = this.__heights__P_81_0[i];
        ...
        if (this.__enableFlex__P_81_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;

          for (i = 0; i < length; i += 1) {
            flex = this.__flexs__P_81_1[i];
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__children__P_81_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__flexs__P_81_1[i];
          var percent = this.__heights__P_81_0[i];
    ...
    */
    destruct: function destruct() {
      this.__heights__P_81_0 = this.__flexs__P_81_1 = this.__children__P_81_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1598045171789