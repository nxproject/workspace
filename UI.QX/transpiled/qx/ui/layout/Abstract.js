  ...
  qx.Class.define("qx.ui.layout.Abstract", {
    ...
    members: {
      ...
      */
      ...
      getSizeHint: function getSizeHint() {
        if (this.__sizeHint__P_63_0) {
          return this.__sizeHint__P_63_0;
        }

        return this.__sizeHint__P_63_0 = this._computeSizeHint();
      },
      ...
      _clearSeparators: function _clearSeparators() {
        ...
        var widget = this.__widget__P_63_1;
      ...
      _renderSeparator: function _renderSeparator(separator, bounds) {
        this.__widget__P_63_1.renderSeparator(separator, bounds);
      },
      ...
      connectToWidget: function connectToWidget(widget) {
        if (widget && this.__widget__P_63_1) {
          throw new Error("It is not possible to manually set the connected widget.");
        }

        this.__widget__P_63_1 = widget; // Invalidate cache
      ...
      _applyLayoutChange: function _applyLayoutChange() {
        if (this.__widget__P_63_1) {
          this.__widget__P_63_1.scheduleLayoutUpdate();
        }
      },
      ...
      _getLayoutChildren: function _getLayoutChildren() {
        return this.__widget__P_63_1.getLayoutChildren();
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__widget__P_63_1 = this.__sizeHint__P_63_0 = null;
    }
  });
  qx.ui.layout.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1598045170132