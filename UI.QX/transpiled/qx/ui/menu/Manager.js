  ...
  qx.Class.define("qx.ui.menu.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__openTimer__P_165_1 = new qx.event.Timer();

      this.__openTimer__P_165_1.addListener("interval", this._onOpenInterval, this); // Create close timer


      this.__closeTimer__P_165_2 = new qx.event.Timer();

      this.__closeTimer__P_165_2.addListener("interval", this._onCloseInterval, this);
    },
    ...
    */
    members: {
      __scheduleOpen__P_165_3: null,
      __scheduleClose__P_165_4: null,
      __openTimer__P_165_1: null,
      __closeTimer__P_165_2: null,
      __objects__P_165_0: null,
      ...
      */
      ...
      _isMenuOpener: function _isMenuOpener(widget) {
        var menus = this.__objects__P_165_0;
      ...
      */
      ...
      add: function add(obj) {
        ...
        var reg = this.__objects__P_165_0;
        reg.push(obj);
      ...
      */
      ...
      scheduleOpen: function scheduleOpen(menu) {
        ...
        if (menu.isVisible()) {
          ...
          if (this.__scheduleOpen__P_165_3) {
            this.cancelOpen(this.__scheduleOpen__P_165_3);
          }
        } // When the menu is not visible and not scheduled already
        // then schedule it for opening
        else if (this.__scheduleOpen__P_165_3 != menu) {
            // menu.debug("Schedule open");
            this.__scheduleOpen__P_165_3 = menu;

            this.__openTimer__P_165_1.restartWith(menu.getOpenInterval());
          }
      },
      ...
      scheduleClose: function scheduleClose(menu) {
        ...
        if (!menu.isVisible()) {
          ...
          if (this.__scheduleClose__P_165_4) {
            this.cancelClose(this.__scheduleClose__P_165_4);
          }
        } // When the menu is visible and not scheduled already
        // then schedule it for closing
        else if (this.__scheduleClose__P_165_4 != menu) {
            // menu.debug("Schedule close");
            this.__scheduleClose__P_165_4 = menu;

            this.__closeTimer__P_165_2.restartWith(menu.getCloseInterval());
          }
      },
      ...
      cancelOpen: function cancelOpen(menu) {
        if (this.__scheduleOpen__P_165_3 == menu) {
          // menu.debug("Cancel open");
          this.__openTimer__P_165_1.stop();

          this.__scheduleOpen__P_165_3 = null;
        }
      },
      ...
      cancelClose: function cancelClose(menu) {
        if (this.__scheduleClose__P_165_4 == menu) {
          // menu.debug("Cancel close");
          this.__closeTimer__P_165_2.stop();

          this.__scheduleClose__P_165_4 = null;
        }
      },
      ...
      */
      ...
      _onOpenInterval: function _onOpenInterval(e) {
        // Stop timer
        this.__openTimer__P_165_1.stop(); // Open menu and reset flag


        this.__scheduleOpen__P_165_3.open();
      ...
      _onCloseInterval: function _onCloseInterval(e) {
        ...
        this.__closeTimer__P_165_2.stop(); // Close menu and reset flag


        this.__scheduleClose__P_165_4.exclude();
      ...
      */
      ...
      preventContextMenuOnce: function preventContextMenuOnce() {
        qx.event.Registration.addListener(document.body, "contextmenu", this.__onPreventContextMenu__P_165_5, this, true);
      },
       ...
       * @internal
       */
      __onPreventContextMenu__P_165_5: function __onPreventContextMenu__P_165_5(e) {
        ...
        qx.event.Registration.removeListener(document.body, "contextmenu", this.__onPreventContextMenu__P_165_5, this, true);
      },
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__objects__P_165_0.length > 0 && !this._isInMenu(target)) {
          this.hideAll();
        }
      },
      ...
      */
      ...
      _onKeyUpDown: function _onKeyUpDown(e) {
        ...
        if (this.__navigationKeys__P_165_7[iden] || this.__selectionKeys__P_165_6[iden] && menu.getSelectedButton()) {
          e.stopPropagation();
        }
      },
      ...
      _onKeyPress: function _onKeyPress(e) {
        ...
        var iden = e.getKeyIdentifier();
        var navigation = this.__navigationKeys__P_165_7[iden];
        var selection = this.__selectionKeys__P_165_6[iden];
      ...
      _onRoll: function _onRoll(e) {
        ...
        if (this.__objects__P_165_0.length > 0 && !this._isInMenu(target) && !this._isMenuOpener(target) && !e.getMomentum()) {
          this.hideAll();
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__openTimer__P_165_1", "__closeTimer__P_165_2");

      this._disposeArray("__objects__P_165_0");
    }
  });
  qx.ui.menu.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1598045326210