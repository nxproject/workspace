(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.menu.Menu", {
    ...
    */
    members: {
      __scheduledOpen__P_166_0: null,
      __onAfterSlideBarAdd__P_166_1: null,
      ...
      */
      ...
      open: function open() {
        if (this.getOpener() != null) {
          ...
          if (isPlaced) {
            this.__updateSlideBar__P_166_2();
      ...
      */
      ...
      _applyVisibility: function _applyVisibility(value, old) {
        ...
        this.__updateBlockerVisibility__P_166_3();
      },

      /**
       * Updates the blocker's visibility
       */
      __updateBlockerVisibility__P_166_3: function __updateBlockerVisibility__P_166_3() {
        if (this.isVisible()) {
      ...
      */
       ...
       * and position.
       */
      __updateSlideBar__P_166_2: function __updateSlideBar__P_166_2() {
        var menuBounds = this._getMenuBounds();

        if (!menuBounds) {
          this.addListenerOnce("resize", this.__updateSlideBar__P_166_2, this);
          return;
        }
      ...
      _assertSlideBar: function _assertSlideBar(callback) {
        ...
        this.__onAfterSlideBarAdd__P_166_1 = callback;
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__onAfterSlideBarAdd__P_166_1) {
          this.__onAfterSlideBarAdd__P_166_1.call(this);

          delete this.__onAfterSlideBarAdd__P_166_1;
        }
      },
      ...
      _onPointerOver: function _onPointerOver(e) {
        ...
        if (target.isEnabled() && target instanceof qx.ui.menu.AbstractButton) {
          ...
          if (subMenu) {
            ...
            this.__scheduledOpen__P_166_0 = subMenu;
          } else {
            ...
            if (this.__scheduledOpen__P_166_0) {
              mgr.cancelOpen(this.__scheduledOpen__P_166_0);
              this.__scheduledOpen__P_166_0 = null;
            }
          }
...
//# sourceMappingURL=Menu.js.map?dt=1598045326406