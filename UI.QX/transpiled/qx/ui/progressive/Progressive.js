  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.Progressive", {
    ...
    construct: function construct(structure) {
      ...
      this.__renderer__P_221_0 = {}; // Prepare to have our pane structure added to us.
      ...
      this.__structure__P_221_1 = structure;
      structure.applyStructure(this); // We've not yet done our initial render

      this.__bInitialRenderComplete__P_221_2 = false; // We're not currently rendering

      this.__bRendering__P_221_3 = false; // Number of elements available to be rendered.  Useful for progress
      // handlers, e.g. a progress bar or status counter.

      this.__initialNumElements__P_221_4 = 0;
    },
    events: {
      /**
    ...
    members: {
      __renderer__P_221_0: null,
      __bRendering__P_221_3: null,
      __t1__P_221_5: null,
      __initialNumElements__P_221_4: null,
      __bInitialRenderComplete__P_221_2: null,
      __structure__P_221_1: null,
      ...
      getStructure: function getStructure() {
        return this.__structure__P_221_1;
      },
      ...
      addRenderer: function addRenderer(name, renderer) {
        this.__renderer__P_221_0[name] = renderer;
      ...
      removeRenderer: function removeRenderer(name) {
        if (!this.__renderer__P_221_0[name]) {
          throw new Error("No existing renderer named " + name);
        }

        delete this.__renderer__P_221_0[name];
      },
      ...
      render: function render() {
        ...
        if (this.__bRendering__P_221_3) {
          return;
        }

        this.__bRendering__P_221_3 = true;
        var state = new qx.ui.progressive.State({
          progressive: this,
          model: this.getDataModel(),
          pane: this.__structure__P_221_1.getPane(),
          batchSize: this.getBatchSize(),
          rendererData: this.__createStateRendererData__P_221_6(),
          userData: {}
        }); // Record render start time

        this.__t1__P_221_5 = new Date(); // Render the first batch of elements.  Subsequent batches will be via
        // timer started from this.__renderElementBatch().

        if (this.__bInitialRenderComplete__P_221_2) {
          // Get the starting number of elements
          this.__initialNumElements__P_221_4 = state.getModel().getElementCount(); // Let listeners know we're beginning to render

          this.fireDataEvent("renderStart", {
            state: state,
            initial: this.__initialNumElements__P_221_4
          }); // Begin rendering

          this.__renderElementBatch__P_221_7(state);
        } else {
          ...
          qx.event.Timer.once(function () {
            this.__initialNumElements__P_221_4 = state.getModel().getElementCount();
            this.fireDataEvent("renderStart", {
              state: state,
              initial: this.__initialNumElements__P_221_4
            });
            ...
            this.__bInitialRenderComplete__P_221_2 = true;
          }, this, 10);
        }
      },
      ...
      _applyDataModel: function _applyDataModel(value, old) {
        if (old) {
          ...
          old.removeListener("dataAvailable", this.__dataAvailable__P_221_8, this); // Dispose the old model

          old.dispose();
        } // Add an event listener so we know when data is available in the model


        value.addListener("dataAvailable", this.__dataAvailable__P_221_8, this);
      },
       ...
       *
       */
      __renderElementBatch__P_221_7: function __renderElementBatch__P_221_7(state) {
        var current;
        var element;
        var renderer;
        ...
        for (var i = state.getBatchSize(); i > 0; i--) {
          ...
          if (!current) {
            ...
            this.debug("Render time: " + (new Date() - this.__t1__P_221_5) + "ms");
            this.__bRendering__P_221_3 = false; // Notify any progress handlers that are listening
          ...
          renderer = this.__renderer__P_221_0[element.renderer]; // Render this element
       ...
       */
      __createStateRendererData__P_221_6: function __createStateRendererData__P_221_6() {
        var rendererData = {};

        for (var name in this.__renderer__P_221_0) {
          rendererData[name] = {};
        }
       ...
       *
       */
      __dataAvailable__P_221_8: function __dataAvailable__P_221_8(e) {
        this.__initialNumElements__P_221_4 = e.getData();
        this.render();
      }
    },
    ...
    destruct: function destruct() {
      ...
      for (var name in this.__renderer__P_221_0) {
        // ... dispose it
        this.__renderer__P_221_0[name].dispose();
      } // Clean up references


      this.__t1__P_221_5 = this.__renderer__P_221_0 = this.__structure__P_221_1 = null;
    }
  });
  qx.ui.progressive.Progressive.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Progressive.js.map?dt=1598051405649