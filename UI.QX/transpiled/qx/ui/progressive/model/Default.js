  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.model.Default", {
    ...
    construct: function construct() {
      ...
      this.__elements__P_279_0 = [];
    },
    members: {
      __elements__P_279_0: null,
      ...
      addElements: function addElements(elems) {
        ...
        this.__elements__P_279_0 = this.__elements__P_279_0.concat(elems); // Tell Progressive that data is available

        this.fireDataEvent("dataAvailable", this.__elements__P_279_0.length);
      },
      ...
      addElement: function addElement(elem) {
        // Add the new elements to our elements queue.
        this.__elements__P_279_0.push(elem); // Tell Progressive that data is available
      ...
      getElementCount: function getElementCount() {
        return this.__elements__P_279_0.length;
      },
      // overridden
      getNextElement: function getNextElement() {
        // Do we have any remaining elements?
        if (this.__elements__P_279_0.length > 0) {
          // Yup.  Give 'em the first one and remove it from our queue.
          return {
            element: this.__elements__P_279_0.shift(),
            remaining: this.__elements__P_279_0.length
          };
        }
    ...
    destruct: function destruct() {
      this.__elements__P_279_0 = null;
    }
  });
  qx.ui.progressive.model.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1598051415854