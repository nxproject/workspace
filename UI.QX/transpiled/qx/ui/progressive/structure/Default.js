  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Default", {
    ...
    construct: function construct(header, footer, pane) {
      ...
      if (!header) {
        this.__nullHeader__P_281_0 = new qx.ui.progressive.headfoot.Null();
        this.__header__P_281_1 = this.__nullHeader__P_281_0;
      } else {
        this.__nullHeader__P_281_0 = null;
        this.__header__P_281_1 = header;
      } // If no footer was specified, use a null footer


      if (!footer) {
        this.__nullFooter__P_281_2 = new qx.ui.progressive.headfoot.Null();
        this.__footer__P_281_3 = this.__nullFooter__P_281_2;
      } else {
        this.__nullFooter__P_281_2 = null;
        this.__footer__P_281_3 = footer;
      }
    },
    members: {
      __header__P_281_1: null,
      __footer__P_281_3: null,
      __nullHeader__P_281_0: null,
      __nullFooter__P_281_2: null,
      // overridden
      applyStructure: function applyStructure(progressive) {
        // Tell the header/footer components who their Progressive is
        this.__header__P_281_1.join(progressive);

        this.__footer__P_281_3.join(progressive); // Add the header, pane, and footer to the Progressive.


        progressive.add(this.__header__P_281_1);
        progressive.add(this.getPane(), {
          flex: 1
        });
        progressive.add(this.__footer__P_281_3);
      },
      ...
      getFooter: function getFooter() {
        return this.__footer__P_281_3;
      }
    },
    destruct: function destruct() {
      if (this.__nullHeader__P_281_0) {
        this.__nullHeader__P_281_0.dispose();

        this.__nullHeader__P_281_0 = null;
      }

      if (this.__nullFooter__P_281_2) {
        this.__nullFooter__P_281_2.dispose();

        this.__nullFooter__P_281_2 = null;
      }

      this.__header__P_281_1 = this.__footer__P_281_3 = null;
    }
  });
  qx.ui.progressive.structure.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1598051415990