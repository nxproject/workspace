  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.structure.Abstract", {
    ...
    construct: function construct(pane) {
      ...
      if (!pane) {
        this.__container__P_280_0 = new qx.ui.core.Widget();
        this.__pane__P_280_1 = this.__container__P_280_0;
      } else {
        this.__container__P_280_0 = null;
        this.__pane__P_280_1 = pane;
      }

      this.__pane__P_280_1.getContentElement().setStyle("overflowY", "auto");
    },
    members: {
      __container__P_280_0: null,
      __pane__P_280_1: null,
      ...
      getPane: function getPane() {
        return this.__pane__P_280_1;
      }
    },
    destruct: function destruct() {
      if (this.__container__P_280_0) {
        this.__container__P_280_0.dispose();
      }

      this.__container__P_280_0 = this.__pane__P_280_1 = null;
    }
  });
  qx.ui.progressive.structure.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1598051415950