  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.renderer.table.Widths", {
    ...
    construct: function construct(numColumns) {
      ...
      this.__columnData__P_327_0 = [];

      for (var i = 0; i < numColumns; i++) {
        this.__columnData__P_327_0[i] = new qx.ui.core.ColumnData();
      }
    },
    members: {
      __columnData__P_327_0: null,
      ...
      getData: function getData() {
        return this.__columnData__P_327_0;
      },
      ...
      setWidth: function setWidth(column, width) {
        if (column > this.__columnData__P_327_0.length - 1 || column < 0) {
          throw new Error("Column number out of range");
        }

        this.__columnData__P_327_0[column].setColumnWidth(width);
      },
      ...
      setMinWidth: function setMinWidth(column, width) {
        ...
        this.__columnData__P_327_0[column].setMinWidth(width);
      },
      ...
      setMaxWidth: function setMaxWidth(column, width) {
        ...
        this.__columnData__P_327_0[column].setMaxWidth(width);
      }
    }
  });
...
//# sourceMappingURL=Widths.js.map?dt=1598051422852