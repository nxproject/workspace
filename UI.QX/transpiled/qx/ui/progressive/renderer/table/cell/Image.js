  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.renderer.table.cell.Image", {
    ...
    construct: function construct(width, height) {
      ...
      if (width === undefined) {
        this.__imageWidth__P_333_0 = width;
      } else {
        this.__imageWidth__P_333_0 = 16;
      }

      if (height === undefined) {
        this.__imageHeight__P_333_1 = height;
      } else {
        this.__imageHeight__P_333_1 = 16;
      }
    },
    members: {
      __imageWidth__P_333_0: null,
      __imageHeight__P_333_1: null,
      // overridden
      _identifyImage: function _identifyImage(cellInfo) {
        var imageData = {
          imageWidth: this.__imageWidth__P_333_0,
          imageHeight: this.__imageHeight__P_333_1
        };
...
//# sourceMappingURL=Image.js.map?dt=1598051423371