  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.headfoot.TableHeading", {
    ...
    construct: function construct(columnWidths, labelArr) {
      ...
      this.__columnWidths__P_278_0 = columnWidths; // Get the array of column width data

      var columnData = columnWidths.getData(); // Create a place to put labels

      this.__labels__P_278_1 = []; // For each label...
      ...
      for (var i = 0; i < columnData.length; i++) {
        ...
        this.__labels__P_278_1[i] = label;
      ...
      this.__layout__P_278_2 = new qx.ui.layout.HBox();

      this.__layout__P_278_2.connectToWidget(this);
    },
    properties: {
      appearance: {
        refine: true,
    ...
    members: {
      __columnWidths__P_278_0: null,
      __bCalculateWidths__P_278_3: null,
      __labels__P_278_1: null,
      __layout__P_278_2: null,
      // overridden
      ...
      getLayoutChildren: function getLayoutChildren() {
        if (this.__bCalculateWidths__P_278_3) {
          return this.__columnWidths__P_278_0.getData();
        } else {
      ...
      _resizeColumns: function _resizeColumns(e) {
        ...
        this.__bCalculateWidths__P_278_3 = true;
        var padding = {
        ...
        this.__layout__P_278_2.renderLayout(width, 100, padding);

        this.__bCalculateWidths__P_278_3 = false; // Get the column data

        var columnData = this.__columnWidths__P_278_0.getData(); // Get the column width data.  For each label...


        for (var i = 0; i < columnData.length; i++) {
          // ... reset the width of the corresponding column (label)
          this.__labels__P_278_1[i].setWidth(columnData[i].getComputedWidth());
        }
      }
    },
    destruct: function destruct() {
      this.__columnWidths__P_278_0 = this.__labels__P_278_1 = null;
...
//# sourceMappingURL=TableHeading.js.map?dt=1598051415777