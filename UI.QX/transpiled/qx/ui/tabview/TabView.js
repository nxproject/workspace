  ...
  qx.Class.define("qx.ui.tabview.TabView", {
    ...
    */
    ...
    construct: function construct(barPosition) {
      ...
      this.__barPositionToState__P_227_0 = {
        top: "barTop",
        right: "barRight",
        bottom: "barBottom",
        left: "barLeft"
      ...
      var mgr = this.__radioGroup__P_227_1 = this._createRadioGroupInstance();
    ...
    members: {
      ...
      */
      ...
      add: function add(page) {
        ...
        this.__radioGroup__P_227_1.add(button); // Add state to page


        page.addState(this.__barPositionToState__P_227_0[this.getBarPosition()]); // Update states
      ...
      remove: function remove(page) {
        ...
        this.__radioGroup__P_227_1.remove(button); // Remove state from page


        page.removeState(this.__barPositionToState__P_227_0[this.getBarPosition()]); // Update states
      ...
      getRadioGroup: function getRadioGroup() {
        return this.__radioGroup__P_227_1;
      },
      ...
      */
      ...
      __barPositionToState__P_227_0: null,
      ...
      _applyBarPosition: function _applyBarPosition(value, old) {
        ...
        if (old) {
          var oldState = this.__barPositionToState__P_227_0[old]; // Update bar
        ...
        if (value) {
          var newState = this.__barPositionToState__P_227_0[value]; // Update bar
      ...
      */
      ...
      getSelection: function getSelection() {
        var buttons = this.__radioGroup__P_227_1.getSelection();
      ...
      setSelection: function setSelection(items) {
        ...
        this.__radioGroup__P_227_1.setSelection(buttons);
      },
      ...
      resetSelection: function resetSelection() {
        this.__radioGroup__P_227_1.resetSelection();
      },
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__radioGroup__P_227_1.isSelected(button);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__radioGroup__P_227_1.isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        var buttons = this.__radioGroup__P_227_1.getSelectables(all);
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__radioGroup__P_227_1");

      this.__barPositionToState__P_227_0 = null;
    }
  });
  qx.ui.tabview.TabView.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=TabView.js.map?dt=1598051407285