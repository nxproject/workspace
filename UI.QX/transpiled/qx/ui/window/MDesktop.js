(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.window.MDesktop", {
    ...
    */
    members: {
      __windows__P_22_0: null,
      __manager__P_22_1: null,
      ...
      setWindowManager: function setWindowManager(manager) {
        if (this.__manager__P_22_1) {
          this.__manager__P_22_1.setDesktop(null);
        }

        manager.setDesktop(this);
        this.__manager__P_22_1 = manager;
      },
      ...
      getWindows: function getWindows() {
        if (!this.__windows__P_22_0) {
          this.__windows__P_22_0 = [];
        }

        return this.__windows__P_22_0;
      }
    },
    ...
    */
    destruct: function destruct() {
      this._disposeArray("__windows__P_22_0");

      this._disposeObjects("__manager__P_22_1");
    }
  });
  qx.ui.window.MDesktop.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MDesktop.js.map?dt=1598045163492