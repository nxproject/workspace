    ...
    */
    members: {
      ...
      */
      ...
      setLayoutParent: function setLayoutParent(parent) {
        ...
        if (oldParent && this.__centeringResizeId__P_24_3) {
          oldParent.removeListenerById(this.__centeringResizeId__P_24_3);
          this.__centeringResizeId__P_24_3 = null;
        } // Call the superclass
        ...
        if (parent && this.getCenterOnContainerResize()) {
          this.__centeringResizeId__P_24_3 = parent.addListener("resize", this.center, this);
        }
      },
      // overridden
      ...
      */
      ...
      maximize: function maximize() {
        ...
        if (parent != null && parent.supportsMaximize()) {
          if (this.fireNonBubblingEvent("beforeMaximize", qx.event.type.Event, [false, true])) {
            ...
            this.__restoredLeft__P_24_1 = props.left === undefined ? 0 : props.left;
            this.__restoredTop__P_24_0 = props.top === undefined ? 0 : props.top; // Update layout properties
      ...
      minimize: function minimize() {
        ...
        if (this.fireNonBubblingEvent("beforeMinimize", qx.event.type.Event, [false, true])) {
          ...
          var props = this.getLayoutProperties();
          this.__restoredLeft__P_24_1 = props.left === undefined ? 0 : props.left;
          this.__restoredTop__P_24_0 = props.top === undefined ? 0 : props.top;
      ...
      restore: function restore() {
        ...
        if (this.fireNonBubblingEvent("beforeRestore", qx.event.type.Event, [false, true])) {
          ...
          var left = this.__restoredLeft__P_24_1;
          var top = this.__restoredTop__P_24_0;
          this.setLayoutProperties({
            edge: null,
            left: left,
            top: top
      ...
      */
      ...
      _applyCenterOnAppear: function _applyCenterOnAppear(value, old) {
        ...
        if (this.__centeringAppearId__P_24_2 !== null) {
          this.removeListenerById(this.__centeringAppearId__P_24_2);
          this.__centeringAppearId__P_24_2 = null;
        } // If we are to center on appear, arrange to do so


        if (value) {
          this.__centeringAppearId__P_24_2 = this.addListener("appear", this.center, this);
        }
      },
      _applyCenterOnContainerResize: function _applyCenterOnContainerResize(value, old) {
        ...
        if (this.__centeringResizeId__P_24_3 !== null) {
          parent.removeListenerById(this.__centeringResizeId__P_24_3);
          this.__centeringResizeId__P_24_3 = null;
    ...
    destruct: function destruct() {
      ...
      if (parent) {
        ...
        id = this.__centeringResizeId__P_24_3;
...
//# sourceMappingURL=Window.js.map?dt=1598045163742