(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.window.Manager", {
    ...
    */
    members: {
      __desktop__P_82_0: null,
      // interface implementation
      setDesktop: function setDesktop(desktop) {
        this.__desktop__P_82_0 = desktop;
      ...
      syncWidget: function syncWidget() {
        this.__desktop__P_82_0.forceUnblock();

        var windows = this.__desktop__P_82_0.getWindows(); // z-index for all three window kinds
        ...
        for (var i = 0, l = windows.length; i < l; i++) {
          ...
          if (win.isModal()) {
            ...
            this.__desktop__P_82_0.blockContent(zIndexModal - 1);
        ...
        this.__desktop__P_82_0.setActiveWindow(active);
      },
      // interface implementation
      bringToFront: function bringToFront(win) {
        var windows = this.__desktop__P_82_0.getWindows();
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__desktop__P_82_0");
    }
  });
  qx.ui.window.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1598045171841