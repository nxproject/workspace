  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__objects__P_151_0 = []; // Register pointerdown handler

      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__onPointerDown__P_151_1, this, true); // Hide all popups on window blur
    ...
    */
    members: {
      ...
      add: function add(obj) {
        ...
        this.__objects__P_151_0.push(obj);

        this.__updateIndexes__P_151_2();
      },
      ...
      remove: function remove(obj) {
        ...
        qx.lang.Array.remove(this.__objects__P_151_0, obj);
      ...
      hideAll: function hideAll() {
        var l = this.__objects__P_151_0.length,
            current = {};

        while (l--) {
          current = this.__objects__P_151_0[l];
      ...
      */
       ...
       *
       */
      __updateIndexes__P_151_2: function __updateIndexes__P_151_2() {
        var min = 1e7;

        for (var i = 0; i < this.__objects__P_151_0.length; i++) {
          this.__objects__P_151_0[i].setZIndex(min++);
        }
      },
      ...
      */
       ...
       */
      __onPointerDown__P_151_1: function __onPointerDown__P_151_1(e) {
        ...
        var reg = this.__objects__P_151_0;
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__onPointerDown__P_151_1, this, true);

      this._disposeArray("__objects__P_151_0");
    }
  });
  qx.ui.popup.Manager.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Manager.js.map?dt=1598045179089