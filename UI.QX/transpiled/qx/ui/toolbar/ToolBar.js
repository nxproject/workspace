  ...
  qx.Class.define("qx.ui.toolbar.ToolBar", {
    ...
    */
    construct: function construct() {
      ...
      this.__removedItems__P_163_0 = [];
      this.__removePriority__P_163_1 = [];
    },
    ...
    */
    members: {
      ...
      ---------------------------------------------------------------------------
      */
      __removedItems__P_163_0: null,
      __removePriority__P_163_1: null,
      // overridden
      ...
      _recalculateOverflow: function _recalculateOverflow(width, requiredWidth) {
        ...
        if (width < requiredWidth) {
          do {
            ...
            this.__hideChild__P_163_2(childToHide); // new width is the requiredWidth - the removed childs width
        ...
        } else if (this.__removedItems__P_163_0.length > 0) {
          do {
            var removedChild = this.__removedItems__P_163_0[0]; // if we have something we can show
            ...
            if (removedChild) {
              ...
              if (this.__removedItems__P_163_0.length == 1 && overflowWidgetWidth > 0) {
              ...
              if (width > requiredWidth + removedChildWidth + margins || fits) {
                this.__showChild__P_163_3(removedChild);

                requiredWidth += removedChildWidth; // check if we need to remove the overflow widget

                if (overflowWidget && this.__removedItems__P_163_0.length == 0) {
          ...
          } while (width >= requiredWidth && this.__removedItems__P_163_0.length > 0);
        }
      },
       ...
       */
      __showChild__P_163_3: function __showChild__P_163_3(child) {
        child.setVisibility("visible");

        this.__removedItems__P_163_0.shift();
       ...
       */
      __hideChild__P_163_2: function __hideChild__P_163_2(child) {
        // ignore the call if no child is given
        if (!child) {
          return;
        }

        this.__removedItems__P_163_0.unshift(child);
      ...
      _getNextToHide: function _getNextToHide() {
        ...
        for (var i = this.__removePriority__P_163_1.length - 1; i >= 0; i--) {
          var item = this.__removePriority__P_163_1[i]; // maybe a priority is left out and spacers don't have the visibility
      ...
      setRemovePriority: function setRemovePriority(item, priority, override) {
        ...
        if (!override && this.__removePriority__P_163_1[priority] != undefined) {
          throw new Error("Priority already in use!");
        }

        this.__removePriority__P_163_1[priority] = item;
      },
      // property apply
      _applyOverflowHandling: function _applyOverflowHandling(value, old) {
        ...
        if (value) {
          ...
          for (var i = 0; i < this.__removedItems__P_163_0.length; i++) {
            this.__removedItems__P_163_0[i].setVisibility("visible");
          }
      ...
      ---------------------------------------------------------------------------
      */
      __allowMenuOpenHover__P_163_4: false,
      ...
      _setAllowMenuOpenHover: function _setAllowMenuOpenHover(value) {
        this.__allowMenuOpenHover__P_163_4 = value;
      },
      ...
      _isAllowMenuOpenHover: function _isAllowMenuOpenHover() {
        return this.__allowMenuOpenHover__P_163_4;
      },
...
//# sourceMappingURL=ToolBar.js.map?dt=1598045325576