  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define('qx.ui.website.DatePicker', {
    ...
    statics: {
      ...
      __validPositions__P_235_0: null,
    ...
    members: {
      ...
      init: function init(date) {
        ...
        this.__setReadOnly__P_235_1(this);

        this.__setIcon__P_235_2(this);

        this.__addInputListener__P_235_3(this);
      ...
      setConfig: function setConfig(name, config) {
        if (name === 'position') {
          var validPositions = qx.ui.website.DatePicker.__validPositions__P_235_0;
       ...
       */
      __setReadOnly__P_235_1: function __setReadOnly__P_235_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __setIcon__P_235_2: function __setIcon__P_235_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __addInputListener__P_235_3: function __addInputListener__P_235_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__validPositions__P_235_0 = ['top-left', 'top-center', 'top-right', 'bottom-left', 'bottom-center', 'bottom-right', 'left-top', 'left-middle', 'left-bottom', 'right-top', 'right-middle', 'right-bottom'];
    }
  });
  qx.ui.website.DatePicker.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=DatePicker.js.map?dt=1598051409336