(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.ui.website.Tabs", {
    ...
    members: {
      __mediaQueryListener__P_238_0: null,
      init: function init() {
        ...
        buttons._forEachElementWrapped(function (button) {
          ...
          if (page.length > 0) {
            ...
            if (orientation == "vertical") {
              this.__deactivateTransition__P_238_1(page);
          ...
          this.__activateTransition__P_238_2(page);
        }.bind(this));
        ...
        if (active.length > 0) {
          ...
          this.__deactivateTransition__P_238_1(activePage);

          this._showPage(active, null);

          this.__activateTransition__P_238_2(activePage);
        }
      ...
      _initMediaQueryListener: function _initMediaQueryListener(mediaQuery) {
        var mql = this.__mediaQueryListener__P_238_0;

        if (!mql) {
          mql = q.matchMedia(mediaQuery);
          this.__mediaQueryListener__P_238_0 = mql;
       ...
       */
      __deactivateTransition__P_238_1: function __deactivateTransition__P_238_1(elem) {
        ...
        if (transition.transitionProperty.indexOf("none") == -1) {
          elem.setProperty("__qxtransition__P_238_3", transition);
       ...
       * @param elem {qxWeb} Element
       */
      __activateTransition__P_238_2: function __activateTransition__P_238_2(elem) {
        var transition = elem.getProperty("__qxtransition__P_238_3");
        var style = elem.getStyle("transitionProperty");

        if (transition && style.indexOf("none") != -1) {
          elem.setStyles(transition);
          elem.setProperty("__qxtransition__P_238_3", "");
        }
      },
      dispose: function dispose() {
        this.__mediaQueryListener__P_238_0 = undefined;
...
//# sourceMappingURL=Tabs.js.map?dt=1598051410015