    ...
    members: {
      ...
      setValue: function setValue(value) {
        ...
        if (qxWeb.type.get(step) != "Array" || step.indexOf(value) != -1) {
          this.__valueToPosition__P_236_1(value);
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        if (this.__dragMode__P_236_0) {
          return;
        }

        this.__dragMode__P_236_0 = true;
      ...
      _onDocPointerUp: function _onDocPointerUp(e) {
        if (this.__dragMode__P_236_0 === true) {
          // Cleanup status flags
          delete this.__dragMode__P_236_0;

          this.__valueToPosition__P_236_1(this.getValue());
      ...
      */
      ...
      _onWindowResize: function _onWindowResize() {
        ...
        this.__valueToPosition__P_236_1(this._value);
      },
       ...
       */
      __valueToPosition__P_236_1: function __valueToPosition__P_236_1(value) {
        var pixels = this._getPixels();
...
//# sourceMappingURL=Slider.js.map?dt=1598051409579