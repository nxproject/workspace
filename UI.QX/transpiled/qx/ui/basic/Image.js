  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    */
    ...
    construct: function construct(source) {
      this.__contentElements__P_58_0 = {};
    ...
    */
    members: {
      __width__P_58_1: null,
      __height__P_58_2: null,
      __mode__P_58_3: null,
      __contentElements__P_58_0: null,
      __currentContentElement__P_58_4: null,
      __wrapper__P_58_5: null,
      __requestId__P_58_6: 0,
      // overridden
      ...
      */
      ...
      getContentElement: function getContentElement() {
        return this.__getSuitableContentElement__P_58_7();
      },
      // overridden
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__width__P_58_1 || 0,
          height: this.__height__P_58_2 || 0
        };
      },
      // overridden
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        if (this.__wrapper__P_58_5) {
          el = el.getChild(0);
        }

        this.__setSource__P_58_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__getMode__P_58_9() === "font") {
          var el = this.getContentElement();
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        ...
        } else if (this.__getMode__P_58_9() === 'font') {
          element.setStyles({
            top: this.getPaddingTop() || 0,
            left: this.getPaddingLeft() || 0
          });
      ...
      */
       ...
       */
      __setMode__P_58_10: function __setMode__P_58_10(mode) {
        this.__mode__P_58_3 = mode;
      },
       ...
       */
      __getMode__P_58_9: function __getMode__P_58_9() {
        if (this.__mode__P_58_3 == null) {
          var source = this.getSource();

          if (source && qx.lang.String.startsWith(source, "@")) {
            this.__mode__P_58_3 = "font";
          }
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__mode__P_58_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__mode__P_58_3 = "scaled";
          } else {
            this.__mode__P_58_3 = "nonScaled";
          }
        }

        return this.__mode__P_58_3;
      },
       ...
       */
      __createSuitableContentElement__P_58_11: function __createSuitableContentElement__P_58_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__wrapper__P_58_5 = new qx.html.Element("div");
            element.connectWidget(this);
       ...
       */
      __getSuitableContentElement__P_58_7: function __getSuitableContentElement__P_58_7() {
        if (this.$$disposed) {
          return null;
        }

        var mode = this.__getMode__P_58_9();

        if (this.__contentElements__P_58_0[mode] == null) {
          this.__contentElements__P_58_0[mode] = this.__createSuitableContentElement__P_58_11(mode);
        }

        var element = this.__contentElements__P_58_0[mode];

        if (!this.__currentContentElement__P_58_4) {
          this.__currentContentElement__P_58_4 = element;
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__resetSource__P_58_12(element);

          return;
        }

        this.__checkForContentElementSwitch__P_58_13(source);
        ...
        var contentEl = this.__getContentElement__P_58_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__setManagedImage__P_58_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__currentContentElement__P_58_4.setStyle("background-size", backgroundSize);
          ...
          this.__fireLoadEvent__P_58_16();
        } else if (qx.io.ImageLoader.isLoaded(source)) {
          this.__setUnmanagedImage__P_58_17(contentEl, source);

          this.__fireLoadEvent__P_58_16();
        } else {
          this.__loadUnmanagedImage__P_58_18(contentEl, source);
        }
      },
       ...
       */
      __fireLoadEvent__P_58_16: function __fireLoadEvent__P_58_16() {
        this.__requestId__P_58_6++;
        qx.bom.AnimationFrame.request(function (rId) {
          // prevent firing of the event if source changed in the meantime
          if (rId === this.__requestId__P_58_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__requestId__P_58_6));
      },
       ...
       */
      __getContentElement__P_58_14: function __getContentElement__P_58_14() {
        var contentEl = this.__currentContentElement__P_58_4;
       ...
       */
      __checkForContentElementSwitch__P_58_13: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(source) {
          ...
          if (isFont) {
            this.__setMode__P_58_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__getMode__P_58_9() != "alphaScaled") {
              this.__setMode__P_58_10("alphaScaled");
            } else if (!this.getScale() && this.__getMode__P_58_9() != "nonScaled") {
              this.__setMode__P_58_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__getMode__P_58_9() != "scaled") {
              this.__setMode__P_58_10("scaled");
            } else if (!this.getScale() && this.__getMode__P_58_9() != "nonScaled") {
              this.__setMode__P_58_10("nonScaled");
            }
          }

          this.__checkForContentElementReplacement__P_58_19(this.__getSuitableContentElement__P_58_7());
        },
        "default": function _default(source) {
          ...
          if (isFont) {
            this.__setMode__P_58_10("font");
          } else if (this.getScale() && this.__getMode__P_58_9() != "scaled") {
            this.__setMode__P_58_10("scaled");
          } else if (!this.getScale() && this.__getMode__P_58_9() != "nonScaled") {
            this.__setMode__P_58_10("nonScaled");
          }
       ...
       */
      __checkForContentElementReplacement__P_58_19: function __checkForContentElementReplacement__P_58_19(elementToAdd) {
        var currentContentElement = this.__currentContentElement__P_58_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__wrapper__P_58_5 ? elementToAdd.getChild(0) : elementToAdd;
            ...
            var currentEl = this.__getContentElement__P_58_14();
            ...
            this.__currentContentElement__P_58_4 = elementToAdd;
          }
        }
      },
       ...
       */
      __setManagedImage__P_58_15: function __setManagedImage__P_58_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          this.__updateContentHint__P_58_20(width, height);

          this.__setSource__P_58_8(el, source); // Apply source

        } else {
          // Apply source
          this.__setSource__P_58_8(el, source); // Compare with old sizes and relayout if necessary


          this.__updateContentHint__P_58_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
       ...
       * @param source {String} source path
       */
      __setUnmanagedImage__P_58_17: function __setUnmanagedImage__P_58_17(el, source) {
       ...
       * @param source {String} source path
       */
      __loadUnmanagedImage__P_58_18: function __loadUnmanagedImage__P_58_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        {
          ...
          if (!sourceLC.startsWith("http") && !sourceLC.startsWith("data:image/")) {
            ...
            if (!self.__warned__P_58_21) {
              self.__warned__P_58_21 = {};
            }

            if (!self.__warned__P_58_21[source]) {
              this.debug("try to load an unmanaged relative image: " + source);
              self.__warned__P_58_21[source] = true;
            }
          }
        } // only try to load the image if it not already failed

        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__loaderCallback__P_58_22, this);
        } else {
          this.__resetSource__P_58_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __resetSource__P_58_12: function __resetSource__P_58_12(el) {
        if (el != null) {
       ...
       * @param source {String} source path
       */
      __setSource__P_58_8: function __setSource__P_58_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__width__P_58_1 > this.__height__P_58_2 ? this.__height__P_58_2 : this.__width__P_58_1) + "px");
          } else {
       ...
       */
      __loaderCallback__P_58_22: function __loaderCallback__P_58_22(source, imageInfo) {
        ...
        this.__setUnmanagedImage__P_58_17(this.__getContentElement__P_58_14(), source);
      },
       ...
       */
      __updateContentHint__P_58_20: function __updateContentHint__P_58_20(width, height) {
        // Compare with old sizes and relayout if necessary
        if (width !== this.__width__P_58_1 || height !== this.__height__P_58_2) {
          this.__width__P_58_1 = width;
          this.__height__P_58_2 = height;
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__contentElements__P_58_0) {
        if (this.__contentElements__P_58_0.hasOwnProperty(mode)) {
          this.__contentElements__P_58_0[mode].disconnectWidget(this);
        }
      }

      delete this.__currentContentElement__P_58_4;

      if (this.__wrapper__P_58_5) {
        delete this.__wrapper__P_58_5;
      }

      this._disposeMap("__contentElements__P_58_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1598045169607