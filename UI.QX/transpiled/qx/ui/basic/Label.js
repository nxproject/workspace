  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    members: {
      __font__P_57_0: null,
      __invalidContentSize__P_57_1: null,
      __tapListenerId__P_57_2: null,
      __webfontListenerId__P_57_3: null,
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        if (this.__invalidContentSize__P_57_1) {
          this.__contentSize__P_57_4 = this.__computeContentSize__P_57_5();
          delete this.__invalidContentSize__P_57_1;
        }

        return {
          width: this.__contentSize__P_57_4.width,
          height: this.__contentSize__P_57_4.height
        };
      },
      // overridden
      ...
      _getContentHeightForWidth: function _getContentHeightForWidth(width) {
        ...
        return this.__computeContentSize__P_57_5(width).height;
      },
      // overridden
      ...
      */
       ...
       */
      __contentSize__P_57_4: {
        width: 0,
        height: 0
      },
      // property apply
      _applyFont: function _applyFont(value, old) {
        if (old && this.__font__P_57_0 && this.__webfontListenerId__P_57_3) {
          this.__font__P_57_0.removeListenerById(this.__webfontListenerId__P_57_3);

          this.__webfontListenerId__P_57_3 = null;
        } // Apply
        ...
        if (value) {
          this.__font__P_57_0 = qx.theme.manager.Font.getInstance().resolve(value);

          if (this.__font__P_57_0 instanceof qx.bom.webfonts.WebFont) {
            this.__webfontListenerId__P_57_3 = this.__font__P_57_0.addListener("changeStatus", this._onWebFontStatusChange, this);
          }

          styles = this.__font__P_57_0.getStyles();
        } else {
          this.__font__P_57_0 = null;
        ...
        this.__invalidContentSize__P_57_1 = true; // Update layout
       ...
       */
      __computeContentSize__P_57_5: function __computeContentSize__P_57_5(width) {
        var Label = qx.bom.Label;
        var font = this.getFont();
        var styles = font ? this.__font__P_57_0.getStyles() : qx.bom.Font.getDefaultStyles();
        var content = this.getValue() || "A";
        var rich = this.getRich();

        if (this.__webfontListenerId__P_57_3) {
          this.__fixEllipsis__P_57_6();
        }
      ...
      */
      __fixEllipsis__P_57_6: function __fixEllipsis__P_57_6() {
      ...
      */
      ...
      _applyBuddy: function _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__tapListenerId__P_57_2);
          this.__tapListenerId__P_57_2 = null;
        }

        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__tapListenerId__P_57_2 = this.addListener("tap", function () {
        ...
        if (ev.getData().valid === true) {
          ...
          if (qx.core.Environment.get("browser.name") == "safari" && parseFloat(qx.core.Environment.get("browser.version")) >= 8) {
            window.setTimeout(function () {
              this.__invalidContentSize__P_57_1 = true;
              qx.ui.core.queue.Layout.add(this);
            }.bind(this), 0);
          }
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__font__P_57_0 && this.__webfontListenerId__P_57_3) {
        this.__font__P_57_0.removeListenerById(this.__webfontListenerId__P_57_3);
      }
...
//# sourceMappingURL=Label.js.map?dt=1598045169415