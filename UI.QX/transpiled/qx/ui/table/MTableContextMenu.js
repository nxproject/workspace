  ...
  qx.Mixin.define("qx.ui.table.MTableContextMenu", {
    construct: function construct() {
      ...
      this.addListener("cellContextmenu", function (e) {
        ...
        var handlerContext = this.__contextMenuHandlerContext__P_225_0[col]; // Get the data model
      ...
      this.__contextMenuHandler__P_225_1 = [];
      this.__contextMenuHandlerContext__P_225_0 = [];
    },
    members: {
      __contextMenuHandler__P_225_1: null,
      __contextMenuHandlerContext__P_225_0: null,
      ...
      setContextMenuHandler: function setContextMenuHandler(col, handler, context) {
        this.__contextMenuHandler__P_225_1[col] = handler;
        this.__contextMenuHandlerContext__P_225_0[col] = context || this;
      },
      ...
      getContextMenuHandler: function getContextMenuHandler(col) {
        return this.__contextMenuHandler__P_225_1[col];
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__contextMenuHandler__P_225_1 = null;
      this.__contextMenuHandlerContext__P_225_0 = null;
    }
  });
  qx.ui.table.MTableContextMenu.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MTableContextMenu.js.map?dt=1598051406606