  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.columnmodel.Basic", {
    ...
    construct: function construct() {
      ...
      this.__overallColumnArr__P_289_0 = [];
      this.__visibleColumnArr__P_289_1 = [];
    },
    ...
    */
    members: {
      __internalChange__P_289_2: null,
      __colToXPosMap__P_289_3: null,
      __visibleColumnArr__P_289_1: null,
      __overallColumnArr__P_289_0: null,
      __columnDataArr__P_289_4: null,
      __headerRenderer__P_289_5: null,
      __dataRenderer__P_289_6: null,
      __editorFactory__P_289_7: null,
      ...
      init: function init(colCount, table) {
        ...
        this.__columnDataArr__P_289_4 = [];
        var width = qx.ui.table.columnmodel.Basic.DEFAULT_WIDTH;
        var headerRenderer = this.__headerRenderer__P_289_5 || (this.__headerRenderer__P_289_5 = new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER());
        var dataRenderer = this.__dataRenderer__P_289_6 || (this.__dataRenderer__P_289_6 = new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER());
        var editorFactory = this.__editorFactory__P_289_7 || (this.__editorFactory__P_289_7 = new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY());
        this.__overallColumnArr__P_289_0 = [];
        this.__visibleColumnArr__P_289_1 = []; // Get the initially hidden column array, if one was provided. Older
        ...
        for (var col = 0; col < colCount; col++) {
          this.__columnDataArr__P_289_4[col] = {
            width: width,
            headerRenderer: headerRenderer,
            dataRenderer: dataRenderer,
            editorFactory: editorFactory
          };
          this.__overallColumnArr__P_289_0[col] = col;
          this.__visibleColumnArr__P_289_1[col] = col;
        }

        this.__colToXPosMap__P_289_3 = null; // If any columns are initially hidden, hide them now. Make it an
        // internal change so that events are not generated.

        this.__internalChange__P_289_2 = true;

        for (var hidden = 0; hidden < initiallyHiddenColumns.length; hidden++) {
          this.setColumnVisible(initiallyHiddenColumns[hidden], false);
        }

        this.__internalChange__P_289_2 = false;
      ...
      getVisibleColumns: function getVisibleColumns() {
        return this.__visibleColumnArr__P_289_1 != null ? this.__visibleColumnArr__P_289_1 : [];
      },
      ...
      setColumnWidth: function setColumnWidth(col, width, isPointerAction) {
        {
          ...
          this.assertNotUndefined(this.__columnDataArr__P_289_4[col], "Column not found in table model");
        }
        var oldWidth = this.__columnDataArr__P_289_4[col].width;

        if (oldWidth != width) {
          this.__columnDataArr__P_289_4[col].width = width;
          var data = {
            col: col,
            newWidth: width,
            oldWidth: oldWidth,
      ...
      getColumnWidth: function getColumnWidth(col) {
        ...
        return this.__columnDataArr__P_289_4[col].width;
      },
      ...
      setHeaderCellRenderer: function setHeaderCellRenderer(col, renderer) {
        ...
        var oldRenderer = this.__columnDataArr__P_289_4[col].headerRenderer;

        if (oldRenderer !== this.__headerRenderer__P_289_5) {
          oldRenderer.dispose();
        }

        this.__columnDataArr__P_289_4[col].headerRenderer = renderer;

        if (!this.__internalChange__P_289_2) {
      ...
      setHeaderCellRenderers: function setHeaderCellRenderers(renderers) {
        ...
        this.__internalChange__P_289_2 = true; // For each listed column...
        ...
        this.__internalChange__P_289_2 = false; // Now we can fire the event once. The data indicates which columns
      ...
      getHeaderCellRenderer: function getHeaderCellRenderer(col) {
        ...
        return this.__columnDataArr__P_289_4[col].headerRenderer;
      },
      ...
      setDataCellRenderer: function setDataCellRenderer(col, renderer) {
        ...
        var oldRenderer = this.__columnDataArr__P_289_4[col].dataRenderer;
        this.__columnDataArr__P_289_4[col].dataRenderer = renderer;

        if (oldRenderer !== this.__dataRenderer__P_289_6) {
          return oldRenderer;
        }
      ...
      getDataCellRenderer: function getDataCellRenderer(col) {
        ...
        return this.__columnDataArr__P_289_4[col].dataRenderer;
      },
      ...
      setCellEditorFactory: function setCellEditorFactory(col, factory) {
        ...
        var oldFactory = this.__columnDataArr__P_289_4[col].editorFactory;

        if (oldFactory === factory) {
          return;
        }

        if (oldFactory !== this.__editorFactory__P_289_7) {
          oldFactory.dispose();
        }

        this.__columnDataArr__P_289_4[col].editorFactory = factory;
      },
      ...
      getCellEditorFactory: function getCellEditorFactory(col) {
        ...
        return this.__columnDataArr__P_289_4[col].editorFactory;
      },
      ...
      _getColToXPosMap: function _getColToXPosMap() {
        if (this.__colToXPosMap__P_289_3 == null) {
          this.__colToXPosMap__P_289_3 = {};

          for (var overX = 0; overX < this.__overallColumnArr__P_289_0.length; overX++) {
            var col = this.__overallColumnArr__P_289_0[overX];
            this.__colToXPosMap__P_289_3[col] = {
              overX: overX
            };
          }

          for (var visX = 0; visX < this.__visibleColumnArr__P_289_1.length; visX++) {
            var col = this.__visibleColumnArr__P_289_1[visX];
            this.__colToXPosMap__P_289_3[col].visX = visX;
          }
        }

        return this.__colToXPosMap__P_289_3;
      },
      ...
      getVisibleColumnCount: function getVisibleColumnCount() {
        return this.__visibleColumnArr__P_289_1 != null ? this.__visibleColumnArr__P_289_1.length : 0;
      },
      ...
      getVisibleColumnAtX: function getVisibleColumnAtX(visXPos) {
        ...
        return this.__visibleColumnArr__P_289_1[visXPos];
      },
      ...
      getOverallColumnCount: function getOverallColumnCount() {
        return this.__overallColumnArr__P_289_0.length;
      },
      ...
      getOverallColumnAtX: function getOverallColumnAtX(overXPos) {
        ...
        return this.__overallColumnArr__P_289_0[overXPos];
      },
      ...
      setColumnVisible: function setColumnVisible(col, visible) {
        ...
        if (visible != this.isColumnVisible(col)) {
          if (visible) {
            ...
            for (var x = overX + 1; x < this.__overallColumnArr__P_289_0.length; x++) {
              var currCol = this.__overallColumnArr__P_289_0[x];
            ...
            if (nextVisX == null) {
              nextVisX = this.__visibleColumnArr__P_289_1.length;
            } // Add the column to the visible columns


            this.__visibleColumnArr__P_289_1.splice(nextVisX, 0, col);
          } else {
            var visX = this.getVisibleX(col);

            this.__visibleColumnArr__P_289_1.splice(visX, 1);
          } // Invalidate the __colToXPosMap


          this.__colToXPosMap__P_289_3 = null; // Inform the listeners
      ...
      moveColumn: function moveColumn(fromOverXPos, toOverXPos) {
        ...
        this.__internalChange__P_289_2 = true;
        var col = this.__overallColumnArr__P_289_0[fromOverXPos];
        ...
        this.__overallColumnArr__P_289_0.splice(fromOverXPos, 1);

        this.__overallColumnArr__P_289_0.splice(toOverXPos, 0, col); // Invalidate the __colToXPosMap


        this.__colToXPosMap__P_289_3 = null;

        if (visible) {
          this.setColumnVisible(col, true);
        }

        this.__internalChange__P_289_2 = false; // Inform the listeners
      ...
      setColumnsOrder: function setColumnsOrder(newPositions) {
        ...
        if (newPositions.length == this.__overallColumnArr__P_289_0.length) {
          this.__internalChange__P_289_2 = true; // Go through each column an switch visible ones to invisible. Reason is unknown,
          ...
          for (var colIdx = 0; colIdx < this.__overallColumnArr__P_289_0.length; colIdx++) {
          ...
          this.__overallColumnArr__P_289_0 = qx.lang.Array.clone(newPositions); // Invalidate the __colToXPosMap

          this.__colToXPosMap__P_289_3 = null; // Go through each column an switch invisible ones back to visible
          ...
          this.__internalChange__P_289_2 = false; // Inform the listeners. Do not add data as all known listeners in qooxdoo
          ...
          throw new Error("setColumnsOrder: Invalid number of column positions given, expected " + this.__overallColumnArr__P_289_0.length + ", got " + newPositions.length);
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      for (var i = 0; i < this.__columnDataArr__P_289_4.length; i++) {
        this.__columnDataArr__P_289_4[i].headerRenderer.dispose();

        this.__columnDataArr__P_289_4[i].dataRenderer.dispose();

        this.__columnDataArr__P_289_4[i].editorFactory.dispose();
      }

      this.__overallColumnArr__P_289_0 = this.__visibleColumnArr__P_289_1 = this.__columnDataArr__P_289_4 = this.__colToXPosMap__P_289_3 = null;

      this._disposeObjects("__headerRenderer__P_289_5", "__dataRenderer__P_289_6", "__editorFactory__P_289_7");
    }
  });
  qx.ui.table.columnmodel.Basic.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Basic.js.map?dt=1598051417301