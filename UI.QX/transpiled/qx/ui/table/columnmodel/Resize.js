  ...
  qx.Class.define("qx.ui.table.columnmodel.Resize", {
    ...
    */
    construct: function construct() {
      ...
      this.__bInProgress__P_290_0 = false; // Track when the table has appeared.  We want to ignore resize events
      // until then since we won't be able to determine the available width
      // anyway.

      this.__bAppeared__P_290_1 = false;
    },
    ...
    */
    members: {
      __bAppeared__P_290_1: null,
      __bInProgress__P_290_0: null,
      __table__P_290_2: null,
      // Behavior modifier
      ...
      init: function init(numColumns, table) {
        ...
        if (this.__table__P_290_2 == null) {
          this.__table__P_290_2 = table; // We'll do our column resizing when the table appears, ...
      ...
      _onappear: function _onappear(event) {
        ...
        if (this.__bInProgress__P_290_0) {
          // Yup.  Ignore it.
          return;
        }

        this.__bInProgress__P_290_0 = true;
        {
        ...
        this.__table__P_290_2._updateScrollerWidths();

        this.__table__P_290_2._updateScrollBarVisibility();

        this.__bInProgress__P_290_0 = false;
        this.__bAppeared__P_290_1 = true;
      },
      ...
      _onTableWidthChanged: function _onTableWidthChanged(event) {
        ...
        if (this.__bInProgress__P_290_0 || !this.__bAppeared__P_290_1) {
          // Yup.  Ignore it.
          return;
        }
      ...
      _onverticalscrollbarchanged: function _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__table__P_290_2 && !this.__table__P_290_2.isDisposed()) {
            this.__table__P_290_2._updateScrollerWidths();
    ...
    destruct: function destruct() {
      ...
      this.__table__P_290_2 = null;
    }
  });
  qx.ui.table.columnmodel.Resize.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Resize.js.map?dt=1598051417373