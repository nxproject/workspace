  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.columnmodel.resizebehavior.Default", {
    ...
    construct: function construct() {
      ...
      this.__resizeColumnData__P_328_0 = []; // This layout is not connected to a widget but to this class. This class
      ...
      this.__layout__P_328_1 = new qx.ui.layout.HBox();

      this.__layout__P_328_1.connectToWidget(this);

      this.__deferredComputeColumnsFlexWidth__P_328_2 = new qx.util.DeferredCall(this._computeColumnsFlexWidth, this);
    },
    ...
    */
    members: {
      __layout__P_328_1: null,
      __layoutChildren__P_328_3: null,
      __resizeColumnData__P_328_0: null,
      __deferredComputeColumnsFlexWidth__P_328_2: null,

      /**
       * Whether we have initialized widths on the first appear yet
       */
      __widthsInitialized__P_328_4: false,
      ...
      setWidth: function setWidth(col, width, flex) {
        ...
        if (col >= this.__resizeColumnData__P_328_0.length) {
          throw new Error("Column number out of range");
        } // Set the new width


        this.__resizeColumnData__P_328_0[col].setColumnWidth(width, flex);

        this.__deferredComputeColumnsFlexWidth__P_328_2.schedule();
      },
      ...
      setMinWidth: function setMinWidth(col, width) {
        ...
        this.__resizeColumnData__P_328_0[col].setMinWidth(width);
      ...
      setMaxWidth: function setMaxWidth(col, width) {
        ...
        this.__resizeColumnData__P_328_0[col].setMaxWidth(width);
      ...
      onAppear: function onAppear(event, forceRefresh) {
        ...
        if (forceRefresh === true || !this.__widthsInitialized__P_328_4 || this.getInitializeWidthsOnEveryAppear()) {
          // Calculate column widths
          this._computeColumnsFlexWidth(); // Track that we've initialized widths at least once


          this.__widthsInitialized__P_328_4 = true;
        }
      },
      // overloaded
      ...
      _setNumColumns: function _setNumColumns(numColumns) {
        var colData = this.__resizeColumnData__P_328_0; // Are there now fewer (or the same number of) columns than there were
        // previously?
      ...
      getLayoutChildren: function getLayoutChildren() {
        return this.__layoutChildren__P_328_3;
      },
      ...
      _computeColumnsFlexWidth: function _computeColumnsFlexWidth() {
        this.__deferredComputeColumnsFlexWidth__P_328_2.cancel();
        ...
        var colData = this.__resizeColumnData__P_328_0;
        var i, l;
        ...
        this.__layoutChildren__P_328_3 = columns;

        this.__clearLayoutCaches__P_328_5(); // Use a horizontal box layout to determine the available width.


        this.__layout__P_328_1.renderLayout(width, 100, {
          top: 0,
          right: 0,
          bottom: 0,
          left: 0
       ...
       */
      __clearLayoutCaches__P_328_5: function __clearLayoutCaches__P_328_5() {
        this.__layout__P_328_1.invalidateChildrenCache();

        var children = this.__layoutChildren__P_328_3;
      ...
      _getResizeColumnData: function _getResizeColumnData() {
        return this.__resizeColumnData__P_328_0;
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__resizeColumnData__P_328_0 = this.__layoutChildren__P_328_3 = null;

      this._disposeObjects("__layout__P_328_1", "__deferredComputeColumnsFlexWidth__P_328_2");
    }
  });
  qx.ui.table.columnmodel.resizebehavior.Default.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Default.js.map?dt=1598051422968