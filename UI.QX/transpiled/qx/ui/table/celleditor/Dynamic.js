(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.celleditor.Dynamic", {
    ...
    */
    members: {
      __cellEditorFactory__P_282_1: null,
      __infos__P_282_0: null,
      ...
      createCellEditor: function createCellEditor(cellInfo) {
        ...
        this.__cellEditorFactory__P_282_1 = cellEditorFactoryFunction(cellInfo);

        var cellEditor = this.__cellEditorFactory__P_282_1.createCellEditor(cellInfo); // save the cell info to the editor (needed for getting the value)


        this.__infos__P_282_0[cellEditor.toHashCode()] = cellInfo;
        return cellEditor;
      },
      ...
      getCellEditorValue: function getCellEditorValue(cellEditor) {
        ...
        var cellInfo = this.__infos__P_282_0[cellEditor.toHashCode()]; // update the propper factory


        this.__cellEditorFactory__P_282_1 = cellEditorFactoryFunction(cellInfo);

        var value = this.__cellEditorFactory__P_282_1.getCellEditorValue(cellEditor);
    ...
    */
    destruct: function destruct() {
      this.__cellEditorFactory__P_282_1 = null;
    }
  });
  qx.ui.table.celleditor.Dynamic.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Dynamic.js.map?dt=1598051416186