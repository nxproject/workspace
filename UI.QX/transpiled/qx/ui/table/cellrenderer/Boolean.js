  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    */
    construct: function construct() {
      ...
      this.__aliasManager__P_285_0 = qx.util.AliasManager.getInstance();
      this.initIconTrue();
    ...
    */
    members: {
      __iconUrlTrue__P_285_1: null,
      __iconUrlFalse__P_285_2: false,
      __aliasManager__P_285_0: null,
      ...
      _applyIconTrue: function _applyIconTrue(value) {
        this.__iconUrlTrue__P_285_1 = this.__aliasManager__P_285_0.resolve(value);
      },
      // property apply
      _applyIconFalse: function _applyIconFalse(value) {
        this.__iconUrlFalse__P_285_2 = this.__aliasManager__P_285_0.resolve(value);
      },
      // overridden
      _identifyImage: function _identifyImage(cellInfo) {
        ...
        ids = rm.getIds(this.__iconUrlTrue__P_285_1); // If ID was found, we'll use its first (likely only) element here.
        ...
        switch (cellInfo.value) {
          case true:
            imageHints.url = this.__iconUrlTrue__P_285_1;
            break;

          case false:
            imageHints.url = this.__iconUrlFalse__P_285_2;
            break;
    ...
    */
    destruct: function destruct() {
      this.__aliasManager__P_285_0 = null; // remove dynamic theme listener
...
//# sourceMappingURL=Boolean.js.map?dt=1598051416525