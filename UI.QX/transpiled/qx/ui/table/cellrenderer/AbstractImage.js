(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.cellrenderer.AbstractImage", {
    ...
    */
    members: {
      __defaultWidth__P_284_0: 16,
      __defaultHeight__P_284_1: 16,
      __imageData__P_284_2: null,
      ...
      _getImageInfos: function _getImageInfos(cellInfo) {
        ...
        if (!imageData.imageWidth || !imageData.imageHeight) {
          var sizes = this.__getImageSize__P_284_3(imageData.url);
       ...
       *    <code>height</code>
       */
      __getImageSize__P_284_3: function __getImageSize__P_284_3(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__defaultWidth__P_284_0;
          height = this.__defaultHeight__P_284_1;
        }
      ...
      createDataCellHtml: function createDataCellHtml(cellInfo, htmlArr) {
        this.__imageData__P_284_2 = this._getImageInfos(cellInfo);
      ...
      _getContentHtml: function _getContentHtml(cellInfo) {
        ...
        if (this.__imageData__P_284_2.url) {
          var srcUrl = this.__imageData__P_284_2.url;
          var highResolutionSource = qx.util.ResourceManager.getInstance().findHighResolutionSource(this.__imageData__P_284_2.url);
          ...
          var style = {
            width: this.__imageData__P_284_2.width + "px",
            height: this.__imageData__P_284_2.height + "px",
            display: qx.core.Environment.get("css.inlineblock"),
            verticalAlign: "middle",
            position: "static"
          };

          if (qx.util.ResourceManager.getInstance().getCombinedFormat(this.__imageData__P_284_2.url) === "") {
            // background size is critical for high-resolution images but breaks combined images
            style["background-size"] = this.__imageData__P_284_2.width + "px " + this.__imageData__P_284_2.height + "px";
          }
      ...
      _getCellAttributes: function _getCellAttributes(cellInfo) {
        var tooltip = this.__imageData__P_284_2.tooltip;
    ...
    */
    destruct: function destruct() {
      this.__imageData__P_284_2 = null;
    }
  });
  qx.ui.table.cellrenderer.AbstractImage.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=AbstractImage.js.map?dt=1598051416465