  ...
  qx.Class.define("qx.ui.table.cellrenderer.Image", {
    ...
    */
    ...
    construct: function construct(width, height) {
      ...
      if (width) {
        this.__imageWidth__P_287_0 = width;
      }

      if (height) {
        this.__imageHeight__P_287_1 = height;
      }

      this.__am__P_287_2 = qx.util.AliasManager.getInstance();
    },
    ...
    */
    members: {
      __am__P_287_2: null,
      __imageHeight__P_287_1: 16,
      __imageWidth__P_287_0: 16,
      // overridden
      _identifyImage: function _identifyImage(cellInfo) {
        var imageHints = {
          imageWidth: this.__imageWidth__P_287_0,
          imageHeight: this.__imageHeight__P_287_1
        };

        if (cellInfo.value == "") {
          imageHints.url = null;
        } else {
          imageHints.url = this.__am__P_287_2.resolve(cellInfo.value);
        }
    ...
    */
    destruct: function destruct() {
      this.__am__P_287_2 = null;
    }
  });
  qx.ui.table.cellrenderer.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1598051416854