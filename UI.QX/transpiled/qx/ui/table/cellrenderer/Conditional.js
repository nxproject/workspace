  ...
  qx.Class.define("qx.ui.table.cellrenderer.Conditional", {
    ...
    */
    ...
    construct: function construct(align, color, style, weight) {
      ...
      this.conditions = [];
      this.__defaultTextAlign__P_286_0 = align || "";
      this.__defaultColor__P_286_1 = color || "";
      this.__defaultFontStyle__P_286_2 = style || "";
      this.__defaultFontWeight__P_286_3 = weight || "";
    },
    ...
    */
    members: {
      __defaultTextAlign__P_286_0: null,
      __defaultColor__P_286_1: null,
      __defaultFontStyle__P_286_2: null,
      __defaultFontWeight__P_286_3: null,
       ...
       */
      __applyFormatting__P_286_4: function __applyFormatting__P_286_4(condition, style) {
        if (condition[1] != null) {
      ...
      _getCellStyle: function _getCellStyle(cellInfo) {
        ...
        var compareValue;
        var style = {
          "text-align": this.__defaultTextAlign__P_286_0,
          "color": this.__defaultColor__P_286_1,
          "font-style": this.__defaultFontStyle__P_286_2,
          "font-weight": this.__defaultFontWeight__P_286_3
        };
        ...
        for (i in this.conditions) {
          ...
          if (cond_test == true) {
            this.__applyFormatting__P_286_4(this.conditions[i], style);
          }
        }
...
//# sourceMappingURL=Conditional.js.map?dt=1598051416605