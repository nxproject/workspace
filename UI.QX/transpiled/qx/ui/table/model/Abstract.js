  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Abstract", {
    ...
    construct: function construct() {
      ...
      this.__columnIdArr__P_291_0 = [];
      this.__columnNameArr__P_291_1 = [];
      this.__columnIndexMap__P_291_2 = {};
    },
    members: {
      __columnIdArr__P_291_0: null,
      __columnNameArr__P_291_1: null,
      __columnIndexMap__P_291_2: null,
      __internalChange__P_291_3: null,
      ...
      getColumnCount: function getColumnCount() {
        return this.__columnIdArr__P_291_0.length;
      },
      // overridden
      getColumnIndexById: function getColumnIndexById(columnId) {
        return this.__columnIndexMap__P_291_2[columnId];
      },
      // overridden
      getColumnId: function getColumnId(columnIndex) {
        return this.__columnIdArr__P_291_0[columnIndex];
      },
      // overridden
      getColumnName: function getColumnName(columnIndex) {
        return this.__columnNameArr__P_291_1[columnIndex];
      },
      ...
      setColumnIds: function setColumnIds(columnIdArr) {
        this.__columnIdArr__P_291_0 = columnIdArr; // Create the reverse map

        this.__columnIndexMap__P_291_2 = {};

        for (var i = 0; i < columnIdArr.length; i++) {
          this.__columnIndexMap__P_291_2[columnIdArr[i]] = i;
        }

        this.__columnNameArr__P_291_1 = new Array(columnIdArr.length); // Inform the listeners

        if (!this.__internalChange__P_291_3) {
      ...
      setColumnNamesByIndex: function setColumnNamesByIndex(columnNameArr) {
        if (this.__columnIdArr__P_291_0.length != columnNameArr.length) {
          throw new Error("this.__columnIdArr and columnNameArr have different length: " + this.__columnIdArr__P_291_0.length + " != " + columnNameArr.length);
        }

        this.__columnNameArr__P_291_1 = columnNameArr; // Inform the listeners
      ...
      setColumnNamesById: function setColumnNamesById(columnNameMap) {
        this.__columnNameArr__P_291_1 = new Array(this.__columnIdArr__P_291_0.length);

        for (var i = 0; i < this.__columnIdArr__P_291_0.length; ++i) {
          this.__columnNameArr__P_291_1[i] = columnNameMap[this.__columnIdArr__P_291_0[i]];
        }
      },
      ...
      setColumns: function setColumns(columnNameArr, columnIdArr) {
        var bSetIds = this.__columnIdArr__P_291_0.length == 0 || columnIdArr;

        if (columnIdArr == null) {
          if (this.__columnIdArr__P_291_0.length == 0) {
            columnIdArr = columnNameArr;
          } else {
            columnIdArr = this.__columnIdArr__P_291_0;
          }
        }
        ...
        if (bSetIds) {
          this.__internalChange__P_291_3 = true;
          this.setColumnIds(columnIdArr);
          this.__internalChange__P_291_3 = false;
        }
    ...
    destruct: function destruct() {
      this.__columnIdArr__P_291_0 = this.__columnNameArr__P_291_1 = this.__columnIndexMap__P_291_2 = null;
    }
  });
  qx.ui.table.model.Abstract.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Abstract.js.map?dt=1598051417604