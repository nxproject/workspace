  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Simple", {
    ...
    construct: function construct() {
      ...
      this._rowArr = [];
      this.__sortColumnIndex__P_293_0 = -1; // Array of objects, each with property "ascending" and "descending"

      this.__sortMethods__P_293_1 = [];
      this.__editableColArr__P_293_2 = null;
    },
    properties: {
      /**
    ...
    members: {
      _rowArr: null,
      __editableColArr__P_293_2: null,
      __sortableColArr__P_293_3: null,
      __sortMethods__P_293_1: null,
      __sortColumnIndex__P_293_0: null,
      __sortAscending__P_293_4: null,
      // overridden
      ...
      setEditable: function setEditable(editable) {
        this.__editableColArr__P_293_2 = [];

        for (var col = 0; col < this.getColumnCount(); col++) {
          this.__editableColArr__P_293_2[col] = editable;
        }
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__editableColArr__P_293_2 == null) {
            this.__editableColArr__P_293_2 = [];
          }

          this.__editableColArr__P_293_2[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        return this.__editableColArr__P_293_2 ? this.__editableColArr__P_293_2[columnIndex] == true : false;
      },
      ...
      setColumnSortable: function setColumnSortable(columnIndex, sortable) {
        if (sortable != this.isColumnSortable(columnIndex)) {
          if (this.__sortableColArr__P_293_3 == null) {
            this.__sortableColArr__P_293_3 = [];
          }

          this.__sortableColArr__P_293_3[columnIndex] = sortable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnSortable: function isColumnSortable(columnIndex) {
        return this.__sortableColArr__P_293_3 ? this.__sortableColArr__P_293_3[columnIndex] !== false : true;
      },
      // overridden
      sortByColumn: function sortByColumn(columnIndex, ascending) {
        ...
        var comparator;
        var sortMethods = this.__sortMethods__P_293_1[columnIndex];
        ...
        this.__sortColumnIndex__P_293_0 = columnIndex;
        this.__sortAscending__P_293_4 = ascending;
        var data = {
      ...
      setSortMethods: function setSortMethods(columnIndex, compare) {
        ...
        this.__sortMethods__P_293_1[columnIndex] = methods;
      },
      ...
      getSortMethods: function getSortMethods(columnIndex) {
        return this.__sortMethods__P_293_1[columnIndex];
      },
      ...
      clearSorting: function clearSorting() {
        if (this.__sortColumnIndex__P_293_0 != -1) {
          this.__sortColumnIndex__P_293_0 = -1;
          this.__sortAscending__P_293_4 = true;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      getSortColumnIndex: function getSortColumnIndex() {
        return this.__sortColumnIndex__P_293_0;
      },
      ...
      isSortAscending: function isSortAscending() {
        return this.__sortAscending__P_293_4;
      },
      ...
      setValue: function setValue(columnIndex, rowIndex, value) {
        if (this._rowArr[rowIndex][columnIndex] != value) {
          ...
          if (columnIndex == this.__sortColumnIndex__P_293_0) {
            this.clearSorting();
          }
        }
      },
    ...
    destruct: function destruct() {
      this._rowArr = this.__editableColArr__P_293_2 = this.__sortMethods__P_293_1 = this.__sortableColArr__P_293_3 = null;
    }
  });
  qx.ui.table.model.Simple.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Simple.js.map?dt=1598051418048