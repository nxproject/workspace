  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Filtered", {
    ...
    construct: function construct() {
      ...
      this.__applyingFilters__P_292_1 = false;
      this.Filters = [];
    },
    members: {
      __fullArr__P_292_2: null,
      __applyingFilters__P_292_1: null,
      __filterTypes__P_292_0: null,
      ...
      getFullArray: function getFullArray() {
        return this.__fullArr__P_292_2;
      },
      ...
      addBetweenFilter: function addBetweenFilter(filter, value1, value2, target) {
        if (this.__filterTypes__P_292_0[filter] === "between" && target != null) {
      ...
      addNumericFilter: function addNumericFilter(filter, value1, target) {
        ...
        if (this.__filterTypes__P_292_0[filter] === "numeric" && target != null) {
          if (value1 != null) {
      ...
      */
      applyFilters: function applyFilters() {
        ...
        for (var row = 0; row < rowLength; row++) {
          ...
          for (i in this.Filters) {
            if (this.__filterTypes__P_292_0[this.Filters[i][0]] === "numeric") {
            ...
            } else if (this.__filterTypes__P_292_0[this.Filters[i][0]] === "between") {
        ...
        if (!this.__applyingFilters__P_292_1) {
          this.__fullArr__P_292_2 = rowArr.slice(0);
          this.__applyingFilters__P_292_1 = true;
        }
      ...
      resetHiddenRows: function resetHiddenRows() {
        if (!this.__fullArr__P_292_2) {
          // nothing to reset
          return;
        }

        this.Filters = [];
        this.setData(qx.lang.Array.clone(this.__fullArr__P_292_2));
      },
      // overridden
      setData: function setData(rowArr, clearSorting) {
        this.__fullArr__P_292_2 = qx.lang.Array.clone(rowArr);
        this.Filters = [];
        qx.ui.table.model.Filtered.prototype.setData.base.call(this, rowArr, clearSorting);
      }
    },
    destruct: function destruct() {
      this.__fullArr__P_292_2 = this.__filterTypes__P_292_0 = this.Filters = null;
    }
  });
  qx.ui.table.model.Filtered.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Filtered.js.map?dt=1598051417687