  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      this.__scrollerParent__P_226_0 = new qx.ui.container.Composite(new qx.ui.layout.HBox());

      this._add(this.__scrollerParent__P_226_0, {
        flex: 1
      ...
      this.__selectionManager__P_226_1 = this.getNewSelectionManager()(this);
      ...
      this.__focusedCol__P_226_2 = null;
      this.__focusedRow__P_226_3 = null; // add an event listener which updates the table content on locale change
    ...
    */
    members: {
      __focusedCol__P_226_2: null,
      __focusedRow__P_226_3: null,
      __scrollerParent__P_226_0: null,
      __selectionManager__P_226_1: null,
      __additionalStatusBarText__P_226_5: null,
      __lastRowCount__P_226_6: null,
      __internalChange__P_226_7: null,
      __columnMenuButtons__P_226_8: null,
      __columnModel__P_226_9: null,
      __emptyTableModel__P_226_10: null,
      __hadVerticalScrollBar__P_226_11: null,
      __timer__P_226_12: null,
      // overridden
      ...
      _applySelectionModel: function _applySelectionModel(value, old) {
        this.__selectionManager__P_226_1.setSelectionModel(value);
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__emptyTableModel__P_226_10) {
          this.__emptyTableModel__P_226_10 = new qx.ui.table.model.Simple();

          this.__emptyTableModel__P_226_10.setColumns([]);

          this.__emptyTableModel__P_226_10.setData([]);
        }

        return this.__emptyTableModel__P_226_10;
      },
      // property modifier
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__columnModel__P_226_9) {
          var columnModel = this.__columnModel__P_226_9 = this.getNewTableColumnModel()(this);
        ...
        return this.__columnModel__P_226_9;
      },
      // property modifier
      ...
      _applyAdditionalStatusBarText: function _applyAdditionalStatusBarText(value, old) {
        this.__additionalStatusBarText__P_226_5 = value;
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__redirectEvents__P_226_4) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__redirectEvents__P_226_4) {
            ...
            this.__scrollerParent__P_226_0.add(paneScroller, {
              flex: flex
            });
      ...
      getSelectionManager: function getSelectionManager() {
        return this.__selectionManager__P_226_1;
      },
      ...
      _getPaneScrollerArr: function _getPaneScrollerArr() {
        return this.__scrollerParent__P_226_0.getChildren();
      },
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (removeCount) {
          ...
          if (this.__focusedRow__P_226_3 >= removeStart && this.__focusedRow__P_226_3 < removeStart + removeCount) {
            this.setFocusedCell();
          }
        }
        ...
        if (rowCount != this.__lastRowCount__P_226_6) {
          this.__lastRowCount__P_226_6 = rowCount;
      ...
      _onScrollY: function _onScrollY(evt) {
        if (!this.__internalChange__P_226_7) {
          this.__internalChange__P_226_7 = true; // Set the same scroll position to all meta columns
          ...
          this.__internalChange__P_226_7 = false;
        }
      },
      ...
      _onKeyDown: function _onKeyDown(evt) {
        ...
        var oldFocusedRow = this.__focusedRow__P_226_3;
        ...
        if (this.isEditing()) {
          ...
          if (evt.getModifiers() == 0) {
            switch (identifier) {
              case "Enter":
                ...
                if (this.__focusedRow__P_226_3 != oldFocusedRow) {
          ...
          if (evt.isCtrlPressed()) {
            ...
            switch (identifier) {
              case "Space":
                this.__selectionManager__P_226_1.handleSelectKeyDown(this.__focusedRow__P_226_3, evt);
              ...
              case "Home":
                this.setFocusedCell(this.__focusedCol__P_226_2, 0, true);
                break;

              case "End":
                var rowCount = this.getTableModel().getRowCount();
                this.setFocusedCell(this.__focusedCol__P_226_2, rowCount - 1, true);
                break;
        ...
        if (oldFocusedRow != this.__focusedRow__P_226_3 && this.getRowFocusChangeModifiesSelection()) {
          // The focus moved -> Let the selection manager handle this event
          this.__selectionManager__P_226_1.handleMoveKeyDown(this.__focusedRow__P_226_3, evt);
        }
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        if (this.__columnMenuButtons__P_226_8 != null && data.col != null && data.visible != null) {
          this.__columnMenuButtons__P_226_8[data.col].setColumnVisible(data.visible);
        }
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        if (!this.isEditing() && (col != this.__focusedCol__P_226_2 || row != this.__focusedRow__P_226_3)) {
          if (col === null) {
            col = 0;
          }

          this.__focusedCol__P_226_2 = col;
          this.__focusedRow__P_226_3 = row;
      ...
      getFocusedColumn: function getFocusedColumn() {
        return this.__focusedCol__P_226_2;
      },
      ...
      getFocusedRow: function getFocusedRow() {
        return this.__focusedRow__P_226_3;
      },
      ...
      moveFocusedCell: function moveFocusedCell(deltaX, deltaY) {
        var col = this.__focusedCol__P_226_2;
        var row = this.__focusedRow__P_226_3; // could also be undefined [BUG #4676]
      ...
      isEditing: function isEditing() {
        if (this.__focusedCol__P_226_2 != null) {
          var x = this.getTableColumnModel().getVisibleX(this.__focusedCol__P_226_2);
      ...
      _updateStatusBar: function _updateStatusBar() {
        ...
        if (this.getStatusBarVisible()) {
          ...
          if (this.__additionalStatusBarText__P_226_5) {
            if (text) {
              text += this.__additionalStatusBarText__P_226_5;
            } else {
              text = this.__additionalStatusBarText__P_226_5;
            }
          }
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__hadVerticalScrollBar__P_226_11 == null) {
              this.__hadVerticalScrollBar__P_226_11 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__timer__P_226_12 = qx.event.Timer.once(function () {
                // reset the last visible state of the vertical scroll bar
                // in a timeout to prevent infinite loops.
                this.__hadVerticalScrollBar__P_226_11 = null;
                this.__timer__P_226_12 = null;
              }, this, 0);
            }
          }
          ...
          if (isLast && verNeeded != this.__hadVerticalScrollBar__P_226_11) {
      ...
      _initColumnMenu: function _initColumnMenu() {
        ...
        this.__columnMenuButtons__P_226_8 = {};
        ...
        for (var col = 0, l = tableModel.getColumnCount(); col < l; col++) {
          ...
          this.__columnMenuButtons__P_226_8[col] = menuButton;
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__redirectEvents__P_226_4[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__selectionManager__P_226_1", "__scrollerParent__P_226_0", "__emptyTableModel__P_226_10", "__emptyTableModel__P_226_10", "__columnModel__P_226_9", "__timer__P_226_12");

      this._disposeMap("__columnMenuButtons__P_226_8");
    }
  });
  qx.ui.table.Table.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Table.js.map?dt=1598051406990