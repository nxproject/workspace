  ...
  qx.Class.define("qx.ui.table.pane.Scroller", {
    ...
    */
    ...
    construct: function construct(table) {
      ...
      this.__table__P_298_0 = table; // init layout
      ...
      this.__header__P_298_1 = this._showChildControl("header");
      this.__tablePane__P_298_2 = this._showChildControl("pane"); // the top line containing the header clipper and the top right widget

      this.__top__P_298_3 = new qx.ui.container.Composite(new qx.ui.layout.HBox()).set({
        minWidth: 0
      });

      this._add(this.__top__P_298_3, {
        row: 0,
        column: 0,
        colSpan: 2
      ...
      this._headerClipper.add(this.__header__P_298_1);
      ...
      this.__top__P_298_3.add(this._headerClipper, {
        flex: 1
      ...
      this._paneClipper.add(this.__tablePane__P_298_2);
      ...
      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this.__clipperContainer__P_298_4 = new qx.ui.container.Composite();

        this.__clipperContainer__P_298_4.setLayout(new qx.ui.layout.Canvas());

        this.__clipperContainer__P_298_4.add(this._paneClipper, {
          edge: 0
        });

        this._add(this.__clipperContainer__P_298_4, {
          row: 1,
          column: 0
        });
      } else {
      ...
      this.__horScrollBar__P_298_5 = this._showChildControl("scrollbar-x");
      this.__verScrollBar__P_298_6 = this._showChildControl("scrollbar-y"); // init focus indicator

      this.__focusIndicator__P_298_7 = this.getChildControl("focus-indicator"); // need to run the apply method at least once [BUG #4057]
      ...
      this.__timer__P_298_8 = new qx.event.Timer();

      this.__timer__P_298_8.addListener("interval", this._oninterval, this);
    ...
    */
    members: {
      __lastRowCount__P_298_9: null,
      __table__P_298_0: null,
      __updateInterval__P_298_10: null,
      __updateContentPlanned__P_298_11: null,
      __onintervalWrapper__P_298_12: null,
      _moveColumn: null,
      __lastMoveColPos__P_298_13: null,
      _lastMoveTargetX: null,
      _lastMoveTargetScroller: null,
      __lastMovePointerPageX__P_298_14: null,
      __resizeColumn__P_298_15: null,
      __lastResizePointerPageX__P_298_16: null,
      __lastResizeWidth__P_298_17: null,
      __lastPointerDownCell__P_298_18: null,
      __firedTapEvent__P_298_19: false,
      __ignoreTap__P_298_20: null,
      __lastPointerPageX__P_298_21: null,
      __lastPointerPageY__P_298_22: null,
      __focusedCol__P_298_23: null,
      __focusedRow__P_298_24: null,
      _cellEditor: null,
      __cellEditorFactory__P_298_25: null,
      __topRightWidget__P_298_26: null,
      __horScrollBar__P_298_5: null,
      __verScrollBar__P_298_6: null,
      __header__P_298_1: null,
      _headerClipper: null,
      __tablePane__P_298_2: null,
      _paneClipper: null,
      __clipperContainer__P_298_4: null,
      __focusIndicator__P_298_7: null,
      __top__P_298_3: null,
      __timer__P_298_8: null,
      __focusIndicatorPointerDownListener__P_298_27: null,
      ...
      getPaneInsetRight: function getPaneInsetRight() {
        ...
        var scrollBar = this.__verScrollBar__P_298_6;
      ...
      _createChildControlImpl: function _createChildControlImpl(id, hash) {
        ...
        switch (id) {
          ...
          case "scrollbar-x":
            ...
            if (this.__clipperContainer__P_298_4 != null) {
              control.setMinHeight(qx.ui.core.scroll.AbstractScrollArea.DEFAULT_SCROLLBAR_WIDTH);

              this.__clipperContainer__P_298_4.add(control, {
                bottom: 0,
                right: 0,
                left: 0
              });
      ...
      _applyHorizontalScrollBarVisible: function _applyHorizontalScrollBarVisible(value, old) {
        if (value === null) {
          this.__horScrollBar__P_298_5.setVisibility("hidden");
        } else {
          this.__horScrollBar__P_298_5.setVisibility(value ? "visible" : "excluded");
        }
      },
      // property modifier
      _applyVerticalScrollBarVisible: function _applyVerticalScrollBarVisible(value, old) {
        this.__verScrollBar__P_298_6.setVisibility(value ? "visible" : "excluded");
      },
      // property modifier
      ...
      _applyShowCellFocusIndicator: function _applyShowCellFocusIndicator(value, old) {
        if (value) {
          this.__focusIndicator__P_298_7.setDecorator("table-scroller-focus-indicator");

          this._updateFocusIndicator();
        } else {
          if (this.__focusIndicator__P_298_7) {
            this.__focusIndicator__P_298_7.setDecorator(null);
          }
        }
      },
      ...
      getScrollY: function getScrollY() {
        return this.__verScrollBar__P_298_6.getPosition();
      },
      ...
      setScrollY: function setScrollY(scrollY, renderSync) {
        this.__verScrollBar__P_298_6.scrollTo(scrollY);
      ...
      getScrollX: function getScrollX() {
        return this.__horScrollBar__P_298_5.getPosition();
      },
      ...
      setScrollX: function setScrollX(scrollX) {
        this.__horScrollBar__P_298_5.scrollTo(scrollX);
      },
      ...
      setColumnWidth: function setColumnWidth(col, width) {
        this.__header__P_298_1.setColumnWidth(col, width);

        this.__tablePane__P_298_2.setColumnWidth(col, width);
      ...
      onColOrderChanged: function onColOrderChanged() {
        this.__header__P_298_1.onColOrderChanged();

        this.__tablePane__P_298_2.onColOrderChanged();
      ...
      onTableModelDataChanged: function onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn) {
        this.__tablePane__P_298_2.onTableModelDataChanged(firstRow, lastRow, firstColumn, lastColumn);

        var rowCount = this.getTable().getTableModel().getRowCount();

        var colCount = this.__table__P_298_0.getTableColumnModel().getOverallColumnCount();

        if (rowCount != this.__lastRowCount__P_298_9) {
          ...
          this.__lastRowCount__P_298_9 = rowCount;
        }
      },
      ...
      onSelectionChanged: function onSelectionChanged() {
        this.__tablePane__P_298_2.onSelectionChanged();
      },
      ...
      onFocusChanged: function onFocusChanged() {
        this.__tablePane__P_298_2.onFocusChanged();
      },
      ...
      onTableModelMetaDataChanged: function onTableModelMetaDataChanged() {
        this.__header__P_298_1.onTableModelMetaDataChanged();

        this.__tablePane__P_298_2.onTableModelMetaDataChanged();
      },
      ...
      _onPaneModelChanged: function _onPaneModelChanged() {
        this.__header__P_298_1.onPaneModelChanged();

        this.__tablePane__P_298_2.onPaneModelChanged();
      },
      ...
      _onResizePane: function _onResizePane() {
        ...
        this.__header__P_298_1._updateContent();

        this.__table__P_298_0._updateScrollBarVisibility();
      },
      ...
      updateHorScrollBarMaximum: function updateHorScrollBarMaximum() {
        ...
        var scrollBar = this.__horScrollBar__P_298_5;
       ...
       * @param e {Map} the event.
       */
      __inOnScrollY__P_298_28: false,
      _onScrollY: function _onScrollY(e) {
        if (this.__inOnScrollY__P_298_28) {
          return;
        }

        var scrollbar = this.__verScrollBar__P_298_6;
        this.__inOnScrollY__P_298_28 = true; // calculate delta so that one row is scrolled at an minimum
        ...
        this.__inOnScrollY__P_298_28 = false;
      ...
      _onRoll: function _onRoll(e) {
        ...
        this.__verScrollBar__P_298_6.scrollBy(parseInt(delta.y, 10));

        var scrolled = delta.y != 0 && !this.__isAtEdge__P_298_29(this.__verScrollBar__P_298_6, delta.y); // horizontal scrolling
        ...
        this.__horScrollBar__P_298_5.scrollBy(parseInt(delta.x, 10)); // Update the focus


        if (this.__lastPointerPageX__P_298_21 && this.getFocusCellOnPointerMove()) {
          this._focusCellAtPagePos(this.__lastPointerPageX__P_298_21, this.__lastPointerPageY__P_298_22);
        }

        scrolled = scrolled || delta.x != 0 && !this.__isAtEdge__P_298_29(this.__horScrollBar__P_298_5, delta.x); // pass the event to the parent if the scrollbar is at an edge
       ...
       */
      __isAtEdge__P_298_29: function __isAtEdge__P_298_29(scrollBar, delta) {
       ...
       */
      __handleResizeColumn__P_298_30: function __handleResizeColumn__P_298_30(pageX) {
        var table = this.getTable(); // We are currently resizing -> Update the position

        var headerCell = this.__header__P_298_1.getHeaderWidgetAtColumn(this.__resizeColumn__P_298_15);

        var minColumnWidth = headerCell.getSizeHint().minWidth;
        var newWidth = Math.max(minColumnWidth, this.__lastResizeWidth__P_298_17 + pageX - this.__lastResizePointerPageX__P_298_16);

        if (this.getLiveResize()) {
          var columnModel = table.getTableColumnModel();
          columnModel.setColumnWidth(this.__resizeColumn__P_298_15, newWidth, true);
        } else {
          var paneModel = this.getTablePaneModel();

          this._showResizeLine(paneModel.getColumnLeft(this.__resizeColumn__P_298_15) + newWidth);
        }

        this.__lastResizePointerPageX__P_298_16 += newWidth - this.__lastResizeWidth__P_298_17;
        this.__lastResizeWidth__P_298_17 = newWidth;
      },
       ...
       *
       */
      __handleMoveColumn__P_298_31: function __handleMoveColumn__P_298_31(pageX) {
        ...
        if (this.__header__P_298_1.isShowingColumnMoveFeedback() || pageX > this.__lastMovePointerPageX__P_298_14 + tapTolerance || pageX < this.__lastMovePointerPageX__P_298_14 - tapTolerance) {
          this.__lastMoveColPos__P_298_13 += pageX - this.__lastMovePointerPageX__P_298_14;

          this.__header__P_298_1.showColumnMoveFeedback(this._moveColumn, this.__lastMoveColPos__P_298_13); // Get the responsible scroller


          var targetScroller = this.__table__P_298_0.getTablePaneScrollerAtPageX(pageX);
          ...
          this.__lastMovePointerPageX__P_298_14 = pageX;
        }
      },
      ...
      _onPointermoveHeader: function _onPointermoveHeader(e) {
        ...
        this.__lastPointerPageX__P_298_21 = pageX;
        this.__lastPointerPageY__P_298_22 = pageY;

        if (this.__resizeColumn__P_298_15 != null) {
          // We are currently resizing -> Update the position
          this.__handleResizeColumn__P_298_30(pageX);

          useResizeCursor = true;
          e.stopPropagation();
        } else if (this._moveColumn != null) {
          // We are moving a column
          this.__handleMoveColumn__P_298_31(pageX);
        ...
        this.__header__P_298_1.setPointerOverColumn(pointerOverColumn);
      },
      ...
      _onPointermovePane: function _onPointermovePane(e) {
        ...
        this.__header__P_298_1.setPointerOverColumn(null);
      },
      ...
      _startResizeHeader: function _startResizeHeader(resizeCol, pageX) {
        ...
        this.__resizeColumn__P_298_15 = resizeCol;
        this.__lastResizePointerPageX__P_298_16 = pageX;
        this.__lastResizeWidth__P_298_17 = columnModel.getColumnWidth(this.__resizeColumn__P_298_15);
      ...
      _startMoveHeader: function _startMoveHeader(moveCol, pageX) {
        ...
        this.__lastMovePointerPageX__P_298_14 = pageX;
        this.__lastMoveColPos__P_298_13 = this.getTablePaneModel().getColumnLeft(moveCol);
      ...
      _onPointerdownPane: function _onPointerdownPane(e) {
        ...
        if (row !== null) {
          ...
          //
          this.__lastPointerDownCell__P_298_18 = {
            row: row,
            col: col
          ...
          this.__firedTapEvent__P_298_19 = false;
        }
      },
      ...
      _onPointerupFocusIndicator: function _onPointerupFocusIndicator(e) {
        if (this.__lastPointerDownCell__P_298_18 && !this.__firedTapEvent__P_298_19 && !this.isEditing() && this.__focusIndicator__P_298_7.getRow() == this.__lastPointerDownCell__P_298_18.row && this.__focusIndicator__P_298_7.getColumn() == this.__lastPointerDownCell__P_298_18.col) {
          this.fireEvent("cellTap", qx.ui.table.pane.CellEvent, [this, e, this.__lastPointerDownCell__P_298_18.row, this.__lastPointerDownCell__P_298_18.col], true);
          this.__firedTapEvent__P_298_19 = true;
      ...
      _stopResizeHeader: function _stopResizeHeader() {
        ...
        if (!this.getLiveResize()) {
          ...
          columnModel.setColumnWidth(this.__resizeColumn__P_298_15, this.__lastResizeWidth__P_298_17, true);
        }

        this.__resizeColumn__P_298_15 = null;
      ...
      _stopMoveHeader: function _stopMoveHeader() {
        ...
        this.__header__P_298_1.hideColumnMoveFeedback();
      ...
      _onPointerupHeader: function _onPointerupHeader(e) {
        ...
        if (this.__resizeColumn__P_298_15 != null) {
          ...
          this.__ignoreTap__P_298_20 = true;
          e.stop();
        } else if (this._moveColumn != null) {
          this._stopMoveHeader();
      ...
      _onTapHeader: function _onTapHeader(e) {
        if (this.__ignoreTap__P_298_20) {
          this.__ignoreTap__P_298_20 = false;
          return;
        }
      ...
      _onTapPane: function _onTapPane(e) {
        ...
        if (row != null && col != null) {
          ...
          if (this.__focusIndicator__P_298_7.isHidden() || this.__lastPointerDownCell__P_298_18 && !this.__firedTapEvent__P_298_19 && !this.isEditing() && row == this.__lastPointerDownCell__P_298_18.row && col == this.__lastPointerDownCell__P_298_18.col) {
      ...
      _onContextMenu: function _onContextMenu(e) {
        ...
        if (!this.getShowCellFocusIndicator() || row === null || this.__lastPointerDownCell__P_298_18 && row == this.__lastPointerDownCell__P_298_18.row && col == this.__lastPointerDownCell__P_298_18.col) {
      ...
      _onPointerout: function _onPointerout(e) {
        ...
        this.__header__P_298_1.setPointerOverColumn(null); // in case the focus follows the pointer, it should be remove on pointerout


        if (this.getFocusCellOnPointerMove()) {
          this.__table__P_298_0.setFocusedCell();
        }
      },
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(pageX) {
        ...
        var paneLeft = this.__tablePane__P_298_2.getContentLocation().left;
      ...
      _focusCellAtPagePos: function _focusCellAtPagePos(pageX, pageY) {
        ...
        if (row != -1 && row != null) {
          ...
          this.__table__P_298_0.setFocusedCell(col, row);
        }
      },
      ...
      setFocusedCell: function setFocusedCell(col, row) {
        if (!this.isEditing()) {
          this.__tablePane__P_298_2.setFocusedCell(col, row, this.__updateContentPlanned__P_298_11);

          this.__focusedCol__P_298_23 = col;
          this.__focusedRow__P_298_24 = row;
      ...
      getFocusedColumn: function getFocusedColumn() {
        return this.__focusedCol__P_298_23;
      },
      ...
      getFocusedRow: function getFocusedRow() {
        return this.__focusedRow__P_298_24;
      },
      ...
      startEditing: function startEditing() {
        var table = this.getTable();
        var tableModel = table.getTableModel();
        var col = this.__focusedCol__P_298_23;

        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          var row = this.__focusedRow__P_298_24;
          var xPos = this.getTablePaneModel().getX(col);
          var value = tableModel.getValue(col, row); // scroll cell into view

          this.scrollCellVisible(col, row);
          this.__cellEditorFactory__P_298_25 = table.getTableColumnModel().getCellEditorFactory(col);
          var cellInfo = {
            col: col,
            row: row,
            xPos: xPos,
          ...
          this._cellEditor = this.__cellEditorFactory__P_298_25.createCellEditor(cellInfo); // We handle two types of cell editors: the traditional in-place
          ...
          if (this._cellEditor === null) {
            ...
            this.__focusIndicatorPointerDownListener__P_298_27 = this.__focusIndicator__P_298_7.addListener("pointerdown", function (e) {
              this.__lastPointerDownCell__P_298_18 = {
                row: this.__focusedRow__P_298_24,
                col: this.__focusedCol__P_298_23
              };
              e.stopPropagation();
            }, this);

            this.__focusIndicator__P_298_7.add(this._cellEditor);

            this.__focusIndicator__P_298_7.addState("editing");

            this.__focusIndicator__P_298_7.setKeepActive(false); // Make the focus indicator visible during editing
      ...
      flushEditor: function flushEditor(cancel) {
        if (this.isEditing()) {
          var value = this.__cellEditorFactory__P_298_25.getCellEditorValue(this._cellEditor);

          var oldValue = this.getTable().getTableModel().getValue(this.__focusedCol__P_298_23, this.__focusedRow__P_298_24);
          this.getTable().getTableModel().setValue(this.__focusedCol__P_298_23, this.__focusedRow__P_298_24, value);

          this.__table__P_298_0.focus();
          ...
          this.__table__P_298_0.fireDataEvent("dataEdited", {
            row: this.__focusedRow__P_298_24,
            col: this.__focusedCol__P_298_23,
            oldValue: oldValue,
            value: value
      ...
      cancelEditing: function cancelEditing() {
        if (this.isEditing()) {
          if (!(this._cellEditor instanceof qx.ui.window.Window)) {
            this.__focusIndicator__P_298_7.removeState("editing");

            this.__focusIndicator__P_298_7.setKeepActive(true);

            if (this.__focusIndicatorPointerDownListener__P_298_27 !== null) {
              this.__focusIndicator__P_298_7.removeListenerById(this.__focusIndicatorPointerDownListener__P_298_27);

              this.__focusIndicatorPointerDownListener__P_298_27 = null;
            }
          }
          ...
          this.__cellEditorFactory__P_298_25 = null;
        }
      },
      ...
      _getColumnForPageX: function _getColumnForPageX(pageX) {
        ...
        var currX = this.__tablePane__P_298_2.getContentLocation().left;
      ...
      _getResizeColumnForPageX: function _getResizeColumnForPageX(pageX) {
        var contentLocation = this.__header__P_298_1.getContentLocation() || this.__tablePane__P_298_2.getContentLocation();
      ...
      _getRowForPagePos: function _getRowForPagePos(pageX, pageY) {
        var panePos = this.__tablePane__P_298_2.getContentLocation();
        ...
        if (pageY >= panePos.top && pageY <= panePos.bottom) {
          ...
          var scrollY = this.__verScrollBar__P_298_6.getPosition();
        ...
        var headerPos = this.__header__P_298_1.getContentLocation();
      ...
      setTopRightWidget: function setTopRightWidget(widget) {
        var oldWidget = this.__topRightWidget__P_298_26;

        if (oldWidget != null) {
          this.__top__P_298_3.remove(oldWidget);
        }

        if (widget != null) {
          this.__top__P_298_3.add(widget);
        }

        this.__topRightWidget__P_298_26 = widget;
      },
      ...
      getTopRightWidget: function getTopRightWidget() {
        return this.__topRightWidget__P_298_26;
      },
      ...
      getTablePane: function getTablePane() {
        return this.__tablePane__P_298_2;
      },
      ...
      _startInterval: function _startInterval(timeout) {
        this.__timer__P_298_8.setInterval(timeout);

        this.__timer__P_298_8.start();
      },
      ...
      _oninterval: qx.event.GlobalError.observeMethod(function () {
        if (this.__updateContentPlanned__P_298_11 && !this.__tablePane__P_298_2._layoutPending) {
          this.__updateContentPlanned__P_298_11 = false;
      ...
      _updateContent: function _updateContent() {
        ...
        var scrollX = this.__horScrollBar__P_298_5.getPosition();
        ...
        var oldFirstRow = this.__tablePane__P_298_2.getFirstVisibleRow();

        this.__tablePane__P_298_2.setFirstVisibleRow(firstRow);
        ...
        this.__tablePane__P_298_2.setVisibleRowCount(visibleRowCount);
      ...
      _updateFocusIndicator: function _updateFocusIndicator() {
        ...
        this.__focusIndicator__P_298_7.moveToCell(this.__focusedCol__P_298_23, this.__focusedRow__P_298_24);
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      this.__lastPointerDownCell__P_298_18 = this.__topRightWidget__P_298_26 = this.__table__P_298_0 = null;

      this._disposeObjects("__horScrollBar__P_298_5", "__verScrollBar__P_298_6", "_headerClipper", "_paneClipper", "__focusIndicator__P_298_7", "__header__P_298_1", "__tablePane__P_298_2", "__top__P_298_3", "__timer__P_298_8", "__clipperContainer__P_298_4");
    }
  });
  qx.ui.table.pane.Scroller.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Scroller.js.map?dt=1598051418869