  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      this.__blocker__P_295_0 = new qx.ui.core.Blocker(this);
      this.__paneScroller__P_295_1 = paneScroller;
    },
    ...
    */
    members: {
      __paneScroller__P_295_1: null,
      __moveFeedback__P_295_2: null,
      __lastPointerOverColumn__P_295_3: null,
      __blocker__P_295_0: null,
      ...
      getPaneScroller: function getPaneScroller() {
        return this.__paneScroller__P_295_1;
      },
      ...
      getTable: function getTable() {
        return this.__paneScroller__P_295_1.getTable();
      },
      ...
      getBlocker: function getBlocker() {
        return this.__blocker__P_295_0;
      },
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__lastPointerOverColumn__P_295_3) {
          if (this.__lastPointerOverColumn__P_295_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__lastPointerOverColumn__P_295_3);
          ...
          this.__lastPointerOverColumn__P_295_3 = col;
        }
      },
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__moveFeedback__P_295_2 == null) {
          ...
          this.__moveFeedback__P_295_2 = feedback;
        }

        this.__moveFeedback__P_295_2.setLayoutProperties({
          left: pos.left + x
        });

        this.__moveFeedback__P_295_2.show();
      },
      ...
      hideColumnMoveFeedback: function hideColumnMoveFeedback() {
        if (this.__moveFeedback__P_295_2 != null) {
          this.__moveFeedback__P_295_2.destroy();

          this.__moveFeedback__P_295_2 = null;
        }
      },
      ...
      isShowingColumnMoveFeedback: function isShowingColumnMoveFeedback() {
        return this.__moveFeedback__P_295_2 != null;
      },
    ...
    */
    destruct: function destruct() {
      this.__blocker__P_295_0.dispose();

      this._disposeObjects("__paneScroller__P_295_1");
    }
  });
  qx.ui.table.pane.Header.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Header.js.map?dt=1598051418255