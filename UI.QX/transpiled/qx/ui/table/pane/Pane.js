  ...
  qx.Class.define("qx.ui.table.pane.Pane", {
    ...
    */
    ...
    construct: function construct(paneScroller) {
      ...
      this.__paneScroller__P_297_0 = paneScroller;
      this.__lastColCount__P_297_1 = 0;
      this.__lastRowCount__P_297_2 = 0;
      this.__rowCache__P_297_3 = [];
    },
    ...
    */
    members: {
      __lastRowCount__P_297_2: null,
      __lastColCount__P_297_1: null,
      __paneScroller__P_297_0: null,
      __tableContainer__P_297_4: null,
      __focusedRow__P_297_5: null,
      __focusedCol__P_297_6: null,
      // sparse array to cache rendered rows
      __rowCache__P_297_3: null,
      __rowCacheCount__P_297_7: 0,
      // property modifier
      ...
      getPaneScroller: function getPaneScroller() {
        return this.__paneScroller__P_297_0;
      },
      ...
      getTable: function getTable() {
        return this.__paneScroller__P_297_0.getTable();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, massUpdate) {
        if (col != this.__focusedCol__P_297_6 || row != this.__focusedRow__P_297_5) {
          var oldRow = this.__focusedRow__P_297_5;
          this.__focusedCol__P_297_6 = col;
          this.__focusedRow__P_297_5 = row; // Update the focused row background
      ...
      _applyMaxCacheLines: function _applyMaxCacheLines(value, old) {
        if (this.__rowCacheCount__P_297_7 >= value && value !== -1) {
          this.__rowCacheClear__P_297_8();
        }
      },
       ...
       * Clear the row cache
       */
      __rowCacheClear__P_297_8: function __rowCacheClear__P_297_8() {
        this.__rowCache__P_297_3 = [];
        this.__rowCacheCount__P_297_7 = 0;
      },
       ...
       *     index is not cached.
       */
      __rowCacheGet__P_297_9: function __rowCacheGet__P_297_9(row, selected, focused) {
        if (!selected && !focused && this.__rowCache__P_297_3[row]) {
          return this.__rowCache__P_297_3[row];
        } else {
          return null;
        }
      },
       ...
       * @param focused {Boolean} Whether the row is currently focused
       */
      __rowCacheSet__P_297_10: function __rowCacheSet__P_297_10(row, rowString, selected, focused) {
        var maxCacheLines = this.getMaxCacheLines();

        if (!selected && !focused && !this.__rowCache__P_297_3[row] && maxCacheLines > 0) {
          this._applyMaxCacheLines(maxCacheLines);

          this.__rowCache__P_297_3[row] = rowString;
          this.__rowCacheCount__P_297_7 += 1;
        }
      },
      ...
      _updateRowStyles: function _updateRowStyles(onlyRow) {
        ...
        for (; y < end; y++, row++) {
          ...
          cellInfo.focusedRow = this.__focusedRow__P_297_5 == row;
      ...
      _getRowsHtml: function _getRowsHtml(firstRow, rowCount) {
        ...
        for (var x = 0; x < colCount; x++) {
          ...
          cols.push({
            ...
            focusedCol: this.__focusedCol__P_297_6 == col,
            styleLeft: left,
        ...
        for (var row = firstRow; row < firstRow + rowCount; row++) {
          ...
          var focusedRow = this.__focusedRow__P_297_5 == row;

          var cachedRow = this.__rowCacheGet__P_297_9(row, selected, focusedRow);
          ...
          this.__rowCacheSet__P_297_10(row, rowString, selected, focusedRow);
      ...
      _scrollContent: function _scrollContent(rowOffset) {
        ...
        if (!this.__tableContainer__P_297_4) {
          this.__tableContainer__P_297_4 = document.createElement("div");
        }

        var tableDummy = '<div>';
        tableDummy += this._getRowsHtml(firstRow + addRowBase, Math.abs(rowOffset));
        tableDummy += '</div>';
        this.__tableContainer__P_297_4.innerHTML = tableDummy;
        var newTableRows = this.__tableContainer__P_297_4.firstChild.childNodes; // append new lines
        ...
        if (this.__focusedRow__P_297_5 !== null) {
          this._updateRowStyles(this.__focusedRow__P_297_5 - rowOffset);

          this._updateRowStyles(this.__focusedRow__P_297_5);
        }
      ...
      _updateAllRows: function _updateAllRows() {
        ...
        this.__lastColCount__P_297_1 = colCount;
        this.__lastRowCount__P_297_2 = rowCount;
        this.fireEvent("paneUpdated");
      }
    },
    ...
    */
    destruct: function destruct() {
      this.__tableContainer__P_297_4 = this.__paneScroller__P_297_0 = this.__rowCache__P_297_3 = null;
...
//# sourceMappingURL=Pane.js.map?dt=1598051418460