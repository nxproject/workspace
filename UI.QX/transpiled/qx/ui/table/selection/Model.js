  ...
  qx.Class.define("qx.ui.table.selection.Model", {
    ...
    */
    construct: function construct() {
      ...
      this.__selectedRangeArr__P_300_0 = [];
      this.__anchorSelectionIndex__P_300_1 = -1;
      this.__leadSelectionIndex__P_300_2 = -1;
      this.hasBatchModeRefCount = 0;
      this.__hadChangeEventInBatchMode__P_300_3 = false;
    },
    ...
    */
    members: {
      __hadChangeEventInBatchMode__P_300_3: null,
      __anchorSelectionIndex__P_300_1: null,
      __leadSelectionIndex__P_300_2: null,
      __selectedRangeArr__P_300_0: null,
      ...
      setBatchMode: function setBatchMode(batchMode) {
        if (batchMode) {
          ...
          if (this.__hadChangeEventInBatchMode__P_300_3) {
            this.__hadChangeEventInBatchMode__P_300_3 = false;
      ...
      getAnchorSelectionIndex: function getAnchorSelectionIndex() {
        return this.__anchorSelectionIndex__P_300_1;
      },
      ...
      _setAnchorSelectionIndex: function _setAnchorSelectionIndex(index) {
        this.__anchorSelectionIndex__P_300_1 = index;
      },
      ...
      getLeadSelectionIndex: function getLeadSelectionIndex() {
        return this.__leadSelectionIndex__P_300_2;
      },
      ...
      _setLeadSelectionIndex: function _setLeadSelectionIndex(index) {
        this.__leadSelectionIndex__P_300_2 = index;
      },
      ...
      _getSelectedRangeArr: function _getSelectedRangeArr() {
        return this.__selectedRangeArr__P_300_0;
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__selectedRangeArr__P_300_0.length == 0;
      },
      ...
      getSelectedCount: function getSelectedCount() {
        ...
        for (var i = 0; i < this.__selectedRangeArr__P_300_0.length; i++) {
          var range = this.__selectedRangeArr__P_300_0[i];
      ...
      getSelectedRanges: function getSelectedRanges() {
        ...
        for (var i = 0; i < this.__selectedRangeArr__P_300_0.length; i++) {
          retVal.push({
            minIndex: this.__selectedRangeArr__P_300_0[i].minIndex,
            maxIndex: this.__selectedRangeArr__P_300_0[i].maxIndex
          });
        }
      ...
      iterateSelection: function iterateSelection(iterator, object) {
        for (var i = 0; i < this.__selectedRangeArr__P_300_0.length; i++) {
          for (var j = this.__selectedRangeArr__P_300_0[i].minIndex; j <= this.__selectedRangeArr__P_300_0[i].maxIndex; j++) {
      ...
      removeSelectionInterval: function removeSelectionInterval(fromIndex, toIndex, rowsRemoved) {
        this.__anchorSelectionIndex__P_300_1 = fromIndex;
        this.__leadSelectionIndex__P_300_2 = toIndex;
        ...
        this.__selectedRangeArr__P_300_0 = newRanges;
      ...
      _addSelectionInterval: function _addSelectionInterval(fromIndex, toIndex) {
        ...
        for (; newRangeIndex < this.__selectedRangeArr__P_300_0.length; newRangeIndex++) {
          var range = this.__selectedRangeArr__P_300_0[newRangeIndex];
        ...
        this.__selectedRangeArr__P_300_0.splice(newRangeIndex, 0, {
          minIndex: minIndex,
          maxIndex: maxIndex
        }); // Merge overlapping ranges


        var lastRange = this.__selectedRangeArr__P_300_0[0];

        for (var i = 1; i < this.__selectedRangeArr__P_300_0.length; i++) {
          var range = this.__selectedRangeArr__P_300_0[i];
          ...
          if (lastRange.maxIndex + 1 >= range.minIndex) {
            ...
            this.__selectedRangeArr__P_300_0.splice(i, 1); // Check this index another time
      ...
      _fireChangeSelection: function _fireChangeSelection() {
        if (this.hasBatchMode()) {
          ...
          this.__hadChangeEventInBatchMode__P_300_3 = true;
        } else {
    ...
    */
    destruct: function destruct() {
      this.__selectedRangeArr__P_300_0 = null;
    }
  });
  qx.ui.table.selection.Model.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Model.js.map?dt=1598051419093