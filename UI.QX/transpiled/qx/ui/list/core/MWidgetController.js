  ...
  qx.Mixin.define("qx.ui.list.core.MWidgetController", {
    ...
    members: {
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        var bindPath = this.__getBindPath__P_248_1(index, sourcePath, type);
        ...
        this.__addBinding__P_248_2(targetWidget, id);
      },
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourceProperty, options, sourceWidget, index) {
        ...
        var bindPath = this.__getBindPath__P_248_1(index, targetPath, type);

        var id = sourceWidget.bind(sourceProperty, this._list, bindPath, options);

        this.__addBinding__P_248_2(sourceWidget, id);
      },
      ...
      removeBindings: function removeBindings() {
        while (this.__boundItems__P_248_0.length > 0) {
          var item = this.__boundItems__P_248_0.pop();
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        var bindings = this.__getBindings__P_248_3(item);
        ...
        if (this.__boundItems__P_248_0.includes(item)) {
          qx.lang.Array.remove(this.__boundItems__P_248_0, item);
        }
      },
       ...
       */
      __getBindPath__P_248_1: function __getBindPath__P_248_1(index, path, type) {
       ...
       */
      __addBinding__P_248_2: function __addBinding__P_248_2(widget, id) {
        var bindings = this.__getBindings__P_248_3(widget);

        if (!bindings.includes(id)) {
          bindings.push(id);
        }

        if (!this.__boundItems__P_248_0.includes(widget)) {
          this.__boundItems__P_248_0.push(widget);
        }
      },
       ...
       */
      __getBindings__P_248_3: function __getBindings__P_248_3(widget) {
    ...
    destruct: function destruct() {
      this.__boundItems__P_248_0 = null;
    }
  });
  qx.ui.list.core.MWidgetController.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MWidgetController.js.map?dt=1598051411854