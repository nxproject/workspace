    ...
    members: {
      ...
      */
      ...
      styleSelectabled: function styleSelectabled(row) {
        var widget = this.__getWidgetFrom__P_249_0(row);
      ...
      */
      ...
      _styleSelectabled: function _styleSelectabled(widget) {
        this.__updateStates__P_249_1(widget, {
          selected: 1
        });
      },
      ...
      */
       ...
       */
      __getWidgetFrom__P_249_0: function __getWidgetFrom__P_249_0(row) {
       ...
       */
      __updateStates__P_249_1: function __updateStates__P_249_1(widget, states) {
        if (widget == null) {
          return;
        }
...
//# sourceMappingURL=WidgetProvider.js.map?dt=1598051411981