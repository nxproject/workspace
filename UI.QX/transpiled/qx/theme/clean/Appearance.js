    ...
    appearances:
    {
        ...
        "dragdrop-cursor":
        {
            style: function (states) {
                ...
                if (states.copy) {
                    icon = "copy";
                    retval = {
                        source: qx.theme.nx.Image.URLS["cursor-" + icon],
        ...
        */
        ...
        "slidebar/button-forward":
        {
            ...
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["arrow-" + (states.vertical ? "down" : "right")],
                    padding: [10, 12]
                };
            }
        },
        ...
        "slidebar/button-backward":
        {
            ...
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["arrow-" + (states.vertical ? "up" : "left")],
                    padding: [10, 12]
                };
            }
        },
        ...
        */
        ...
        "treevirtual-line":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-line"]
                };
            }
        },
        ...
        "treevirtual-contract":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["tree-minus"]
                };
            }
        },
        ...
        "treevirtual-expand":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["tree-plus"]
                };
            }
        },
        ...
        "treevirtual-only-contract":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-minus-only"]
                };
            }
        },
        ...
        "treevirtual-only-expand":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-plus-only"]
                };
            }
        },
        ...
        "treevirtual-start-contract":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-minus-start"]
                };
            }
        },
        ...
        "treevirtual-start-expand":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-plus-start"]
                };
            }
        },
        ...
        "treevirtual-end-contract":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-minus-end"]
                };
            }
        },
        ...
        "treevirtual-end-expand":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-plus-end"]
                };
            }
        },
        ...
        "treevirtual-cross-contract":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-minus-cross"]
                };
            }
        },
        ...
        "treevirtual-cross-expand":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-plus-cross"]
                };
            }
        },
        ...
        "treevirtual-end":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-end"]
                };
            }
        },
        ...
        "treevirtual-cross":
        {
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["treevirtual-cross"]
                };
            }
        },
        ...
        */
        ...
        "menu-checkbox":
        {
            ...
            style: function (states) {
                return {
                    icon: states.checked ? qx.theme.nx.Image.URLS["checkbox-checked"] : qx.theme.nx.Image.URLS["blank"]
                };
            }
        },
        ...
        "menu-radiobutton":
        {
            ...
            style: function (states) {
                return {
                    icon: !states.checked ? undefined : qx.theme.nx.Image.URLS["blank"]
                };
            }
        },
        ...
        */
        ...
        "scrollbar/button":
        {
            style: function (states) {
                ...
                styles.icon = qx.theme.nx.Image.URLS["arrow-" + icon];
        ...
        "checkbox":
        {
            ...
            style: function (states) {
                ...
                if (states.checked && !states.disabled) {
                    icon = qx.theme.nx.Image.URLS["checkbox-checked"];
                    // Undetermined
                } else if (states.checked && states.disabled) {
                    icon = qx.theme.nx.Image.URLS["checkbox-checked-disabled"];
        ...
        "listitem":
        {
            ...
            style: function (states) {
                ...
                return {
                    ...
                    opacity: states.drag ? 0.5 : undefined,
                    height: window.nxTheme.Defaults.itemHeight,
                    maxHeight: window.nxTheme.Defaults.itemHeight
                };
            }
        },
        ...
        */
        ...
        "tree-folder":
        {
            style: function (states) {
                ...
                return {
                    padding: [3, 8, 3, 5],
                    icon: states.opened ? qx.theme.nx.Image.URLS["tree-folder-open"] : qx.theme.nx.Image.URLS["tree-folder"],
                    iconOpened: qx.theme.nx.Image.URLS["tree-folder-open"],
                    backgroundColor: backgroundColor,
                    opacity: states.drag ? 0.5 : undefined
                };
            }
        ...
        "tree-file":
        {
            ...
            style: function (states) {
                return {
                    icon: qx.theme.nx.Image.URLS["tree-file"],
                    opacity: states.drag ? 0.5 : undefined
                };
            }
        },
        ...
        */
        ...
        "window":
        {
            style: function (states) {
                return {
                    ...
                    backgroundColor: window.nxTheme.Defaults.winBackgroundColor,
        ...
        "window/captionbar":
        {
            style: function (states) {
                return {
                    backgroundColor: window.nxTheme.Defaults.winCaptionColor,
                    padding: window.nxTheme.Defaults.winCaptionPadding,
                    paddingLeft: window.nxTheme.Defaults.winCaptionIconPadding,
        ...
        "window/close-button":
        {
            ...
            style: function (states) {
                return {
                    icon: states.hovered ? qx.theme.nx.Image.URLS["tabview-close-hovered"] : qx.theme.nx.Image.URLS["tabview-close"],
                    padding: [1, 1],
                    marginLeft: 6,
                    cursor: states.disabled ? undefined : "pointer"
                };
        ...
        */
        ...
        "toolbar":
        {
            style: function (states) {
                return {
                    backgroundColor: window.nxTheme.Defaultsnxfill,
                    padding: 0
                };
            }
        },
        ...
        "toolbar-separator":
        {
            style: function (states) {
                return {
                    ...
                    margin: [7, 0],
                    width: window.nxTheme.Defaults.toolbarGap
                };
            }
        },
        ...
        "toolbar-button":
        {
            ...
            style: function (states) {
                ...
                return {
                    ...
                    center: true,
                    padding: [10, 18],
                    gap: window.nxTheme.Defaults.buttonGap
                };
            }
        },
