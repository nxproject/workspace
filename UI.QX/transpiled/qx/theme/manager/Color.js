  ...
  qx.Class.define("qx.theme.manager.Color", {
    ...
    */
    members: {
      _applyTheme: function _applyTheme(value) {
        ...
        if (value) {
          ...
          for (var name in colors) {
            dest[name] = this.__parseColor__P_70_0(colors, name);
          }
        }
       ...
       */
      __parseColor__P_70_0: function __parseColor__P_70_0(colors, name) {
        ...
        if (typeof color === "string") {
          if (!qx.util.ColorUtil.isCssString(color)) {
            ...
            if (colors[color] != undefined) {
              return this.__parseColor__P_70_0(colors, color);
            }
          ...
          return this.__parseColor__P_70_0(colors, color(name));
...
//# sourceMappingURL=Color.js.map?dt=1598045171015