    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__getFontClass__P_92_0(theme.fonts[value]);
       ...
       */
      __resolveInclude__P_92_1: function __resolveInclude__P_92_1(fonts, fontName) {
        if (fonts[fontName].include) {
          ...
          this.__resolveInclude__P_92_1(fonts, fontName);
        }
      },
      // apply method
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__resolveInclude__P_92_1(source, key);
            }

            var font = this.__getFontClass__P_92_0(source[key]);
       ...
       * @return {Class}
       */
      __getFontClass__P_92_0: function __getFontClass__P_92_0(config) {
        if (config.sources) {
...
//# sourceMappingURL=Font.js.map?dt=1598045173803