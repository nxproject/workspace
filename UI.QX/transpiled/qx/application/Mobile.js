(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.application.Mobile", {
    ...
    */
    members: {
      __root__P_173_0: null,
      __routing__P_173_1: null,
      // interface method
      main: function main() {
        this.__root__P_173_0 = this._createRootWidget();

        if (qx.core.Environment.get("qx.mobile.nativescroll") == false) {
          this.__root__P_173_0.setShowScrollbarY(false);
        }
      },
      ...
      getRouting: function getRouting() {
        if (!this.__routing__P_173_1) {
          this.__routing__P_173_1 = new qx.application.Routing();
        }

        return this.__routing__P_173_1;
      },
...
//# sourceMappingURL=Mobile.js.map?dt=1598045571652