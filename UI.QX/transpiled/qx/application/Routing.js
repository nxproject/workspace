  ...
  *
  ...
  qx.Bootstrap.define("qx.application.Routing", {
    ...
    construct: function construct() {
      this.__messaging__P_174_0 = new qx.event.Messaging();
      this.__navigationHandler__P_174_1 = qx.bom.History.getInstance();

      this.__navigationHandler__P_174_1.addListener("changeState", this.__onChangeHash__P_174_2, this);
    },
    statics: {
      DEFAULT_PATH: "/",
      __back__P_174_3: [],
    ...
    members: {
      __navigationHandler__P_174_1: null,
      __messaging__P_174_0: null,
      __currentGetPath__P_174_5: null,
      ...
      _getPathOrFallback: function _getPathOrFallback(path, defaultPath) {
        if (path == "" || path == null || !this.__messaging__P_174_0.has("get", path)) {
      ...
      onGet: function onGet(route, handler, scope) {
        return this.__messaging__P_174_0.on("get", route, handler, scope);
      },
      ...
      onPost: function onPost(route, handler, scope) {
        return this.__messaging__P_174_0.on("post", route, handler, scope);
      },
      ...
      onPut: function onPut(route, handler, scope) {
        return this.__messaging__P_174_0.on("put", route, handler, scope);
      },
      ...
      onDelete: function onDelete(route, handler, scope) {
        return this.__messaging__P_174_0.on("delete", route, handler, scope);
      },
      ...
      onAny: function onAny(route, handler, scope) {
        return this.__messaging__P_174_0.onAny(route, handler, scope);
      },
      ...
      remove: function remove(id) {
        this.__messaging__P_174_0.remove(id);
      },
       ...
       */
      __onChangeHash__P_174_2: function __onChangeHash__P_174_2(evt) {
        var path = evt.getData();
        path = this._getPathOrFallback(path);

        if (path != this.__currentGetPath__P_174_5) {
          this._executeGet(path, null, true);
        }
      },
      ...
      _executeGet: function _executeGet(path, customData, fromEvent) {
        this.__currentGetPath__P_174_5 = path;

        var history = this.__getFromHistory__P_174_6(path);
        ...
        if (history) {
          if (!customData) {
            ...
            this.__replaceCustomData__P_174_7(path, customData);
          }
        } else {
          this.__addToHistory__P_174_8(path, customData);

          qx.application.Routing.__forward__P_174_4 = [];
        }

        this.__navigationHandler__P_174_1.setState(path);

        this.__messaging__P_174_0.emit("get", path, null, customData);
      },
      ...
      executePost: function executePost(path, params, customData) {
        this.__messaging__P_174_0.emit("post", path, params, customData);
      },
      ...
      executePut: function executePut(path, params, customData) {
        this.__messaging__P_174_0.emit("put", path, params, customData);
      },
      ...
      executeDelete: function executeDelete(path, params, customData) {
        this.__messaging__P_174_0.emit("delete", path, params, customData);
      },
      ...
      getState: function getState() {
        return this.__navigationHandler__P_174_1.getState();
      },
       ...
       */
      __addToHistory__P_174_8: function __addToHistory__P_174_8(path, customData) {
        qx.application.Routing.__back__P_174_3.unshift({
          path: path,
       ...
       * @param customData {var} The custom data to store.
       */
      __replaceCustomData__P_174_7: function __replaceCustomData__P_174_7(path, customData) {
        var register = [qx.application.Routing.__back__P_174_3, qx.application.Routing.__forward__P_174_4];
       ...
       */
      __getFromHistory__P_174_6: function __getFromHistory__P_174_6(path) {
        var back = qx.application.Routing.__back__P_174_3;
        var forward = qx.application.Routing.__forward__P_174_4;
        var found = false;
        var entry = null;
      ...
      */
      back: function back(customData) {
        ...
        var path,
            back = qx.application.Routing.__back__P_174_3;
      ...
      dispose: function dispose() {
        this.__navigationHandler__P_174_1.removeListener("changeState", this.__onChangeHash__P_174_2, this);
      }
    }
  });
...
//# sourceMappingURL=Routing.js.map?dt=1598045571883