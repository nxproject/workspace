  ...
  qx.Bootstrap.define("qx.bom.element.Class", {
    ...
    */
    statics: {
      ...
      __splitter__P_153_0: /\s+/g,

      /** @type {RegExp} String trim regular expression. */
      __trim__P_153_1: /^\s+|\s+$/g,
      ...
      addClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          if (old) {
            result = old.split(this.__splitter__P_153_0);
      ...
      removeClasses: {
        ...
        "default": function _default(element, classes) {
          ...
          return element.className = element.className.replace(reg, "").replace(this.__trim__P_153_1, "").replace(this.__splitter__P_153_0, " ");
        }
      }[qx.core.Environment.get("html.classlist") ? "native" : "default"],
...
//# sourceMappingURL=Class.js.map?dt=1598045179322