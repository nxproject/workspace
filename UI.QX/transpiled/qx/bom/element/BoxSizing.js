  ...
  qx.Bootstrap.define("qx.bom.element.BoxSizing", {
    ...
    */
    statics: {
       ...
       */
      __usesNativeBorderBox__P_97_1: function __usesNativeBorderBox__P_97_1(element) {
        var map = this.__nativeBorderBox__P_97_0;
      ...
      get: function get(element) {
        ...
        if (qx.bom.Document.isStandardMode(qx.dom.Node.getWindow(element))) {
          if (!this.__usesNativeBorderBox__P_97_1(element)) {
            return "content-box";
          }
        }
...
//# sourceMappingURL=BoxSizing.js.map?dt=1598045174289