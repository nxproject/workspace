  ...
  qx.Class.define("qx.bom.Shortcut", {
    ...
    */
    ...
    construct: function construct(shortcut) {
      ...
      this.__modifier__P_334_0 = {};
      this.__key__P_334_1 = null;
    ...
    */
    members: {
      ...
      */
       ...
       */
      __onKeyDown__P_334_2: function __onKeyDown__P_334_2(event) {
        if (this.getEnabled() && this.__matchesKeyEvent__P_334_3(event)) {
       ...
       * @param event {qx.event.type.KeySequence} The key event object
       */
      __onKeyPress__P_334_4: function __onKeyPress__P_334_4(event) {
        if (this.getEnabled() && this.__matchesKeyEvent__P_334_3(event)) {
          if (this.isAutoRepeat()) {
            this.execute(event.getTarget());
          }
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (value) {
          qx.event.Registration.addListener(document.documentElement, "keydown", this.__onKeyDown__P_334_2, this);
          qx.event.Registration.addListener(document.documentElement, "keypress", this.__onKeyPress__P_334_4, this);
        } else {
          qx.event.Registration.removeListener(document.documentElement, "keydown", this.__onKeyDown__P_334_2, this);
          qx.event.Registration.removeListener(document.documentElement, "keypress", this.__onKeyPress__P_334_4, this);
        }
      },
      // property apply
      _applyShortcut: function _applyShortcut(value, old) {
        if (value) {
          ...
          this.__key__P_334_1 = null; // To support shortcuts with "+" and "-" as keys it is necessary
          ...
          for (var i = 0; i < al; i++) {
            var identifier = this.__normalizeKeyIdentifier__P_334_5(a[i]);
            ...
            switch (identifier) {
              ...
              case "Meta":
              case "Alt":
                this.__modifier__P_334_0[identifier] = true;
                break;
              ...
              default:
                if (this.__key__P_334_1) {
                  var msg = "You can only specify one non modifier key!";
                  this.error(msg);
                  throw msg;
                }

                this.__key__P_334_1 = identifier;
            }
          }
        }
      ...
      */
       ...
       */
      __matchesKeyEvent__P_334_3: function __matchesKeyEvent__P_334_3(e) {
        var key = this.__key__P_334_1;
        ...
        if (!this.__modifier__P_334_0.Shift && e.isShiftPressed() || this.__modifier__P_334_0.Shift && !e.isShiftPressed() || !this.__modifier__P_334_0.Control && e.isCtrlPressed() || this.__modifier__P_334_0.Control && !e.isCtrlPressed() || !this.__modifier__P_334_0.Meta && e.isMetaPressed() || this.__modifier__P_334_0.Meta && !e.isMetaPressed() || !this.__modifier__P_334_0.Alt && e.isAltPressed() || this.__modifier__P_334_0.Alt && !e.isAltPressed()) {
          return false;
        }
      ...
      */
       ...
       */
      __oldKeyNameToKeyIdentifierMap__P_334_6: {
       ...
       */
      __normalizeKeyIdentifier__P_334_5: function __normalizeKeyIdentifier__P_334_5(keyName) {
        ...
        var keyIdentifier = this.__oldKeyNameToKeyIdentifierMap__P_334_6[keyName] || qx.lang.String.firstUp(keyName);
    ...
    */
    destruct: function destruct() {
      ...
      this.__modifier__P_334_0 = this.__key__P_334_1 = null;
    }
  });
  qx.bom.Shortcut.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Shortcut.js.map?dt=1598051423551