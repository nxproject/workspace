  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    statics: {
       ...
       */
      __prepareText__P_111_1: function __prepareText__P_111_1() {
        var el = this.__createMeasureElement__P_111_2(false);
       ...
       * @return {Element} Helper DOM element
       */
      __prepareHtml__P_111_3: function __prepareHtml__P_111_3() {
        var el = this.__createMeasureElement__P_111_2(true);
       ...
       */
      __createMeasureElement__P_111_2: function __createMeasureElement__P_111_2(html) {
        ...
        if (html) {
          ...
          if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
            ...
            for (var key in this.__styles__P_111_0) {
              style[key] = "inherit";
            }
       ...
       */
      __getStyles__P_111_4: function __getStyles__P_111_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__getStyles__P_111_4(html));
        }
      ...
      setSanitizer: function setSanitizer(func) {
        ...
        qx.bom.Label.__sanitizer__P_111_5 = func;
      },
      ...
      setValue: function setValue(element, value) {
        ...
        if (element.useHtml) {
          if (qx.bom.Label.__sanitizer__P_111_5 && typeof qx.bom.Label.__sanitizer__P_111_5 === "function") {
            value = qx.bom.Label.__sanitizer__P_111_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__prepareHtml__P_111_3(); // apply width


        element.style.width = width != undefined ? width + "px" : "auto"; // insert content

        element.innerHTML = content;
        return this.__measureSize__P_111_6(element, styles);
      },
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__prepareText__P_111_1();
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __measureSize__P_111_6: function __measureSize__P_111_6(element, styles) {
        // sync styles
        var keys = this.__styles__P_111_0;
...
//# sourceMappingURL=Label.js.map?dt=1598045175448