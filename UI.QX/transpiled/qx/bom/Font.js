(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.Font", {
    ...
    */
    statics: {
      ...
      getDefaultStyles: function getDefaultStyles() {
        return this.__defaultStyles__P_110_1;
      }
    },
    ...
    */
    members: {
      __lookupMap__P_110_0: null,
      // property apply
      _applySize: function _applySize(value, old) {
        this.__lookupMap__P_110_0.fontSize = value === null ? null : value + "px";
      },
      _applyLineHeight: function _applyLineHeight(value, old) {
        this.__lookupMap__P_110_0.lineHeight = value === null ? null : value;
      },
      // property apply
      _applyFamily: function _applyFamily(value, old) {
        ...
        this.__lookupMap__P_110_0.fontFamily = family;
      },
      // property apply
      _applyBold: function _applyBold(value, old) {
        this.__lookupMap__P_110_0.fontWeight = value == null ? null : value ? "bold" : "normal";
      },
      // property apply
      _applyItalic: function _applyItalic(value, old) {
        this.__lookupMap__P_110_0.fontStyle = value == null ? null : value ? "italic" : "normal";
      },
      // property apply
      _applyDecoration: function _applyDecoration(value, old) {
        this.__lookupMap__P_110_0.textDecoration = value == null ? null : value;
      },
      // property apply
      _applyColor: function _applyColor(value, old) {
        this.__lookupMap__P_110_0.color = null;

        if (value) {
          this.__lookupMap__P_110_0.color = qx.theme.manager.Color.getInstance().resolve(value);
        }
      },
      // property apply
      _applyWeight: function _applyWeight(value, old) {
        this.__lookupMap__P_110_0.fontWeight = value;
      },
      // property apply
      _applyTextShadow: function _applyTextShadow(value, old) {
        this.__lookupMap__P_110_0.textShadow = value == null ? null : value;
      },
      ...
      getStyles: function getStyles() {
        return this.__lookupMap__P_110_0;
      }
    }
  });
...
//# sourceMappingURL=Font.js.map?dt=1598045175379