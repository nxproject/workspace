  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Idle", {
    ...
    */
    ...
    members: {
      __timer__P_149_0: null,
      // property apply
      _applyTimeoutInterval: function _applyTimeoutInterval(value) {
        if (this.__timer__P_149_0) {
          this.__timer__P_149_0.setInterval(value);
        }
      },
       ...
       */
      __startTimer__P_149_1: function __startTimer__P_149_1() {
        if (!this.__timer__P_149_0 && this.hasListener("interval")) {
          var timer = new qx.event.Timer(this.getTimeoutInterval());
          timer.addListener("interval", this._onInterval, this);
          timer.start();
          this.__timer__P_149_0 = timer;
        }
      },
       ...
       */
      __stopTimer__P_149_2: function __stopTimer__P_149_2() {
        if (this.__timer__P_149_0 && !this.hasListener("interval")) {
          this.__timer__P_149_0.stop();

          this.__timer__P_149_0.dispose();

          this.__timer__P_149_0 = null;
        }
      },
...
//# sourceMappingURL=Idle.js.map?dt=1598045178967