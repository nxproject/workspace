  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    ...
    construct: function construct(interval) {
      ...
      this.__oninterval__P_93_0 = function () {
    ...
    */
    statics: {
      ...
      once: function once(func, obj, timeout) {
        ...
        timer.__onceFunc__P_93_1 = func; // Add event listener to interval

        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__onceFunc__P_93_1;
          timer.dispose();
          obj = null;
    ...
    */
    members: {
      __intervalHandler__P_93_2: null,
      __oninterval__P_93_0: null,
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__intervalHandler__P_93_2);
          this.__intervalHandler__P_93_2 = null;
        } else if (value) {
          this.__intervalHandler__P_93_2 = window.setInterval(this.__oninterval__P_93_0, this.getInterval());
        }
      },
    ...
    */
    destruct: function destruct() {
      if (this.__intervalHandler__P_93_2) {
        window.clearInterval(this.__intervalHandler__P_93_2);
      }

      this.__intervalHandler__P_93_2 = this.__oninterval__P_93_0 = null;
    }
  });
  qx.event.Timer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Timer.js.map?dt=1598045173901