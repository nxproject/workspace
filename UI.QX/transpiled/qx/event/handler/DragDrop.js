  ...
  qx.Class.define("qx.event.handler.DragDrop", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__manager__P_60_0 = manager;
      this.__root__P_60_1 = manager.getWindow().document.documentElement; // Initialize listener

      this.__manager__P_60_0.addListener(this.__root__P_60_1, "longtap", this._onLongtap, this);

      this.__manager__P_60_0.addListener(this.__root__P_60_1, "pointerdown", this._onPointerdown, this, true);

      qx.event.Registration.addListener(window, "blur", this._onWindowBlur, this); // Initialize data structures

      this.__rebuildStructures__P_60_2();
    },
    ...
    */
    members: {
      __manager__P_60_0: null,
      __root__P_60_1: null,
      __dropTarget__P_60_3: null,
      __dragTarget__P_60_4: null,
      __types__P_60_5: null,
      __actions__P_60_6: null,
      __keys__P_60_7: null,
      __cache__P_60_8: null,
      __currentType__P_60_9: null,
      __currentAction__P_60_10: null,
      __sessionActive__P_60_11: false,
      __validDrop__P_60_12: false,
      __validAction__P_60_13: false,
      __dragTargetWidget__P_60_14: null,
      __startConfig__P_60_15: null,
      ...
      */
      ...
      addType: function addType(type) {
        this.__types__P_60_5[type] = true;
      },
      ...
      addAction: function addAction(action) {
        this.__actions__P_60_6[action] = true;
      },
      ...
      supportsType: function supportsType(type) {
        return !!this.__types__P_60_5[type];
      },
      ...
      supportsAction: function supportsAction(type) {
        return !!this.__actions__P_60_6[type];
      },
      ...
      setDropAllowed: function setDropAllowed(isAllowed) {
        this.__validDrop__P_60_12 = isAllowed;

        this.__detectAction__P_60_16();
      },
      ...
      getData: function getData(type) {
        if (!this.__validDrop__P_60_12 || !this.__dropTarget__P_60_3) {
          throw new Error("This method must not be used outside the drop event listener!");
        }

        if (!this.__types__P_60_5[type]) {
          throw new Error("Unsupported data type: " + type + "!");
        }

        if (!this.__cache__P_60_8[type]) {
          this.__currentType__P_60_9 = type;

          this.__fireEvent__P_60_17("droprequest", this.__dragTarget__P_60_4, this.__dropTarget__P_60_3, false, false);
        }
        ...
        return this.__cache__P_60_8[type] || null;
      },
      ...
      getDataAsync: function getDataAsync(type) {
        ...
        if (!this.__cache__P_60_8[type]) {
          qx.event.Utils.then(tracker, function () {
            self.__currentType__P_60_9 = type;
            return self.__fireEvent__P_60_17("droprequest", self.__dragTarget__P_60_4, self.__dropTarget__P_60_3, false);
          });
        }
      ...
      getCurrentAction: function getCurrentAction() {
        ...
        return this.__currentAction__P_60_10;
      },
      ...
      getCurrentActionAsync: function getCurrentActionAsync() {
        var self = this;
        return qx.Promise.resolve(self.__detectAction__P_60_16()).then(function () {
          return self.__currentAction__P_60_10;
        });
      },
      ...
      getDragTarget: function getDragTarget() {
        return this.__dragTargetWidget__P_60_14;
      },
      ...
      addData: function addData(type, data) {
        this.__cache__P_60_8[type] = data;
      },
      ...
      getCurrentType: function getCurrentType() {
        return this.__currentType__P_60_9;
      },
      ...
      isSessionActive: function isSessionActive() {
        return this.__sessionActive__P_60_11;
      },
      ...
      */
       ...
       */
      __rebuildStructures__P_60_2: function __rebuildStructures__P_60_2() {
        this.__types__P_60_5 = {};
        this.__actions__P_60_6 = {};
        this.__keys__P_60_7 = {};
        this.__cache__P_60_8 = {};
      },
       ...
       */
      __detectAction__P_60_16: function __detectAction__P_60_16() {
        if (this.__dragTarget__P_60_4 == null) {
          {
            return qx.Promise.reject();
          }
        }

        var actions = this.__actions__P_60_6;
        var keys = this.__keys__P_60_7;
        var current = null;

        if (this.__validDrop__P_60_12) {
        ...
        var self = this;
        var tracker = {};
        var old = this.__currentAction__P_60_10;

        if (current != old) {
          if (this.__dropTarget__P_60_3) {
            qx.event.Utils["catch"](function () {
              self.__validAction__P_60_13 = false;
              current = null;
            });
            qx.event.Utils.then(tracker, function () {
              self.__currentAction__P_60_10 = current;
              return self.__fireEvent__P_60_17("dragchange", self.__dropTarget__P_60_3, self.__dragTarget__P_60_4, true);
            });
            qx.event.Utils.then(tracker, function (validAction) {
              self.__validAction__P_60_13 = validAction;
        ...
        return qx.event.Utils.then(tracker, function () {
          if (current != old) {
            self.__currentAction__P_60_10 = current;
            return self.__fireEvent__P_60_17("dragchange", self.__dragTarget__P_60_4, self.__dropTarget__P_60_3, false);
          }
        });
      },
       ...
       * not prevented
       */
      __fireEvent__P_60_17: function __fireEvent__P_60_17(type, target, relatedTarget, cancelable, original, async) {
       ...
       */
      __findDraggable__P_60_18: function __findDraggable__P_60_18(elem) {
       ...
       */
      __findDroppable__P_60_19: function __findDroppable__P_60_19(elem) {
        while (elem && elem.nodeType == 1) {
      ...
      clearSession: function clearSession() {
        ...
        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "pointermove", this._onPointermove, this);

        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "pointerup", this._onPointerup, this, true);

        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "keydown", this._onKeyDown, this, true);

        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "keyup", this._onKeyUp, this, true);

        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "keypress", this._onKeyPress, this, true);

        this.__manager__P_60_0.removeListener(this.__root__P_60_1, "roll", this._onRoll, this, true);

        var tracker = {};
        var self = this; // Fire dragend event

        if (this.__dragTarget__P_60_4) {
          qx.event.Utils.then(tracker, function () {
            return self.__fireEvent__P_60_17("dragend", self.__dragTarget__P_60_4, self.__dropTarget__P_60_3, false);
          });
        }

        return qx.event.Utils.then(tracker, function () {
          // Cleanup
          self.__validDrop__P_60_12 = false;
          self.__dropTarget__P_60_3 = null;

          if (self.__dragTargetWidget__P_60_14) {
            self.__dragTargetWidget__P_60_14.removeState("drag");

            self.__dragTargetWidget__P_60_14 = null;
          } // Clear init
          //self.debug("Clearing drag target");


          self.__dragTarget__P_60_4 = null;
          self.__sessionActive__P_60_11 = false;
          self.__startConfig__P_60_15 = null;

          self.__rebuildStructures__P_60_2();
        });
      },
      ...
      */
      ...
      _onLongtap: function _onLongtap(e) {
        ...
        this.__manager__P_60_0.addListener(this.__root__P_60_1, "roll", this._onRoll, this, true);
      ...
      _start: function _start(e) {
        ...
        var target = this.__startConfig__P_60_15 ? this.__startConfig__P_60_15.target : e.getTarget();

        var draggable = this.__findDraggable__P_60_18(target);

        if (draggable) {
          // This is the source target
          //this.debug("Setting dragtarget = " + draggable);
          this.__dragTarget__P_60_4 = draggable;
          var widgetOriginalTarget = qx.ui.core.Widget.getWidgetByElement(this.__startConfig__P_60_15.original);
          ...
          if (widgetOriginalTarget) {
            this.__dragTargetWidget__P_60_14 = widgetOriginalTarget;
          ...
          qx.event.Utils.then(tracker, function () {
            return self.__fireEvent__P_60_17("dragstart", self.__dragTarget__P_60_4, self.__dropTarget__P_60_3, true, e);
          });
          return qx.event.Utils.then(tracker, function (validAction) {
            ...
            self.__manager__P_60_0.addListener(self.__root__P_60_1, "keydown", self._onKeyDown, self, true);

            self.__manager__P_60_0.addListener(self.__root__P_60_1, "keyup", self._onKeyUp, self, true);

            self.__manager__P_60_0.addListener(self.__root__P_60_1, "keypress", self._onKeyPress, self, true);

            self.__sessionActive__P_60_11 = true;
          });
        }
      },
      ...
      _onPointerdown: function _onPointerdown(e) {
        if (e.isPrimary()) {
          ...
          this.__manager__P_60_0.addListener(this.__root__P_60_1, "pointermove", this._onPointermove, this);

          this.__manager__P_60_0.addListener(this.__root__P_60_1, "pointerup", this._onPointerup, this, true);
        }
      },
      ...
      _onPointermove: function _onPointermove(e) {
        ...
        if (!self.__sessionActive__P_60_11 && e.getPointerType() == "mouse") {
        ...
        return qx.event.Utils.then(tracker, function () {
          ...
          if (!self.__sessionActive__P_60_11) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            return self.__fireEvent__P_60_17("drag", self.__dragTarget__P_60_4, self.__dropTarget__P_60_3, true, e);
          });
          qx.event.Utils.then(tracker, function (validAction) {
            if (!validAction) {
              this.clearSession();
            ...
            if (self.__startConfig__P_60_15.target === el) {
            ...
            if (el !== cursorEl) {
              var droppable = self.__findDroppable__P_60_19(el); // new drop target detected


              if (droppable && droppable != self.__dropTarget__P_60_3) {
                var dropLeaveTarget = self.__dropTarget__P_60_3;
                self.__validDrop__P_60_12 = true; // initial value should be true

                self.__dropTarget__P_60_3 = droppable;
                var innerTracker = {};
                ...
                if (dropLeaveTarget) {
                  qx.event.Utils.then(innerTracker, function () {
                    return self.__fireEvent__P_60_17("dragleave", dropLeaveTarget, self.__dragTarget__P_60_4, false, e);
                  });
                }

                qx.event.Utils.then(innerTracker, function () {
                  return self.__fireEvent__P_60_17("dragover", droppable, self.__dragTarget__P_60_4, true, e);
                });
                return qx.event.Utils.then(innerTracker, function (validDrop) {
                  self.__validDrop__P_60_12 = validDrop;
                });
              } // only previous drop target
              else if (!droppable && self.__dropTarget__P_60_3) {
                  var innerTracker = {};
                  qx.event.Utils.then(innerTracker, function () {
                    return self.__fireEvent__P_60_17("dragleave", self.__dropTarget__P_60_3, self.__dragTarget__P_60_4, false, e);
                  });
                  return qx.event.Utils.then(innerTracker, function () {
                    self.__dropTarget__P_60_3 = null;
                    self.__validDrop__P_60_12 = false;
                    return self.__detectAction__P_60_16();
                  });
                }
            }
          });
      ...
      _getDelta: function _getDelta(e) {
        if (!this.__startConfig__P_60_15) {
          return null;
        }

        var deltaX = e.getDocumentLeft() - this.__startConfig__P_60_15.left;

        var deltaY = e.getDocumentTop() - this.__startConfig__P_60_15.top;
      ...
      _onPointerup: function _onPointerup(e) {
        ...
        if (this.__validDrop__P_60_12 && this.__validAction__P_60_13) {
          qx.event.Utils.then(tracker, function () {
            return self.__fireEvent__P_60_17("drop", self.__dropTarget__P_60_3, self.__dragTarget__P_60_4, false, e);
          });
        }

        return qx.event.Utils.then(tracker, function () {
          // Stop event
          if (e.getTarget() == self.__dragTarget__P_60_4) {
            e.stopPropagation();
          } // Clean up
      ...
      _onKeyDown: function _onKeyDown(e) {
        ...
        switch (iden) {
          ...
          case "Control":
          case "Shift":
            if (!this.__keys__P_60_7[iden]) {
              this.__keys__P_60_7[iden] = true;
              return this.__detectAction__P_60_16();
            }
      ...
      _onKeyUp: function _onKeyUp(e) {
        ...
        switch (iden) {
          ...
          case "Shift":
            if (this.__keys__P_60_7[iden]) {
              this.__keys__P_60_7[iden] = false;
              return this.__detectAction__P_60_16();
            }
    ...
    */
    destruct: function destruct() {
      ...
      this.__dragTarget__P_60_4 = this.__dropTarget__P_60_3 = this.__manager__P_60_0 = this.__root__P_60_1 = this.__types__P_60_5 = this.__actions__P_60_6 = this.__keys__P_60_7 = this.__cache__P_60_8 = null;
    },
...
//# sourceMappingURL=DragDrop.js.map?dt=1598045169909