    ...
    statics: {
      ...
      addPendingDefer: function addPendingDefer(clazz, cb) {
        if (qx.$$loader && qx.$$loader.delayDefer) {
          this.__pendingDefers__P_7_0.push(clazz);
      ...
      executePendingDefers: function executePendingDefers(dbClassInfo) {
        ...
        if (!dbClassInfo) {
          var pendingDefers = this.__pendingDefers__P_7_0;
          this.__pendingDefers__P_7_0 = [];
      ...
      */
       ...
       * @type {String[]}
       */
      __shadowedKeys__P_7_1: ["isPrototypeOf", "hasOwnProperty", "toLocaleString", "toString", "valueOf", "propertyIsEnumerable", "constructor"],
      ...
      keys: {
        ...
        "BROKEN_IE": function BROKEN_IE(map) {
          ...
          var shadowedKeys = qx.Bootstrap.__shadowedKeys__P_7_1;
      ...
      */
      ...
      getClass: function getClass(value) {
        ...
        return qx.Bootstrap.__classToTypeMap__P_7_2[classString] || classString.slice(8, -1);
      },
...
//# sourceMappingURL=Bootstrap.js.map?dt=1598045160913