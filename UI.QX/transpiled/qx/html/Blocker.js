  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Blocker", {
    ...
    construct: function construct(backgroundColor, opacity) {
      ...
      this.addListener("appear", this.__refreshCursor__P_126_0, this);
      this.addListener("disappear", this.__refreshCursor__P_126_0, this);
    },
    members: {
      /**
       ...
       * old value.
       */
      __refreshCursor__P_126_0: function __refreshCursor__P_126_0() {
...
//# sourceMappingURL=Blocker.js.map?dt=1598045176699