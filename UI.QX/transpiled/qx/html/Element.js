  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__nodeName__P_67_0 = tagName || "div";
      this.__styleValues__P_67_1 = styles || null;
      this.__attribValues__P_67_2 = attributes || null;
    },
    ...
    */
    statics: {
      ...
      */
      ...
      __selection__P_67_3: {},
      __focusHandler__P_67_4: null,
      __mouseCapture__P_67_5: null,
      ...
      */
      ...
      _scheduleFlush: function _scheduleFlush(job) {
        qx.html.Element.__deferredCall__P_67_6.schedule();
      },
      ...
      flush: function flush() {
        ...
        var focusHandler = this.__getFocusHandler__P_67_7();

        var focusedDomElement = focusHandler.getFocus();

        if (focusedDomElement && this.__willBecomeInvisible__P_67_8(focusedDomElement)) {
        ...
        if (activeDomElement && this.__willBecomeInvisible__P_67_8(activeDomElement)) {
          qx.bom.Element.deactivate(activeDomElement);
        } // release capture for elements, which will be removed


        var captureDomElement = this.__getCaptureElement__P_67_9();

        if (captureDomElement && this.__willBecomeInvisible__P_67_8(captureDomElement)) {
        ...
        for (var hc in modified) {
          ...
          if (obj.__willBeSeeable__P_67_10() || obj.classname == "qx.html.Iframe") {
            // Separately queue rendered elements
            if (obj.__element__P_67_11 && qx.dom.Hierarchy.isRendered(obj.__element__P_67_11)) {
              later.push(obj);
        ...
        for (var hc in visibility) {
          obj = visibility[hc];
          var element = obj.__element__P_67_11;
          ...
          {
            if (this.DEBUG) {
              qx.log.Logger.debug(this, "Switching visibility to: " + obj.__visible__P_67_13);
            }
          ...
          if (!obj.$$disposed) {
            element.style.display = obj.__visible__P_67_13 ? "" : "none"; // also hide the element (fixed some rendering problem in IE<8 & IE8 quirks)

            if (qx.core.Environment.get("engine.name") == "mshtml") {
              if (!(document.documentMode >= 8)) {
                element.style.visibility = obj.__visible__P_67_13 ? "visible" : "hidden";
              }
            }
          }
        ...
        for (var hc in scroll) {
          obj = scroll[hc];
          var elem = obj.__element__P_67_11;

          if (elem && elem.offsetWidth) {
            var done = true; // ScrollToX

            if (obj.__lazyScrollX__P_67_14 != null) {
              obj.__element__P_67_11.scrollLeft = obj.__lazyScrollX__P_67_14;
              delete obj.__lazyScrollX__P_67_14;
            } // ScrollToY


            if (obj.__lazyScrollY__P_67_15 != null) {
              obj.__element__P_67_11.scrollTop = obj.__lazyScrollY__P_67_15;
              delete obj.__lazyScrollY__P_67_15;
            } // ScrollIntoViewX


            var intoViewX = obj.__lazyScrollIntoViewX__P_67_16;
            ...
            if (intoViewX != null) {
              ...
              if (child && child.offsetWidth) {
                ...
                delete obj.__lazyScrollIntoViewX__P_67_16;
              } else {
                done = false;
              }
            } // ScrollIntoViewY
            ...
            var intoViewY = obj.__lazyScrollIntoViewY__P_67_17;
            ...
            if (intoViewY != null) {
              ...
              if (child && child.offsetWidth) {
                ...
                delete obj.__lazyScrollIntoViewY__P_67_17;
              } else {
                done = false;
              }
        ...
        for (var i = 0; i < this._actions.length; i++) {
          ...
          var element = action.element.__element__P_67_11;

          if (!element || !activityEndActions[action.type] && !action.element.__willBeSeeable__P_67_10()) {
            continue;
          }
        ...
        for (var hc in this.__selection__P_67_3) {
          var selection = this.__selection__P_67_3[hc];
          var elem = selection.element.__element__P_67_11;

          if (elem) {
            qx.bom.Selection.set(elem, selection.start, selection.end);
            delete this.__selection__P_67_3[hc];
          }
       ...
       */
      __getFocusHandler__P_67_7: function __getFocusHandler__P_67_7() {
        if (!this.__focusHandler__P_67_4) {
          var eventManager = qx.event.Registration.getManager(window);
          this.__focusHandler__P_67_4 = eventManager.getHandler(qx.event.handler.Focus);
        }

        return this.__focusHandler__P_67_4;
      },
       ...
       */
      __getCaptureElement__P_67_9: function __getCaptureElement__P_67_9() {
        if (!this.__mouseCapture__P_67_5) {
          var eventManager = qx.event.Registration.getManager(window);
          this.__mouseCapture__P_67_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
        }

        return this.__mouseCapture__P_67_5.getCaptureElement();
      },
       ...
       */
      __willBecomeInvisible__P_67_8: function __willBecomeInvisible__P_67_8(domElement) {
        var element = this.fromDomElement(domElement);
        return element && !element.__willBeSeeable__P_67_10();
      },
    ...
    */
    members: {
      ...
      ---------------------------------------------------------------------------
      */
      __nodeName__P_67_0: null,

      /** @type {Element} DOM element of this object */
      __element__P_67_11: null,

      /** @type {qx.ui.core.Widget} the Widget this element is attached to */
      __widget__P_67_18: null,

      /** @type {Boolean} Marker for always visible root nodes (often the body node) */
      __root__P_67_19: false,

      /** @type {Boolean} Whether the element should be included in the render result */
      __included__P_67_20: true,

      /** @type {Boolean} Whether the element should be visible in the render result */
      __visible__P_67_13: true,
      __lazyScrollIntoViewX__P_67_16: null,
      __lazyScrollIntoViewY__P_67_17: null,
      __lazyScrollX__P_67_14: null,
      __lazyScrollY__P_67_15: null,
      __styleJobs__P_67_21: null,
      __attribJobs__P_67_22: null,
      __propertyJobs__P_67_23: null,
      __styleValues__P_67_1: null,
      __attribValues__P_67_2: null,
      __propertyValues__P_67_24: null,
      __eventValues__P_67_25: null,
      __children__P_67_26: null,
      __modifiedChildren__P_67_27: null,
      __parent__P_67_28: null,
      ...
      _scheduleChildrenUpdate: function _scheduleChildrenUpdate() {
        if (this.__modifiedChildren__P_67_27) {
          return;
        }

        this.__modifiedChildren__P_67_27 = true;
      ...
      _createDomElement: function _createDomElement() {
        return qx.dom.Element.create(this.__nodeName__P_67_0);
      },
      ...
      connectWidget: function connectWidget(widget) {
        {
          qx.core.Assert.assertTrue(!this.__widget__P_67_18 || this.__widget__P_67_18 === widget);
        }
        this.__widget__P_67_18 = widget;

        if (this.__element__P_67_11) {
          {
            qx.core.Assert.assertTrue(!this.__element__P_67_11.$$widget && !this.__element__P_67_11.$$widgetObject || this.__element__P_67_11.$$widgetObject === widget && this.__element__P_67_11.$$widget === widget.toHashCode());
          }
          this.__element__P_67_11.$$widget = widget.toHashCode();
          this.__element__P_67_11.$$widgetObject = widget;
        }
      ...
      disconnectWidget: function disconnectWidget(widget) {
        {
          qx.core.Assert.assertTrue(this.__widget__P_67_18 === widget);
        }
        delete this.__widget__P_67_18;

        if (this.__element__P_67_11) {
          {
            qx.core.Assert.assertTrue(!this.__element__P_67_11.$$widget && !this.__element__P_67_11.$$widgetObject || this.__element__P_67_11.$$widgetObject === widget && this.__element__P_67_11.$$widget === widget.toHashCode());
          }
          this.__element__P_67_11.$$widget = "";
          delete this.__element__P_67_11.$$widgetObject;
        }
       ...
       */
      __connectDomElement__P_67_29: function __connectDomElement__P_67_29(domElement) {
        {
          qx.core.Assert.assertTrue(!this.__element__P_67_11 || this.__element__P_67_11 === domElement);
        ...
        ;
        this.__element__P_67_11 = domElement;
        domElement.$$elementObject = this;
        domElement.$$element = this.toHashCode();

        if (this.__widget__P_67_18) {
          domElement.$$widget = this.__widget__P_67_18.toHashCode();
          domElement.$$widgetObject = this.__widget__P_67_18;
        }
      },
      ...
      */
       ...
       *
       */
      __flush__P_67_12: function __flush__P_67_12() {
        {
          if (this.DEBUG) {
        ...
        var length;
        var children = this.__children__P_67_26;
        ...
        if (children) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__visible__P_67_13 && child.__included__P_67_20 && !child.__element__P_67_11) {
              child.__flush__P_67_12();
            }
          }
        }

        if (!this.__element__P_67_11) {
          this.__connectDomElement__P_67_29(this._createDomElement());
        ...
        delete this.__modifiedChildren__P_67_27;
      },
      ...
      */
      ...
      _insertChildren: function _insertChildren() {
        ...
        if (length > 2) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__element__P_67_11 && child.__included__P_67_20) {
              domElement.appendChild(child.__element__P_67_11);
            }
          }

          this.__element__P_67_11.appendChild(domElement);
        } else {
          var domElement = this.__element__P_67_11;
      ...
      _syncChildren: function _syncChildren() {
        var dataChildren = this.__children__P_67_26;
        var dataLength = dataChildren.length;
        var dataChild;
        var dataEl;
        var domParent = this.__element__P_67_11;
        ...
        for (var i = domChildren.length - 1; i >= 0; i--) {
          ...
          if (!dataEl || !dataEl.__included__P_67_20 || dataEl.__parent__P_67_28 !== this) {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          if (dataChild.__included__P_67_20) {
            dataEl = dataChild.__element__P_67_11;
      ...
      */
      updateObjectId: function updateObjectId() {
        ...
        if (qx.core.Environment.get("module.objectid")) {
          ...
          if (this.__widget__P_67_18 && this.__widget__P_67_18.getQxObjectId()) {
            id = qx.core.Id.getAbsoluteIdOf(this.__widget__P_67_18, true) || null;
          }
      ...
      _copyData: function _copyData(fromMarkup) {
        var elem = this.__element__P_67_11; // Copy attributes

        var data = this.__attribValues__P_67_2;
        ...
        var data = this.__styleValues__P_67_1;
        ...
        var data = this.__propertyValues__P_67_24;
        ...
        var data = this.__eventValues__P_67_25;
        ...
        if (data) {
          ...
          delete this.__eventValues__P_67_25;
        }
      },
      ...
      _syncData: function _syncData() {
        var elem = this.__element__P_67_11;
        var Attribute = qx.bom.element.Attribute;
        var Style = qx.bom.element.Style; // Sync attributes

        var jobs = this.__attribJobs__P_67_22;
        ...
        if (jobs) {
          ...
          this.__attribJobs__P_67_22 = null;
        } // Sync styles


        var jobs = this.__styleJobs__P_67_21;
        ...
        if (jobs) {
          ...
          this.__styleJobs__P_67_21 = null;
        } // Sync misc


        var jobs = this.__propertyJobs__P_67_23;
        ...
        if (jobs) {
          ...
          this.__propertyJobs__P_67_23 = null;
      ...
      */
       ...
       */
      __willBeSeeable__P_67_10: function __willBeSeeable__P_67_10() {
        var pa = this; // Any chance to cache this information in the parents?

        while (pa) {
          if (pa.__root__P_67_19) {
            return true;
          }

          if (!pa.__included__P_67_20 || !pa.__visible__P_67_13) {
            return false;
          }

          pa = pa.__parent__P_67_28;
        }
       ...
       *     of this element
       */
      __addChildHelper__P_67_30: function __addChildHelper__P_67_30(child) {
        if (child.__parent__P_67_28 === this) {
          throw new Error("Child is already in: " + child);
        }

        if (child.__root__P_67_19) {
          throw new Error("Root elements could not be inserted into other ones.");
        } // Remove from previous parent


        if (child.__parent__P_67_28) {
          child.__parent__P_67_28.remove(child);
        } // Convert to child of this object


        child.__parent__P_67_28 = this; // Prepare array

        if (!this.__children__P_67_26) {
          this.__children__P_67_26 = [];
       ...
       *     of this element
       */
      __removeChildHelper__P_67_31: function __removeChildHelper__P_67_31(child) {
        if (child.__parent__P_67_28 !== this) {
        ...
        delete child.__parent__P_67_28;
      },
       ...
       *     of this element
       */
      __moveChildHelper__P_67_32: function __moveChildHelper__P_67_32(child) {
        if (child.__parent__P_67_28 !== this) {
          throw new Error("Has no child: " + child);
        } // Schedule children update
      ...
      */
      ...
      getChildren: function getChildren() {
        return this.__children__P_67_26 || null;
      },
      ...
      add: function add(varargs) {
        if (arguments[1]) {
          for (var i = 0, l = arguments.length; i < l; i++) {
            this.__addChildHelper__P_67_30(arguments[i]);
          }

          this.__children__P_67_26.push.apply(this.__children__P_67_26, arguments);
        } else {
          this.__addChildHelper__P_67_30(varargs);

          this.__children__P_67_26.push(varargs);
        } // Chaining support
      ...
      addAt: function addAt(child, index) {
        this.__addChildHelper__P_67_30(child);

        qx.lang.Array.insertAt(this.__children__P_67_26, child, index); // Chaining support
      ...
      remove: function remove(childs) {
        ...
        if (arguments[1]) {
          ...
          for (var i = 0, l = arguments.length; i < l; i++) {
            ...
            this.__removeChildHelper__P_67_31(child);

            qx.lang.Array.remove(children, child);
          }
        } else {
          this.__removeChildHelper__P_67_31(childs);
      ...
      removeAt: function removeAt(index) {
        ...
        qx.lang.Array.removeAt(this.__children__P_67_26, index); // Chaining support
      ...
      removeAll: function removeAll() {
        ...
        if (children) {
          for (var i = 0, l = children.length; i < l; i++) {
            this.__removeChildHelper__P_67_31(children[i]);
          } // Clear array
      ...
      */
      ...
      getParent: function getParent() {
        return this.__parent__P_67_28 || null;
      },
      ...
      insertInto: function insertInto(parent, index) {
        parent.__addChildHelper__P_67_30(this);

        if (index == null) {
          parent.__children__P_67_26.push(this);
        } else {
          qx.lang.Array.insertAt(this.__children__P_67_26, this, index);
        }
      ...
      insertBefore: function insertBefore(rel) {
        var parent = rel.__parent__P_67_28;

        parent.__addChildHelper__P_67_30(this);

        qx.lang.Array.insertBefore(parent.__children__P_67_26, this, rel);
        return this;
      },
      ...
      insertAfter: function insertAfter(rel) {
        ...
        qx.lang.Array.insertAfter(parent.__children__P_67_26, this, rel);
        return this;
      },
      ...
      moveTo: function moveTo(index) {
        var parent = this.__parent__P_67_28;

        parent.__moveChildHelper__P_67_32(this);

        var oldIndex = parent.__children__P_67_26.indexOf(this);
        ...
        qx.lang.Array.removeAt(parent.__children__P_67_26, oldIndex);
        qx.lang.Array.insertAt(parent.__children__P_67_26, this, index);
        return this;
      },
      ...
      moveBefore: function moveBefore(rel) {
        var parent = this.__parent__P_67_28;
        return this.moveTo(parent.__children__P_67_26.indexOf(rel));
      },
      ...
      moveAfter: function moveAfter(rel) {
        var parent = this.__parent__P_67_28;
        return this.moveTo(parent.__children__P_67_26.indexOf(rel) + 1);
      },
      ...
      free: function free() {
        ...
        if (!parent.__children__P_67_26) {
          return this;
        }

        parent.__removeChildHelper__P_67_31(this);

        qx.lang.Array.remove(parent.__children__P_67_26, this);
        return this;
      },
      ...
      */
      ...
      getDomElement: function getDomElement() {
        return this.__element__P_67_11 || null;
      },
      ...
      getNodeName: function getNodeName() {
        return this.__nodeName__P_67_0;
      },
      ...
      useMarkup: function useMarkup(html) {
        ...
        return this.__element__P_67_11;
      },
      ...
      useElement: function useElement(elem) {
        ...
        this.__connectDomElement__P_67_29(elem); // Copy currently existing data over to element
      ...
      isFocusable: function isFocusable() {
        ...
        if (tabIndex >= 0 && focusable[this.__nodeName__P_67_0]) {
          return true;
        }
      ...
      isNativelyFocusable: function isNativelyFocusable() {
        return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__nodeName__P_67_0];
      },
      ...
      */
      ...
      include: function include() {
        if (this.__included__P_67_20) {
          return this;
        }

        delete this.__included__P_67_20;

        if (this.__parent__P_67_28) {
          this.__parent__P_67_28._scheduleChildrenUpdate();
        }
      ...
      exclude: function exclude() {
        ...
        this.__included__P_67_20 = false;
      ...
      isIncluded: function isIncluded() {
        return this.__included__P_67_20 === true;
      },
      ...
      */
      ...
      fadeIn: function fadeIn(duration) {
        var col = qxWeb(this.__element__P_67_11);
        ...
        if (!this.__element__P_67_11) {
          this.__flush__P_67_12();

          col.push(this.__element__P_67_11);
        }
      ...
      */
      ...
      show: function show() {
        ...
        delete this.__visible__P_67_13;
        return this;
      },
      ...
      isVisible: function isVisible() {
        return this.__visible__P_67_13 === true;
      },
      ...
      */
      ...
      scrollChildIntoViewX: function scrollChildIntoViewX(elem, align, direct) {
        var thisEl = this.__element__P_67_11;
        ...
        if (direct !== false && thisEl && thisEl.offsetWidth && childEl && childEl.offsetWidth) {
          ...
          this.__lazyScrollIntoViewX__P_67_16 = {
            element: elem,
            align: align
          };
        ...
        delete this.__lazyScrollX__P_67_14;
      },
      ...
      scrollChildIntoViewY: function scrollChildIntoViewY(elem, align, direct) {
        ...
        if (direct !== false && thisEl && thisEl.offsetWidth && childEl && childEl.offsetWidth) {
          ...
          this.__lazyScrollIntoViewY__P_67_17 = {
            element: elem,
            align: align
          };
          qx.html.Element._scroll[this.toHashCode()] = this;
        ...
        delete this.__lazyScrollY__P_67_15;
      },
      ...
      scrollToX: function scrollToX(x, lazy) {
        ...
        if (lazy !== true && thisEl && thisEl.offsetWidth) {
          ...
          this.__lazyScrollX__P_67_14 = x;
          qx.html.Element._scroll[this.toHashCode()] = this;

          qx.html.Element._scheduleFlush("element");
        }

        delete this.__lazyScrollIntoViewX__P_67_16;
      },
      ...
      getScrollX: function getScrollX() {
        ...
        return this.__lazyScrollX__P_67_14 || 0;
      },
      ...
      scrollToY: function scrollToY(y, lazy) {
        ...
        if (lazy !== true && thisEl && thisEl.offsetWidth) {
          ...
          this.__lazyScrollY__P_67_15 = y;
          qx.html.Element._scroll[this.toHashCode()] = this;

          qx.html.Element._scheduleFlush("element");
        }

        delete this.__lazyScrollIntoViewY__P_67_17;
      },
      ...
      getScrollY: function getScrollY() {
        ...
        return this.__lazyScrollY__P_67_15 || 0;
      },
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__onScroll__P_67_33, this);
      },
      ...
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__onScroll__P_67_33, this);
      },
      __inScroll__P_67_34: null,
       ...
       */
      __onScroll__P_67_33: function __onScroll__P_67_33(e) {
        if (!this.__inScroll__P_67_34) {
          this.__inScroll__P_67_34 = true;
          this.__element__P_67_11.scrollTop = 0;
          this.__element__P_67_11.scrollLeft = 0;
          delete this.__inScroll__P_67_34;
        }
      },
      ...
      */
      ...
      getTextSelection: function getTextSelection() {
        var el = this.__element__P_67_11;
      ...
      setTextSelection: function setTextSelection(start, end) {
        ...
        qx.html.Element.__selection__P_67_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function clearTextSelection() {
        ...
        delete qx.html.Element.__selection__P_67_3[this.toHashCode()];
      },
      ...
      */
       ...
       */
      __performAction__P_67_35: function __performAction__P_67_35(action, args) {
      ...
      focus: function focus() {
        this.__performAction__P_67_35("focus");
      },
       ...
       */
      blur: function blur() {
        this.__performAction__P_67_35("blur");
      },
      ...
      activate: function activate() {
        this.__performAction__P_67_35("activate");
      },
      ...
      deactivate: function deactivate() {
        this.__performAction__P_67_35("deactivate");
      },
      ...
      capture: function capture(containerCapture) {
        this.__performAction__P_67_35("capture", [containerCapture !== false]);
      },
      ...
      releaseCapture: function releaseCapture() {
        this.__performAction__P_67_35("releaseCapture");
      },
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        if (!this.__styleValues__P_67_1) {
          this.__styleValues__P_67_1 = {};
        }

        if (this.__styleValues__P_67_1[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__styleValues__P_67_1[key];
        } else {
          this.__styleValues__P_67_1[key] = value;
        ...
        if (this.__element__P_67_11) {
          ...
          if (direct) {
            qx.bom.element.Style.set(this.__element__P_67_11, key, value);
            return this;
          } // Dynamically create if needed


          if (!this.__styleJobs__P_67_21) {
            this.__styleJobs__P_67_21 = {};
          } // Store job info


          this.__styleJobs__P_67_21[key] = true; // Register modification
      ...
      setStyles: function setStyles(map, direct) {
        ...
        if (this.__element__P_67_11) {
          ...
          for (var key in map) {
            ...
            if (direct) {
              Style.set(this.__element__P_67_11, key, value);
              continue;
            } // Store job info


            this.__styleJobs__P_67_21[key] = true;
      ...
      getStyle: function getStyle(key) {
        return this.__styleValues__P_67_1 ? this.__styleValues__P_67_1[key] : null;
      },
      ...
      getAllStyles: function getAllStyles() {
        return this.__styleValues__P_67_1 || null;
      },
      ...
      */
      ...
      setAttribute: function setAttribute(key, value, direct) {
        if (!this.__attribValues__P_67_2) {
          this.__attribValues__P_67_2 = {};
        }

        if (this.__attribValues__P_67_2[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__attribValues__P_67_2[key];
        } else {
          this.__attribValues__P_67_2[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__element__P_67_11) {
          // Omit queuing in direct mode
          if (direct) {
            qx.bom.element.Attribute.set(this.__element__P_67_11, key, value);
            return this;
          } // Dynamically create if needed


          if (!this.__attribJobs__P_67_22) {
            this.__attribJobs__P_67_22 = {};
          } // Store job info


          this.__attribJobs__P_67_22[key] = true; // Register modification
      ...
      getAttribute: function getAttribute(key) {
        return this.__attribValues__P_67_2 ? this.__attribValues__P_67_2[key] : null;
      },
      ...
      */
      ...
      _setProperty: function _setProperty(key, value, direct) {
        if (!this.__propertyValues__P_67_24) {
          this.__propertyValues__P_67_24 = {};
        }

        if (this.__propertyValues__P_67_24[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__propertyValues__P_67_24[key];
        } else {
          this.__propertyValues__P_67_24[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__element__P_67_11) {
          ...
          if (!this.__propertyJobs__P_67_23) {
            this.__propertyJobs__P_67_23 = {};
          } // Store job info


          this.__propertyJobs__P_67_23[key] = true; // Register modification
      ...
      _getProperty: function _getProperty(key) {
        var db = this.__propertyValues__P_67_24;
      ...
      */
      ...
      addListener: function addListener(type, listener, self, capture) {
        ...
        if (this.__element__P_67_11) {
          return qx.event.Registration.addListener(this.__element__P_67_11, type, listener, self, capture);
        }

        if (!this.__eventValues__P_67_25) {
          this.__eventValues__P_67_25 = {};
        }
        ...
        this.__eventValues__P_67_25[id] = {
          type: type,
          listener: listener,
          self: self,
          capture: capture,
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        ...
        if (this.__element__P_67_11) {
          ...
          qx.event.Registration.removeListener(this.__element__P_67_11, type, listener, self, capture);
        } else {
          var values = this.__eventValues__P_67_25;
          var entry;
      ...
      removeListenerById: function removeListenerById(id) {
        ...
        if (this.__element__P_67_11) {
          qx.event.Registration.removeListenerById(this.__element__P_67_11, id);
        } else {
          delete this.__eventValues__P_67_25[id];
        }
      ...
      hasListener: function hasListener(type, capture) {
        ...
        if (this.__element__P_67_11) {
          return qx.event.Registration.hasListener(this.__element__P_67_11, type, capture);
        }
      ...
      getListeners: function getListeners() {
        ...
        if (this.__element__P_67_11) {
          return qx.event.Registration.getManager(this.__element__P_67_11).serializeListeners(this.__element__P_67_11);
        }

        var listeners = [];

        for (var id in this.__eventValues__P_67_25) {
          var listenerData = this.__eventValues__P_67_25[id];
          listeners.push({
    ...
    */
    defer: function defer(statics) {
      statics.__deferredCall__P_67_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeArray("__children__P_67_26");

      this.__attribValues__P_67_2 = this.__styleValues__P_67_1 = this.__eventValues__P_67_25 = this.__propertyValues__P_67_24 = this.__attribJobs__P_67_22 = this.__styleJobs__P_67_21 = this.__propertyJobs__P_67_23 = this.__element__P_67_11 = this.__parent__P_67_28 = this.__lazyScrollIntoViewX__P_67_16 = this.__lazyScrollIntoViewY__P_67_17 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1598045170729