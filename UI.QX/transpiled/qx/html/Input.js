(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Input", {
    ...
    */
    members: {
      __type__P_339_0: null,
      // used for webkit only
      __selectable__P_339_1: null,
      __enabled__P_339_2: null,
      ...
      */
      ...
      _createDomElement: function _createDomElement() {
        return qx.bom.Input.create(this.__type__P_339_0);
      },
      // overridden
      ...
      setEnabled: function setEnabled(value) {
        ...
        if (qx.core.Environment.get("engine.name") == "webkit") {
          if (!value) {
            ...
            this.setStyles({
              "userModify": null,
              "userSelect": this.__selectable__P_339_1 ? null : "none"
            });
          }
        }
      },
      ...
      setSelectable: qx.core.Environment.select("engine.name", {
        "webkit": function webkit(value) {
          this.__selectable__P_339_1 = value; // Only apply the value when it is enabled

          qx.html.Input.prototype.setSelectable.base.call(this, this.__enabled__P_339_2 && value);
        },
      ...
      */
      ...
      setWrap: function setWrap(wrap, direct) {
        if (this.__type__P_339_0 === "textarea") {
...
//# sourceMappingURL=Input.js.map?dt=1598051423934