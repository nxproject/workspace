  ...
  qx.Class.define("qx.html.Iframe", {
    ...
    */
    ...
    construct: function construct(url, styles, attributes) {
      ...
      this.setSource(url);
      this.addListener("navigate", this.__onNavigate__P_338_0, this); // add yourself to the element queue to enforce the creation of DOM element
    ...
    */
    members: {
      ...
      */
      __onNavigate__P_338_0: function __onNavigate__P_338_0(e) {
...
//# sourceMappingURL=Iframe.js.map?dt=1598051423850