  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.util.RingBuffer", {
    ...
    members: {
      ...
      __nextIndexToStoreTo__P_100_0: 0,
      //Number of elements in ring buffer
      __entriesStored__P_100_1: 0,
      //Was a mark set?
      __isMarkActive__P_100_2: false,
      //How many elements were stored since setting of mark?
      __entriesStoredSinceMark__P_100_3: 0,
      //ring buffer
      __entries__P_100_4: null,
      //Maximum number of messages to store. Could be converted to a qx property.
      __maxEntries__P_100_5: null,
      ...
      setMaxEntries: function setMaxEntries(maxEntries) {
        this.__maxEntries__P_100_5 = maxEntries;
        this.clear();
      },
      ...
      getMaxEntries: function getMaxEntries() {
        return this.__maxEntries__P_100_5;
      },
      ...
      addEntry: function addEntry(entry) {
        this.__entries__P_100_4[this.__nextIndexToStoreTo__P_100_0] = entry;
        this.__nextIndexToStoreTo__P_100_0 = this.__addToIndex__P_100_6(this.__nextIndexToStoreTo__P_100_0, 1); //Count # of stored entries

        var max = this.getMaxEntries();

        if (this.__entriesStored__P_100_1 < max) {
          this.__entriesStored__P_100_1++;
        } //Count # of stored elements since last mark call


        if (this.__isMarkActive__P_100_2 && this.__entriesStoredSinceMark__P_100_3 < max) {
          this.__entriesStoredSinceMark__P_100_3++;
        }
      },
      ...
      getNumEntriesStored: function getNumEntriesStored() {
        return this.__entriesStored__P_100_1;
      },
       ...
       */
      mark: function mark() {
        this.__isMarkActive__P_100_2 = true;
        this.__entriesStoredSinceMark__P_100_3 = 0;
      },
      ...
      clearMark: function clearMark() {
        this.__isMarkActive__P_100_2 = false;
      },
      ...
      getEntries: function getEntries(count, startingFromMark) {
        ...
        if (count > this.__entriesStored__P_100_1) {
          count = this.__entriesStored__P_100_1;
        } // Trim count so it does not exceed last call to mark (if mark was called
        // and startingFromMark was true)


        if (startingFromMark && this.__isMarkActive__P_100_2 && count > this.__entriesStoredSinceMark__P_100_3) {
          count = this.__entriesStoredSinceMark__P_100_3;
        }

        if (count > 0) {
          var indexOfYoungestElementInHistory = this.__addToIndex__P_100_6(this.__nextIndexToStoreTo__P_100_0, -1);

          var startIndex = this.__addToIndex__P_100_6(indexOfYoungestElementInHistory, -count + 1);

          var result;

          if (startIndex <= indexOfYoungestElementInHistory) {
            //Requested segment not wrapping around ringbuffer boundary, get in one run
            result = this.__entries__P_100_4.slice(startIndex, indexOfYoungestElementInHistory + 1);
          } else {
            //Requested segment wrapping around ringbuffer boundary, get two parts & concat
            result = this.__entries__P_100_4.slice(startIndex, this.__entriesStored__P_100_1).concat(this.__entries__P_100_4.slice(0, indexOfYoungestElementInHistory + 1));
          }
        } else {
          result = [];
        }
      ...
      clear: function clear() {
        this.__entries__P_100_4 = new Array(this.getMaxEntries());
        this.__entriesStored__P_100_1 = 0;
        this.__entriesStoredSinceMark__P_100_3 = 0;
        this.__nextIndexToStoreTo__P_100_0 = 0;
      },
       ...
       */
      __addToIndex__P_100_6: function __addToIndex__P_100_6(idx, addMe) {
        var max = this.getMaxEntries();
...
//# sourceMappingURL=RingBuffer.js.map?dt=1598045174496