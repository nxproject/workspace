    ...
    statics: {
      ...
      cssStringToRgb: function cssStringToRgb(str) {
        ...
        if (this.isNamedColor(str)) {
          ...
          color = this.__rgbaStringToRgb__P_124_0(str);
        } else if (this.isRgbString(str)) {
          color = this.__rgbStringToRgb__P_124_1();
        } else if (this.ishexShortString(str)) {
          color = this.__hexShortStringToRgb__P_124_2();
        } else if (this.ishexLongString(str)) {
          color = this.__hexLongStringToRgb__P_124_3();
        }
       ...
       */
      __rgbStringToRgb__P_124_1: function __rgbStringToRgb__P_124_1() {
      ...
      * @return {Array} an array with red, green, blue
      */
      __rgbaStringToRgb__P_124_0: function __rgbaStringToRgb__P_124_0() {
        var red = parseInt(RegExp.$1, 10);
        var green = parseInt(RegExp.$2, 10);
        var blue = parseInt(RegExp.$3, 10);
       ...
       * @return {Array} an array with red, green, blue
       */
      __hexShortStringToRgb__P_124_2: function __hexShortStringToRgb__P_124_2() {
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex3StringToRgb__P_124_4: function __hex3StringToRgb__P_124_4() {
        var red = parseInt(RegExp.$1, 16) * 17;
        var green = parseInt(RegExp.$2, 16) * 17;
        var blue = parseInt(RegExp.$3, 16) * 17;
        return [red, green, blue];
       ...
       * @return {Array} an array with red, green, blue
       */
      __hex6StringToRgb__P_124_5: function __hex6StringToRgb__P_124_5() {
       ...
       * @return {Array} an array with red, green, blue
       */
      __hexLongStringToRgb__P_124_3: function __hexLongStringToRgb__P_124_3() {
      ...
      hex3StringToRgb: function hex3StringToRgb(value) {
        if (this.isHex3String(value)) {
          return this.__hex3StringToRgb__P_124_4(value);
        }
      ...
      hex6StringToRgb: function hex6StringToRgb(value) {
        if (this.isHex6String(value)) {
          return this.__hex6StringToRgb__P_124_5(value);
        }
      ...
      hexStringToRgb: function hexStringToRgb(value) {
        if (this.ishexShortString(value)) {
          return this.__hexShortStringToRgb__P_124_2(value);
        }

        if (this.ishexLongString(value)) {
          return this.__hexLongStringToRgb__P_124_3(value);
        }
       ...
       */
      __tuner__P_124_6: function __tuner__P_124_6(color, tuneMap, tuner, hue_tuner) {
      ...
      scale: function scale(color, scaleMap) {
        return this.__tuner__P_124_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust: function adjust(color, adjustMap) {
        return this.__tuner__P_124_6(color, adjustMap, function (value, offset, max) {
          value += offset;
...
//# sourceMappingURL=ColorUtil.js.map?dt=1598045176585