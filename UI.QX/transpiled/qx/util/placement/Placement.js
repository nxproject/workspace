  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct: function construct() {
      ...
      this.__defaultAxis__P_150_0 = qx.util.placement.DirectAxis;
    },
    properties: {
      /**
    ...
    statics: {
      ...
      compute: function compute(size, area, target, offsets, position, modeX, modeY) {
        this.__instance__P_150_1 = this.__instance__P_150_1 || new qx.util.placement.Placement();
        ...
        this.__instance__P_150_1.set({
          axisX: this.__getAxis__P_150_2(modeX),
          axisY: this.__getAxis__P_150_2(modeY),
          edge: edge,
          align: align
        });

        return this.__instance__P_150_1.compute(size, area, target, offsets);
      },
      __direct__P_150_3: null,
      __keepAlign__P_150_4: null,
      __bestFit__P_150_5: null,
       ...
       */
      __getAxis__P_150_2: function __getAxis__P_150_2(mode) {
        switch (mode) {
          case "direct":
            this.__direct__P_150_3 = this.__direct__P_150_3 || qx.util.placement.DirectAxis;
            return this.__direct__P_150_3;

          case "keep-align":
            this.__keepAlign__P_150_4 = this.__keepAlign__P_150_4 || qx.util.placement.KeepAlignAxis;
            return this.__keepAlign__P_150_4;

          case "best-fit":
            this.__bestFit__P_150_5 = this.__bestFit__P_150_5 || qx.util.placement.BestFitAxis;
            return this.__bestFit__P_150_5;
    ...
    members: {
      ...
      compute: function compute(size, area, target, offsets) {
        ...
        var axisX = this.getAxisX() || this.__defaultAxis__P_150_0;
        ...
        }, area.width, this.__getPositionX__P_150_6());

        var axisY = this.getAxisY() || this.__defaultAxis__P_150_0;
        ...
        }, area.height, this.__getPositionY__P_150_7());
        return {
          left: left,
          top: top
        };
       ...
       */
      __getPositionX__P_150_6: function __getPositionX__P_150_6() {
       ...
       * @return {String} the position
       */
      __getPositionY__P_150_7: function __getPositionY__P_150_7() {
        var edge = this.getEdge();
        var align = this.getAlign();
    ...
    destruct: function destruct() {
      this._disposeObjects("__defaultAxis__P_150_0");
    }
  });
  qx.util.placement.Placement.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Placement.js.map?dt=1598045179018