  ...
  qx.Class.define("qx.util.TimerManager", {
    ...
    members: {
      ...
      start: function start(callback, recurTime, context, userData, initialTime) {
        ...
        qx.util.TimerManager.__timerData__P_337_1[++qx.util.TimerManager.__timerId__P_337_2] = {
          callback: callback,
        ...
        this.__insertNewTimer__P_337_4(expireAt, qx.util.TimerManager.__timerId__P_337_2); // Give 'em the timer id


        return qx.util.TimerManager.__timerId__P_337_2;
      },
      ...
      stop: function stop(timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__timerQueue__P_337_0;
        ...
        delete qx.util.TimerManager.__timerData__P_337_1[timerId]; // If there are no more timers pending...

        if (timerQueue.length == 0 && this.__timerListenerActive__P_337_3) {
          // ... then stop listening for the periodic timer
          qx.event.Idle.getInstance().removeListener("interval", this.__processQueue__P_337_5, this);
          this.__timerListenerActive__P_337_3 = false;
        }
      },
       ...
       *
       */
      __insertNewTimer__P_337_4: function __insertNewTimer__P_337_4(expireAt, timerId) {
        ...
        var timerQueue = qx.util.TimerManager.__timerQueue__P_337_0;
        var timerData = qx.util.TimerManager.__timerData__P_337_1;
        var length = timerQueue.length;
        ...
        if (!this.__timerListenerActive__P_337_3) {
          // ... then start listening for the periodic timer.
          qx.event.Idle.getInstance().addListener("interval", this.__processQueue__P_337_5, this);
          this.__timerListenerActive__P_337_3 = true;
        }
      },
       ...
       *
       */
      __processQueue__P_337_5: function __processQueue__P_337_5() {
        // Get the current time
        var timeNow = new Date().getTime(); // While there are timer elements that need processing...

        var timerQueue = qx.util.TimerManager.__timerQueue__P_337_0;
        var timerData = qx.util.TimerManager.__timerData__P_337_1; // Is it time to process the first timer element yet?
        ...
        while (timerQueue.length > 0 && timerData[timerQueue[0]].expireAt <= timeNow) {
          ...
          if (expiredTimerData.recurTime && timerData[expiredTimerId]) {
            ...
            this.__insertNewTimer__P_337_4(expiredTimerData.expireAt, expiredTimerId);
          } else {
...
//# sourceMappingURL=TimerManager.js.map?dt=1598051423786