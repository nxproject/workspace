  ...
  qx.Class.define("qx.util.LibraryManager", {
    ...
    members: {
      ...
      has: function has(namespace) {
        return !!qx.util.LibraryManager.__libs__P_134_0[namespace];
      },
      ...
      get: function get(namespace, key) {
        return qx.util.LibraryManager.__libs__P_134_0[namespace][key] ? qx.util.LibraryManager.__libs__P_134_0[namespace][key] : null;
      },
      ...
      set: function set(namespace, key, value) {
        qx.util.LibraryManager.__libs__P_134_0[namespace][key] = value;
      }
    }
  });
...
//# sourceMappingURL=LibraryManager.js.map?dt=1598045177558