  ...
  qx.Class.define("qx.util.format.DateFormat", {
    ...
    */
    ...
    construct: function construct(format, locale) {
      ...
      this.__initialLocale__P_45_0 = this.__locale__P_45_1 = locale;

      if (format != null) {
        this.__format__P_45_2 = format.toString();

        if (this.__format__P_45_2 in qx.util.format.DateFormat.ISO_MASKS) {
          if (this.__format__P_45_2 === 'isoUtcDateTime') {
            this.__UTC__P_45_3 = true;
          }

          this.__format__P_45_2 = qx.util.format.DateFormat.ISO_MASKS[this.__format__P_45_2];
        }
      } else {
        this.__format__P_45_2 = qx.locale.Date.getDateFormat("long", this.getLocale()) + " " + qx.locale.Date.getDateTimeFormat("HHmmss", "HH:mm:ss", this.getLocale());
      }
    },
    ...
    */
    statics: {
      ...
      getDateInstance: function getDateInstance() {
        ...
        if (DateFormat._dateInstance == null || DateFormat._dateInstance.__format__P_45_2 != format) {
      ...
      getDateTimeInstance: function getDateTimeInstance() {
        ...
        if (DateFormat._dateTimeInstance == null || DateFormat._dateTimeInstance.__format__P_45_2 != format) {
    ...
    */
    members: {
      __locale__P_45_1: null,
      __initialLocale__P_45_0: null,
      __format__P_45_2: null,
      __parseFeed__P_45_4: null,
      __parseRules__P_45_5: null,
      __formatTree__P_45_6: null,
      __UTC__P_45_3: null,
       ...
       */
      __fillNumber__P_45_7: function __fillNumber__P_45_7(number, minSize) {
       ...
       */
      __getDayInYear__P_45_8: function __getDayInYear__P_45_8(date) {
       ...
       */
      __thursdayOfSameWeek__P_45_9: function __thursdayOfSameWeek__P_45_9(date) {
       ...
       */
      __getWeekInYear__P_45_10: function __getWeekInYear__P_45_10(date) {
        ...
        var thursdayDate = this.__thursdayOfSameWeek__P_45_9(date); // Get the year the thursday (and therefore the week) belongs to


        var weekYear = thursdayDate.getFullYear(); // Get the thursday of the week january 4th belongs to
        // (which defines week 1 of a year)

        var thursdayWeek1 = this.__thursdayOfSameWeek__P_45_9(new Date(weekYear, 0, 4)); // Calculate the calendar week
       ...
       */
      __getWeekInMonth__P_45_11: function __getWeekInMonth__P_45_11(date) {
        var thursdayDate = this.__thursdayOfSameWeek__P_45_9(date);

        var thursdayWeek1 = this.__thursdayOfSameWeek__P_45_9(new Date(date.getFullYear(), date.getMonth(), 4));
       ...
       */
      __getWeekYear__P_45_12: function __getWeekYear__P_45_12(date) {
        var thursdayDate = this.__thursdayOfSameWeek__P_45_9(date);
       ...
       */
      __isLeapYear__P_45_13: function __isLeapYear__P_45_13(year) {
       ...
       */
      __getMonthAndDayFromDayOfYear__P_45_14: function __getMonthAndDayFromDayOfYear__P_45_14(dayOfYear, year) {
        var month = 0;
       ...
       */
      __getYearFromWeekYearAndMonth__P_45_15: function __getYearFromWeekYearAndMonth__P_45_15(weekYear, month, dayOfMonth) {
        var year;
        ...
        switch (month) {
          case 11:
            ...
            if (weekYear != this.__getWeekYear__P_45_12(new Date(year, month, dayOfMonth))) {
              year = weekYear;
            }
      ...
      setLocale: function setLocale(value) {
        ...
        this.__locale__P_45_1 = value === null ? this.__initialLocale__P_45_0 : value;
      },
      ...
      getLocale: function getLocale() {
        var locale = this.__locale__P_45_1;
      ...
      format: function format(date) {
        ...
        this.__initFormatTree__P_45_16();

        var output = "";

        for (var i = 0; i < this.__formatTree__P_45_6.length; i++) {
          var currAtom = this.__formatTree__P_45_6[i];
          ...
          if (currAtom.type == "literal") {
            ...
            switch (wildcardChar) {
              case 'y':
                // Year
                if (wildcardSize == 2) {
                  replacement = this.__fillNumber__P_45_7(fullYear % 100, 2);
                } else {
              ...
              case 'Y':
                // Year
                replacement = this.__getWeekYear__P_45_12(date) + "";
              ...
              case 'Q':
                ...
                if (wildcardSize == 1 || wildcardSize == 2) {
                  replacement = this.__fillNumber__P_45_7(parseInt(month / 4) + 1, wildcardSize);
                }
              ...
              case 'D':
                // Day in year (e.g. 189)
                replacement = this.__fillNumber__P_45_7(this.__getDayInYear__P_45_8(date), wildcardSize);
                break;

              case 'd':
                // Day in month
                replacement = this.__fillNumber__P_45_7(dayOfMonth, wildcardSize);
                break;

              case 'w':
                // Week in year (e.g. 27)
                replacement = this.__fillNumber__P_45_7(this.__getWeekInYear__P_45_10(date), wildcardSize);
                break;

              case 'W':
                // Week in year (e.g. 27)
                replacement = this.__getWeekInMonth__P_45_11(date);
                break;
              ...
              case 'e':
                ...
                if (wildcardSize >= 1 && wildcardSize <= 2) {
                  replacement = this.__fillNumber__P_45_7(localeDayOfWeek, wildcardSize);
              ...
              case 'M':
                // Month
                if (wildcardSize == 1 || wildcardSize == 2) {
                  replacement = this.__fillNumber__P_45_7(month + 1, wildcardSize);
                } else if (wildcardSize == 3) {
              ...
              case 'H':
                // Hour in day (0-23)
                replacement = this.__fillNumber__P_45_7(hours, wildcardSize);
                break;

              case 'k':
                // Hour in day (1-24)
                replacement = this.__fillNumber__P_45_7(hours == 0 ? 24 : hours, wildcardSize);
                break;

              case 'K':
                // Hour in am/pm (0-11)
                replacement = this.__fillNumber__P_45_7(hours % 12, wildcardSize);
                break;

              case 'h':
                // Hour in am/pm (1-12)
                replacement = this.__fillNumber__P_45_7(hours % 12 == 0 ? 12 : hours % 12, wildcardSize);
                break;

              case 'm':
                // Minute in hour
                replacement = this.__fillNumber__P_45_7(minutes, wildcardSize);
                break;

              case 's':
                // Second in minute
                replacement = this.__fillNumber__P_45_7(seconds, wildcardSize);
                break;

              case 'S':
                // Fractional second
                replacement = this.__fillNumber__P_45_7(ms, 3);
              ...
              case 'z':
                ...
                if (wildcardSize >= 1 && wildcardSize <= 4) {
                  replacement = "GMT" + (timezoneSign > 0 ? "-" : "+") + this.__fillNumber__P_45_7(Math.abs(timezoneHours), 2) + ":" + this.__fillNumber__P_45_7(timezoneMinutes, 2);
                }
              ...
              case 'Z':
                // RFC 822 time zone
                if (wildcardSize >= 1 && wildcardSize <= 3) {
                  replacement = (timezoneSign > 0 ? "-" : "+") + this.__fillNumber__P_45_7(Math.abs(timezoneHours), 2) + this.__fillNumber__P_45_7(timezoneMinutes, 2);
                } else {
                  replacement = "GMT" + (timezoneSign > 0 ? "-" : "+") + this.__fillNumber__P_45_7(Math.abs(timezoneHours), 2) + ":" + this.__fillNumber__P_45_7(timezoneMinutes, 2);
                }
      ...
      parse: function parse(dateStr) {
        this.__initParseFeed__P_45_17(); // Apply the regex


        var hit = this.__parseFeed__P_45_4.regex.exec(dateStr);

        if (hit == null) {
          throw new Error("Date string '" + dateStr + "' does not match the date format: " + this.__format__P_45_2);
        } // Apply the rules
        ...
        for (var i = 0; i < this.__parseFeed__P_45_4.usedRules.length; i++) {
          var rule = this.__parseFeed__P_45_4.usedRules[i];
          ...
          if (rule.pattern == "Y+") {
            ...
            for (var k = 0; k < this.__parseFeed__P_45_4.usedRules.length; k++) {
              if (this.__parseFeed__P_45_4.usedRules[k].pattern == 'y+') {
          ...
          if (rule.pattern.indexOf("D") != -1) {
            ...
            for (var k = 0; k < this.__parseFeed__P_45_4.usedRules.length; k++) {
              if (this.__parseFeed__P_45_4.usedRules[k].pattern.indexOf("d") != -1) {
                dayRuleApplied = true;
                break;
              }
            }
        ...
        if (applyWeekYearAfterRule) {
          dateValues.year = this.__getYearFromWeekYearAndMonth__P_45_15(dateValues.weekYear, dateValues.month, dateValues.day);
        }

        if (applyDayOfYearAfterRule) {
          var dayAndMonth = this.__getMonthAndDayFromDayOfYear__P_45_14(dateValues.dayOfYear, dateValues.year);
       ...
       *
       */
      __initFormatTree__P_45_16: function __initFormatTree__P_45_16() {
        if (this.__formatTree__P_45_6 != null) {
          return;
        }

        this.__formatTree__P_45_6 = [];
        var currWildcardChar;
        var currWildcardSize = 0;
        var currLiteral = "";
        var format = this.__format__P_45_2;
        var state = "default";
        var i = 0;
          ...
          switch (state) {
            ...
            case "wildcard":
              ...
              if (currChar == currWildcardChar) {
                ...
                this.__formatTree__P_45_6.push({
                  type: "wildcard",
       ...
       */
      __initParseFeed__P_45_17: function __initParseFeed__P_45_17() {
        if (this.__parseFeed__P_45_4 != null) {
          // We already have the parse feed
          return;
        }

        var format = this.__format__P_45_2; // Initialize the rules

        this.__initParseRules__P_45_18();

        this.__initFormatTree__P_45_16(); // Get the used rules and construct the regex pattern


        var usedRules = [];
        var pattern = "^";

        for (var atomIdx = 0; atomIdx < this.__formatTree__P_45_6.length; atomIdx++) {
          var currAtom = this.__formatTree__P_45_6[atomIdx];
          ...
          if (currAtom.type == "literal") {
            ...
            for (var ruleIdx = 0; ruleIdx < this.__parseRules__P_45_5.length; ruleIdx++) {
              var rule = this.__parseRules__P_45_5[ruleIdx];

              if (this.__isRuleForWildcard__P_45_19(rule, wildcardChar, wildcardSize)) {
       ...
       */
      __isRuleForWildcard__P_45_19: function __isRuleForWildcard__P_45_19(rule, wildcardChar, wildcardSize) {
       ...
       *
       */
      __initParseRules__P_45_18: function __initParseRules__P_45_18() {
        var DateFormat = qx.util.format.DateFormat;
        var LString = qx.lang.String;

        if (this.__parseRules__P_45_5 != null) {
          // The parse rules are already initialized
          return;
        }

        var rules = this.__parseRules__P_45_5 = [];
...
//# sourceMappingURL=DateFormat.js.map?dt=1598045167371