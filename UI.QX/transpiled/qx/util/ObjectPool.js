  ...
  qx.Class.define("qx.util.ObjectPool", {
    ...
    members: {
      ...
      */
      ...
      getObject: function getObject(clazz) {
        ...
        var obj = null;
        var pool = this.__pool__P_62_0[clazz.classname];
      ...
      poolObject: function poolObject(obj) {
        // Dispose check
        if (!this.__pool__P_62_0) {
          return;
        }

        var classname = obj.classname;
        var pool = this.__pool__P_62_0[classname];
        ...
        if (!pool) {
          this.__pool__P_62_0[classname] = pool = [];
    ...
    */
    destruct: function destruct() {
      ...
      delete this.__pool__P_62_0;
    }
  });
  qx.util.ObjectPool.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=ObjectPool.js.map?dt=1598045170090