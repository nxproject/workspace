  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.Array", {
    ...
    construct: function construct(param) {
      ...
      if (param == undefined) {
        this.__array__P_87_0 = []; // check for elements (create the array)
        ...
        this.__array__P_87_0 = new Array(param); // check for an array itself
      } else if (param instanceof Array) {
        this.__array__P_87_0 = qx.lang.Array.clone(param); // error case
      } else {
        this.__array__P_87_0 = [];
        this.dispose();
      ...
      this.__updateLength__P_87_1(); // work against the console printout of the array
    ...
    */
    ...
    members: {
      ...
      pop: function pop() {
        ...
        this.__updateLength__P_87_1(); // remove the possible added event listener
      ...
      push: function push(varargs) {
        for (var i = 0; i < arguments.length; i++) {
          ...
          this.__updateLength__P_87_1(); // apply to every pushed item an event listener for the bubbling
      ...
      shift: function shift() {
        ...
        this.__updateEventPropagation__P_87_2(0, this.length); // fire change bubbles event
      ...
      splice: function splice(startIndex, amount, varargs) {
        ...
        var oldLength = this.__array__P_87_0.length; // invoke the slice on the array

        var returnArray = this.__array__P_87_0.splice.apply(this.__array__P_87_0, arguments); // fire a change event for the length
        ...
        this.__updateEventPropagation__P_87_2(startIndex + (arguments.length - 2) - amount, this.length); // fire the changeBubble event
      ...
      sort: function sort(func) {
        ...
        this.__array__P_87_0.sort.apply(this.__array__P_87_0, arguments); // prevent changeBubble event if nothing has been changed
      ...
      unshift: function unshift(varargs) {
        for (var i = arguments.length - 1; i >= 0; i--) {
          ...
          this.__updateLength__P_87_1(); // apply to every item an event listener for the bubbling
      ...
      setItem: function setItem(index, item) {
        var oldItem = this.__array__P_87_0[index]; // ignore settings of already set items [BUG #4106]

        if (oldItem === item) {
          return;
        }

        this.__array__P_87_0[index] = item; // set an event listener for the bubbling
      ...
      */
      ...
      removeAll: function removeAll() {
        ...
        var items = this.__array__P_87_0.concat(); // change the length


        this.__array__P_87_0.length = 0;

        this.__updateLength__P_87_1(); // fire change bubbles event
      ...
      append: function append(array) {
        ...
        Array.prototype.push.apply(this.__array__P_87_0, array); // add a listener to the new items
        ...
        this.__updateLength__P_87_1(); // fire change bubbles
      ...
      forEach: function forEach(callback, context) {
        for (var i = 0; i < this.__array__P_87_0.length; i++) {
          callback.call(context, this.__array__P_87_0[i], i, this);
        }
      },
...
//# sourceMappingURL=Array.js.map?dt=1598045173302