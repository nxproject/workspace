    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        {
          try {
            this.__validateConfig__P_2_1(name, config);
          } catch (ex) {
            if (implicitType) {
        ...
        var clazz = this.__createClass__P_2_2(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include); // Initialise class and constructor/destructor annotations


        ["@", "@construct", "@destruct"].forEach(function (id) {
          this.__attachAnno__P_2_3(clazz, id, null, config[id]);
        }, this); // Members, properties, events and mixins are only allowed for non-static classes

        if (config.extend) {
          // Attach properties
          if (config.properties) {
            this.__addProperties__P_2_4(clazz, config.properties, true);
          } // Attach members


          if (config.members) {
            this.__addMembers__P_2_5(clazz, config.members, true, true, false);
          } // Process events


          if (config.events) {
            this.__addEvents__P_2_6(clazz, config.events, true);
          } // Include mixins
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__addMixin__P_2_7(clazz, config.include[i], false);
            }
          }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__addInterface__P_2_8(clazz, config.implement[i]);
          }
        }

        {
          this.__validateAbstractInterfaces__P_2_9(clazz);
        } // Process defer
          ...
          qx.Bootstrap.addPendingDefer(clazz, function () {
            ...
            config.defer(clazz, clazz.prototype, {
              add: function add(name, config) {
                ...
                qx.Class.__addProperties__P_2_4(clazz, properties, true);
              }
            });
          });
        }
      ...
      include: function include(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_2_7(clazz, mixin, false);
      },
      ...
      patch: function patch(clazz, mixin) {
        ...
        qx.Class.__addMixin__P_2_7(clazz, mixin, true);
      ...
      */
       ...
       */
      __validateConfig__P_2_1: function __validateConfig__P_2_1(name, config) {
        // Validate type
        ...
        var allowed = config.type === "static" ? this.__staticAllowedKeys__P_2_11 : this.__allowedKeys__P_2_10;
       ...
       */
      __validateAbstractInterfaces__P_2_9: function __validateAbstractInterfaces__P_2_9(clazz) {
       ...
       */
      __attachAnno__P_2_3: function __attachAnno__P_2_3(clazz, group, key, anno) {
        if (anno !== undefined) {
       ...
       */
      __createClass__P_2_2: function __createClass__P_2_2(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__createDefaultConstructor__P_2_12();
            }

            clazz = this.__wrapConstructor__P_2_13(construct, name, type); // Add singleton getInstance()
          ...
          if (statics) {
            ...
            for (var i = 0, a = Object.keys(statics), l = a.length; i < l; i++) {
              ...
              this.__attachAnno__P_2_3(clazz, "statics", key, statics["@" + key]);
            }
          }
        } // Create namespace
      ...
      */
       ...
       */
      __addEvents__P_2_6: function __addEvents__P_2_6(clazz, events, patch) {
        {
       ...
       */
      __addProperties__P_2_4: function __addProperties__P_2_4(clazz, properties, patch) {
        ...
        for (var name in properties) {
          ...
          {
            this.__validateProperty__P_2_14(clazz, name, config, patch);
          ...
          if (config.event !== undefined) {
            ...
            this.__addEvents__P_2_6(clazz, event, patch);
          ...
          this.__attachAnno__P_2_3(clazz, "properties", name, config["@"]);
        }
      },
       ...
       */
      __validateProperty__P_2_14: function __validateProperty__P_2_14(clazz, name, config, patch) {
       ...
       */
      __addMembers__P_2_5: function __addMembers__P_2_5(clazz, members, patch, base, wrap) {
        var proto = clazz.prototype;
        var key, member;
        ...
        for (var i = 0, a = Object.keys(members), l = a.length; i < l; i++) {
          ...
          if (key.charAt(0) === '@') {
            ...
            if (members[annoKey] === undefined) {
              this.__attachAnno__P_2_3(clazz, "members", annoKey, members[key]);
            }
          ...
          if (base !== false && member instanceof Function && member.$$type == null) {
            if (wrap == true) {
              ...
              member = this.__mixinMemberWrapper__P_2_15(member, proto[key]);
            } else {
          ...
          this.__attachAnno__P_2_3(clazz, "members", key, members["@" + key]);
        }
      },
       ...
       */
      __mixinMemberWrapper__P_2_15: function __mixinMemberWrapper__P_2_15(member, base) {
        if (base) {
          return function () {
       ...
       */
      __addInterface__P_2_8: function __addInterface__P_2_8(clazz, iface) {
        {
          if (!clazz || !iface) {
       ...
       */
      __addMixin__P_2_7: function __addMixin__P_2_7(clazz, mixin, patch) {
        {
          if (!clazz || !mixin) {
            throw new Error("Incomplete parameters!");
          }
        ...
        for (var i = 0, l = list.length; i < l; i++) {
          ...
          if (entry.$$events) {
            this.__addEvents__P_2_6(clazz, entry.$$events, patch);
          } // Attach properties (Properties are already readonly themselves, no patch handling needed)


          if (entry.$$properties) {
            this.__addProperties__P_2_4(clazz, entry.$$properties, patch);
          } // Attach members (Respect patch setting, but dont apply base variables)


          if (entry.$$members) {
            this.__addMembers__P_2_5(clazz, entry.$$members, patch, patch, patch);
          }
      ...
      */
       ...
       */
      __createDefaultConstructor__P_2_12: function __createDefaultConstructor__P_2_12() {
       ...
       */
      __wrapConstructor__P_2_13: function __wrapConstructor__P_2_13(construct, name, type) {
...
//# sourceMappingURL=Class.js.map?dt=1598045159522