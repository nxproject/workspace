  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.fireEvent(this, type, clazz, args);
        }
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.fireEventAsync(this, type, clazz, args);
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.fireNonBubblingEvent(this, type, clazz, args);
        }
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__Registration__P_89_0.fireNonBubblingEventAsync(this, type, clazz, args);
        }
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__Registration__P_89_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__Registration__P_89_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
...
//# sourceMappingURL=MEvent.js.map?dt=1598045173425