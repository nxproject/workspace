...
(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    members: {
      __Property__P_29_0: true ? qx.core.Property : null,
      ...
      */
      ...
      clone: function clone() {
        ...
        var user = this.__Property__P_29_0.$$store.user;
        var setter = this.__Property__P_29_0.$$method.set;
      ...
      */
      ...
      setUserData: function setUserData(key, value) {
        if (!this.__userData__P_29_1) {
          this.__userData__P_29_1 = {};
        }

        this.__userData__P_29_1[key] = value;
      },
      ...
      getUserData: function getUserData(key) {
        ...
        var data = this.__userData__P_29_1[key];
    ...
    */
    destruct: function destruct() {
      ...
      this.__userData__P_29_1 = null; // only of properties are available

      {
        // Cleanup properties
        var clazz = this.constructor;
        var properties;
        var store = this.__Property__P_29_0.$$store;
...
//# sourceMappingURL=Object.js.map?dt=1598045165934